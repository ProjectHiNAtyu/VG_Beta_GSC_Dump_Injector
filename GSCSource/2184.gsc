...
_id_0271()
{
    ...
    {
        level._id_030F thread _id_FBCC();
...
_id_021D()
{
    ...
    level._id_03E1 = _func_020F();
    level._id_03E1._id_4871 = _func_020F();
    level._id_03E1._id_CB24 = _func_020F();
    ...
    level._id_03E1._id_71D7 = _func_020F();
...
_id_D19D( var_0 )
{
    foreach ( var_7, var_2 in var_0 )
    {
        foreach ( var_6, var_4 in var_2 )
        {
            ...
            {
                _func_01EA( var_7, var_4 );
                var_5 = "ai_busyEvent" + _func_00D6( var_7, 8 );
                _func_01EA( var_5, var_4 );
            }
        }
    }
}
...
_id_9A15()
{
    for (;;)
    {
        ...
        if ( !_id_B6FF() )
            _func_01EA( "#x3102271c5c0c0f040", 1 );

        _id_077B::_id_5C04( "stealth_spotted" );

        if ( !_id_B6FF() )
            _func_01EA( "#x3102271c5c0c0f040", 0 );
...
_id_18ED()
{
    if ( isdefined( level._id_03E1._id_7208 ) )
    {
        ...
        {
            if ( _id_0886::_id_71DB( var_1._id_02BA ) )
                return 1;
        }
    }
...
_id_FBCC()
{
    ...
    for (;;)
    {
        ...
        if ( var_1 )
        {
            ...
            {
                _id_077B::_id_5BFB( "stealth_spotted" );

                if ( isdefined( self._id_03E1 ) )
                {
                    var_2 = _id_088C::_id_64B3( "stealth_spotted" );
                    _id_077B::_id_5BFB( var_2 );
                }
            }
        }
        else if ( _id_077B::_id_5BE0( "stealth_spotted" ) )
        {
            _id_077B::_id_5BE4( "stealth_spotted" );
...
_id_EFA0()
{
    ...
    {
        _id_077B::_id_5C04( "stealth_enabled" );
        level._id_03E1._id_533F["axis"] = level._id_B758;
...
_id_5672( var_0 )
{
    ...
    {
        _func_01EA( var_4, var_2[var_0] );
        var_3 = "ai_busyEvent" + _func_00D6( var_4, 8 );
        _func_01EA( var_3, var_2[var_0] );
    }
}

_id_8081()
{
    _id_077B::_id_5BF1( "stealth_player_nade" );
    level._id_03E1._id_CB24._id_B543 = 0;
    _id_077B::_id_1BBA( level._id_B758, ::_id_B4AA );
}
...
_id_B4AA()
{
    for (;;)
    {
        ...
        _id_077B::_id_5BFB( "stealth_player_nade" );
...
_id_B4AB( var_0 )
{
    ...
    var_0 _id_077B::_id_108F3( "death", 10 );
    level._id_03E1._id_CB24._id_B543--;
    waittillframeend;

    if ( !level._id_03E1._id_CB24._id_B543 )
        _id_077B::_id_5BE4( "stealth_player_nade" );
}
...
_id_E7E6()
{
    ...
    if ( isdefined( level._id_03E1 ) )
    {
        ...
        {
            level._id_03E1._id_EBE7 = _func_020F();
            level._id_03E1._id_EBE7._id_4E2C = [];
            level._id_03E1._id_EBE7._id_C5E6 = 30;
            level._id_03E1._id_EBE7._id_DD2F = spawnstruct( 600 );
            level._id_03E1._id_EBE7._id_4873 = spawnstruct( 500 );
            level._id_03E1._id_EBE7._id_5EF1 = spawnstruct( 300 );
        }
...
_id_80AC()
{
    ...
    var_1 = _id_077B::_id_1B72( var_1, var_0 );

    if ( isdefined( var_1 ) )
    {
        foreach ( var_3 in var_1 )
        {
            var_4 = _func_021A( var_3._id_CE61, " " );
