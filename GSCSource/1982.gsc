...
_id_021D()
{
    ...
    for (;;)
    {
        var_1 = _func_021E( "mp/miscKillcamItems.csv", var_0, 0 );

        if ( !isdefined( var_1 ) || var_1 == "" )
            break;

        var_1 = int( var_1 );
        var_2 = _func_021E( "mp/miscKillcamItems.csv", var_0, 1 );
...
{
    self _meth_82F6( "cam_scene_name", var_0 );
    self _meth_82F6( "cam_scene_lead", var_1 );
    self _meth_82F6( "cam_scene_support", var_2 );
}

_id_6ABA( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_0 ) || !isdefined( var_1 ) || var_0 == var_1 && !_func_0102( var_0 ) )
        return undefined;
    ...
    switch ( var_2._id_0084 )
    {
        ...
        case "trophy_mp":
        case "trip_mine_mp":
            return _id_077B::_id_F07F( isdefined( var_1._id_8D49 ), var_1._id_8D49, var_1 );
    ...
    if ( _id_06BB::_id_87E2( var_2._id_0084 ) || _id_0A7F::_id_876D( var_2._id_0084 ) )
    {
        if ( isdefined( var_1._id_8D49 ) && !var_0 _id_0A6F::_id_1DB0() )
            return var_1._id_8D49;
        else
            return undefined;
    }
...
_id_D5BB( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    else if ( isdefined( var_6 ) && isdefined( var_6._id_0084 ) )
    {
        if ( var_6._id_0084 == "manual_turret_mp" )
            return 1;
    }
    else if ( var_4 > 0 )
    {
...
_id_BB86( var_0 )
{
    if ( isdefined( var_0 ) && !_func_0102( var_0 ) )
    {
        var_1 = [];

        if ( isdefined( self._id_37D9 ) && isdefined( self._id_37E4 ) )
        {
            var_2 = _id_07D9::_id_6C23( self._id_37E4 );
            var_1[var_1.size] = var_2;
        }

        if ( isdefined( var_0._id_37D9 ) && isdefined( var_0._id_37E4 ) )
        {
            var_3 = _id_07D9::_id_6C23( var_0._id_37E4 );
            var_1[var_1.size] = var_3;
        }

        if ( var_1.size > 0 )
            _id_07D9::_id_968F( var_1, 1 );
...
_id_99E0( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15 )
{
    ...
    var_16._id_A90B = var_7;
    var_16._id_A970 = var_8;
    var_16._id_9C9A = var_9;
    var_16._id_006E = var_10;
...
{
    _id_8D46( var_0._id_50FD, var_0._id_7E79, var_0._id_1DB3, var_0._id_8D4A, var_0._id_8D4B, var_0._id_8D50, var_0._id_8D4D, var_0._id_A90B, var_1, var_0._id_A970, var_2, var_0._id_9C9A, var_0._id_006E, var_0._id_103C0, var_0._id_DE28, var_0._id_1DB2, var_0._id_DDB4, var_0._id_4E56, var_3 );
}
...
_id_2E97( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( getdvar( "scr_killcam_time" ) == "" )
    {
        ...
        else if ( var_7._id_0084 == "artillery_mp" )
            var_11 = 2.25;
        else if ( var_7._id_0084 == "hover_jet_proj_mp" )
            var_11 = 3.0;
        else if ( var_7._id_0084 == "hover_jet_turret_mp" || var_7._id_0084 == "chopper_support_turret_mp" )
            var_11 = 1.5;
        else if ( var_7._id_0084 == "s4_ks_ord_ger_mp" )
            var_11 = 2.5;
        else if ( var_7._id_0084 == "cruise_proj_mp" )
            var_11 = 3.0;
        else if ( var_7._id_0084 == "javelin_mp" )
            var_11 = 8;
        else if ( _func_0121( var_7._id_0084, "remotemissile_" ) )
            var_11 = 5;
        else if ( isdefined( var_0._id_D112 ) && var_0._id_D112 == "multiturret" )
            var_11 = 2.0;
        else if ( !var_8 || var_8 > 5.0 )
            var_11 = 5.0;
        else if ( var_7._id_0084 == "s4_frag_usa_mk2_mp" || var_7._id_0084 == "frag_grenade_short_mp" || var_7._id_0084 == "s4_semtex_mp" || var_7._id_0084 == "semtexproj_mp" || var_7._id_0084 == "mortar_shell__mp" || var_7._id_0084 == "cluster_grenade_mp" || var_7._id_0084 == "s4_frag_gbr_n23_mp" || var_7._id_0084 == "s4_frag_ger_m24_mp" || var_7._id_0084 == "s4_frag_gbr_n82_mp" || var_7._id_0084 == "s4_bundle_charge_mp" )
            var_11 = 4.25;
        else
            var_11 = 2.5;
    }
    ...
    if ( _func_0102( var_2 ) || _func_0102( var_0 ) )
...
_id_D5C4( var_0 )
{
    self _meth_82F6( "ui_killcam_killedby_id", var_0 getentitynumber() );
}

_id_D5C2( var_0 )
{
    self _meth_82F6( "ui_killcam_end_milliseconds", int( var_0 * 1000 ) + gettime() );
}
...
_id_D87C( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        _id_D5C4( var_0 );
        self _meth_82F6( "ui_killcam_victim_id", var_1 getentitynumber() );
        self _meth_8214( var_0 );
    }

    if ( _id_0A7F::_id_88DC( var_2._id_0084 ) )
        _id_D5BE( var_2 );
    else if ( _id_0A69::_id_8743() )
    {
        for ( var_6 = 0; var_6 < 6; var_6++ )
            self _meth_82F6( "ui_killcam_killedby_perk" + var_6, -1 );
        ...
        if ( isdefined( var_0.arena_evo_perks ) )
        {
            ...
            foreach ( var_9 in var_0.arena_evo_perks )
            {
                ...
                self _meth_82F6( "ui_killcam_killedby_perk" + var_7, var_10 );
                var_7++;
            }
        }
    }
    ...
    if ( var_4 && !level._id_609B || isdefined( self ) && !level._id_609B || var_12 == 0 && !level._id_609B )
        self _meth_82F6( "ui_killcam_text", "skip" );
    else if ( !level._id_609B )
        self _meth_82F6( "ui_killcam_text", "respawn" );
    else
        self _meth_82F6( "ui_killcam_text", "none" );
...
_id_247C( var_0, var_1, var_2, var_3 )
{
    ...
    foreach ( var_5 in level._id_EF86 )
        self allowprone( var_5, 1 );
}

_id_34FF( var_0 )
{
    if ( self.archived + 0.015 < var_0 )
    {
        var_1 = var_0 - self.archived;
...
_id_BEC5()
{
    ...
    if ( istrue( level._id_DCB7 ) && _id_0A69::_id_6A43() == "br" )
        var_0 = 5;
...
_id_8D46( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15, var_16, var_17, var_18 )
{
    ...
    _id_0A74::_id_BD13( "killcam::killcam() START" );
    _id_C627();
    ...
    var_20._id_308C = self.archived - level._id_5F1B - var_8;
    ...
    _id_8D48( 1, undefined, var_18 );
    _id_0A74::_id_BD13( "killcam::killcam() COMPLETE" );
}

_id_C63B()
{
    self endon( "disconnect" );
    _id_077B::_id_108A6( 0.15, "killcam_canceled", "spawned" );
    self _meth_8282();
...
_id_BA7C( var_0, var_1, var_2, var_3 )
{
    ...
    _id_34FF( var_6 );
    self._id_8D4F = self.archived - var_7;
    self._id_8D46 = 1;
...
_id_D5C0( var_0, var_1, var_2, var_3 )
{
    if ( var_1 == "MOD_EXECUTION" )
        _id_D5BC( var_3 );
    else if ( !isdefined( var_0 ) || var_0._id_0084 == "none" )
        _id_3927();
    else
    {
        if ( isdefined( var_2._id_6FF8 ) )
        {
            ...
            var_4 = _id_0A7F::_id_69F9( var_0._id_0084 );

        if ( isdefined( _id_07F2::_id_6D89( var_0 ) ) )
            _id_D5C1( var_0 );
        else
        {
            ...
            if ( isdefined( level._id_8D51[var_0._id_0084] ) )
            {
                _id_D5BF( level._id_8D51[var_0._id_0084] );
                return;
            }
...
waittillhostmigrationdone()
{
    ...
    _id_0A74::_id_BD13( "killcam::waittillKillcamOver() START" );
    wait( self._id_8D4F - level._id_01CC / 1000.0 );
    _id_0A74::_id_BD13( "killcam::waittillKillcamOver() COMPLETE" );
}
...
_id_1085D( var_0 )
{
    ...
    if ( !_func_0104( self ) )
    {
        self _meth_824A( "kc_respawn", "+usereload" );
        self _meth_824A( "kc_respawn", "+activate" );
        self waittill( "kc_respawn" );
        _id_0A7B::_id_7D93( "skippedKillcams", 1 );
        _id_0A74::_id_BD13( "killcam::waitSkipKillcamButton() Killcam SKIPPED" );
...
_id_10861()
{
    ...
    {
        while ( !self _meth_81F7() )
            waitframe();
    }
    else
    {
        while ( self _meth_8427() || !self _meth_81F7() )
            waitframe();
    }

    _id_0A7B::_id_7D93( "skippedKillcams", 1 );
    _id_0A74::_id_BD13( "killcam::waitSkipKillcamKBMOrTouch() Killcam SKIPPED" );
    self notify( "abort_killcam" );
}
...
_id_5303()
{
    ...
    _id_0A74::_id_BD13( "killcam::endKillcamIfNothingToShow() Killcam SKIPPED" );
    self notify( "abort_killcam" );
}
...
_id_3929()
{
    ...
    self _meth_82F6( "ui_killcam_killedby_id", -1 );
    self _meth_82F6( "ui_killcam_victim_id", -1 );
    self _meth_82F6( "ui_killcam_killedby_loot_variant_id", -1 );
    self _meth_82F6( "ui_killcam_killedby_weapon_rarity", -1 );
    _id_3927();

    for ( var_0 = 0; var_0 < 6; var_0++ )
        self _meth_82F6( "ui_killcam_killedby_perk" + var_0, -1 );
}
...
_id_3928()
{
    self _meth_82F6( "ui_killcam_killedby_item_type", -1 );
    self _meth_82F6( "ui_killcam_killedby_item_id", -1 );
}

_id_D5BD( var_0, var_1 )
{
    self _meth_82F6( "ui_killcam_killedby_item_type", var_0 );
    self _meth_82F6( "ui_killcam_killedby_item_id", var_1 );
}
...
_id_D5C3( var_0, var_1 )
{
    ...
    var_0 = _id_0A7F::_id_9AB4( var_0, var_1 );
    var_2 = _id_0A7F::_id_6E6C( var_0._id_0084 );
    var_3 = _func_0225( "mp/statstable.csv", 4, var_2 );
    self _meth_82F6( "ui_weapon_pickup", 0 );
    ...
    var_4 = _id_07C4::_id_6B01( var_0._id_0084, var_0._id_04A4 );

    if ( isdefined( var_4 ) )
    {
        self _meth_82F6( "ui_killcam_killedby_loot_variant_id", var_4._id_04A4 );
        self _meth_82F6( "ui_killcam_killedby_weapon_rarity", var_4._id_BE8A - 1 );
    }
    else
    {
        self _meth_82F6( "ui_killcam_killedby_loot_variant_id", -1 );
    ...
    self _meth_82F6( "ui_killcam_killedby_weapon_rarity_notify", gettime() );
    _id_D5BD( 0, var_3 );
    ...
    if ( var_2 != "s4_me_knife" )
    {
        ...
        {
            var_8 = var_5[var_7];
            var_9 = _id_0A7F::_id_1D7D( var_8 );

            if ( _id_0A7F::_id_1D73( var_2, var_9 ) )
            {
                if ( var_6 >= 8 )
                    break;
                ...
                {
                    self _meth_82F6( "ui_killcam_killedby_attachment" + ( var_6 + 1 ), var_10 );
                    var_6++;
                }
            }
        }
        ...
        for ( var_7 = var_6; var_7 < 8; var_7++ )
            self _meth_82F6( "ui_killcam_killedby_attachment" + ( var_7 + 1 ), -1 );
    }
}

_id_D5C1( var_0 )
{
    var_1 = _id_07F2::_id_6D89( var_0 );
    var_2 = _id_07F2::_id_6D83( var_1 );
    _id_D5BD( 2, var_2 );
    _id_3933();
    _id_3927();
}
...
_id_D5BE( var_0 )
{
    var_1 = _id_0A6F::_id_6AC4( level._id_8DD5[var_0._id_0084] );
    ...
    if ( isdefined( self._id_CC15 ) )
    {
        ...
        self _meth_82F6( "ui_killcam_killedby_item_type", 1 );
        self _meth_82F6( "ui_killcam_killedby_loot_variant_id", var_1 );
        self _meth_82F6( "ui_killcam_killedby_weapon_rarity", var_2 - 1 );
    }
    else
    {
        _id_D5BD( 1, var_1 );
...
_id_D5BA( var_0 )
{
    var_1 = scripts\engine\trace::_id_69F5( var_0 );
    var_2 = scripts\engine\trace::_id_69F8( var_1 );
...
_id_3927()
{
    for ( var_0 = 0; var_0 < 8; var_0++ )
        self _meth_82F6( "ui_killcam_killedby_attachment" + ( var_0 + 1 ), -1 );
}
...
_id_8818( var_0 )
{
    ...
    if ( isdefined( var_0._id_8D49 ) && isdefined( var_0._id_00DE ) )
    {
