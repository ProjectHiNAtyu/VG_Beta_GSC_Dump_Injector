...
_id_325D()
{
    var_0 = _id_09B4::_id_100BF( "cargo_truck", 1 );
    ...
    if ( _id_099D::_id_8A10( "cargo_truck", "init" ) )
        [[ _id_099D::_id_6D05( "cargo_truck", "init" ) ]]();
...
_id_3261()
{
    if ( _id_099D::_id_8A10( "cargo_truck", "initLate" ) )
        [[ _id_099D::_id_6D05( "cargo_truck", "initLate" ) ]]();
}

_id_3262()
{
    var_0 = _id_09BA::_id_101A1( "cargo_truck", 1 );
    var_0._id_54B6 = ::_id_3257;
    var_0._id_5770 = _id_09BA::_id_10183;
    var_0._id_575B = ::_id_3259;
    var_0._id_C718 = _id_09BA::_id_10192();
    ...
    var_0._id_5758[var_1] = "left";
    var_2 = "driver";
    var_3 = _id_09BA::_id_101A0( "cargo_truck", var_2, 1 );
...
_id_325F()
{
    level._id_0BA3["cargo_truck_explode"] = _func_0139( "vfx/iw8_mp/vehicle/vfx_cargotr_mp_death_exp.vfx" );
}
...
_id_3254( var_0, var_1 )
{
    ...
    _id_09B4::_id_10024( var_2, "cargo_truck", var_0 );
    var_2._id_A90B = _func_034C( "cargo_truck_mp" );
    _id_09B5::_id_10016( var_2 );
    _id_09B4::vehicle_create( var_2, var_0 );
    thread _id_09B4::_id_102E0( var_2, undefined, _id_09B4::_id_100A8 );

    if ( _id_099D::_id_8A10( "cargo_truck", "create" ) )
        [[ _id_099D::_id_6D05( "cargo_truck", "create" ) ]]( var_2 );
...
_id_325B( var_0, var_1 )
{
    ...
    if ( level._id_60D1 == "base" && isdefined( var_0._id_006E ) && _func_0117( var_0._id_006E ) && _id_099D::_id_8A10( "game", "addCashForScoreEvent" ) )
        var_0._id_006E thread [[ _id_099D::_id_6D05( "game", "addCashForScoreEvent" ) ]]( "destroyed_truck", undefined, undefined );
    ...
    if ( !istrue( level._id_EBC0 ) )
    {
        ...
        self _meth_8287( var_2, 256, 140, 70, var_3, "MOD_EXPLOSIVE", "cargo_truck_mp" );
        _func_0196( _id_077B::_id_6A40( "cargo_truck_explode" ), var_2, anglestoforward( self._id_0054 ), anglestoup( self._id_0054 ) );
...
_id_3256()
{
    ...
    if ( _id_099D::_id_8A10( "cargo_truck", "delete" ) )
        [[ _id_099D::_id_6D05( "cargo_truck", "delete" ) ]]( self );
...
_id_3264()
{
    ...
    var_0._id_E271 = _id_099D::_id_6D05( "cargo_truck", "spawnCallback" );
    var_0._id_38FF = 185;
    var_0._id_38FB = 138;
    var_0._id_38FD = 185;
}
...
_id_325C()
{
    var_0 = _id_077B::_id_6D7C( "cargotruck_spawn", "targetname" );
