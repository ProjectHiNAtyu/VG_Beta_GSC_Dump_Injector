...
_id_95FF()
{
    var_0 = _func_0225( "mp/gameModeMatchStats.csv", 0, level._id_60D1 );
    ...
    {
        var_3 = _func_021E( "mp/gameModeMatchStats.csv", var_0, var_2 );
...
_id_8241()
{
    if ( isdefined( self._id_0309["matchstats"] ) )
        self._id_9BE0 = self._id_0309["matchstats"];
    else
    {
        self._id_9BE0 = _func_020F();
        var_0 = self._id_9BE0;
