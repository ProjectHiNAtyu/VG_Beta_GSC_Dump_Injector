...
_id_1D17( var_0 )
{
    var_0 _meth_80B7( 200, self._id_02EA, self._id_02F2, self, "MOD_EXPLOSIVE", _func_034C( "at_mine_mp" ) );
    var_1 = var_0 _id_0A62::_id_A58E( self._id_02F2, _func_034C( "at_mine_mp" ), self, "MOD_EXPLOSIVE" );
    thread _id_1D18();
    waitframe();
...
_id_1D1D( var_0 )
{
    ...
    var_1 = _id_0A7F::_hasperk( "at_mine_ap_mp", self._id_02EA, ( 0, 0, 0 ), 100, 1 );
    var_1 _meth_820B( self );
    thread _id_1D0E( var_1 );
    var_1._id_10D0A = _func_034C( "at_mine_ap_mp" );
    self._id_4320 = var_1;
...
_id_1D1A( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_2._id_0084 != "at_mine_mp" && var_2._id_0084 != "at_mine_ap_mp" )
        return var_4;
