...
_id_ACC0( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    foreach ( var_11 in var_7._id_B7D8 )
    {
        ...
        var_12 = outlinedisable( var_0, var_11 );
...
_id_ACB8( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
    {
        level._id_ACC4 = _id_077B::_id_1BA9( level._id_ACC4 );
        return;
    }
    ...
    foreach ( var_4 in var_2._id_B7D8 )
    {
        ...
        var_5 = outlinedisable( var_1, var_4 );
...
_id_ACE7( var_0 )
{
    ...
    foreach ( var_7, var_2 in var_0._id_ACEB )
    {
        ...
        foreach ( var_4 in var_2._id_B7D8 )
        {
            ...
            var_5 = outlinedisable( var_0, var_4 );
...
_id_ACE1( var_0 )
{
    if ( !isdefined( var_0._id_045B ) || var_0._id_045B == "spectator" || var_0._id_045B == "follower" )
        return;
...
_id_ACEA( var_0, var_1 )
{
    ...
    foreach ( var_3 in level._id_ACC4 )
    {
        ...
        foreach ( var_6 in var_3._id_ACEB )
        {
            ...
            var_6._id_B7D8 = _id_077B::_id_1BA9( var_6._id_B7D8 );

            if ( isdefined( var_0 ) && _id_077B::_id_1B78( var_6._id_B7D8, var_0 ) )
            {
                var_6._id_B7D8 = _id_077B::_id_1B96( var_6._id_B7D8, var_0 );
                var_4 = 1;
            }
        }
...
_id_ACAC( var_0 )
{
    foreach ( var_2 in level._id_ACC4 )
    {
        ...
        {
            if ( var_5._id_048F == "ALL" || var_5._id_048F == "TEAM" && var_5._id_045B == var_0._id_045B )
            {
                if ( !_id_077B::_id_1B78( var_5._id_B7D8, var_0 ) )
...
_id_ACAD( var_0 )
{
    ...
    foreach ( var_2 in level._id_ACC4 )
    {
        ...
        foreach ( var_5 in var_2._id_ACEB )
        {
            if ( var_5._id_048F == "SQUAD" && var_5._id_045B == var_0._id_045B && isdefined( var_5._id_E493 ) && var_5._id_E493 == var_0._id_E493 )
            {
                if ( !_id_077B::_id_1B78( var_5._id_B7D8, var_0 ) )
                    var_5._id_B7D8[var_5._id_B7D8.size] = var_0;
                else
...
_id_ACAF( var_0 )
{
    if ( !_id_077B::_id_1B78( level._id_ACC4, var_0 ) )
        level._id_ACC4[level._id_ACC4.size] = var_0;
}

_id_ACE9( var_0 )
{
    level._id_ACC4 = _id_077B::_id_1B96( level._id_ACC4, var_0 );
}
...
outlinedisable( var_0, var_1 )
{
    ...
    foreach ( var_5, var_4 in var_0._id_ACEB )
    {
        ...
        if ( _id_077B::_id_1B78( var_4._id_B7D8, var_1 ) && ( !isdefined( var_2 ) || var_4._id_BD19 > var_2._id_BD19 ) )
            var_2 = var_4;
    }
...
_id_ACE8( var_0, var_1 )
{
    ...
    var_2._id_B7D9 = _id_077B::_id_1BA9( var_2._id_B7D9 );
...
_id_3180( var_0 )
{
    return var_0._id_0392 != "spectator";
}
