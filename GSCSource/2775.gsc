...
_id_021D()
{
    self._id_1877 = _func_020F();
    self._id_1877._id_AAB1 = [];
    self._id_1877._id_AAB1["idle"] = _id_0AD4::_id_0271;
    self._id_1877._id_AAB1["move"] = _id_0AD6::_id_0271;
    self._id_1877._id_AAB1["traverse"] = _id_0AD8::_id_0271;
    self._id_1877._id_AAB1["melee"] = _id_0AD5::_id_0271;
...
_id_4957( var_0 )
{
    ...
    if ( distance2dsquared( var_0._id_02EA, self._id_901A ) > 4 )
        return 0;

    if ( self._id_251B )
        return 1;

    if ( distancesquared( self._id_02EA, self._id_9019 ) > 4096 && gettime() - self._id_901B > 2000 )
        return 0;
...
_id_4956()
{
    if ( isdefined( self._id_8FFB ) && isdefined( self._id_8FFA ) && distance2dsquared( self._id_411B._id_02EA, self._id_8FFB ) < 4 && distancesquared( self._id_02EA, self._id_8FFA ) < 2500 )
        return 1;
...
_id_FCCB()
{
    ...
    if ( self._id_A24F == "pursuit" )
    {
        ...
        if ( isdefined( self._id_8F7E ) && gettime() - self._id_8F7E < 1000 )
        {
            if ( distance2dsquared( var_0, self._id_8F7C ) < 16 )
                var_4 = 1;
            else if ( isdefined( self._id_8F7D ) && self._id_8F7D == "pursuit" && distance2dsquared( self._id_8F7F, self._id_017D._id_02EA ) < 16 )
                var_4 = 1;
        }
    ...
    {
        if ( self._id_02F2._id_0392 == "spectator" )
            return;
        ...
        {
            var_5 = self._id_02F2 getstance();

            if ( !isdefined( self._id_02F2._id_BC55 ) && isdefined( self._id_02F2 ) )
                self._id_02F2._id_BC55 = var_5;

            var_6 = !isdefined( self._id_AD97 ) || distance2dsquared( self._id_AD97, self._id_02F2._id_02EA ) > 20736;

            if ( var_6 )
                self._id_AD97 = self._id_02F2._id_02EA;

            var_7 = distance2dsquared( self._id_02EA, self._id_02F2._id_02EA );
        ...
        else if ( self._id_1328 == "protect" )
        {
            ...
            var_10 = distance2dsquared( self._id_02EA, self._id_BDB3 );
...
_id_6B4B( var_0 )
{
    if ( isdefined( self._id_017D ) )
    {
        ...
        if ( abs( self._id_02EA[2] - self._id_017D._id_02EA[2] ) < self._id_109F9 && distance2dsquared( self._id_017D._id_02EA, self._id_02EA ) < self._id_1DCF )
            return "pursuit";

        if ( isdefined( self._id_411B ) && self._id_411B == self._id_017D )
        {
            if ( distance2dsquared( self._id_411B._id_02EA, self._id_02EA ) < self._id_8CB0 )
                return "pursuit";
        }
    }
...
_id_D637( var_0 )
{
    if ( var_0 )
    {
        ...
        {
            self._id_901A = self._id_017D._id_02EA;
            self._id_9019 = self._id_02EA;
            var_1 = _id_06B7::_id_5036( self._id_017D._id_02EA );
...
_id_107F5()
{
    ...
    for (;;)
    {
        ...
        if ( self._id_A24F == "follow" && isdefined( self._id_02F2 ) )
        {
            self._id_8F7F = self._id_02F2._id_02EA;
            continue;
        }

        if ( self._id_A24F == "pursuit" && isdefined( self._id_017D ) )
            self._id_8F7F = self._id_017D._id_02EA;
    }
}
...
_id_6A32( var_0 )
{
    ...
    var_2 = distancesquared( var_1, self._id_02EA );

    switch ( var_0 )
    {
        case "sprint":
            return _id_077B::_id_F07F( var_2 < 160000, "run", "sprint" );
        case "run":
            if ( var_2 < 40000 )
                return "trot";
        ...
        case "trot":
            if ( var_2 < 2500 )
                ...
                return "trot";
        case "walk":
            return _id_077B::_id_F07F( var_2 > 2500, "trot", "walk" );
        default:
            return "walk";
    }
...
_id_D503( var_0 )
{
    ...
    var_2 = var_1;
    var_3 = distancesquared( self _meth_87DF(), self._id_02EA );
    ...
    switch ( var_0 )
    {
        case "sprint":
            ...
            else
            {
                ...
                var_2 = _id_0777::_id_9192( 241, 300, var_4 );
            }

            break;
        case "run":
            var_4 = ( var_3 - 40000 ) / 120000;
            var_2 = _id_0777::_id_9192( 107, 240, var_4 );
            break;
        case "trot":
            var_4 = ( var_3 - 2500 ) / 37500;
            var_2 = _id_0777::_id_9192( 56, 106, var_4 );
            break;
        case "walk":
            var_4 = var_3 / 2500;
            var_2 = _id_0777::_id_9192( 0, 55, var_4 );
            break;
        default:
            break;
    }
...
_id_91BD( var_0, var_1 )
{
    ...
    {
        var_2 = var_2 + 0.05;
        var_3 = _id_0777::_id_9192( var_0, var_1, _func_0148( 1, var_2 / 0.5 ) );
...
_id_10AD7()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( self._id_01A8 ) )
            var_0 = distancesquared( self._id_02F2._id_02EA, self._id_01A8._id_02EA ) < self._id_AD8C || distancesquared( self._id_02EA, self._id_01A8._id_02EA ) < self._id_4CA6;
        else
        {
            foreach ( var_2 in level._id_B758 )
            {
                var_3 = isai( var_2 );
                var_4 = var_2 == self._id_02F2;
                var_5 = var_2._id_045B == self._id_045B;

                if ( !var_3 || var_4 || var_5 )
                    continue;

                var_6 = distancesquared( self._id_02EA, var_2._id_02EA );
...
_id_109CF( var_0 )
{
    ...
    return !_id_8AFE( self._id_411B._id_02EA ) && distance2dsquared( self._id_02EA, self._id_411B._id_02EA ) < self._id_9D80 * 0.75 * 0.75 && ( !var_0 || self _meth_8006( self._id_411B ) );
}
...
_id_C0A1()
{
    ...
    if ( !_id_0A74::_id_89D3( self._id_411B ) )
        return 0;

    if ( self._id_13BF == "traverse" )
        return 0;

    if ( distance2dsquared( self._id_02EA, self._id_411B._id_02EA ) > self._id_9D80 )
        return 0;

    if ( !_id_8AFE( self._id_411B._id_02EA ) )
        return 0;
...
_id_109CB()
{
    ...
    if ( abs( self._id_02EA[2] - self._id_017D._id_02EA[2] ) <= self._id_109F9 || self _meth_8006( self._id_017D ) )
    {
        var_0 = distance2dsquared( self._id_02EA, self._id_017D._id_02EA );
...
_id_109C9()
{
    var_0 = distancesquared( self _meth_87DF(), self._id_02EA ) < 576;
    var_1 = self._id_1328 == "escort";
    var_2 = distancesquared( self._id_02F2._id_02EA, self._id_02EA ) > 160000;
    var_3 = var_1 && var_2;
...
{
    var_0 = self._id_02EA;
    var_1 = self._id_02F2._id_02EA;
    var_2 = distance2dsquared( var_0, var_1 );
    var_3 = var_2 < self._id_AD98;
    var_4 = _func_0130( self._id_02F2 getvelocity() );
    var_5 = _func_025A( self._id_02EA - self._id_02F2._id_02EA );
    ...
    var_7 = _func_0080( self._id_02F2._id_02EA );
    ...
    var_13 = 0;
    var_14 = undefined;
    var_15 = anglestoforward( self._id_02F2._id_0054 );
    var_15 = ( var_15[0], var_15[1], 0 );
    var_15 = _func_025A( var_15 );
    var_8[var_8.size] = var_7;

    foreach ( var_17 in var_8 )
    {
        var_18 = 0;
        var_19 = var_17._id_02EA - self._id_02F2._id_02EA;
        var_20 = _func_0130( var_19 );
        ...
        if ( var_12 )
        {
            var_24 = _func_0257( self._id_42D3, var_19 );
    ...
    var_26 = var_14._id_02EA - self._id_02F2._id_02EA;
    var_27 = _func_0130( var_26 );

    if ( var_27 > self._id_BB7F )
    {
        var_28 = var_7._id_02EA - self._id_02F2._id_02EA;

        if ( _func_0257( var_28, var_26 / var_27 ) < 0 )
            var_6 = var_14._id_02EA;
        else
        {
            var_29 = _func_025A( var_14._id_02EA - var_7._id_02EA );
            var_6 = var_7._id_02EA + var_29 * self._id_BB7F;
        }
    }
    else
        var_6 = var_14._id_02EA;
...
{
    self endon( "death" );
    var_0 _id_077B::_id_1087E( "disconnect", "joined_team" );
...
_id_B353( var_0 )
{
    ...
    if ( !isdefined( self._id_2203 ) )
    {
        self playsoundtoplayer( "kstreak_dog_bark", _id_077B::_id_6460( self._id_045B ) );
        self playsoundtoplayer( "kstreak_dog_pant_run", self._id_045B );
        self._id_2203 = 1;
...
_id_B838( var_0 )
{
    ...
    for (;;)
    {
        ...
        self playsoundtoplayer( "kstreak_dog_growl", _id_077B::_id_6460( self._id_045B ) );
        self playsoundtoplayer( "kstreak_dog_pant_run", self._id_045B );
        wait( _func_01B9( 3, 5 ) );
    }
}
...
_id_10A85()
{
    ...
    if ( isdefined( self._id_02F2 ) && _func_0117( self._id_02F2 ) )
        var_0 = self._id_02F2;
    else
    ...
    self._id_FE8E disableoffhandweapons( var_0 );
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0 ) && var_0 )
        {
            ...
            else if ( self._id_1328 == "escort" )
            {
                ...
                if ( self._id_BDB3 == self._id_02EA )
                    _id_394E();
                else
                {
                    self._id_1328 = "protect";
                    level thread _id_0789::_id_F756( self._id_02F2, "gdog_protect" );
                }
            }
            else
            {
                ...
                _id_394E();
                self _meth_8325( _id_5AE3() );
                level thread _id_0789::_id_F756( self._id_02F2, "gdog_escort" );
            }
...
_id_10BC0()
{
    ...
    for (;;)
    {
        ...
        self._id_02F2 waittill( "damage", var_0, var_1 );

        if ( _func_0117( var_1 ) && var_1 != self._id_02F2 )
        {
            if ( self._id_1DD2 == "attacking" )
                continue;

            if ( distancesquared( self._id_02F2._id_02EA, self._id_02EA ) > self._id_AD8C )
                continue;

            if ( distancesquared( self._id_02F2._id_02EA, var_1._id_02EA ) > self._id_AD8C )
                continue;
...
_id_10BC1()
{
    ...
    for (;;)
    {
        ...
        {
            case "sd":
                scripts\cp_mp\utility\script_utility::_id_8D58();
                return;
            case "sr":
                var_0 = level _id_077B::waittill_any_return( "sr_player_eliminated", "sr_player_respawned" );
        ...
        if ( self._id_4CCD == "guard_dog" && isdefined( self._id_02F2._id_0251 ) && isai( self._id_02F2._id_0251 ) )
            _id_D550( self._id_02F2._id_0251 );
    }
}
...
_id_10AE4()
{
    ...
    self endon( "death" );
    self._id_01A8 _id_077B::_id_108A5( 10, "death_or_disconnect" );
...
_id_AA87( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( isdefined( self._id_02F2 ) )
        self._id_42D3 = _func_025A( self._id_02EA - self._id_02F2._id_02EA );
}

_id_DBA1( var_0, var_1, var_2 )
{
    if ( isdefined( var_1 ) && visionsetnight( var_1 ) == "sniper" )
        return 1;
...
_id_A0FC()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_3 ) && var_3 == self._id_02F2 )
            continue;
