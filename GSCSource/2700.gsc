...
_id_9566()
{
    _id_099D::_id_C2A5( "little_bird", "spawnCallback", ::_id_956A );
    _id_9568();
    _id_9567();
    scripts\mp\utility\killstreak::_id_10228( "little_bird", _id_09AE::_id_9556 );

    if ( istrue( level._id_DCED ) )
        _id_099D::_id_C2A5( "little_bird", "endEnterInternal", ::_id_9564 );
}
...
_id_956B()
{
    ...
    var_2 = _func_020F();
    var_3 = _id_09BB::vehicle_spawn_spawnvehicle( "little_bird", var_1, var_2 );
