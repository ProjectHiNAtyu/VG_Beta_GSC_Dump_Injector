...
_id_021D()
{
    ...
    for (;;)
    {
        var_1 = _func_021E( "mp/gesturetable.csv", var_0, 0 );

        if ( !isdefined( var_1 ) || var_1 == "" )
            break;

        var_2 = _func_021E( "mp/gesturetable.csv", var_0, 1 );

        if ( !isdefined( var_2 ) || var_2 == "" )
            break;

        var_3 = int( _func_021E( "mp/gesturetable.csv", var_0, 8 ) );
...
_id_6A4B( var_0 )
{
    if ( _func_0107( self ) && var_0 == "devilhorns_mp" )
        var_0 = "gesture009";
...
_id_391D()
{
    ...
    if ( isdefined( self._id_62D2 ) && self._id_62D2 != "none" )
    {
        ...
        if ( self hasweapon( self._id_62D2 ) )
            _id_099A::_id_0D6A( self._id_62D2 );
...
{
    if ( _id_077B::_id_864F() )
        self _meth_82D0( 1, "taunt" );
    else
        self _meth_82D0( 7, "taunt" );
    ...
    {
        if ( ![[ _id_099D::_id_6D05( "game", "lpcFeatureGated" ) ]]() )
        {
            switch ( var_0 )
            {
                ...
                case "ges_plyr_gesture050":
                    var_1 = _id_077B::_id_F07F( _id_077B::_id_3A02(), "ges_plyr_gesture050", "ges_plyr_gesture052" );
...
_id_62AE()
{
    return level._id_C8AE[_func_01B9( 0, level._id_C8AE.size )];
}
...
_id_62AF()
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            ...
            var_2 = _id_077B::_id_F07F( var_1 == self, var_0, self );
...
_id_62A4()
{
    ...
    var_1 = _id_06BB::_id_B7AC( self._id_02EA, 500 );
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        var_4 = var_3._id_02EA - self._id_02EA;
        var_4 = _func_025A( var_4 );
        var_5 = _func_0257( var_4, var_0 );
...
_id_6295( var_0, var_1, var_2, var_3 )
{
    ...
    {
        case "ges_plyr_gesture043":
            return _id_077B::_id_F07F( var_3 == "ges_plyr_gesture114", var_2, var_0 );
        case "ges_plyr_gesture114":
            return _id_077B::_id_F07F( var_3 == "ges_plyr_gesture115", var_2, var_0 );
        case "ges_plyr_gesture115":
            return _id_077B::_id_F07F( var_3 == "ges_plyr_gesture043", var_2, var_0 );
    }
}
...
_id_6904()
{
    ...
    return _func_021E( "mp/cac/bodies.csv", var_0, 1 );
}
...
_id_A0E9()
{
    ...
    if ( _id_077B::_id_864F() )
        self _meth_824A( "activateGesture", "+actionslot 1" );
    else
        self _meth_824A( "activateGesture", "+actionslot 7" );
...
_id_BD56()
{
    ...
    {
        var_15 = _func_0257( var_2, _func_025A( var_8._id_02EA - var_0 ) );
    ...
    else
    {
        ...
        var_18 = _func_02C4( var_17 );
        var_19 = var_0 + var_2 * 10000;
        var_20 = _id_077A::_id_E406( var_0, var_19, 0.1, self, var_18, 0 );
...
_id_9B77( var_0 )
{
    ...
    if ( !isdefined( self._id_10F47 ) )
    {
        ...
        if ( self._id_10F47 != -1 )
        {
            ...
            _id_07D0::_id_A8B7( self._id_10F47, self._id_045B );
...
_id_19B9( var_0 )
{
    ...
    if ( _id_099D::_id_8A10( "rank", "getScoreInfoValue" ) )
        var_5 = [[ _id_099D::_id_6D05( "rank", "getScoreInfoValue" ) ]]( var_4 );

    if ( _id_099D::_id_8A10( "rank", "giveRankXP" ) )
        self thread [[ _id_099D::_id_6D05( "rank", "giveRankXP" ) ]]( var_4, var_5 );

    if ( _id_099D::_id_8A10( "supers", "giveSuperPoints" ) )
        self thread [[ _id_099D::_id_6D05( "supers", "giveSuperPoints" ) ]]( var_5 );

    if ( _id_099D::_id_8A10( "rank", "scoreEventPopup" ) )
        self thread [[ _id_099D::_id_6D05( "rank", "scoreEventPopup" ) ]]( var_4 );

    var_6 = [];
    var_7 = undefined;

    if ( _id_099D::_id_8A10( "outline", "outlineEnableForTeam" ) )
        var_7 = [[ _id_099D::_id_6D05( "outline", "outlineEnableForTeam" ) ]]( var_0, self._id_045B, "outline_nodepth_red", "perk_superior" );
    ...
    if ( isdefined( var_0._id_F81C ) )
    {
        ...
        if ( _id_099D::_id_8A10( "outline", "outlineEnableForTeam" ) )
            var_7 = [[ _id_099D::_id_6D05( "outline", "outlineEnableForTeam" ) ]]( var_0._id_F81C, self._id_045B, "outline_nodepth_red", "perk_superior" );
...
_id_BD75( var_0, var_1 )
{
    ...
    foreach ( var_6, var_5 in var_1 )
    {
        if ( _id_099D::_id_8A10( "outline", "outlineDisable" ) )
            [[ _id_099D::_id_6D05( "outline", "outlineDisable" ) ]]( var_6, var_5 );
    }
}
...
_id_BD52( var_0, var_1 )
{
    ...
    foreach ( var_3 in var_0._id_ACB0 )
    {
        ...
        if ( istrue( _id_099C::_id_B779( var_3, var_1 ) ) )
            continue;
        ...
        if ( _id_099D::_id_8A10( "rank", "giveRankXP" ) )
            var_3 thread [[ _id_099D::_id_6D05( "rank", "giveRankXP" ) ]]( var_4, var_5 );

        if ( _id_099D::_id_8A10( "supers", "giveSuperPoints" ) )
            var_3 thread [[ _id_099D::_id_6D05( "supers", "giveSuperPoints" ) ]]( var_5 );

        if ( _id_099D::_id_8A10( "rank", "scoreEventPopup" ) )
            var_3 thread [[ _id_099D::_id_6D05( "rank", "scoreEventPopup" ) ]]( var_4 );

        var_5 = 25;

        if ( _id_099D::_id_8A10( "rank", "giveRankXP" ) )
            var_1 thread [[ _id_099D::_id_6D05( "rank", "giveRankXP" ) ]]( var_4, var_5 );

        if ( _id_099D::_id_8A10( "supers", "giveSuperPoints" ) )
            var_1 thread [[ _id_099D::_id_6D05( "supers", "giveSuperPoints" ) ]]( var_5 );

        if ( _id_099D::_id_8A10( "rank", "scoreEventPopup" ) )
            var_1 thread [[ _id_099D::_id_6D05( "rank", "scoreEventPopup" ) ]]( var_4 );
    }
}
...
_id_19AD( var_0, var_1, var_2 )
{
    ...
    else
    {
        ...
        if ( _id_099D::_id_8A10( "rank", "getScoreInfoValue" ) )
            var_4 = [[ _id_099D::_id_6D05( "rank", "getScoreInfoValue" ) ]]( var_3 );

        if ( _id_099D::_id_8A10( "rank", "giveRankXP" ) )
            self thread [[ _id_099D::_id_6D05( "rank", "giveRankXP" ) ]]( var_3, var_4 );

        if ( _id_099D::_id_8A10( "supers", "giveSuperPoints" ) )
            self thread [[ _id_099D::_id_6D05( "supers", "giveSuperPoints" ) ]]( var_4 );

        if ( _id_099D::_id_8A10( "rank", "scoreEventPopup" ) )
            self thread [[ _id_099D::_id_6D05( "rank", "scoreEventPopup" ) ]]( var_3 );
    }
    ...
    if ( isdefined( var_0._id_ACC3 ) )
    {
        ...
        if ( _id_099D::_id_8A10( "outline", "outlineEnableForTeam" ) )
            var_5 = [[ _id_099D::_id_6D05( "outline", "outlineEnableForTeam" ) ]]( var_0._id_ACC3, self._id_045B, "outline_nodepth_red", "perk_superior" );
    }
    ...
    var_9 = 30.0;
    _id_077B::_id_108F3( "callout_processed_" + var_2, var_9 );
    self notify( "callout_timeout_" + var_2 );

    if ( isdefined( var_0._id_ACC3 ) )
    {
        if ( _id_099D::_id_8A10( "outline", "outlineDisable" ) )
            [[ _id_099D::_id_6D05( "outline", "outlineDisable" ) ]]( var_5, var_0._id_ACC3 );
    }
...
_id_10960( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        if ( var_5 )
        {
            ...
            if ( _id_099D::_id_8A10( "rank", "getScoreInfoValue" ) )
                var_7 = [[ _id_099D::_id_6D05( "rank", "getScoreInfoValue" ) ]]( var_6 );

            if ( _id_099D::_id_8A10( "rank", "giveRankXP" ) )
                self thread [[ _id_099D::_id_6D05( "rank", "giveRankXP" ) ]]( var_6, var_7 );

            if ( _id_099D::_id_8A10( "supers", "giveSuperPoints" ) )
                self thread [[ _id_099D::_id_6D05( "supers", "giveSuperPoints" ) ]]( var_7 );

            if ( _id_099D::_id_8A10( "rank", "scoreEventPopup" ) )
                self thread [[ _id_099D::_id_6D05( "rank", "scoreEventPopup" ) ]]( var_6 );

            var_7 = 25;

            if ( _id_099D::_id_8A10( "rank", "giveRankXP" ) )
                var_4 thread [[ _id_099D::_id_6D05( "rank", "giveRankXP" ) ]]( var_6, var_7 );

            if ( _id_099D::_id_8A10( "supers", "giveSuperPoints" ) )
                var_4 thread [[ _id_099D::_id_6D05( "supers", "giveSuperPoints" ) ]]( var_7 );

            if ( _id_099D::_id_8A10( "rank", "scoreEventPopup" ) )
                var_4 thread [[ _id_099D::_id_6D05( "rank", "scoreEventPopup" ) ]]( var_6 );

            if ( isdefined( var_1._id_ACC3 ) )
            {
                if ( _id_099D::_id_8A10( "outline", "outlineDisable" ) )
                    [[ _id_099D::_id_6D05( "outline", "outlineDisable" ) ]]( var_0, var_1._id_ACC3 );
            }
...
{
    if ( ( level._id_60D1 == "br" || level._id_60D1 == "dmz" ) && self hasweapon( "armor_plate_deploy_mp" ) )
        return;
    ...
    if ( var_0 == "radial_menu_selection_gesture" )
    {
        ...
        if ( isdefined( var_2 ) )
        {
            if ( var_2 == "iw8_ges_plyr_gesture024" )
            {
                ...
                self _meth_82F6( "ui_smart_watch_interact", self._id_DE27 );
            }
            else if ( var_2 == "iw8_ges_plyr_gesture023" )
            {
                ...
                self _meth_82F6( "ui_smart_watch_check", self._id_10AAE );
            }

            var_3 = _func_034C( var_2 );

            if ( isdefined( var_3 ) && !_func_036F( var_3 ) )
            {
                _id_10BEB( var_3 );
                return;
            }
    ...
    {
        var_3 = _func_034C( "iw8_ges_plyr_spray" );
