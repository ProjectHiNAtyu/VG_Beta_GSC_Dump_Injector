...
_id_1E8A()
{
    if ( _id_077B::_id_85A4( level._id_60D1, "dom" ) )
    {
    ...
    if ( _id_077B::_id_85A4( level._id_60D1, "war" ) )
    {
...
_id_AB65()
{
    if ( !_func_0104( self ) && istrue( self._id_A404 ) )
    {
        thread _id_4CDF();
...
_id_B828()
{
    level endon( "host_migration_begin" );
    self endon( "disconnect" );
    var_0 = _id_0A69::_id_6DC8() / 1000 + 6;
...
_id_4CDF()
{
    ...
    if ( !isdefined( level._id_7E65 ) && _id_0A69::_id_EF73( self._id_045B ) && game["roundsPlayed"] == 0 )
        level._id_7E65 = 1;

    if ( isdefined( game["trial"] ) && isdefined( game["trial"]["tries_remaining"] ) && game["trial"]["tries_remaining"] < 3 )
        return;

    if ( _id_0A69::_id_8744() || level._id_036A == "mp_m_speed" )
        var_0 = 0;
    else
        var_0 = !_id_07A8::_id_609F( "prematch_done" ) && ( !_id_0A69::_id_89F1() || _id_0A69::_id_8842() );
    ...
    if ( !level._id_E427 && !isdefined( self._id_B384 ) || level._id_E427 && !isdefined( level._id_B387 ) )
    {
        if ( !self _meth_81E1() || self _meth_81E2() )
        {
            if ( isdefined( self._id_045B ) && self._id_045B != "spectator" && _id_0A69::_id_6A43() != "arm" && _id_0A69::_id_6A43() != "ctf" && !_id_0A69::_id_8744() && _id_0A69::_id_6A43() != "sd" && _id_0A69::_id_6A43() != "dd" && _id_0A69::_id_6A43() != "cyber" && _id_0A69::_id_6A43() != "siege" && _id_0A69::_id_6A43() != "rugby" )
            {
                var_3 = getdvar( "#x32ea5e908954bfea7" );

                if ( var_3 == "mp_gunsmith_gl" )
                    self _meth_84A8( "" );
                else if ( self._id_045B == "allies" )
                {
                ...
                else
                {
                    ...
                    var_5 = _func_01B8( var_6 );
                    self._id_A5CD = 1;
                }
            }

            if ( ( _id_0A69::_id_6A43() == "sd" || _id_0A69::_id_6A43() == "dd" || _id_0A69::_id_6A43() == "cyber" || _id_0A69::_id_6A43() == "ctf" || _id_0A69::_id_6A43() == "siege" || _id_0A69::_id_6A43() == "rugby" ) && isdefined( game["roundsPlayed"] ) && game["roundsPlayed"] == 0 )
            {
            ...
            if ( _id_0A69::_id_6A43() == "arm" && !isdefined( level._id_B387 ) )
            {
                if ( self._id_045B == "allies" )
                {
                    var_4 = game["music"]["spawn_allies"].size - 1;
            ...
            if ( _id_0A69::_id_6A43() == "arena" && isdefined( game["roundsPlayed"] ) && game["roundsPlayed"] == 0 )
            {
                if ( self._id_045B == "allies" )
                {
                    var_4 = game["music"]["gunfight_spawn_allies"].size - 1;
                    var_5 = _func_01B8( var_4 );
                    self _meth_84A8( game["music"]["gunfight_spawn_" + self._id_045B][var_5] );
                }
                else
                {
    ...
    if ( isdefined( game["dialog"]["gametype"] ) && ( !level._id_E427 || self == level._id_B758[0] ) )
    {
        if ( isdefined( game["dialog"]["allies_gametype"] ) && self._id_045B == "allies" )
            _id_0A64::_id_9120( "allies_gametype" );
        else if ( isdefined( game["dialog"]["axis_gametype"] ) && self._id_045B == "axis" )
...
_id_DB96()
{
    ...
    else if ( game["matchPoint"] == 1 )
    {
        ...
        {
            var_3 = _id_0A69::getrankxp( var_2 );
...
_id_AB0A()
{
    ...
    if ( _id_0A69::_id_6A43() == "siege" )
    {
        var_0 _id_0A64::_id_9120( "siege_lastalive_zones" );
        level thread _id_AB0A();
        return;
    }
    else if ( _id_0A69::_id_6A43() == "sr" && !level._id_A573 )
    {
...
_id_B91F( var_0 )
{
    ...
    var_1 = _id_07AE::_id_6DBB();

    foreach ( var_3 in level._id_B758 )
    {
        var_4 = var_1[var_3._id_045B];
...
_id_AAE3()
{
    ...
    if ( level._id_EF62 )
    {
        ...
        else if ( var_0 == "allies" )
        {
            foreach ( var_2 in level._id_B758 )
            {
                ...
                if ( isdefined( var_2._id_045B ) && var_2._id_045B == "allies" )
                {
                    var_2 _meth_84A8( game["music"]["mp_match_winners_circle"][1] );
                    continue;
                }
        ...
        else if ( var_0 == "axis" )
        {
            foreach ( var_2 in level._id_B758 )
            {
                ...
                if ( isdefined( var_2._id_045B ) && var_2._id_045B == "axis" )
                {
                    var_2 _meth_84A8( game["music"]["mp_match_winners_circle"][1] );
                    continue;
                }
    ...
    else
    {
        foreach ( var_2 in level._id_B758 )
        {
            ...
            if ( var_2._id_0309["team"] != "allies" && var_2._id_0309["team"] != "axis" )
            {
                var_2 _meth_8275( game["music"]["nuke_music"] );
                continue;
            }

            if ( isdefined( var_0 ) && _func_0117( var_0 ) && var_2 == var_0 )
            {
                var_2 _meth_84A8( game["music"]["victory_" + var_2._id_0309["team"]] );
                continue;
            }

            if ( !level._id_E427 )
                var_2 _meth_84A8( game["music"]["defeat_" + var_2._id_0309["team"]] );
        }
    }
...
_id_60DE()
{
    ...
    if ( _func_0117( var_0 ) && !level._id_EF62 )
    {
...
_id_A34A()
{
    ...
    if ( level._id_C936 == 1 || game["roundsPlayed"] == level._id_C936 - 1 || _id_0A69::_id_891B() )
    {
        if ( !level._id_E427 )
        {
            if ( var_0 == "time" )
            ...
            else if ( var_0 == "score" )
            {
                ...
                if ( level._id_EF62 && !_id_0A69::_id_8744() )
                {
                    if ( game["teamScores"]["allies"] > game["teamScores"]["axis"] )
                    {
                        if ( _id_8923() )
                ...
                {
                    var_11 = _id_07AE::_id_6A7F();
                    var_12 = _id_07AE::_id_6B07();
                    var_13[0] = var_11;
                    ...
                    if ( _id_8923() )
                    {
                        ...
                        var_16 = "winning_" + var_11._id_0309["team"];

                        if ( var_11._id_0309["team"] == "allies" )
                            var_7 = _func_01B8( var_15 );
                        else
                            var_7 = _func_01B8( var_14 );
                        ...
                        foreach ( var_20 in level._id_B758 )
                        {
                            ...
                            var_21 = "losing_" + var_20._id_0309["team"];

                            if ( var_20._id_0309["team"] == "allies" )
                                var_22 = _func_01B8( var_18 );
                            else
                                var_22 = _func_01B8( var_17 );
    ...
    else if ( !level._id_74A8 && !_id_0A69::_id_8744() )
    {
        foreach ( var_4 in level._id_B758 )
            var_4 _meth_84A8( "" );
    }
...
_id_EBE5( var_0 )
{
    ...
    level._id_41FD = [];
    level._id_41FD["allies"] = _func_01B8( var_2 );
    level._id_41FD["axis"] = _func_01B8( var_3 );
...
_id_C925( var_0, var_1, var_2 )
{
        ...
        foreach ( var_4 in level._id_B758 )
        {
            if ( var_0 == "allies" )
            {
                ...
                else
                {
                    ...
                    if ( isdefined( var_4._id_045B ) && var_4._id_045B == "allies" )
                    {
                        var_10 = game["music"]["gunfight_roundwin_" + var_14 + "_allies"].size - 1;
                        var_15 = _func_01B8( var_10 );
    ...
    else if ( level._id_73A1 == "halftime" && _id_0A69::_id_6A43() == "dd" && !_id_0A69::_id_7999() )
    {
        foreach ( var_4 in level._id_B758 )
        {
            if ( var_0 == "allies" )
...
_id_29F6( var_0, var_1 )
{
    ...
    foreach ( var_6 in level._id_B758 )
    {
        if ( !_func_0107( var_6 ) && !var_6 scripts\mp\gametypes\br_public::_id_8976() )
        {
            if ( var_4 < var_2 )
            {
                var_7 = game["music"]["br_ring_low"].size - 1;
                var_8 = _func_01B8( var_7 );
...
_id_2A0C( var_0, var_1 )
{
    ...
    {
        if ( !_func_0107( var_8 ) && !var_8 scripts\mp\gametypes\br_public::_id_8976() )
        {
            if ( var_6 < var_5 )
            {
...
killstreak_warmachine_music()
{
    ...
    _id_077B::_id_10886( self, "death", level, "start_game_win_audio", level, "round_end_music" );
