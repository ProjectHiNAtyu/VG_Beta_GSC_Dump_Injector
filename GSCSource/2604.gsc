...
_id_021D()
{
    level._id_0BA3["mortar_initial_flare"] = _func_0139( "vfx/iw8_mp/killstreak/vfx_white_phosphorus_expl_inair.vfx" );
    level._id_0BA3["mortar_impact"] = _func_0139( "vfx/s4/killstreaks/vfx_bombingrun_exp_imp_lrg_01.vfx" );
    level._id_8DCC["mortar_barrage"] = _func_020F();
    level._id_8DCC["mortar_barrage"]._id_47CD = _func_034C( "s4_binoculars_mp", [ "spotterscope" ] );
    _id_0A28::_id_C25C( "mortar_barrage", ::_id_F790 );
}
...
_id_F790( var_0 )
{
    ...
    var_1 = _func_034C( "s4_ks_flare_canister_mp" );
    ...
    if ( isdefined( var_2 ) && !var_2 )
    {
        if ( _id_099D::_id_8A10( "sound", "trySayLocalSound" ) )
            [[ _id_099D::_id_6D05( "sound", "trySayLocalSound" ) ]]( self, "use_mortar_fail" );

        return 0;
    }

    var_3 = self._id_5C37._id_02EA;
    ...
    if ( _id_099D::_id_8A10( "hud", "teamPlayerCardSplash" ) )
        [[ _id_099D::_id_6D05( "hud", "teamPlayerCardSplash" ) ]]( "used_mortar_barrage", self );
...
_id_688F( var_0, var_1 )
{
    ...
    for ( var_3 = 0; var_3 < 24; var_3++ )
    {
        ...
        var_5 = _func_01B6( var_1 );
        var_2[var_3] = var_0 + _func_01C2( ( 1, 0, 0 ), ( 0, var_4, 0 ) ) * var_5;
    }
...
burnatorigin( var_0 )
{
    ...
    for (;;)
    {
        ...
        {
            if ( distance( var_2._id_02EA, var_0 ) < 60 )
                var_2 _meth_80B7( 2, var_0, self, undefined, "MOD_FIRE" );
        }
...
{
    var_2 = _func_0143( "s4_ks_mortar_mp", var_0, var_1, 10, self );
    var_2._id_0054 = _func_025B( ( 0, 0, -1 ) );
    var_2 setmaxpitchroll( 1 );
    var_2 _meth_8312( self );
    var_2 setorigin( self );
    var_2._id_5798 = _func_0205( "script_model", var_2._id_02EA );
    var_2._id_5798 _meth_820B( var_2 );
    var_2._id_5798 _meth_80BE();
    var_2._id_5798 _meth_8312( self );
    var_3 = _func_0205( "script_model", var_0 );
    var_3 _meth_820B( var_2, "tag_origin", ( 10, 0, 10 ), ( 0, 0, 0 ) );
    var_2._id_8D49 = var_3;
    var_2._id_02F2 = self;
    thread _id_0823::_id_A15B( var_2 );
    var_2 thread _id_A196( _func_025B( var_1 ), gettime(), var_1 );
}
...
_id_A17F( var_0 )
{
    ...
    _func_0196( level._id_0BA3["mortar_impact"], var_0 );
    self _meth_8287( var_0, 550.0, 125, 40, self._id_02F2, "MOD_EXPLOSIVE", self._id_10D06 );
...
_id_10DDE( var_0, var_1 )
{
    ...
    self _meth_800D( 0 );
    self _meth_824A( "flare_cannister_use", "+frag" );
    self _meth_824A( "flare_cannister_use", "+attack" );
    self _meth_824A( "flare_cannister_use", "+speed_throw" );
    ...
    if ( istrue( var_1 ) )
    {
        ...
        for (;;)
        {
            ...
            var_2 = self._id_02EA + anglestoforward( self._id_0054 ) * 147;

            if ( _id_333D( var_2, var_2 + ( 0, 0, 10000 ) ) )
            {
                _id_07B9::_id_DC9F( "KILLSTREAKS/MORTAR_BARRAGE_INVALID_PLACEMENT" );
                waitframe();
                continue;
            }

            self _meth_800D( 1 );
            self switchtoweapon( self._id_BC5D );
...
_id_10AEB( var_0 )
{
    ...
    var_1 setmode( "ks_airstrike_marker_mp" );
    ...
    for (;;)
    {
        ...
        var_3 = self player_recoilscaleon();
...
_id_10AC3( var_0 )
{
    ...
    if ( isdefined( var_1 ) && var_1 == "successful_fire" )
    {
        ...
        var_5 = _id_077A::_id_C042( var_3, var_4, self );
        var_6 = var_5["normal"];
...
_id_D062( var_0 )
{
    ...
    thread _id_07BA::_id_EF8A( var_5, self );
...
_id_1D1C( var_0 )
{
    ...
    wait 1;
    var_0._id_5C32 = _func_03C0( "ks_white_phosphorus_mp_p", var_0._id_02EA, var_0._id_0054 );
    var_0._id_5C32 _meth_8373( "flare", "on", 0 );
    wait 8.0;
    var_0._id_5C32 _meth_8373( "flare", "off", 0 );
    var_0._id_5C32 _meth_8373( "flare_death", "on", 0 );
...
{
    var_2 = _id_077A::_id_C042( var_0, var_1 );
