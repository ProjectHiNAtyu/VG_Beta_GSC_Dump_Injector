...
{
    var_4 = _func_020F();
    var_4._id_7C71 = int( stopfxontag( "mp/accoladestable.csv", 1, var_0, 0 ) );
    var_4._id_0E31 = int( stopfxontag( "mp/accoladestable.csv", 1, var_0, 2 ) );
...
_id_0B73()
{
    foreach ( var_1 in level._id_B758 )
    {
        ...
        {
            var_1 _meth_82F6( "ui_wc_winner_" + var_2, -1 );

            for ( var_3 = 0; var_3 < 1; var_3++ )
            {
                var_1 _meth_82F6( "ui_wc_accolade_" + var_2 + "_" + var_3, -1 );
                var_1 _meth_82F6( "ui_wc_accolade_player_" + var_3, -1 );
                var_1 _meth_82F6( "ui_wc_accolade_score_" + var_2 + "_" + var_3, -1 );
            }
        }
    }
}
...
_id_0B19()
{
    foreach ( var_1 in level._id_B758 )
    {
        ...
        {
            for ( var_2 = 0; var_2 < _func_0148( 1, var_1._id_9B90.size ); var_2++ )
            {
                var_3 = level._id_0E30[var_1._id_9B90[var_2]]._id_7C71;
                var_1 _meth_82F6( "ui_wc_accolade_player_" + var_2, var_3 );
            }
        }
    }
}
...
_id_A69B( var_0 )
{
    ...
    foreach ( var_2 in level._id_EF86 )
    {
        ...
        {
            for ( var_6 = 0; var_6 < _func_0148( 3, var_0.size ); var_6++ )
            {
                var_7 = var_0[var_6];
                var_5 _meth_82F6( "ui_wc_winner_" + var_6, var_7 getentitynumber() );
            }
        }
    }
}
...
_id_A69A()
{
    ...
    foreach ( var_1 in level._id_EF86 )
    {
        ...
        foreach ( var_6 in var_4 )
        {
            for ( var_7 = 0; var_7 < _func_0148( 3, var_2.size ); var_7++ )
            {
                var_8 = var_2[var_7];
                var_6 _meth_82F6( "ui_wc_winner_" + var_7, var_8 getentitynumber() );

                for ( var_9 = 0; var_9 < _func_0148( 1, var_8._id_9B90.size ); var_9++ )
                {
                    var_3 = var_3 + 1;
                    var_10 = level._id_0E30[var_8._id_9B90[var_9]]._id_7C71;
                    var_6 _meth_82F6( "ui_wc_accolade_" + var_7 + "_" + var_9, var_10 );
                    var_6 _meth_82F6( "ui_wc_accolade_score_" + var_7 + "_" + var_9, level._id_0E30[var_8._id_9B90[var_9]]._id_10E5E );
                }
            }
        }
...
_id_81D3()
{
    ...
    foreach ( var_6 in level._id_B758 )
    {
        ...
        for ( var_3 = 0; var_3 < 9; var_3++ )
        {
            ...
            var_6 setclientomnvar( "ui_wc_vote_bits", var_3, 0 );
            var_6 _meth_82F6( "ui_wc_votes_" + var_3, 0 );
        }
    }
}
...
_id_0C60( var_0 )
{
    ...
    if ( !isdefined( var_1.gainedxpfromaccoladevoting ) )
    {
        ...
        var_1 thread _id_07E1::_id_6FC0( "accolade_vote", _id_07E1::_id_6CEE( "accolade_vote" ) );
    }

    var_1 setclientomnvar( "ui_wc_vote_bits", var_0, 1 );
    var_11 = level._id_EF67[var_2]["players"];

    foreach ( var_13 in var_11 )
        var_13 _meth_82F6( "ui_wc_votes_" + var_0, var_5 );
}
...
_id_7548( var_0, var_1 )
{
    ...
    foreach ( var_3 in level._id_B780[var_1] )
    {
        ...
        {
            var_4 = _id_077B::_id_F07F( var_3._id_B74D._id_0309["deaths"] > 0, var_3._id_B74D._id_0309["deaths"], 1 );
            var_5 = var_3._id_B74D._id_0309["kills"] + var_3._id_B74D._id_0309["assists"];
...
_id_756C( var_0, var_1 )
{
    ...
    {
        if ( var_5._id_0309["team"] != var_1 )
            continue;

        var_6 = 0;

        foreach ( var_8 in level._id_0E30[var_0]._id_4340 )
            var_6 = var_6 + var_5._id_0309[var_8];
...
_id_756A( var_0, var_1 )
{
    ...
    {
        if ( var_4._id_0309["team"] != var_1 )
            continue;

        var_5 = _id_077B::_id_F07F( isdefined( var_4._id_9B90 ), var_4._id_9B90.size, 0 );
...
_id_B7C7()
{
    ...
    foreach ( var_1 in level._id_EF86 )
    {
        ...
        {
            if ( level._id_B758[var_3]._id_0309["team"] != var_1 )
                continue;

            var_4 = _func_020F();
            var_4._id_B74D = level._id_B758[var_3];
            var_4._id_04A3 = level._id_B758[var_3]._id_0309["score"];
...
_id_B7C6()
{
    ...
    foreach ( var_2 in level._id_B758 )
    {
        ...
        {
            if ( isdefined( var_2._id_0309[var_5] ) )
                var_3 = var_3 + var_2._id_0309[var_5];
        }

        var_2._id_0309["totalObjScore"] = var_3;
    }
    ...
    foreach ( var_9 in level._id_EF86 )
    {
        ...
        for ( var_11 = 0; var_11 < level._id_B758.size; var_11++ )
        {
            if ( level._id_B758[var_11]._id_0309["team"] != var_9 )
                continue;

            var_12 = _func_020F();
            var_12._id_B74D = level._id_B758[var_11];
            var_12._id_04A3 = level._id_B758[var_11]._id_0309["totalObjScore"];
...
_id_8939()
{
    return !_id_0A69::_id_CA3E();
}

_id_8796()
{
    _id_07A8::_id_60A3( "infil_setup_complete" );
    return _id_0A69::_id_1575();
}
...
_id_893F()
{
    return _id_0A69::_id_6A43() != "war" && _id_0A69::_id_6A43() != "dm" && _id_0A69::_id_6A43() != "br";
}
...
_id_8868()
{
    return _id_0A69::_id_6A43() == "grind";
}

_id_88A7()
{
    return _id_0A69::_id_6A43() == "infect";
}

_id_886C()
{
    return _id_0A69::_id_6A43() == "gun";
}

_id_8875()
{
    return _id_0A69::_id_6A43() == "koth" || _id_0A69::_id_6A43() == "grnd";
}
