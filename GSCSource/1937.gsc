...
_id_021D()
{
    level._id_2F56 = _func_020F();
    level._id_2F56._id_2FA7 = "mp/map_callouts/" + level._id_9AA7 + "_callouts.csv";
    _id_3F7F();
...
_id_3F7F()
{
    ...
    for (;;)
    {
        var_2 = _func_021E( level._id_2F56._id_2FA7, var_1, 0 );

        if ( !isdefined( var_2 ) || var_2 == "" )
            break;

        var_2 = int( var_2 );
        var_3 = _func_021E( level._id_2F56._id_2FA7, var_1, 3 );
        ...
        {
            var_4 = _func_021E( level._id_2F56._id_2FA7, var_1, 1 );
...
_id_D650( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        self _meth_82F6( "ui_callout_area_id", var_2 );
        var_3 = _id_0A74::_id_668B( 1, 0 );

        foreach ( var_5 in var_3 )
        {
            if ( var_5 _meth_81D2() )
                var_5 _meth_82F6( "ui_callout_area_id", var_2 );
        }
    }
    else if ( var_0 != "none" )
        return;
