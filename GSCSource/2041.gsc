...
_id_AA44()
{
    ...
    _func_01DA( "commonMatchData", "player_count_start", level._id_B758.size );
    ...
    if ( var_0 == "br" )
        _id_06BB::_id_F737( level._id_9B95 );
...
_id_AA4A( var_0 )
{
    if ( !isdefined( var_0._id_0309["telemetry"] ) || !isdefined( var_0._id_0309["telemetry"]._id_3B5D ) )
    {
        if ( !isdefined( var_0._id_0309["telemetry"] ) )
            var_0._id_0309["telemetry"] = _func_020F();

        if ( isdefined( game["telemetry"] ) && isdefined( game["telemetry"].total_player_connections ) )
        {
            var_0._id_0309["telemetry"].connect_index = game["telemetry"].total_player_connections;
            game["telemetry"].total_player_connections++;
        }
        else
            return;

        var_0._id_0309["telemetry"].utc_connect_time_s = _func_00D7();
        var_0._id_0309["telemetry"]._id_3B5D = 1;
        var_1 = 0;
        ...
        if ( !istrue( game["isLaunchChunk"] ) && !_func_0107( var_0 ) )
        {
            if ( level._id_EF62 )
            {
        ...
        var_0._id_0309["telemetry"].rank_at_start = 0;
        var_9 = var_0 _id_07E1::_id_6CC0();

        if ( isdefined( var_9 ) )
            var_0._id_0309["telemetry"].rank_at_start = var_0 _id_07E1::_id_6CB8( var_9 );

        if ( var_0 _id_0A69::_id_C01A() && var_0 _meth_85AB() )
        {
            var_0._id_0309["telemetry"].xp_at_start = var_0 getplayerdata( "common", "mpProgression", "playerLevel", "xp" );
            var_0._id_0309["telemetry"].score_at_start = var_0 getplayerdata( "mp", "playerStats", "matchStats", "score" );
            var_0._id_0309["telemetry"].prestige_at_start = var_0 getplayerdata( "rankedloadouts", "squadMembers", "season_rank" );
        }
        else
        {
            var_0._id_0309["telemetry"].xp_at_start = 0;
            var_0._id_0309["telemetry"].score_at_start = 0;
            var_0._id_0309["telemetry"].prestige_at_start = 0;
        }

        var_10 = _id_0A69::_id_6A43();
        ...
        if ( isdefined( var_0._id_0309["telemetry"].connect_index ) )
            var_13 = var_0._id_0309["telemetry"].connect_index;
...
on_player_spawned( var_0 )
{
    ...
    var_0._id_0309["telemetry"]._id_934E = _func_020F();

    if ( isdefined( game["telemetry"] ) && isdefined( game["telemetry"].life_count ) )
    {
        var_0._id_0309["telemetry"]._id_934E.life_index = game["telemetry"].life_count;
        game["telemetry"].life_count++;
    }

    if ( isdefined( var_0._id_0309["summary"]["xp"] ) )
        var_0._id_0309["telemetry"]._id_934E.xp_at_spawn = var_0._id_0309["summary"]["xp"];
    else
        var_0._id_0309["telemetry"]._id_934E.xp_at_spawn = 0;

    if ( isdefined( var_0._id_0369 ) )
        var_0._id_0309["telemetry"]._id_934E.score_at_spawn = var_0._id_0369;
    else
        var_0._id_0309["telemetry"]._id_934E.score_at_spawn = 0;
}
...
on_player_match_end( var_0 )
{
    ...
    if ( isdefined( var_1._id_0309["telemetry"].utc_connect_time_s ) )
        var_2 = var_1._id_0309["telemetry"].utc_connect_time_s;
    ...
    if ( level._id_EF62 )
        var_4 = int( var_1 _id_07E1::_id_6DB9( var_1._id_045B ) );

    var_5 = 0;

    if ( isdefined( var_1._id_0309["telemetry"].connect_index ) )
        var_5 = var_1._id_0309["telemetry"].connect_index;
    ...
    {
        if ( isdefined( var_1._id_0309["summary"]["xp"] ) )
            var_6 = var_1._id_0309["summary"]["xp"];

        if ( isdefined( var_1._id_0309["summary"]["score"] ) )
            var_7 = var_1._id_0309["summary"]["score"];

        if ( isdefined( var_1._id_0309["summary"]["challenge"] ) )
            var_8 = var_1._id_0309["summary"]["challenge"];

        if ( isdefined( var_1._id_0309["summary"]["match"] ) )
            var_9 = var_1._id_0309["summary"]["match"];

        if ( isdefined( var_1._id_0309["summary"]["medal"] ) )
            var_10 = var_1._id_0309["summary"]["medal"];

        if ( isdefined( var_1._id_0309["summary"]["bonusXP"] ) )
            var_11 = var_1._id_0309["summary"]["bonusXP"];

        if ( isdefined( var_1._id_0309["summary"]["misc"] ) )
            var_12 = var_1._id_0309["summary"]["misc"];

        if ( isdefined( var_1._id_0309["summary"]["accolade"] ) )
            var_13 = var_1._id_0309["summary"]["accolade"];

        if ( isdefined( var_1._id_0309["summary"]["weaponXP"] ) )
            var_14 = var_1._id_0309["summary"]["weaponXP"];

        if ( isdefined( var_1._id_0309["summary"]["operatorXP"] ) )
            var_15 = var_1._id_0309["summary"]["operatorXP"];

        if ( isdefined( var_1._id_0309["summary"]["clanXP"] ) )
            var_16 = var_1._id_0309["summary"]["clanXP"];

        if ( isdefined( var_1._id_0309["summary"]["battlepassXP"] ) )
            var_17 = var_1._id_0309["summary"]["battlepassXP"];
    }

    if ( var_1._id_0309["telemetry"].rank_at_start )
        var_18 = var_1._id_0309["telemetry"].rank_at_start;
    else
        var_18 = 0;

    var_19 = 0;
    var_20 = var_1 _id_07E1::_id_6CC0();

    if ( isdefined( var_20 ) )
        var_19 = var_1 _id_07E1::_id_6CB8( var_20 );

    if ( var_1._id_0309["telemetry"].xp_at_start )
        var_21 = var_1._id_0309["telemetry"].xp_at_start;
    else
        var_21 = 0;

    if ( var_1._id_0309["telemetry"].score_at_start )
        var_22 = var_1._id_0309["telemetry"].score_at_start;
    else
        var_22 = 0;

    if ( var_1._id_0309["telemetry"].prestige_at_start )
        var_23 = var_1._id_0309["telemetry"].prestige_at_start;
    else
        var_23 = 0;

    if ( var_1 _id_0A69::_id_C01A() && var_1 _meth_85AB() )
    {
    ...
    if ( isdefined( var_1._id_0309["totalDistTraveled"] ) )
        var_40 = float( var_1._id_0309["totalDistTraveled"] );
    ...
    if ( isdefined( var_1._id_0309["suicides"] ) )
    ...
    if ( _id_0A69::_id_6A43() == "arm" && isdefined( var_1._id_732B ) )
    {
...
on_player_death( var_0 )
{
    ...
    {
        var_6 = _id_0A7F::_id_6E4C( var_3 );
        var_5 = _id_0A7F::_id_1D8B( var_6, var_3 );
    }
    ...
    if ( isdefined( var_2._id_0309["telemetry"]._id_934E.life_index ) )
        var_10 = var_2._id_0309["telemetry"]._id_934E.life_index;
    ...
    if ( _id_06B9::is_valid_client( var_1 ) )
    {
        ...
        var_15 = var_1;
        var_16 = var_1 _id_0A7F::_id_8964( var_3 );
        var_17 = var_1 _meth_8542( var_3 );
        var_18 = 0.0;

        if ( _id_0A7F::_id_877F( var_3 ) )
            var_18 = var_1 player_recoilscaleon();

        var_19 = _id_077B::_id_10E74( var_2._id_02EA, var_2._id_0054, var_1._id_02EA, 0.4226 );
        var_20 = _id_077B::_id_10E74( var_1._id_02EA, var_1._id_0054, var_2._id_02EA, 0.4226 );
        var_21 = var_1 _id_06B9::mount_string_to_dlog_enum();
        var_22 = var_1._id_02EA;
        var_23 = var_1._id_0054;

        if ( isdefined( var_1._id_0309["telemetry"]._id_934E.life_index ) )
            var_11 = var_1._id_0309["telemetry"]._id_934E.life_index;
    ...
    if ( isdefined( var_2._id_90B7 ) )
    {
        ...
        var_28 = _id_0A7F::_id_6E4C( var_27 );
        var_25 = _id_0A7F::_id_1D8B( var_28, var_27 );
        var_26 = getweaponbasename( var_27 );
        var_29 = var_2 _id_0A7F::_id_8964( var_27 );
        var_30 = var_2 _meth_8542( var_27, 0, 1 );
        var_31 = var_2 player_recoilscaleon();
    }
    else
    {
        var_29 = 0;
    ...
    if ( isdefined( var_2._id_0309["summary"]["xp"] ) )
    {
        var_35 = var_2._id_0309["summary"]["xp"];
        var_34 = var_35 - var_2._id_0309["telemetry"]._id_934E.xp_at_spawn;
    }

    var_36 = var_2._id_0369 - var_2._id_0309["telemetry"]._id_934E.score_at_spawn;
    var_37 = -1;
...
_id_AA4B( var_0 )
{
    ...
    if ( isdefined( var_0._id_030F._id_0309["telemetry"]._id_934E.last_life_index_sent ) )
        var_1 = var_0._id_030F._id_0309["telemetry"]._id_934E.last_life_index_sent;

    var_2 = -1;

    if ( isdefined( var_0._id_030F._id_0309["telemetry"]._id_934E.life_index ) )
        var_2 = var_0._id_030F._id_0309["telemetry"]._id_934E.life_index;

    if ( var_1 != var_2 )
    {
        var_3 = _func_020F();
        var_3._id_103C0 = var_0._id_030F;
        var_3._id_006E = undefined;
