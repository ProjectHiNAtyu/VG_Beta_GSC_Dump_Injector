...
_id_AB65()
{
    ...
    if ( !level._id_EF62 || level._id_8A71 || istrue( level._id_4A60 ) || _id_0A69::_id_873A() )
        self._id_2402 = 1;
    else
    {
        if ( !_id_0A69::_id_CA3E() || istrue( level._id_2A7D ) )
        {
...
_id_90DE( var_0 )
{
    ...
    for (;;)
    {
        var_1 = _id_06BB::_id_B7AC( var_0._id_02EA, 500 );
        ...
        foreach ( var_3 in var_1 )
        {
            ...
            if ( isdefined( var_0._id_02F2 ) && !var_0._id_02F2 _id_0A74::_id_8803( var_3 ) )
                continue;
...
_id_8B86( var_0, var_1 )
{
    ...
    var_2 = _id_077B::_id_BFC7( _id_0A69::_id_6BC3( var_0 ) );
    var_3 = _id_0A74::_id_6C40( var_1, 360000, var_2 );
...
calloutequipment( var_0 )
{
    ...
    switch ( var_0 )
    {
        ...
        case "s4_equipment_resupply_box":
            ...
            break;
        default:
            if ( visionsetnight( var_0 ) == "rocketlauncher" )
...
_id_7153()
{
    ...
    while ( !var_2 )
    {
        var_3 = _id_06BB::_id_B7AC( self._id_02EA, 384 );
        ...
        foreach ( var_5 in var_3 )
        {
            ...
            if ( !isdefined( var_5 ) || var_5 _id_099C::_giveweapon() == 0 || isdefined( self._id_02F2 ) && self._id_02F2 _id_0A74::_id_8803( var_5 ) == 0 )
                continue;
            ...
            {
                if ( !_func_01FD( var_5 geteye(), self._id_02EA, 0, var_5 ) )
                    continue;
...
{
    var_0 = 0;
    var_1 = _id_06BB::_id_B7AC( self._id_02EA, 384 );
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        if ( !isdefined( var_3 ) || var_3 _id_099C::_giveweapon() == 0 || isdefined( self ) && _id_0A74::_id_8803( var_3 ) == 0 )
            continue;

        var_4 = distancesquared( self._id_02EA, var_3._id_02EA );

        if ( isdefined( var_4 ) && var_4 < 147456 )
        {
            if ( _func_01FD( var_3 geteye(), self._id_02EA, 0, var_3 ) )
            {
...
_id_C30D()
{
    ...
    for (;;)
    {
        ...
        var_1 = _id_0A7F::_id_10D98( var_0, "akimbo" );
        ...
        var_3 = istrue( var_0._id_022A ) && ( visionsetnight( var_0 ) == "grenade" || visionsetnight( var_0 ) == "spread" );

        if ( var_2 <= visionsetthermal( var_0 ) || var_1 && var_2 <= visionsetthermal( var_0 ) * 2 )
        {
            var_4 = _id_0A7F::_id_6E59( var_0 );
            var_5 = _id_0A7F::_id_6E6C( var_0 ) == "s4_ar_stango44" || var_3;

            if ( !var_5 )
            {
                var_6 = "last_mag_o";
                var_7 = _id_0A69::_id_8A45() && _id_0A69::_id_6A43() == "br";
...
_id_F15F( var_0, var_1 )
{
    ...
    var_2 = _func_025A( ( var_1[0], var_1[1], var_0._id_02EA[2] ) - var_0._id_02EA );
    var_3 = _func_0257( anglestoforward( var_0._id_0054 ), var_2 );
    var_4 = _func_0257( anglestoright( var_0._id_0054 ), var_2 );
...
_id_F15E()
{
    ...
    for (;;)
    {
        ...
        if ( scripts\mp\tac_ops\hostage_utility::_id_0BF6( "specialty_no_battle_chatter" ) || istrue( self._id_2402 ) )
            continue;
        ...
        var_1 = 0;
        var_2 = 4000000;
        var_3 = self player_recoilscaleon() > 0.7;
        ...
        {
            var_11 = _func_025A( var_10._id_02EA - self._id_02EA );
            var_12 = var_10 scripts\mp\tac_ops\hostage_utility::_id_0BF6( "specialty_coldblooded" );
            var_13 = _func_0257( var_8, var_11 ) > _id_077B::_id_F07F( var_3, _id_077B::_id_F07F( var_4, 0.965928, 0.984808 ), _id_077B::_id_F07F( var_4, 0.866025, 0.939692 ) );
            var_14 = distancesquared( self._id_02EA, var_10._id_02EA ) < var_2;

            if ( !isdefined( var_10 ) || !_id_0A74::_id_89D3( var_10 ) || var_12 || !var_14 || !var_13 )
            {
                var_0 = _id_077B::_id_1B96( var_0, var_10 );
                continue;
            }

            if ( _id_0A69::_id_6A43() == "arena_evo" && isdefined( var_10 ) )
            {
                var_15 = scripts\mp\gametypes\arena_evo_tourney_util::_id_67A2( self._id_0309["team"] );

                if ( !isdefined( var_15 ) )
                    break;

                if ( var_10._id_0309["team"] != var_15 || scripts\mp\gametypes\arena_evo_tourney_util::_id_85E8( var_10._id_0309["team"] ) )
                    var_0 = _id_077B::_id_1B96( var_0, var_10 );
            }
        }
        ...
        if ( var_1 == 1 )
        {
            level thread _id_F756( self, "clock_callout", undefined, undefined, var_0[0]._id_02EA );
            continue;
        }
    }
}
    ...
    if ( var_1 )
    {
        if ( level._id_2409["play_for_all"][var_2] )
        {
            foreach ( var_7 in level._id_EF86 )
            {
                ...
                if ( _id_0A69::_id_6A43() == "arena_evo" && var_7 != scripts\mp\gametypes\arena_evo_tourney_util::_id_67A2( self._id_0309["team"] ) )
                    continue;
        ...
        {
            if ( isdefined( self._id_045B ) && isdefined( self._id_E493 ) && isdefined( level._id_E48B[self._id_045B][self._id_E493] ) )
            {
                var_9 = level._id_E48B[self._id_045B][self._id_E493]._id_B758;
            ...
            doplaysoundtoteam( var_4, self._id_045B, self );
        else
            doplaysoundtoteam( var_4, self._id_045B );
    }
...
_id_B356( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_1 )
    {
            ...
            foreach ( var_9 in level._id_EF86 )
            {
                ...
                foreach ( var_12 in var_10 )
                {
                    if ( var_12 _meth_81E1() )
                    {
                        ...
                        if ( !_id_077B::_id_1B78( var_6, var_12 ) && !_id_077B::_id_1B78( var_6, var_7 ) )
                            var_6[var_6.size] = var_12;
                    }

                    if ( _id_0A69::_id_6A43() == "arena_evo" && var_9 != scripts\mp\gametypes\arena_evo_tourney_util::_id_67A2( self._id_0309["team"] ) )
                    {
                        if ( !_id_077B::_id_1B78( var_6, var_12 ) )
                            var_6[var_6.size] = var_12;
                    }
        ...
        {
            var_10 = level._id_EF67[self._id_045B]["players"];
            ...
            foreach ( var_12 in var_10 )
            {
                ...
                if ( istrue( var_12._id_7245 ) && !_id_077B::_id_1B78( var_6, var_12 ) )
                    var_6[var_6.size] = var_12;
            }
...
_id_B357( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_1 )
    {
        if ( level._id_2409["play_for_all"][var_2] )
        {
            foreach ( var_9 in level._id_EF86 )
            {
                if ( var_9 == self._id_045B )
                {
                    var_10 = level._id_EF67[self._id_045B]["players"];

                    foreach ( var_12 in var_10 )
                    {
                        if ( !_id_077B::_id_1B78( var_7, var_12 ) )
                            doplaysoundtoplayer( var_4, var_12 );
                    }
...
_id_8D87( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( var_6 )
        var_7 = _func_0147( var_7, _func_0140( var_5 ) / 1000 );

    var_8 = _id_077B::_id_108F5( "death", var_7 );
...
{
    var_2 = _id_077B::waittill_any_return( var_0, "death_or_disconnect" );
    ...
    if ( isdefined( var_2 ) && var_2 == var_0 )
    {
        ...
        var_4 = self._id_02EA;
        wait 0.5;
        var_5 = _id_0A7C::_id_6A3A( var_3, 1 );
        ...
        foreach ( var_7 in var_5 )
        {
            ...
            if ( var_7._id_045B != var_3 )
                continue;

            if ( _func_0102( var_7 ) )
                continue;

            if ( self._id_AC2A._id_1068F != var_7._id_AC2A._id_1068F && distancesquared( var_4, var_7._id_02EA ) <= 262144 && !_id_8A30( var_7 ) )
            {
                var_8 = _id_6AA2( var_7 );
                var_9 = "mp_glob3d" + var_7._id_AC2A._id_1068F + "_loc_" + var_1 + "_echo";

                if ( _func_0200( var_9 ) && _id_077B::_id_3A02() )
                    var_10 = var_9;
                else
                    var_10 = undefined;
...
_id_8A30( var_0, var_1 )
{
    ...
    if ( isdefined( var_0 ) && isdefined( var_0._id_045B ) && var_0._id_045B != "spectator" )
    {
        for ( var_3 = 0; var_3 < level._id_E3AD[var_0._id_045B].size; var_3++ )
        {
            var_4 = level._id_E3AD[var_0._id_045B][var_3]["player"];
            ...
            if ( distancesquared( var_4._id_02EA, var_0._id_02EA ) < var_2 )
                return 1;
        }
    }
...
_id_FC27( var_0 )
{
    ...
    level._id_2409["last_say_pos"][var_0][self._id_AC2A._id_1068F] = self._id_02EA;
    _id_3869( var_1 );
}
...
_id_8787( var_0 )
{
    return _func_0121( var_0, "_report" );
}
...
{
    if ( _func_0121( var_0, "_qa" ) && _func_0200( var_0 ) )
        return 1;
...
_id_6AFF( var_0 )
{
    var_1 = "dx_mpo_" + _id_077B::_id_F07F( self._id_045B == "allies", "usop", "ruop" ) + "_loc_enemy_" + var_0;
    return var_1;
}
...
_id_5F75( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        if ( var_3 != self && distancesquared( var_3._id_02EA, self._id_02EA ) <= var_0 )
            return 1;
    }
...
_id_CB63( var_0, var_1, var_2, var_3 )
{
    ...
    if ( _func_0102( var_0 ) || !_func_0117( var_0 ) )
        return;
    ...
    if ( !isdefined( var_0._id_0309["selfVOBonusChance"] ) )
        var_0 thread _id_FD1F();

    if ( _func_01B6( 1.0 ) > level._id_D080[level._id_D081[var_1]]["chance"] + var_0._id_0309["selfVOBonusChance"] )
        return;
...
_id_FD1F()
{
    self endon( "disconnect" );
    level endon( "game_ended" );
    self._id_0309["selfVOBonusChance"] = 0;

    if ( !_id_0A69::_id_CA3E() )
    {
        for (;;)
        {
            self._id_0309["selfVOBonusChance"] = self._id_0309["selfVOBonusChance"] + 0.1;
            wait 3.0;
        }
    }
    else if ( _id_0A69::_id_6A43() == "br" )
        self._id_0309["selfVOBonusChance"] = 0.25;
}
...
_id_F759( var_0, var_1 )
{
    ...
    if ( self._id_BEC4 == "none" || level._id_D080[level._id_D081[self._id_BEC4]]["priority"] < level._id_D080[level._id_D081[var_0]]["priority"] || level._id_D080[level._id_D081[self._id_BEC4]]["priority"] == level._id_D080[level._id_D081[var_0]]["priority"] && _id_077B::_id_3A02() )
        self._id_BEC4 = var_0;
    else
        return;
...
_id_6AA2( var_0 )
{
    var_2 = _id_0A69::_id_6DC9();
    var_3 = var_0 _id_68E8();

    if ( var_3 > 5000 || var_2 >= 80 || _id_0A69::_id_82B7() )
        return "high";
    else
        return "mid";
}
...
{
    var_2 = _id_06BB::_id_B7B4( var_0._id_02EA, 4000 );
    ...
    foreach ( var_4 in var_2 )
    {
        ...
        var_5 = _func_0147( _id_077B::_id_4B6B( var_0._id_02EA, var_4._id_02EA ), 1.0 );

        if ( _id_0A7F::_id_8780( var_1._id_0084 ) || _id_0A7F::_id_8782( var_1._id_0084 ) )
        {
            var_6 = 0;
            var_7 = _id_0A7F::_id_6E59( var_1._id_0084 );
            ...
            if ( _id_0A7F::_id_10D98( var_1, "silencer" ) )
                var_6 = var_6 * 0.25;
...
_id_107A( var_0, var_1, var_2 )
{
    ...
    {
        var_4 = _id_0A7F::_id_6E59( var_1 );

        if ( var_4 == "weapon_sniper" || var_4 == "weapon_dmr" )
        {
            if ( distance2d( self._id_02EA, var_0._id_02EA ) > 2250000 )
                var_3 = 1;
        }
    }
...
_id_FF48( var_0, var_1 )
{
    ...
    if ( var_8 < var_2 )
    {
        ...
        var_10 = _func_02C4( var_9 );
        var_11 = _id_077A::_id_C042( var_4, var_3, var_0, var_10 );

        if ( isdefined( var_11["entity"] ) && _func_0117( var_11["entity"] ) || var_11["fraction"] > 0.8 )
            return 1;
    }
...
_id_34C4()
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        if ( distancesquared( self._id_02EA, var_2._id_02EA ) <= 262144 )
        {
            var_3 = anglestoforward( var_2 getplayerangles() );

            if ( _func_0130( var_2._id_02EA - self._id_02EA ) > 0 )
            {
                if ( _id_0777::_id_1763( var_3, var_2._id_02EA - self._id_02EA ) < 80 )
                    break;
            }
        }
    }
...
_id_F756( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( !_id_0A74::_id_89D3( var_0 ) && level._id_2409["requires_alive"][var_1] )
        return;

    if ( var_0._id_045B == "spectator" )
        return;

    if ( var_0._id_045B == "follower" )
        return;
    ...
    if ( var_0 scripts\mp\tac_ops\hostage_utility::_id_0BF6( "specialty_no_battle_chatter" ) )
        return;
    ...
    if ( _func_01B6( 1 ) > level._id_2409["chance"][var_1] )
        return;
    ...
    level notify( "kill_queued_bc_sound_" + var_0._id_02BA );
    return var_0 _id_CB61( var_5, var_1, var_2, var_3, var_4 );
}

_id_CB61( var_0, var_1, var_2, var_3, var_4 )
{
    level endon( "kill_queued_bc_sound_" + self._id_02BA );
    self endon( "death_or_disconnect" );
    wait( var_0 / 1000 );
    ...
    while ( var_0 <= level._id_2409["max_wait_time"] + var_3 * 1000 )
    {
        ...
        {
            var_6 = gettime();
            var_5["higher"]["player"] _id_077B::_id_1087F( var_5["higher"]["sound_alias"], "death", "disconnect" );
            waitframe();
...
_id_68EA( var_0, var_1 )
{
    ...
    if ( isdefined( level._id_2409["last_say_time"] ) && isdefined( level._id_2409["last_say_time"][var_0] ) )
    {
        if ( var_0 == "ping_enemy_general_o" || var_0 == "ping_enemy_infantry_o" || var_0 == "ping_enemy_multiple_o" )
        {
            ...
            foreach ( var_6 in var_4 )
            {
                ...
                {
                    if ( distancesquared( var_8, self._id_02EA ) < 4000000 )
                    {
        ...
        else if ( var_0 == "inform_on_your_six_o" )
        {
            ...
            {
                if ( distancesquared( var_8, self._id_02EA ) < 2250000 )
                {
        ...
        else if ( isdefined( level._id_2409["last_say_pos"][var_0][self._id_AC2A._id_1068F] ) )
        {
            ...
            var_3 = distancesquared( level._id_2409["last_say_pos"][var_0][self._id_AC2A._id_1068F], self._id_02EA ) < 1048576;
        }
    }
    ...
    if ( var_3 )
        var_15 = _func_0147( var_13, _func_0147( var_2, var_14 ) );
    else
        var_15 = _func_0147( var_13, var_14 );
...
_id_6D43( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0 ) && isdefined( var_0._id_045B ) && var_0._id_045B != "spectator" )
    {
        foreach ( var_6 in level._id_E3AD[var_0._id_045B] )
        {
            var_7 = var_6;
            var_8 = var_7["player"];
            ...
            if ( distancesquared( var_8._id_02EA, var_0._id_02EA ) < var_3 )
            {
                if ( isdefined( var_9 ) )
                {
                    if ( var_9 > var_1 || var_9 == var_1 && _id_077B::_id_3A02() )
                    {
                        var_4["higher"] = var_7;
                        return var_4;
                    }
...
_id_3ADE( var_0, var_1 )
{
    ...
    var_4 = level._id_2409["priority"][var_1] == level._id_2409["priority"][var_0] && _id_077B::_id_3A02();
    return var_3 || var_4;
}

_id_CAFB( var_0, var_1 )
{
    if ( !isdefined( self ) || !_id_0A7C::_id_885E( self._id_045B ) )
        return 1;
