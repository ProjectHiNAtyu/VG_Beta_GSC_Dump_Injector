...
_id_AA64( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !_func_0104( self ) )
    {
        self _meth_824A( "placePlaceable", "+attack" );
        self _meth_824A( "placePlaceable", "+attack_akimbo_accessible" );
        self _meth_824A( "cancelPlaceable", "+actionslot 4" );

        if ( !self _meth_8682() )
        {
            self _meth_824A( "cancelPlaceable", "+actionslot 5" );
            self _meth_824A( "cancelPlaceable", "+actionslot 6" );
            self _meth_824A( "cancelPlaceable", "+actionslot 7" );
        }
    }

    for (;;)
    {
        if ( isdefined( var_3 ) && var_3 == 1 && !self isonground() && self _meth_81D7() && !self _meth_81CD() )
            var_4 = "placePlaceable";
        else
            var_4 = _id_077B::_id_10896( "placePlaceable", "cancelPlaceable", "force_cancel_placement" );
...
{
    var_1 = level._id_B144[var_0];
    self._id_02EA = self._id_B161;
    self._id_0054 = self._id_32A9._id_0054;
    self _meth_827B( var_1._id_B14F );
    _id_DCD1( var_0 );
    ...
    self _meth_832B( var_1._id_020A );
    var_2 = self._id_02F2;
    var_2 _meth_80FC();
    var_2._id_878D = undefined;
    ...
    self makeunusable();
    _id_07E9::_id_C2A4( "Killstreak_Ground", self._id_02F2 );
    ...
    {
        level thread _id_07BA::_id_EF8A( var_1._id_E416, var_2 );
        self._id_DBDE = 0;
    }
    ...
    thread _id_07CD::_id_73E7( var_6 );
    thread _id_10BD3();
    self notify( "placed" );
    self._id_32A9 _meth_809A();
...
_id_FCF0( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        var_5._id_02EA = self._id_B161 + var_4;
        var_5._id_0054 = var_6["angles"];
        self._id_3126 = var_1 _meth_81D7() && var_6["result"] && abs( self._id_B161[2] - var_1._id_02EA[2] ) < var_3._id_B15B;
        ...
        if ( self._id_3126 != var_2 )
        {
            if ( self._id_3126 )
            {
                var_5 setmode( var_3._id_9FCA );
                var_1 _meth_80FD( var_3._id_B169 );
            }
            else
            {
                var_5 setmode( var_3._id_9FCB );
...
_id_7413( var_0 )
{
    self endon( "carried" );
    var_1 = level._id_B144[var_0];
    _id_079A::_id_A0EC( var_1._id_027F, var_1._id_42DC, ::_id_7417, ::_id_9FF4, 1 );
}
...
_id_7417( var_0 )
{
    ...
    if ( var_6 && isdefined( var_5._id_AAA0 ) )
        self [[ var_5._id_AAA0 ]]( self._id_EA0F, var_1, self._id_02F2, var_3 );
}
...
_id_F221( var_0 )
{
    ...
    if ( isdefined( self._id_02F2 ) && isdefined( var_1._id_70BE ) )
        self._id_02F2 thread _id_0A64::_id_9120( var_1._id_70BE );
...
_id_3F85( var_0 )
{
    ...
    var_1 = _func_0210( "misc_turret", self._id_02EA + ( 0, 0, 25 ), "sentry_minigun_mp" );
    var_1._id_0054 = self._id_0054;
    var_1._id_02F2 = self;
    var_2 = level._id_B144[var_0];
    var_1 setmode( var_2._id_9FBD );
    var_1 _meth_8223();
    var_1 _meth_839C( 1 );
