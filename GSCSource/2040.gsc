...
get_objective_timer()
{
    ...
    {
        var_1 = gettime();
        return _id_077B::_id_F07F( var_1 < var_0, var_0 - var_1, 0 );
    }
...
update_player_death_data()
{
    ...
    var_2 = self._id_0309["cur_kill_streak"];
...
_id_AA4A( var_0 )
{
    ...
    var_0.sent_telemetry = _func_020F();
    var_0 initialize_player_pers_data();

    if ( _id_077B::_id_5BEC( "pre_game_over" ) && !isdefined( var_0.round_start_data ) )
...
_id_AA4B( var_0 )
{
    ...
    if ( var_1 _meth_81D2() || !_id_077B::_id_5BEC( "pre_game_over" ) )
        return;
...
{
    var_0 = [ "game_type", level._id_60D1, "map_name", level._id_9AA7, "team1_name", _id_6469( "allies" ), "team2_name", _id_6469( "axis" ) ];
...
{
    var_1 = [ "match_time", _id_6566(), "rounds_played", game["roundsPlayed"], "team1_name", _id_6469( "allies" ), "team1_score", _func_00DB( "allies" ), "team2_name", _id_6469( "axis" ), "team2_score", _func_00DB( "axis" ), "win_team", _id_6847( var_0._id_10E51 ), "game_type", level._id_60D1, "map_name", level._id_9AA7 ];
    _func_03BA( "dlog_event_esports_match_end", var_1 );
}

add_match_interval_control_data( var_0 )
{
    var_0 = _id_077B::_id_1B72( var_0, [ "point1_tiers_captured", 0, "point2_tiers_captured", 0 ] );
    return var_0;
}

send_match_interval_telemetry()
{
    var_0 = [ "game_timer", int( _id_07AC::_id_6DCA() / 1000 ), "objective_timer", int( get_objective_timer() / 1000 ), "team1_score", _func_00DB( "allies" ), "team2_score", _func_00DB( "axis" ) ];
...
send_round_end_telemetry( var_0 )
{
    ...
    var_2 = [ "result", _id_66F3( var_0._id_529F ), "win_side", var_1._id_DD0F, "match_time", _id_6566(), "game_type", level._id_60D1, "map_name", level._id_9AA7, "win_team", _id_6469( var_1._id_10E20 ), "loss_team", _id_6469( var_1._id_988C ) ];
...
add_objective_info_control_data( var_0 )
{
    ...
    var_0 = _id_077B::_id_1B72( var_0, [ "control_info", var_1 ] );
    return var_0;
}
...
send_objective_info_telemetry()
{
    ...
    foreach ( var_4 in var_1 )
    {
        ...
        var_0 = _id_077B::_id_1B63( var_0, var_5 );
        var_0 = _id_077B::_id_1B63( var_0, get_objective_info( var_4 ) );
        var_2++;
    }
...
add_objective_state_changed_koth_data( var_0, var_1 )
{
    ...
    var_0 = _id_077B::_id_1B72( var_0, [ "obj_name", get_objective_name_koth(), "is_captured", var_2 != "none", "is_contested", self._id_E578 ] );
    return var_0;
}
...
add_objective_state_changed_sd_data( var_0, var_1 )
{
    ...
    var_0 = _id_077B::_id_1B72( var_0, [ "obj_name", get_objective_name_sd(), "is_bomb_picked_up", _id_077B::_id_F07F( isdefined( var_2 ), var_2._id_8769, 0 ), "is_bomb_planted", level._id_263D, "is_bomb_defused", level._id_260F ] );
    return var_0;
}
...
{
    var_2 = var_1.obj_team;
    var_0 = _id_077B::_id_1B72( var_0, [ "obj_name", get_objective_name_control(), "is_captured", var_2 != "none", "is_contested", 0, "team1_remaining_lives", 0, "team2_remaining_lives", 0, "point1_tiers_captured", 0, "point2_tiers_captured", 0 ] );
    return var_0;
}
...
send_objective_state_changed_telemetry( var_0 )
{
    ...
    var_3 = _id_077B::_id_F07F( isdefined( var_1 ), var_1._id_02BA, "none" );
    var_4 = _id_077B::_id_F07F( isdefined( var_1 ), _id_6469( var_1._id_0393 ), "none" );
...
{
    var_1 = var_0._id_030F;
    var_2 = [ "player_name", var_1._id_02BA ];
...
send_player_spawned_telemetry( var_0 )
{
    ...
    var_3 = [ "player_name", var_0._id_02BA, "player_team", _id_6469( var_0._id_0393 ), "match_time", _id_6566(), "origin", vector_to_array( var_1 ), "viewangles", vector_to_array( var_2 ) ];
...
send_player_death_telemetry( var_0 )
{
    ...
    var_2 = _id_077B::_id_F07F( isdefined( var_1._id_9FE8 ), var_1._id_9FE8, [] );
    var_3 = var_1._id_8FA4;
    var_4 = var_1._id_8FA1;
    var_5 = var_1._id_90B7;
    var_6 = var_0._id_006E;

    if ( _func_0117( var_6 ) )
    {
        var_7 = var_6._id_02EA;
        var_8 = var_6 getplayerangles();
        var_9 = var_0._id_A90B;
        var_10 = _id_077B::_id_F07F( isdefined( var_6._id_9FE8 ), var_6._id_9FE8, [] );
        var_11 = [ "name", var_6._id_02BA, "team", _id_6469( var_6._id_0393 ), "origin", vector_to_array( var_7 ), "viewangles", vector_to_array( var_8 ), "weapon", var_9._id_0084, "weapon_attachments", _id_0A7F::_id_6E4C( var_9 ) ];
        var_12 = [ "is_ads", var_6 _id_0A74::_id_896F(), "is_flashed", istrue( var_6._id_5C76 ), "is_interacting_objective", var_6 is_interacting_objective() ];
    ...
    var_15 = [ "name", var_1._id_02BA, "team", _id_6469( var_1._id_0393 ), "origin", vector_to_array( var_3 ), "viewangles", vector_to_array( var_4 ), "weapon", var_5._id_0084, "weapon_attachments", _id_0A7F::_id_6E4C( var_5 ) ];
    var_16 = [ "is_ads", var_1 _id_0A74::_id_896F(), "is_flashed", istrue( var_1._id_5C76 ), "is_interacting_objective", var_1 is_interacting_objective() ];
...
send_player_match_end_telemetry( var_0 )
{
    ...
    var_3 = var_1._id_0309;
    var_4 = var_1 _id_0796::getlocalcodcasterclientstat( 0 );
    var_5 = var_1 _id_0796::getlocalcodcasterclientstat( 1 );
    var_6 = [ "total_score", var_3["score"], "total_assists", var_3["assists"], "total_kills", var_3["kills"], "highest_streak", var_3["longestStreak"], "total_deaths", var_3["deaths"], "total_headshots", var_3["headshots"], "total_time_alive", _id_077B::_id_F07F( var_3["total_time_alive"] == 0, _id_6566(), var_3["total_time_alive"] ), "total_damage_dealt", var_3["damage"], "total_distance_traveled", _id_077B::_id_F07F( isdefined( var_3["totalDistTraveled"] ), float( var_3["totalDistTraveled"] ), 0.0 ), "average_speed_during_match", var_2.average_speed_during_match, "time_spent_moving", var_2.time_spent_moving, "total_suicides", var_3["suicides"], "total_shots_fired", var_4, "total_shots_hit", var_5, "total_shots_head", var_3["shotsHitHead"], "total_multikills", var_3["totalMultikills"], "highest_multikill", var_3["highestMultikill"], "rounds_played", var_1 get_number_of_rounds( var_0._id_9CBF ), "player_name", var_1._id_02BA, "game_type", level._id_60D1 ];
...
send_players_interval_telemetry()
{
    ...
    foreach ( var_2 in level._id_B758 )
    {
        ...
        var_3 = var_2._id_0309;
        var_4 = var_2 _id_0796::getlocalcodcasterclientstat( 0 );
        var_5 = var_2 _id_0796::getlocalcodcasterclientstat( 1 );
        var_6 = [ "player_name", var_2._id_02BA, "origin", vector_to_array( var_2._id_02EA ), "damage_dealt", var_3["damage"], "assists", var_3["assists"], "deaths", var_3["deaths"], "kills", var_3["kills"], "current_killstreak", var_3["cur_kill_streak"], "highest_killstreak", var_3["longestStreak"], "multikills", var_3["totalMultikills"], "highest_multikill", var_3["highestMultikill"], "score", var_3["score"], "shots_fired", var_4, "shots_hit", var_5, "shots_head", var_3["shotsHitHead"], "objective_time", var_3["objTime"], "packet_loss", 0, "latency", 0, "ping", 0 ];
        var_7 = _func_020F();
        var_7._id_030F = var_2;
        var_7._id_5669 = var_6;
        var_0 = _id_077B::_id_1B63( var_0, var_7 );
    }

    foreach ( var_7 in var_0 )
    {
        var_2 = var_7._id_030F;
...
send_player_round_end_telemetry( var_0 )
{
    ...
    var_2 = var_1._id_0309;
    var_3 = var_1.round_start_data;
    var_4 = var_1 _id_0796::getlocalcodcasterclientstat( 0 );
    var_5 = var_1 _id_0796::getlocalcodcasterclientstat( 1 );
    var_6 = var_3.highest_streak;
    var_7 = var_2["cur_kill_streak"];
    var_8 = [ "kills", var_2["kills"] - var_3._id_024B, "assists", var_2["assists"] - var_3._id_006A, "deaths", var_2["deaths"] - var_3._id_0146, "damage_dealt", var_2["damage"] - var_3.damage_dealt, "highest_streak", _id_077B::_id_F07F( var_6 < var_7, var_7, var_6 ), "time_alive", var_2["total_time_alive"] - var_3.time_alive, "rounds_played", var_1 get_number_of_rounds(), "rounds_won", _id_0A69::getrankxp( var_1._id_0393 ), "score", var_2["score"] - var_3._id_0369, "shots_fired", var_4 - var_3._id_DA5E, "shots_hit", var_5 - var_3._id_DA60, "shots_head", var_2["shotsHitHead"] - var_3.shots_head, "player_name", var_1._id_02BA, "game_type", level._id_60D1 ];
...
send_player_loadout_changed_telemetry( var_0 )
{
    ...
    var_8 = [ "player_name", var_1._id_02BA, "primary_weapon", var_2._id_966C, "primary_weapon_attachments", var_6, "secondary_weapon", var_2._id_967B, "secondary_weapon_attachments", var_7, "primary_grenade", var_2._id_9653, "secondary_grenade", var_2._id_9654, "field_upgrades", var_5, "streaks", var_4, "perks", _id_077B::_id_1B72( var_2._id_9668, var_2._id_9659 ), "match_time", _id_6566() ];
