...
_id_DEC9( var_0, var_1 )
{
    ...
    var_3 = 0;
    var_4 = anglestoforward( var_2._id_0054 );
    var_5 = var_0 - var_2._id_02EA;
...
_id_DECF( var_0, var_1 )
{
    ...
    {
        level._id_0CD7._id_BFC1 = _func_020F();
...
{
    var_1 = _func_020F();
    var_1._id_02BA = "throttle_waiter";
    var_1._id_010E = 0;
    var_1._id_C5E4 = 0;
    var_2 = 10;

    if ( isdefined( var_0 ) )
        var_2 = _func_0147( var_0, 1 );
...
_id_DF3E()
{
    for (;;)
    {
        ...
        {
            var_2 = distance( level._id_030F._id_02EA, var_1["origin"] );
