...
_id_021D()
{
    if ( _id_0A69::_id_6A43() == "br" || istrue( game["isLaunchChunk"] ) )
    {
        level._id_BA7D = 0;
        return;
    }
    ...
    var_0._id_AF70 = 0;
    _id_95FD();
    _func_01D1( "#x3438da3956879c21", 5000 );
    _func_01D1( "#x35805e05dfd2245d7", 3000 );
    _func_01D1( "#x32ebcc0d172f2f174", 1000 );
    _func_01D1( "#x3f5c43063fe0f37ed", 1 );
    _func_01D1( "#x32fa12d8b14255fd5", 420 );
    thread _id_AB46();
    _id_0A65::_id_C277( ::_id_AB50 );
    scripts\mp\healthoverlay::_id_021D();
}
...
_id_95FD()
{
    ...
    for (;;)
    {
        var_2 = _func_021E( "mp/potg_event_table.csv", var_1, 0 );

        if ( !isdefined( var_2 ) || var_2 == "" )
            break;

        var_0._id_56A3[var_2] = [];
        var_3 = _func_021E( "mp/potg_event_table.csv", var_1, 1 );
        var_0._id_56A3[var_2]["score"] = float( var_3 );
        var_4 = _func_021E( "mp/potg_event_table.csv", var_1, 2 );
...
_id_AB7F( var_0 )
{
    ...
    scripts\mp\healthoverlay::_id_AB7F( var_0 );
    waitframe();
    thread _id_10820();
}
...
{
    var_1 = level._id_BA7E;
    scripts\mp\healthoverlay::_id_AB6B();
...
_id_BD5E( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_8 = int( _func_0147( _id_6995(), var_7._id_901F ) );
...
_id_1080F( var_0 )
{
    ...
    if ( var_4 > gettime() )
    {
        ...
        var_5 = _id_077B::_id_1089D( "potg_pending_scene_timeout", "potg_stop_recording" );
...
_id_C631()
{
    ...
    {
        var_1 _meth_82F6( "ui_potg_score_event_control", -1 );
        var_1 _meth_82F6( "ui_score_event_list_0", -1 );
        var_1 _meth_82F6( "ui_score_event_list_1", -1 );
        var_1 _meth_82F6( "ui_score_event_list_2", -1 );
        var_1 _meth_82F6( "ui_score_event_list_3", -1 );
        var_1 _meth_82F6( "ui_score_event_list_4", -1 );
    }
}
...
_id_2E9D( var_0 )
{
    ...
    var_3 = int( _func_0147( var_2, _func_0147( var_0._id_C13A, var_1 ) ) );
    var_4 = var_0._id_0E6B - _id_6CE7();
    var_5 = int( _func_0148( var_0._id_0E6B, var_0._id_532E - _id_6E7A() ) );
...
_id_CC62( var_0, var_1 )
{
    ...
    if ( _func_0117( var_0._id_BCC0 ) )
        var_2 = var_0._id_BCC0._id_02BA;
    else
        var_2 = "(GameObject)";
    ...
    if ( isdefined( var_1 ) && _func_0117( var_1._id_BCC0 ) && var_1._id_BCC0 != var_0._id_BCC0 )
...
_id_CC61()
{
    ...
    var_0 = _id_697E();
    var_1 = gettime() - int( self.archived * 1000 );
    var_2 = 0.15;
    var_3 = [];
...
_id_433A( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_5 = _id_433B();
    _func_03BA( "mpscript_potg_archive", [ "requestTime", var_0, "archiveStartTime", var_1, "archiveDuration", var_2, "desiredSceneStartTime", var_3, "desiredSceneEndTime", var_4, "playerCount", level._id_B758.size, "tickRate", int( 1.0 / level._id_5F1B ), "dedi", _id_077B::_id_F07F( _func_010A(), 1, 0 ), "version", 0 ] );
}
