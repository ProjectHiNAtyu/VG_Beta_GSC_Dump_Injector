...
_id_0BEB( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_1 ) )
        var_1 = -1;
...
_id_0D6A( var_0 )
{
    ...
    if ( _func_036D( var_0 ) )
        ...
        var_1 = _func_034D( self _meth_8588() ) == var_0;

    if ( var_1 )
    {
        var_2 = _id_077B::_id_F07F( _func_0120( var_0 ), var_0, _func_034D( var_0 ) );
...
_id_EDDC( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( !_id_87C6( var_0 ) )
        {
            ...
            if ( !_func_036F( var_2 ) && self._id_0122 == var_2 )
                var_1 = 0;
            else
                var_1 = 1;
        }
...
_id_3158( var_0, var_1 )
{
    ...
    if ( !istrue( var_1 ) && !_id_06BB::_id_870A() && !_id_06BB::_id_8692() )
        return 0;
...
_id_4D21( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        if ( !_id_06BB::_id_8702() || !istrue( var_2 ) && !_id_06BB::_id_870A() && !_id_06BB::_id_8692() )
        {
            self _meth_858B( var_0 );
            return 0;
        }
...
_id_6CD8( var_0, var_1 )
{
    ...
    if ( _func_0107( self ) )
    {
        self switchtoweapon( _func_0370() );
        var_2 = 1;
    }
...
_id_5EB7( var_0 )
{
    ...
    while ( _func_036F( self getcurrentweapon() ) )
    {
        if ( self _meth_81EA() || _id_873B() )
        {
            waitframe();
            continue;
        }
        ...
        {
            if ( !isdefined( self._id_8FAB ) || self._id_8FAB._id_0084 == "none" )
                break;
        ...
        else if ( self hasweapon( "iw8_fists_mp" ) )
        {
            ...
            {
                if ( var_1[0]._id_0084 == "iw8_fists_mp" )
                    var_2 = var_1[0];
                else
                    var_2 = var_1[1];
            }
...
_id_87C6( var_0 )
{
    ...
    return _func_036E( self getcurrentweapon(), var_0, 1 );
}
