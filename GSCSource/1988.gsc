...
_id_021D()
{
    ...
    for (;;)
    {
        var_1 = _func_021E( "mp/loot/iw7_weapon_loot_master.csv", var_0, 0 );

        if ( !isdefined( var_1 ) || var_1 == "" )
            break;

        var_1 = int( var_1 );
        var_2 = _func_021E( "mp/loot/iw7_weapon_loot_master.csv", var_0, 1 );
...
_id_6E49( var_0, var_1 )
{
    ...
    var_3 = stopfxontag( var_2, 0, var_1, 3 );
    return var_3;
}
...
{
    var_2 = "mp/loot/weapon/" + var_0 + ".csv";
    var_3 = stopfxontag( var_2, 0, var_1, 1 );
    return var_3;
}
...
_id_C09A( var_0, var_1 )
{
    ...
    var_3 = _func_020F();
    var_3._id_C17B = _func_021E( var_0, var_2, 1 );
    var_3._id_10D5C = _func_021E( var_0, var_2, 1 );
    var_3._id_AE99 = [];

    for ( var_4 = 0; var_4 < 3; var_4++ )
    {
        var_5 = _func_021E( var_0, var_2, 5 + var_4 );

        if ( isdefined( var_5 ) && var_5 != "" )
            var_3._id_AE99[var_3._id_AE99.size] = var_5;
    }

    var_3._id_BE8A = int( _func_021E( var_0, var_2, 4 ) );
...
_id_6E64( var_0, var_1 )
{
    ...
    var_2 = weaponisbeam( var_0 );
    var_3 = int( stopfxontag( var_2, 0, var_1, 4 ) );
    return var_3;
}
