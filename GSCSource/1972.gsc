...
_id_021D()
{
    var_0 = _id_0A66::_id_6BDC( "scr_" + _id_0A69::_id_6A43() + "_healthregentime", "scr_player_healthregentime" );
...
{
    thread _id_9A12();
    self _meth_8456( game["thermal_vision"] );
}
...
_id_9A12()
{
    ...
    for (;;)
    {
        _id_077B::_id_108C3( "damage", "force_regeneration" );
        thread _id_7612();
    }
}
...
_id_AAB5()
{
    ...
    if ( !istrue( self._id_43E8 ) )
    {
        ...
        self _meth_8275( "sys_deaths_door_lp_mp" );
...
_id_AACC( var_0 )
{
    ...
    self._id_43E8 = 0;
    self _meth_83EE( "sys_deaths_door_intro_impact" );
    self _meth_8275( "sys_deaths_door_exit" );
...
_id_AAE2()
{
    ...
    self _meth_82F6( "ui_health_regen_hud", 0 );
    ...
    if ( _id_0A69::_id_6A43() == "br" )
    {
        if ( isdefined( var_0 ) )
        {
            if ( var_0 == "equip_bandages" )
                return self._id_027F * _id_09DA::_id_68D7() / _id_09DA::_id_68D8();

            return self._id_027F / _id_09DA::_id_6A1C();
        }
    }
...
_id_7612( var_0 )
{
    ...
    if ( var_2 < 0.55 && !_id_0A74::_id_8AB5() )
        _id_AAB5();
    ...
    if ( var_1 )
    {
        ...
        while ( istrue( self._id_762C ) || !_id_0A74::_id_85D2() )
            waitframe();

        _id_10804();
    }

    if ( !var_1 || scripts\mp\tac_ops\hostage_utility::_id_0BF6( "specialty_regenfaster" ) )
        self _meth_82F6( "ui_health_regen_hud", 1 );

    var_3 = self._id_027F / 50.0;
    var_4 = 0.0;
    var_5 = self._id_01FF;
    ...
    for (;;)
    {
        if ( !_id_0A74::_id_85D2() || istrue( self._id_762C ) && var_1 )
            return;
        ...
        else if ( scripts\mp\tac_ops\hostage_utility::_id_0BF6( "specialty_regenfaster" ) )
            var_7 = var_3 * level._id_C1B0;

        if ( self._id_01FF < self._id_027F )
        {
            var_8 = self._id_01FF + var_7 + var_4;
            var_9 = int( _func_0148( self._id_027F, var_8 ) );
            var_4 = var_8 - var_9;
            self._id_01FF = var_9;
            var_2 = self._id_01FF / self._id_027F;
    ...
    if ( var_1 )
        level thread _id_0789::_id_F756( self, "player_recover" );
...
_id_10804()
{
    ...
    if ( isdefined( self._id_902D ) )
    {
        ...
        if ( scripts\mp\tac_ops\hostage_utility::_id_0BF6( "specialty_shrapnel_resist" ) )
        {
            var_2 = 1;
            self._id_DD01 = _func_0147( var_2 - var_1, 0 );
        }
        else
            self._id_DD01 = _func_0147( 3 - var_1, 0 );
    }
...
_id_B656( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( level._id_762C )
        {
            ...
            if ( self._id_ADD2 > _id_077B::_id_F07F( istrue( self._id_753A ), 1, 4 ) )
            {
                wait 1.0;
                self._id_753A = 1;
                _id_AACC( 0 );
...
_id_19BF()
{
    ...
    self _meth_82F6( "ui_shrapnel_overlay", 1 );
    var_0 = _id_19C0();

    if ( istrue( var_0 ) )
        self _meth_82F6( "ui_shrapnel_overlay", 2 );
    else
        self _meth_82F6( "ui_shrapnel_overlay", 3 );
}
...
_id_19C0()
{
    ...
    level endon( "game_ended" );
    var_0 = _id_077B::_id_10896( "shrapnel_ended_early", "shrapnel_ended", "force_regeneration" );
