...
_id_E76D( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_3 ) || !_id_0A69::_id_AB13() )
        return;
...
{
    if ( !_id_0A69::_id_AB13() && !istrue( var_2 ) )
        return 0;
...
{
    if ( !_id_0A69::_id_AB13() && !istrue( var_3 ) )
        return;
...
_id_FC19()
{
    ...
    while ( !level._id_609B )
    {
        ...
        {
            level._id_B758[var_0] _id_10FC1();
            level._id_B758[var_0] _id_FD86();
        }
...
_id_10FC0()
{
    foreach ( var_1 in level._id_B758 )
    {
        if ( isdefined( var_1 ) && var_1 _id_0A69::_id_AB13() )
        {
...
_id_10FC3()
{
    ...
    if ( _id_0A69::_id_10A14() || !_id_0A69::_id_89F1() && _id_0A69::_id_79A6() )
    {
        foreach ( var_1 in level._id_B758 )
        {
            var_2 = 0;

            if ( isdefined( var_1._id_0309["shotsFired"] ) && isdefined( var_1._id_0309["shotsHit"] ) && var_1._id_0309["shotsFired"] > 0 )
            {
                var_3 = var_1._id_0309["shotsFired"];
                var_4 = var_1._id_0309["shotsHit"];
                var_2 = var_4 / var_3;
            }

            if ( !isdefined( var_1._id_7602 ) )
                var_1._id_7602 = _id_077B::_id_F07F( isdefined( var_1._id_0309["headshots"] ), var_1._id_0309["headshots"], 0 );

            var_1 _id_7DD9( var_1._id_024B, var_1._id_0146, var_1._id_7602, var_2, var_1._id_0309["damage"] );
        }
    }
}
...
_id_7DD0( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !_id_0A7F::_id_1D75( var_0, var_3 ) )
        return;
...
_id_FD86()
{
    ...
    if ( _func_036F( self._id_F40C ) )
        return;

    if ( _id_0A7F::_id_8A63( self._id_F40C ) )
    {
        if ( !istrue( _id_07F2::_id_DBF9( self._id_F40C ) ) )
            return;
    }

    if ( _id_0A7F::_id_88DC( self._id_F40C ) || _id_0A7F::_id_881A( self._id_F40C ) || _id_0A7F::_id_876D( self._id_F40C ) )
        return;
    ...
    if ( var_0._id_022A )
    {
        var_2 = _id_0A7F::_id_1D7D( var_0._id_0490 );
    ...
    if ( !_id_0A7F::_id_8780( var_1 ) && !_id_0A7F::_id_8782( var_1 ) )
        return;

    var_5 = _func_02F2( var_0 );
    _id_AFFC( var_1, var_5 );

    if ( !_id_0A7F::_id_8964( var_0 ) )
    ...
    {
        var_8 = _id_0A7F::_id_1D7D( var_2 );

        if ( !_id_0A7F::_id_1D75( var_8, var_0 ) )
            continue;
...
{
    if ( self._id_F411 > 0 )
        _id_06BB::_id_F737( level._id_9BA3, var_0, "shots", self._id_F411, var_1 );

    if ( self._id_F410 > 0 )
        _id_06BB::_id_F737( level._id_9BA3, var_0, "kills", self._id_F410, var_1 );

    if ( self._id_F40F > 0 )
        _id_06BB::_id_F737( level._id_9BA3, var_0, "hits", self._id_F40F, var_1 );

    if ( self._id_F40E > 0 )
        _id_06BB::_id_F737( level._id_9BA3, var_0, "headshots", self._id_F40E, var_1 );

    if ( self._id_F40D > 0 )
        _id_06BB::_id_F737( level._id_9BA3, var_0, "deaths", self._id_F40D, var_1 );
}

_id_B006( var_0, var_1 )
{
    if ( !_id_0A7F::_id_1D75( var_0, var_1 ) )
        return;

    if ( self._id_F411 > 0 && var_0 != "tactical" )
    {
        _id_7DD0( var_0, "shots", self._id_F411, var_1 );
        _id_06BB::_id_F737( level._id_9B99, var_0, "shots", self._id_F411, var_1 );
    }

    if ( self._id_F410 > 0 && var_0 != "tactical" )
    {
        _id_7DD0( var_0, "kills", self._id_F410, var_1 );
        _id_06BB::_id_F737( level._id_9B99, var_0, "kills", self._id_F410, var_1 );
    }

    if ( self._id_F40F > 0 && var_0 != "tactical" )
    {
        _id_7DD0( var_0, "hits", self._id_F40F, var_1 );
        _id_06BB::_id_F737( level._id_9B99, var_0, "hits", self._id_F40F, var_1 );
    }

    if ( self._id_F40E > 0 && var_0 != "tactical" )
    {
        _id_7DD0( var_0, "headShots", self._id_F40E, var_1 );
        _id_06BB::_id_F737( level._id_9B99, var_0, "headShots", self._id_F40E, var_1 );
    }

    if ( self._id_F40D > 0 )
    {
        _id_7DD0( var_0, "deaths", self._id_F40D, var_1 );
        _id_06BB::_id_F737( level._id_9B99, var_0, "deaths", self._id_F40D, var_1 );
    }
}
...
_id_FD9C()
{
    ...
    if ( _id_0A69::_id_89F1() && !_id_0A69::_id_10A14() )
        return;
