...
_id_021D()
{
    level._id_0BA3["flashpoint_kill_s1"] = _func_0139( "vfx/iw8_mp/flashpoint/vfx_fp_gunfight_s1.vfx" );
    level._id_0BA3["flashpoint_kill_s2"] = _func_0139( "vfx/iw8_mp/flashpoint/vfx_fp_gunfight_s2.vfx" );
    level._id_0BA3["flashpoint_kill_s3"] = _func_0139( "vfx/iw8_mp/flashpoint/vfx_fp_gunfight_s3.vfx" );
    level._id_0BA3["flashpoint_gunfire_s1"] = _func_0139( "vfx/iw8_mp/flashpoint/vfx_fp_gunfight_small_s1.vfx" );
    level._id_0BA3["flashpoint_pulse_friendly"] = _func_0139( "vfx/iw8_mp/flashpoint/vfx_fp_pulse_friendly.vfx" );
    level._id_0BA3["flashpoint_pulse_squad"] = _func_0139( "vfx/iw8_mp/flashpoint/vfx_fp_pulse_squad.vfx" );
    level._id_0BA3["flashpoint_pulse_enemy"] = _func_0139( "vfx/iw8_mp/flashpoint/vfx_fp_pulse_enemy.vfx" );
        ...
        foreach ( var_1 in level._id_5CAC._id_5CB6 )
        {
            ...
            foreach ( var_5 in var_3 )
            {
                if ( var_2 - var_5 > 12500 )
                    var_1._id_569C = _id_077B::_id_1B9E( var_1._id_569C, var_5 );
            }
        }
...
_id_5CA9( var_0, var_1, var_2, var_3 )
{
    ...
    if ( 0 )
        var_4 = ( _func_01B7( -1000, 1000 ), _func_01B7( -1000, 1000 ), 0 );

    if ( var_3 == "gunfire" )
    {
        var_5 = var_0._id_02EA + ( 0, 0, 32 );
    ...
    else
    {
        ...
        if ( level._id_5CA8 )
            var_5 = _func_0259( var_0._id_02EA + ( 0, 0, 48 ), var_1._id_02EA + ( 0, 0, 48 ), 0.25 );
        else
            var_5 = var_1._id_02EA + ( 0, 0, 48 );
        ...
        if ( level._id_5CA8 )
        {
            ...
            var_7 = var_6 _id_077B::_id_1BAE( level._id_5CAC._id_5CB6, ::_id_E031 );
            var_6 _meth_809A();
...
_id_5CAA( var_0 )
{
    ...
    level._id_5CAC._id_5CB6 = _id_077B::_id_1B96( level._id_5CAC._id_5CB6, var_0 );
}
...
_id_5CA3( var_0 )
{
    ...
    if ( ( var_1 - 1 > var_2 || var_2 == 0 ) && var_0._id_045B != "axis" && var_1 != 0 )
    {
        if ( level._id_5CA8 )
        {
    ...
    else if ( ( var_2 - 1 > var_1 || var_1 == 0 ) && var_0._id_045B != "allies" && var_2 != 0 )
    {
        if ( level._id_5CA8 )
        {
    ...
    else if ( var_0._id_045B != "neutral" && var_2 != 0 && var_1 != 0 )
    {
        if ( level._id_5CA8 )
        {
...
{
    return distancesquared( var_0._id_411F, self._id_02EA ) < distancesquared( var_1._id_411F, self._id_02EA );
}
...
{
    _func_0196( _id_077B::_id_6A40( var_1 ), var_0 );
}
...
_id_5CAB()
{
    ...
    while ( self._id_82D8 )
    {
        foreach ( var_1 in level._id_B758 )
        {
            ...
            if ( self._id_045B != var_1._id_045B )
            {
                if ( istrue( level._id_E371 ) )
                    _func_0198( level._id_0BA3["flashpoint_pulse_enemy"], var_1, "tag_eye", self );
            ...
            if ( istrue( level._id_E372 ) )
            {
                ...
                {
                    _func_0198( level._id_0BA3["flashpoint_pulse_squad"], var_1, "tag_eye", self );
                    continue;
                }

                _func_0198( level._id_0BA3["flashpoint_pulse_friendly"], var_1, "tag_eye", self );
            }
        }
