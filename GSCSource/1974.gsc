...
_id_D5C7( var_0, var_1 )
{
    if ( getdvarint( "#x3a94ab57f69760eb2", 0 ) == 1 && getdvarint( "high_fives_enabled" ) == 1 && _func_00BE( "ui_hf_target_player" ) == -1 )
    {
        if ( var_1 > level._id_7916 )
        {
            ...
            _func_01E4( "ui_hf_target_player", var_0 getentitynumber() );
            _func_01E4( "ui_hf_trigger_event", level._id_7916 );
        }
    }
}
...
_id_81C9()
{
    ...
    _func_01E4( "ui_hf_target_player", -1 );

    foreach ( var_1 in level._id_B758 )
    {
        var_1._id_7557 = 0;
        var_1 _meth_82F6( "ui_hf_offer_hf", 0 );
        var_1 _meth_82F6( "ui_hf_return_hf", 0 );
        var_1 _meth_82F6( "ui_hf_returned_hfs", 0 );
...
_id_DCB0()
{
    ...
    var_0 _meth_82F6( "ui_hf_offer_hf", 1 );
    var_0 _id_077B::_id_1087E( "high_five_given", "give_high_five_timer_elapsed" );
    var_0 _meth_82F6( "ui_hf_offer_hf", 0 );
}
...
_id_DCDC()
{
    self endon( "disconnect" );
    var_0 = self;
    var_0 _meth_82F6( "ui_hf_return_hf", 1 );
    var_0 thread _id_C789();
    var_0 _id_077B::_id_1087E( "high_fives_returned", "return_high_five_timer_elapsed" );
    var_0 _meth_82F6( "ui_hf_return_hf", 0 );
}
...
_id_DCB1()
{
    ...
    {
        if ( var_1._id_7557 )
            var_1 _meth_82F6( "ui_hf_returned_hfs", 1 );
    }
