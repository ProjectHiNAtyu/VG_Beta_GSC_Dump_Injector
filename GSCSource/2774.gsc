...
_id_1082A()
{
    ...
    var_6 = _id_6D74();
    var_7 = _id_2E8B( var_6._id_B9F0, var_6._id_0054[1], var_2, var_3 );
    ...
    if ( distancesquared( var_7, self._id_02EA ) > 4 )
    {
...
_id_1082B()
{
    ...
    if ( distancesquared( self._id_02EA, self._id_02F2._id_02EA ) <= var_4 )
        return;
...
_id_E6F5()
{
    ...
    if ( distancesquared( var_1, self._id_02EA ) < 10000 )
        return;
    ...
    if ( length( var_4 ) > 16 )
    {
        ...
        if ( _func_0257( var_4, var_2 ) > 0.707 )
            return;
    }

    var_5 = _func_000B( var_3[1] - self._id_0054[1] );
    var_6 = _func_0321( var_5 );
    var_7 = self _meth_810C( "move_start", var_6 );
    var_8 = _func_00B0( var_7 );
    var_9 = _func_01C2( var_8, self._id_0054 ) + self._id_02EA;

    if ( !_id_06B7::_id_3173( self._id_02EA, var_9 ) )
        return;
...
_id_6D74()
{
    ...
    {
        var_0._id_B9F0 = self._id_02CD._id_02EA;
        var_0._id_0054 = self._id_02CD._id_0054;
    }
    else
    {
        var_1 = self _meth_816A();
        var_0._id_B9F0 = var_1;
        var_0._id_0054 = _func_025B( self _meth_8153() );
    }
...
_id_6D73( var_0 )
{
    if ( isdefined( self._id_02CD ) )
    {
        var_1 = self._id_02CD._id_0054[1] - self._id_0054[1];
...
_id_742E( var_0, var_1, var_2, var_3 )
{
    ...
    switch ( var_0 )
    {
        ...
        case "footstep_back_right_large":
            ...
            if ( _func_0121( var_0, "front_left" ) )
            {
