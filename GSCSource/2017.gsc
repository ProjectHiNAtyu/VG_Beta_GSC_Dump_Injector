...
_id_021D()
{
    ...
    level._id_C01B = [];
    level._id_10DC1 = [];
    level._id_9C85 = int( stopfxontag( "mp/rankTable.csv", 0, "maxrank", 1 ) );
    level._id_9C51 = int( stopfxontag( "mp/rankTable.csv", 0, "maxelder", 1 ) );

    for ( var_4 = 0; var_4 <= level._id_9C85; var_4++ )
    {
        level._id_C01B[var_4][0] = int( stopfxontag( "mp/rankTable.csv", 0, var_4, 2 ) );
        level._id_C01B[var_4][1] = int( stopfxontag( "mp/rankTable.csv", 0, var_4, 3 ) );
        level._id_C01B[var_4][2] = int( stopfxontag( "mp/rankTable.csv", 0, var_4, 7 ) );
        level._id_C01B[var_4][3] = stopfxontag( "mp/rankTable.csv", 0, var_4, 15 );
    }
...
_id_C29E( var_0, var_1, var_2 )
{
    ...
    if ( var_0 == "kill" && var_1 == "value" )
        _func_01E4( "ui_game_type_kill_value", int( var_2 ) );
}

_id_6CEE( var_0 )
{
    var_1 = "scr_" + _id_0A69::_id_6A43() + "_score_" + var_0;
...
_id_6CED( var_0, var_1 )
{
    ...
    {
        case "value":
            var_2 = "scr_" + _id_0A69::_id_6A43() + "_score_" + var_0;
...
getrandomgraverobberattachment( var_0 )
{
...
{
    return stopfxontag( "mp/rankIconTable.csv", 0, var_0, var_1 + 1 );
}

_id_6CBC( var_0 )
{
    return int( stopfxontag( "mp/rankTable.csv", 0, var_0, 13 ) );
}
...
_id_AB46()
{
    for (;;)
    {
        ...
        if ( !_func_0104( var_0 ) )
        {
            if ( level._id_B811 )
            {
                var_0._id_0309["rankxp"] = var_0 getplayerdata( "rankedloadouts", "squadMembers", "player_xp" );
                var_1 = var_0 getplayerdata( "rankedloadouts", "squadMembers", "season_rank" );

                if ( !isdefined( var_0._id_0309["xpEarnedThisMatch"] ) )
                    var_0._id_0309["xpEarnedThisMatch"] = 0;
        ...
        var_0._id_0309["prestige"] = var_1;

        if ( var_0._id_0309["rankxp"] < 0 )
            var_0._id_0309["rankxp"] = 0;

        var_2 = var_0 _id_6CB8( var_0 _id_6CC0() );
        var_0._id_0309["rank"] = var_2;
        var_0 setpulsefx( var_2, var_1 );
        var_0._id_0309["participation"] = 0;
        var_0._id_CC18 = 0;
        var_0._id_CC07 = 0;
        var_0._id_CBF4 = [];
        var_0._id_BA3E = 0;
        ...
        if ( !isdefined( var_0._id_0309["summary"] ) )
        {
            var_0._id_0309["summary"] = [];
            var_0._id_0309["summary"]["xp"] = 0;
            var_0._id_0309["summary"]["score"] = 0;
            var_0._id_0309["summary"]["challenge"] = 0;
            var_0._id_0309["summary"]["match"] = 0;
            var_0._id_0309["summary"]["misc"] = 0;
            var_0._id_0309["summary"]["medal"] = 0;
            var_0._id_0309["summary"]["bonusXP"] = 0;
            var_0._id_0309["summary"]["accolade"] = 0;
            var_0._id_0309["summary"]["weaponXP"] = 0;
            var_0._id_0309["summary"]["operatorXP"] = 0;
            var_0._id_0309["summary"]["clanXP"] = 0;
            var_0._id_0309["summary"]["battlepassXP"] = 0;
        }

        var_0 _meth_82F4( "ui_opensummary", 0 );

        if ( level._id_B811 && !_func_0104( var_0 ) )
        {
        ...
        var_0._id_CBED = 0;
        var_0._id_CBF0 = 0;
        var_0 _meth_82F6( "ui_score_event_control", -1 );
        var_0 _meth_82F6( "ui_potg_score_event_control", -1 );
    }
}
...
{
    if ( _func_0104( self ) )
        self._id_0309["rankxp"] = _id_09D1::_id_66CD();
...
_id_B7F7()
{
    ...
    self._id_0309["rank"] = var_1;

    if ( _func_0104( self ) || !isdefined( self._id_0309["prestige"] ) )
    {
        ...
        self._id_0309["prestige"] = var_2;
    }
}

_id_F753()
{
    if ( _func_0121( self._id_37D9, "custom" ) )
    {
        if ( !level._id_B811 )
            self._id_0309["rankxp"] = 0;
...
_id_6FC0( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        self._id_02F2 _id_6FC0( var_0, var_1, var_2 );
        return;
    }
    ...
    if ( !isdefined( level._id_5E9A ) || !level._id_5E9A )
    {
        if ( level._id_EF62 )
        {
            ...
            {
                if ( _id_0A7C::_id_6DAC( var_8, "teamCount" ) )
                {
                    var_6++;
        ...
        else
        {
            ...
            foreach ( var_8 in level._id_EF86 )
            {
                var_10 = var_10 + _id_0A7C::_id_6DAC( var_8, "teamCount" );
...
_id_C144( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_7 = var_1 - var_6;
    var_7 = int( var_7 );
    self._id_0309["summary"]["bonusXP"] = self._id_0309["summary"]["bonusXP"] + var_7;
    self._id_0309["summary"]["xp"] = self._id_0309["summary"]["xp"] + var_1;
    self._id_0309["summary"]["weaponXP"] = self._id_0309["summary"]["weaponXP"] + var_2;
    self._id_0309["summary"]["operatorXP"] = self._id_0309["summary"]["operatorXP"] + var_4;
    self._id_0309["summary"]["clanXP"] = self._id_0309["summary"]["clanXP"] + var_5;
    self._id_0309["summary"]["battlepassXP"] = self._id_0309["summary"]["battlepassXP"] + var_3;
    ...
    if ( !isdefined( var_8 ) || var_8 == "" )
    {
        ...
        self._id_0309["summary"]["misc"] = self._id_0309["summary"]["misc"] + var_1;
        return;
    }
    ...
    {
        case "match_bonus":
            self._id_0309["summary"]["match"] = self._id_0309["summary"]["match"] + var_1;
            break;
        case "challenge":
            self._id_0309["summary"]["challenge"] = self._id_0309["summary"]["challenge"] + var_1;
            break;
        case "medal":
            if ( !isdefined( self._id_0309["combatXP"] ) )
                self._id_0309["combatXP"] = var_1;
            else
                self._id_0309["combatXP"] = self._id_0309["combatXP"] + var_1;

            self._id_0309["summary"]["medal"] = self._id_0309["summary"]["medal"] + var_1;
            break;
        case "combat":
            if ( !isdefined( self._id_0309["combatXP"] ) )
                self._id_0309["combatXP"] = var_1;
            ...
            self._id_0309["summary"]["score"] = self._id_0309["summary"]["score"] + var_1;
            break;
        case "looting":
            if ( !isdefined( self._id_0309["lootingXP"] ) )
                self._id_0309["lootingXP"] = var_1;
            else
                self._id_0309["lootingXP"] = self._id_0309["lootingXP"] + var_1;

            self._id_0309["summary"]["score"] = self._id_0309["summary"]["score"] + var_1;
            break;
        case "missions":
            if ( !isdefined( self._id_0309["missionXP"] ) )
                self._id_0309["missionXP"] = var_1;
            else
                self._id_0309["missionXP"] = self._id_0309["missionXP"] + var_1;

            self._id_0309["summary"]["score"] = self._id_0309["summary"]["score"] + var_1;
            break;
        case "accolade":
            self._id_0309["summary"]["accolade"] = self._id_0309["summary"]["accolade"] + var_1;
            break;
        default:
            self._id_0309["summary"]["score"] = self._id_0309["summary"]["score"] + var_1;
            break;
...
_id_FD0A( var_0 )
{
    var_1 = _id_6CB7();
    var_2 = _id_6C6A();
    var_3 = self._id_0309["rank"] + self._id_0309["prestige"];
    var_4 = var_1 + var_2;
    self._id_0309["rank"] = var_1;
    self._id_0309["prestige"] = var_2;
...
_id_FD0B()
{
    ...
    if ( !_id_07A8::_id_933A( "game_over" ) )
        level _id_077B::_id_108F3( "game_over", 0.25 );

    var_1 = self._id_0309["rank"] + self._id_0309["prestige"];
...
_id_CC06( var_0, var_1 )
{
    ...
    if ( !_id_0A74::_id_89D3( self ) && !self _meth_81D2() && !_id_0A74::_id_8AB5() )
    {
        if ( !istrue( var_1 ) || _id_0A74::_id_88AD() )
        {
            _id_BECA( var_0 );
            thread _id_5D08();
            return;
    ...
    self _meth_82F6( "ui_points_popup", self._id_CC18 );
    self _meth_82F6( "ui_points_popup_notify", gettime() );
    wait 1.0;
    self._id_CC18 = 0;
}
...
_id_CBF3( var_0 )
{
    ...
    self _meth_82F6( "ui_potg_score_event_list_" + self._id_CBF0, var_1 );
    self _meth_82F6( "ui_score_event_list_" + self._id_CBF0, var_1 );
    self _meth_82F6( "ui_score_event_control", self._id_CBED % 10 );
    self _meth_82F6( "ui_potg_score_event_control", self._id_CBED % 10 );
    self._id_CBF0++;
...
{
    var_0 = self._id_0309["rankxp"];
    var_1 = self._id_0309["rank"];

    if ( var_0 < _id_6CBE( var_1 ) + getrandomgraverobberattachment( var_1 ) )
        return var_1;
    else
...
_id_6CB8( var_0 )
{
    ...
    while ( var_1 > 0 )
    {
        if ( var_0 >= _id_6CBE( var_1 ) && var_0 < _id_6CBE( var_1 ) + getrandomgraverobberattachment( var_1 ) )
            return var_1;
...
_id_6C6A()
{
    if ( _func_0104( self ) && isdefined( self._id_0309["prestige_fake"] ) )
        return self._id_0309["prestige_fake"];
    else
...
_id_7D96( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_1 ) && _id_07FD::_id_10DD0( var_1._id_0084 ) )
    {
        var_4 = _id_0A7F::_id_69B9( var_1._id_0084 );
        var_7 = stopfxontag( "mp/statstable.csv", 5, var_4, 4 );
        var_8 = var_7 + "_variant_0";
        var_5 = int( stopfxontag( "loot/weapon_ids.csv", 6, var_8, 0 ) );
        var_6 = var_0;
    ...
    var_9 = _id_6CC0();
    var_10 = int( _func_0148( var_9 + var_0, _id_6CBD( level._id_9C85 ) - 1 ) );

    if ( self._id_0309["rank"] == level._id_9C85 && var_10 >= _id_6CBD( level._id_9C85 ) )
        var_10 = _id_6CBD( level._id_9C85 );

    self._id_0309["xpEarnedThisMatch"] = self._id_0309["xpEarnedThisMatch"] + var_0;
    self._id_0309["rankxp"] = var_10;
    var_11 = var_0;
    ...
    if ( isdefined( var_16 ) )
        var_15 = int( stopfxontag( "loot/operator_ids.csv", 1, var_16, 0 ) );
...
_id_6A49()
{
    if ( !isdefined( level._id_60DD ) )
    {
        ...
        if ( var_0 != 1.0 )
            ...
            level._id_60DD = float( stopfxontag( "mp/gametypesTable.csv", 0, _id_0A69::_id_6A43(), 17 ) );
    }
...
_id_10F3( var_0, var_1 )
{
    ...
    if ( isdefined( self._id_C01C[var_1] ) )
        self._id_C01C[var_1] = _func_0147( self._id_C01C[var_1], var_0 );
    else
...
_id_111B( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( level._id_EF97[var_1][var_2] ) )
        level._id_EF97[var_1][var_2] = _func_0147( self._id_EF97[var_1][var_2], var_0 );
    else
...
_id_106A( var_0, var_1 )
{
    ...
    if ( isdefined( self._id_2359[var_1] ) )
        self._id_2359[var_1] = _func_0147( self._id_2359[var_1], var_0 );
    else
...
_id_10DD( var_0, var_1 )
{
    ...
    if ( isdefined( self._id_AC2D[var_1] ) )
        self._id_AC2D[var_1] = _func_0147( self._id_AC2D[var_1], var_0 );
    else
...
addclanxpmultiplier( var_0, var_1 )
{
    ...
    if ( isdefined( self.clanrankxpmultipliers[var_1] ) )
        self.clanrankxpmultipliers[var_1] = _func_0147( self.clanrankxpmultipliers[var_1], var_0 );
    else
