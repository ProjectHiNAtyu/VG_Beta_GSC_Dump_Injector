...
_id_021D()
{
    if ( _id_099D::_id_8A10( "airstrike", "init" ) )
        [[ _id_099D::_id_6D05( "airstrike", "init" ) ]]();

    level._id_0BA3["airstrike_tracer"] = _func_0139( "vfx/iw8_mp/killstreak/vfx_a10_tracer_sep.vfx" );
    level._id_0BA3["airstrike_death"] = _func_0139( "vfx/s4/killstreaks/vfx_airstrike_death_exp_medium.vfx" );

    if ( _id_099D::_id_8A10( "airstrike", "airstrike_params" ) )
        [[ _id_099D::_id_6D05( "airstrike", "airstrike_params" ) ]]();
...
_id_10D87( var_0 )
{
    ...
    if ( var_0._id_EA0F == "multi_airstrike" )
    {
        ...
        if ( _id_099D::_id_8A10( "airstrike", "startMapSelectSequence" ) )
            self [[ _id_099D::_id_6D05( "airstrike", "startMapSelectSequence" ) ]]( 0, 1, var_2 );
    }
    else if ( var_0._id_EA0F == "fuel_airstrike" )
    {
        if ( _id_099D::_id_8A10( "airstrike", "startMapSelectSequence" ) )
            self [[ _id_099D::_id_6D05( "airstrike", "startMapSelectSequence" ) ]]();
    }
...
_id_F767( var_0 )
{
    ...
    switch ( var_0._id_EA0F )
    {
        ...
        case "toma_strike":
            ...
            {
                var_3 = [[ _id_099D::_id_6D05( "game", "getGameType" ) ]]();
...
_id_D043( var_0 )
{
    ...
    var_3 = undefined;
    var_4 = undefined;
    var_5 = _func_0205( "script_origin", self._id_02EA );
    ...
    else if ( var_0._id_EA0F == "multi_airstrike" )
    {
        ...
        if ( _id_099D::_id_8A10( "airstrike", "getSelectMapPoint" ) )
            var_2 = self [[ _id_099D::_id_6D05( "airstrike", "getSelectMapPoint" ) ]]( var_0, var_7, 1 );
    ...
    else if ( var_0._id_EA0F == "fuel_airstrike" )
    {
        ...
        if ( _id_099D::_id_8A10( "airstrike", "getSelectMapPoint" ) )
            var_2 = self [[ _id_099D::_id_6D05( "airstrike", "getSelectMapPoint" ) ]]( var_0, var_7 );
    ...
    if ( _id_099D::_id_8A10( "hud", "teamPlayerCardSplash" ) )
        thread [[ _id_099D::_id_6D05( "hud", "teamPlayerCardSplash" ) ]]( var_6, self );

    if ( _id_099D::_id_8A10( "killstreak", "logKillstreakEvent" ) )
        self [[ _id_099D::_id_6D05( "killstreak", "logKillstreakEvent" ) ]]( var_0._id_EA0F, var_1 );

    if ( level._id_60D1 == "br" )
    {
        if ( _id_099D::_id_8A10( "killstreak", "dangerNotifyPlayersInRange" ) )
            self [[ _id_099D::_id_6D05( "killstreak", "dangerNotifyPlayersInRange" ) ]]( var_1, 800, var_0._id_EA0F );
    }
...
_id_5AFA( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( _id_099D::_id_8A10( "player", "printGameAction" ) )
        self [[ _id_099D::_id_6D05( "player", "printGameAction" ) ]]( "killstreak ended - " + var_4._id_EA0F, self );

    _id_099B::_id_C13C( var_4 );
...
_id_5AFE( var_0, var_1, var_2 )
{
    ...
    if ( _id_099D::_id_8A10( "player", "printGameAction" ) )
        self [[ _id_099D::_id_6D05( "player", "printGameAction" ) ]]( "killstreak ended - " + var_2._id_EA0F, self );

    _id_099B::_id_C13C( var_2 );
    self._id_13B6 = undefined;
}
...
_id_5AF1( var_0, var_1, var_2, var_3 )
{
    ...
    level thread _id_4C17( var_0, var_1, self, self._id_0309["team"], var_2, var_3 );
}
...
{
    var_5 = 0;
    var_6 = _id_099B::_id_6ABC();
    var_7 = 24000;
    var_8 = 6500;
    var_9 = level._id_13BB[var_4._id_EA0F]._id_B17A;
    var_5 = 1500;
    var_10 = _id_0999::_id_6AF9();

    if ( isdefined( var_10 ) && var_10 == "locale_6" )
        var_9 = var_9 + 500;

    if ( level._id_9AA7 == "mp_br_mechanics" || level._id_9AA7 == "mp_donetsk" )
        var_9 = var_9 + 2500;
    ...
    {
        var_15 = _id_077B::_id_F07F( var_4._id_EA0F == "precision_airstrike", 1, 3 );

        for ( var_16 = 0; var_16 < var_15; var_16++ )
        {
            var_9 = var_9 + _func_01B9( 200, 300 );
...
_id_2FB2( var_0, var_1, var_2 )
{
    ...
    var_5 = _id_077A::_id_C042( var_1 - var_3 * 30, var_1 + var_3 * 1000, undefined, var_4 );
    var_1 = var_5["position"] + var_5["normal"] * 20;
    var_6 = var_1;
    var_7 = var_2 * 3;
    var_8 = anglestoforward( var_0._id_0054 );
    var_9 = anglestoright( var_0._id_0054 );
    var_10 = 0;
    ...
    var_12 = _func_025A( var_11[0] - var_6 );
    var_13 = 0;

    foreach ( var_15 in var_11 )
    {
        var_16 = _func_025A( var_15 - var_6 );
        ...
        {
            var_22 = _id_077A::_id_C047( var_17, var_21, undefined, var_4 );
...
_id_4E45( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_11 = _func_025B( var_2 - var_1 );
    var_10 = var_10 - anglestoforward( var_11 ) * 11000 / 2.0;
    var_12 = var_7._id_9FBD;

    if ( _id_099C::_id_6C48( var_6 ) && isdefined( var_7._id_9FBE ) )
        var_12 = var_7._id_9FBE;

    var_13 = _func_0205( "script_model", var_10 );
    var_13 setmode( var_12 );
    var_13._id_0054 = var_11;
    var_13._id_5CD2 = anglestoforward( var_11 );
    var_13._id_5CD3 = var_3;
    var_13._id_02F2 = var_6;
    var_13._id_045B = var_6._id_045B;
    var_13._id_9355 = var_5._id_9355;
    var_13._id_EA0B = var_5;
    var_13 setorigin( var_6 );
    var_13 _meth_856C();
    var_13 _meth_85AD();
    var_13 _meth_856B();
    level notify( "airstrike_plane_spawned", var_13._id_0054 );

    if ( var_5._id_EA0F == "precision_airstrike" )
    {
        var_13._id_F81C = _func_0205( "script_model", var_13 gettagorigin( "tag_turret" ) );
        var_13._id_F81C setmode( "plane_wm_dalpha_turret_front" );
        var_13._id_F81C._id_0054 = var_13._id_0054;
        var_13._id_F81C _meth_820B( var_13, "tag_turret" );
    }

    if ( _id_099D::_id_8A10( "killstreak", "addToActiveKillstreakList" ) )
        var_13 [[ _id_099D::_id_6D05( "killstreak", "addToActiveKillstreakList" ) ]]( var_5._id_EA0F, "Killstreak_Air", var_6, 0, 1, 100 );
    ...
    if ( _id_099D::_id_8A10( "game", "createObjective" ) )
        var_13._id_9F0F = var_13 [[ _id_099D::_id_6D05( "game", "createObjective" ) ]]( var_14, var_13._id_045B, undefined, 1, 1 );
    ...
    var_13._id_8725 = 1;
    var_13 thread [[ _id_099D::_id_6D05( "airstrike", "monitorDamage" ) ]]( 100, "hitequip", ::_id_7465, ::_id_7464, 1 );
    ...
    var_13._id_2D0F = _func_0205( "script_model", var_13._id_02EA );
    var_13._id_2D0F setmode( "ks_airstrike_target_mp" );
    var_13._id_2D0F _meth_8312( var_6 );
    var_13._id_2D0F._id_10D06 = "artillery_mp";
    var_13._id_2D0F._id_EA0B = var_5;
    var_13._id_2D0F._id_0054 = var_13._id_0054;
    var_13._id_2D0F _meth_80BE();
    var_13._id_1887 = var_5._id_EA0F;
    var_13 _id_069D::_id_D46E();
    var_13._id_CBC3 = _func_0205( "script_model", var_10 );
    var_13._id_CBC3._id_0054 = var_13._id_0054;
    var_13._id_CBC3 setmode( "tag_origin" );
    ...
    if ( isdefined( var_13._id_9F0F ) )
    {
        if ( _id_099D::_id_8A10( "game", "returnObjectiveID" ) )
            [[ _id_099D::_id_6D05( "game", "returnObjectiveID" ) ]]( var_13._id_9F0F );
    }

    var_13 notify( "delete" );

    if ( isdefined( var_13._id_F896 ) )
        var_13._id_F896 _meth_809A();

    if ( isdefined( var_13._id_2D0F ) )
    {
        var_13._id_2D0F _meth_809A();

        if ( isdefined( var_13._id_2D0F._id_8D49 ) )
            var_13._id_2D0F._id_8D49 _meth_809A();
    }

    if ( isdefined( var_13._id_CBC3 ) )
        var_13._id_CBC3 _meth_809A();
...
_id_13A6( var_0, var_1, var_2 )
{
    ...
    var_0 _meth_8373( "fire", "on", 0 );
    var_0 waittill( "fire_finished" );
    var_0 _meth_8373( "fire", "off", 0 );
}
...
_id_13A4( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_7 = _func_0205( "script_model", var_1 + var_2 * 2000 );
    var_7 setmode( "ks_airstrike_mp" );
    var_7 _meth_80BE();
...
_id_13A3()
{
    self endon( "death" );
    level endon( "game_ended" );
    _id_076B::_id_7A8B( 6.397 );
    self _meth_8373( "flyby", "on", 0 );
}
...
_id_2FB1( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_10 = var_7;
    var_11 = _func_0205( "script_model", var_8 );
    var_11 thread _id_139D( var_1 - 3, var_9, var_10 );
    var_0._id_2D0F._id_8D49 = var_11;
    _id_076B::_id_7A8B( var_1 );
    ...
    {
        var_14 = var_0._id_02EA - ( 0, 0, 15 );
        var_15 = _func_020F();
        var_16 = ( 0, 0, 0 );

        if ( var_13 % 2 == 0 )
            var_16 = anglestoright( var_0._id_0054 ) * 50;
        else
            var_16 = _func_0301( var_0._id_0054 ) * 50;

        var_15._id_E06C = var_14 + var_16;
        var_15._id_01E7 = var_3 + var_6 * 5 + var_16;

        if ( !isdefined( var_12 ) )
            var_12 = _func_025A( var_15._id_01E7 - var_15._id_E06C ) * 1000;
...
_id_2FB6( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_9 = var_6;
    var_10 = _func_0205( "script_model", var_7 );
    var_10 thread _id_139D( var_1 - 3, var_8, var_9 );
    var_0._id_2D0F._id_8D49 = var_10;
    _id_076B::_id_7A8B( var_1 );
    ...
    var_12 = ( 0, 0, 0 );
    var_13 = var_12;
    var_0._id_2D0F _meth_8373( "bullet_impact", "on", 0 );
    var_14 = 0;
    var_15 = 0;
    ...
    {
        if ( _id_099D::_id_8A10( "airstrike", "addSpawnDangerZone" ) )
            [[ _id_099D::_id_6D05( "airstrike", "addSpawnDangerZone" ) ]]( var_18, 512, 512, var_4._id_045B, 5, var_4, 1 );
    }
    ...
    for ( var_25 = 0; var_25 < var_11; var_25++ )
    {
        ...
        {
            var_28 = _func_01C2( var_5, ( 0, 90, 0 ) );
            var_28 = var_28 * 50;
            var_29 = var_16[var_25] + _id_077B::_id_F07F( var_14 % 2 == 0, var_28, -1 * var_28 );
            var_30 = _id_077B::_id_F07F( var_14 % 2 == 0, "TAG_MUZZLE_FX_1", "TAG_MUZZLE_FX_2" );
            var_31 = var_0._id_F81C gettagorigin( var_30 ) * ( 1, 1, 0 ) + ( 0, 0, var_24 ) + var_5 * 1000;
            var_33 = _func_025A( var_29 - var_31 );
            var_34 = var_29 + var_33 * 30000;
            var_35 = _id_077A::_id_C042( var_31, var_34, undefined, _id_077A::_id_3EC3( 0, 1, 0, 1, 0, 1, 0 ) );
            var_36 = var_35["position"];
            var_37 = var_35["normal"];
            var_38 = var_36 + var_37 * 10;
            var_39 = _func_025A( var_36 - var_0._id_F81C gettagorigin( var_30 ) );
            var_40 = _func_0256( var_39, ( 0, 0, 1 ) );
            var_41 = _func_0256( var_40, var_39 );
            var_0 thread _id_2FB5( _id_077B::_id_6A40( "airstrike_tracer" ), var_38, var_39, var_41 );
            var_0._id_2D0F thread _id_A20F( var_14 + 1, var_38 );
            var_13 = var_36;
            var_14++;
            var_0._id_2D0F._id_EA0B._id_DA5E++;
            var_26 = var_26 + 20;
            var_27 = var_27 + 40;
            var_24 = var_24 - 200;
    ...
    var_0._id_2D0F _meth_8373( "bullet_impact", "off", 0 );
}
...
_id_2FB4( var_0, var_1, var_2, var_3 )
{
    ...
    var_6 = _func_01B9( var_0, var_1 );
    var_7 = _func_01B8( 80 ) - 40;
    var_8 = var_4 * cos( var_7 ) * var_6;
    return var_2 + var_8 + var_5 * _func_01FE( var_7 ) * var_6;
}
...
_id_2FB3( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( _id_099D::_id_8A10( "airstrike", "addSpawnDangerZone" ) )
            [[ _id_099D::_id_6D05( "airstrike", "addSpawnDangerZone" ) ]]( var_8, 650, 650, var_4._id_045B, var_2, var_4, 1 );
    }
    ...
    foreach ( var_8 in var_6 )
    {
        ...
        var_14 = _id_077A::_id_C042( var_12, var_13, undefined, _id_077A::_id_3EC3( 0, 1, 0, 1, 0, 1, 0 ) );
        var_15 = var_14["position"];
        var_16 = var_14["normal"];
        var_17 = var_15 + var_16 * 10;
        var_18 = _func_0205( "script_model", var_17 + ( 0, 0, 400 ) );
        var_18 setmode( "ks_fuelstrike_mp" );
        var_18 _meth_8373( "release", "on", 0 );
        var_19 = _func_0205( "script_model", var_17 );
        var_19 setmode( "ks_fuelstrike_mp" );
        var_19 _meth_8373( "ignite", "on", 0 );
        var_19 _meth_8312( var_4 );
...
_id_6A2F( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    var_12 = _func_0130( var_10 - var_11 );
    var_13 = var_12 / var_5;
...
_id_139B( var_0, var_1 )
{
    ...
    var_3 = _func_02C4( var_2 );
    var_4 = var_0 getvieworigin();
    var_5 = var_4 + anglestoforward( var_0 getplayerangles() ) * 50000;
    var_6 = var_0 _id_099B::_id_B6EF();
    var_7 = _id_077A::_id_C042( var_4, var_5, var_6, var_3 );
...
_id_13AE( var_0, var_1 )
{
    ...
    var_2 setmode( "ks_airstrike_marker_mp" );
    ...
    for (;;)
    {
        if ( _id_0764::_id_8599() && istrue( var_2._id_FCB7 ) )
        {
            _id_06BB::_id_1516( 0 );
            var_2 hide();
            var_2 _meth_8373( "marker_scope", "off", 0 );
            self notify( "stop_update_marker" );
            var_2._id_FCB7 = 0;
        }

        var_4 = self player_recoilscaleon();
        ...
        if ( var_4 == 1 && !istrue( var_2._id_FCB7 ) )
        {
            if ( !_id_0764::_id_8599() )
            {
                _id_06BB::_id_1516( 1 );
                var_2 _meth_83C3();
                var_2 _meth_8373( "marker_scope", "on", 0 );
...
_id_13AB( var_0 )
{
    ...
    var_1 = 0;
    var_0 _meth_82F6( "ui_spotter_scope_danger", 0 );
    ...
    for (;;)
    {
        ...
        {
            self._id_02EA = var_2;
            var_3 = int( self._id_02EA[0] );
            var_4 = int( self._id_02EA[1] );
            var_5 = int( self._id_02EA[2] );
        }

        var_0 _meth_82F6( "ui_ac130_coord3_posx", var_3 );
        var_0 _meth_82F6( "ui_ac130_coord3_posy", var_4 );
        var_0 _meth_82F6( "ui_ac130_coord3_posz", var_5 );

        if ( isdefined( var_2 ) )
        {
            if ( !istrue( var_1 ) && distance2dsquared( var_0._id_02EA, var_2 ) <= 1638400 )
            {
                var_0 _meth_82F6( "ui_spotter_scope_danger", 1 );
                var_1 = 1;
            }
            else if ( istrue( var_1 ) && distance2dsquared( var_0._id_02EA, var_2 ) > 1638400 )
            {
                var_0 _meth_82F6( "ui_spotter_scope_danger", 0 );
                var_1 = 0;
            }
...
_id_13AC( var_0 )
{
    ...
    self endon( "death" );
    level endon( "game_ended" );
    var_1 = var_0 _id_077B::waittill_any_return( "cancel_fire", "successful_fire" );

    if ( isdefined( var_1 ) && var_1 == "successful_fire" )
    {
        var_0 notify( "deploy_fired" );
        self _meth_8373( "marker_scope", "off", 0 );
        var_2 = anglestoforward( var_0 getplayerangles() );
        var_3 = self._id_02EA - var_2 * 500;
        var_4 = self._id_02EA + var_2 * 20;
        var_5 = _id_077A::_id_C042( var_3, var_4, var_0 );
        var_6 = var_5["normal"];
        level waittill( "airstrike_plane_spawned", var_7 );
        self._id_0054 = var_7;
        self._id_0054 = _func_0311( var_6, self._id_0054 );
        self _meth_8373( "marker_placed", "on", 0 );
    ...
    else
    {
        ...
        if ( !var_0 [[ _id_099D::_id_6D05( "player", "isPlayerADS" ) ]]() )
...
_id_139D( var_0, var_1, var_2 )
{
    self endon( "death" );
    _id_076B::_id_7A8B( var_0 );
    self _meth_823B( var_1, 4 );
    _id_076B::_id_7A8B( 3.95 );
    self _meth_823B( var_2, 5 );
}
