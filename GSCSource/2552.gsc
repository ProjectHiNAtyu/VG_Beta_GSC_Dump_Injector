...
{
    if ( !_id_099D::_id_8A10( "infil", "get_all_infils" ) )
        _id_099D::_id_C2A5( "infil", "get_all_infils", ::_id_6312 );
...
_id_7E28()
{
    ...
    foreach ( var_3 in _id_6312() )
    {
        ...
        if ( var_3 _id_7E2D( var_4 ) && var_3 _id_7E2C( var_5 ) && _id_0A7C::_id_885E( var_3._id_CE70 ) )
        {
            level._id_7E5A++;
            ...
            if ( _func_0121( var_9, "alpha" ) )
                var_9 = "alpha";

            if ( _func_0121( var_9, "bravo" ) )
                var_9 = "bravo";

            if ( !isdefined( var_7 ) )
                var_7 = game["infil"]["types"][var_4][var_9];

            var_10 = var_3 [[ var_7["spawn_func"] ]]( var_3._id_CE70, var_3._id_0457, var_9, var_8 );
            var_10._id_B758 = [];
...
_id_60D9()
{
    ...
    if ( _id_0A69::_id_6A43() == "war" && level._id_036A == "mp_donetsk" )
        return 0;
...
_id_1082C()
{
    ...
    if ( isdefined( self._id_045B ) )
    {
        ...
        if ( _id_07A8::_id_609F( "infil_will_run" ) && !_id_07A8::_id_609F( "prematch_done" ) )
        {
            ...
            if ( isdefined( game["infil"] ) && isdefined( game["infil"][self._id_045B] ) && isdefined( game["infil"][self._id_045B]["lanes"] ) )
            {
                foreach ( var_7, var_3 in game["infil"][self._id_045B]["lanes"] )
                {
    ...
    while ( !istrue( self._id_0309["streamSyncComplete"] ) )
        waitframe();

    var_8 = _id_675E( self, _id_0A69::_id_6BC3( self._id_045B )[0] );

    if ( isdefined( var_8 ) )
        _id_B46C( self, _id_0A69::_id_6BC3( self._id_045B )[0] );
...
{
    if ( isdefined( var_0 ) )
        return _id_077B::_id_6D7C( var_0, "script_noteworthy" );
    else
        var_1 = _id_077B::_id_6D7C( "mp_infil", "targetname" );

    return _id_077B::_id_6D7C( "mp_infil", "targetname" );
}
...
_id_7E2A()
{
    ...
    if ( self._id_03C3 & 1 )
    {
        if ( level._id_60D1 == "sd" && level._id_9AA7 == "mp_petrograd" || level._id_60D1 == "sd" && level._id_9AA7 == "mp_piccadilly" )
            return 0;
        else
            return 1;
    }
    ...
    if ( self._id_03C3 & 4 )
    {
        switch ( level._id_60D1 )
        {
            ...
            case "sr":
            case "sd":
                if ( level._id_9AA7 == "mp_petrograd" || level._id_9AA7 == "mp_piccadilly" )
                    return 0;
                else
                    return 1;
        }
...
_id_7E16()
{
    return isdefined( self._id_CD8C ) && level._id_60D1 == "tac_ops";
}

_id_7E29()
{
    if ( level._id_60D1 == "tac_ops" && !isdefined( game["infil"]["map_config"] ) )
    {
        _id_07F3::_id_021D();
...
{
    if ( self _meth_81C3() && getdvarint( "scr_infil_spectator" ) == 1 )
    {
        _id_06BB::_id_1565( var_0 );
        return;
    }

    if ( !_id_0A69::_id_EF73( self._id_045B ) && !istrue( var_1 ) )
    {
        _id_07D9::_id_B748( var_0 );
        return;
    }

    self allowdoublejump( var_0 );
    _id_06BB::_id_1548( var_0 );
    _id_06BB::_id_1508( var_0 );
    _id_06BB::_id_1526( var_0 );
    _id_06BB::_id_1516( var_0 );
    _id_06BB::_id_14F7( var_0 );
    _id_06BB::_id_1559( var_0 );
    _id_06BB::_id_152C( var_0 );
    _id_06BB::_id_154D( var_0 );
    _id_06BB::_id_1529( var_0 );
    _id_06BB::_id_1557( var_0 );
...
{
    if ( !isdefined( game["infil"][var_0._id_045B]["spots"] ) )
    {

    }

    if ( !isdefined( game["infil"][var_0._id_045B]["spots"][var_1] ) )
    {

    }

    if ( isdefined( game["infil"][var_0._id_045B]["spots"][var_1]["player"] ) )
    {

    }

    game["infil"][var_0._id_045B]["spots"][var_1]["player"] = var_0;
    return game["infil"][var_0._id_045B]["spots"][var_1];
}

_id_B46C( var_0, var_1 )
{
    var_0 _meth_82F6( "ui_player_in_infil", 0 );
...
_id_675F( var_0 )
{
    ...
    var_1 = _id_077B::_id_F07F( var_0 == "allies", "a", "b" ) + _func_00D6( self._id_5E6B, 5, 6 );
    var_2 = [];

    foreach ( var_5, var_4 in game["infil"][var_0]["spots"] )
    {
        if ( _func_0121( var_4["infil"]._id_8E8F, var_1 ) && !_id_86B4( var_0, var_5 ) )
...
_id_66C4( var_0, var_1 )
{
    ...
    if ( isdefined( var_1 ) )
        var_2 = _id_077B::_id_1B96( var_2, var_1 );

    var_4 = _id_077B::_id_BFC7( var_2 );
    return var_4;
}
...
{
    self endon( "death" );
    self._id_B758 = _id_077B::_id_1B63( self._id_B758, var_0 );
    var_0 waittill( "death_or_disconnect" );
    self._id_B758 = _id_077B::_id_1B96( self._id_B758, var_0 );
}
...
_id_B516()
{
    ...
    if ( game["infil"][self._id_045B].size == 0 )
        return;
    ...
    var_0 = 0;
    var_1 = game["infil"][self._id_045B]["spots"][0]["priority"] != -1;

    if ( level._id_60D1 == "tac_ops" && isdefined( self._id_ED15._id_5094 ) )
        var_2 = _id_66C5( self._id_045B, self._id_ED15._id_5094 );
    else if ( var_0 )
        var_2 = _id_6760( self._id_045B );
    else if ( var_1 )
        var_2 = _id_675D( self._id_045B );
    else
        var_2 = _id_66C4( self._id_045B );

    var_3 = getdvarint( "scr_infil_reserve_seat", -1 );

    if ( var_3 != -1 )
    {
        if ( _id_077B::_id_85A4( self, level._id_030F ) )
            var_2 = var_3;
        else
            var_2 = _id_66C4( self._id_045B, var_3 );
    }
    ...
    self _meth_82F6( "ui_player_in_infil", 1 );
    thread _id_AB45();
    thread _id_3922();
    _id_B393();
}
...
_id_7E3E()
{
    _func_01E4( "ui_in_infil", 3 );
    level waittill( "infil_started" );
    var_0 = _func_00BE( "ui_always_show_nameplates" );
    _func_01E4( "ui_always_show_nameplates", 1 );
    ...
    foreach ( var_6 in level._id_B758 )
    {
        if ( var_4 )
        {
            if ( _id_099D::_id_8A10( "player", "showMiniMap" ) )
                var_6 [[ _id_099D::_id_6D05( "player", "showMiniMap" ) ]]();

            continue;
        }

        if ( _id_099D::_id_8A10( "player", "hideMiniMap" ) )
            var_6 [[ _id_099D::_id_6D05( "player", "hideMiniMap" ) ]]();
    }

    _func_01E4( "ui_in_infil", -1 );
    _func_01E4( "ui_always_show_nameplates", var_0 );
    _func_01D0( "#x32ffe930f83bee667", var_1 );
    _func_01D0( "#x3c7ddb09585c5a055", var_2 );
    _func_01D0( "#x3ab3d8fbdc5691bb", var_3 );
}

_id_7E3F()
{
    wait( level._id_BBA0 - 5 );
    _func_01E4( "ui_in_infil", 2 );
}
...
_id_1631()
{
    ...
    else
    {
        ...
        var_2[1] = "default2";
        var_2[2] = "default3";
        var_1 = _id_077B::_id_BFC7( var_2 );
    }

    self._id_0309["class"] = var_1;
...
{
    foreach ( var_4 in self._id_B758 )
        var_4 _meth_827E( var_0, var_4 );
}
...
_id_7E3D( var_0, var_1 )
{
    ...
    while ( var_2 > 0.0 )
    {
        ...
        var_2 = _func_0147( var_2, 0.0 );
        self _meth_82F6( "ui_world_fade", var_2 );
        waitframe();
    }
}
...
_id_1022B( var_0, var_1, var_2 )
{
    ...
    {
        var_5 = _func_020F();
        var_5._id_02EA = ( self._id_02EA[0], self._id_02EA[1], self._id_02EA[2] + var_2 );
    ...
    while ( isdefined( var_7 ) )
    {
        ...
        {
            self notify( "unload" );
            _id_077B::_id_108F3( "unloaded", self._id_F974 );
        }
...
_id_6626( var_0 )
{
    ...
    {
        if ( isdefined( _id_6497( var_0._id_0457 ) ) )
            var_1 = ::_id_6497;

        if ( isdefined( _id_6498( var_0._id_0457 ) ) )
            var_1 = ::_id_6498;
    }
...
_id_AE5D()
{
    ...
    for (;;)
    {
        ...
        var_3 = distance( var_0._id_02EA, var_2._id_02EA );
...
_id_BD74( var_0, var_1 )
{
    ...
    switch ( var_0 )
    {
        case "shake_low":
            ...
            foreach ( var_3 in self._id_7E09._id_B758 )
...
_id_5DDA()
{
    ...
    if ( getdvar( "scr_force_player_infil_team", "" ) != "" )
    {
        ...
        if ( _id_077B::_id_85A4( var_2, "axis" ) )
            var_1 = "infil_para";
        else
            var_1 = "infil_stairs";
    }

    var_3 = _func_0205( "script_model", level._id_5DDB[var_1] );
...
_id_C9BD( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_4 in level._id_B758 )
        {
            ...
            if ( _id_077B::_id_85A4( var_4._id_7E09._id_048F, var_1 ) )
        ...
        var_7 = _func_025B( var_6 - var_0._id_02EA );
        var_0 rotateroll( var_7, 0.5, 0.1, 0.1 );
    }
}
