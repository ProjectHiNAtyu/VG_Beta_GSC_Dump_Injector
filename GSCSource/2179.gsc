...
_id_7F68()
{
    ...
    _id_077B::_id_5453( "stealth_override_goal" );
    _id_077B::_id_5453( "stealth_hold_position" );
    _id_077B::_id_5453( "stealth_attack" );
    _id_077B::_id_5453( "stealth_cover_blown" );
    _id_077B::_id_5453( "stealth_local_investigation_only" );
    _id_077B::_id_5453( "stealth_disable_unresponsive_ai_check" );
    _id_077B::_id_5453( "stealth_non_player_combat" );
...
_id_8090()
{
    ...
    self._id_02C3 = spawnstruct( level._id_03E1._id_0031["ai_eventDistFootstepSprint"]["hidden"] );
    _id_0881::_id_3D59();
...
_id_BDBD()
{
    ...
    foreach ( var_8 in level._id_B758 )
    {
        ...
        if ( _func_011C( var_8 ) && ( var_8._id_0213 || var_8.name ) )
            continue;

        var_11 = distancesquared( var_1, var_8._id_02EA + var_2 );

        if ( distance2dsquared( self._id_02EA, var_8._id_02EA ) < var_3 )
        {
            var_12 = self._id_02EA[2] - var_8._id_02EA[2];
        ...
        if ( !var_9 && isdefined( level._id_03E1._id_BDBF ) && level._id_03E1._id_BDBF > 0 )
        {
            if ( var_11 < level._id_03E1._id_BDBF * level._id_03E1._id_BDBF )
            {
                ...
                {
                    var_13 = var_8._id_02EA - self._id_02EA;
                    var_13 = ( var_13[0], var_13[1], 0 );
                    var_14 = anglestoforward( ( 0, self._id_0054[1], 0 ) );

                    if ( _func_0257( var_14, var_13 ) > 0 )
                    {
                        var_10 = 1;
                        var_9 = 1;
                    }
        ...
        if ( !var_9 && isdefined( level._id_03E1._id_BDBE ) && level._id_03E1._id_BDBE > 0 )
        {
            ...
            {
                var_15 = length( var_8 getvelocity() );
        ...
        if ( var_9 && var_10 )
            var_9 = _id_077A::_id_C047( self _meth_86A7(), var_8 geteye(), [ self, var_8 ] );

        if ( var_9 )
        {
            self _meth_8522( "proximity", var_8, var_8._id_02EA );
            _id_077B::_id_4684( 0.05, ::_meth_812E, var_8 );
            return;
        }
    }
}
    ...
    if ( isdefined( var_1 ) && isdefined( self._id_140E ) && _id_088C::_id_140D( self._id_140E ) < _id_088C::_id_140D( var_0 ) )
    {
        if ( isdefined( level._id_B758 ) && level._id_B758.size > 0 )
        {
            foreach ( var_3 in level._id_B758 )
            {
                ...
                var_3 _id_077B::_id_CD54( "logStealthAlertIfNeeded", var_1 );
            }
        }
    }
...
_id_A0B2( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( isai( self ) && !_id_077B::_id_544E( "stealth_enabled" ) )
            continue;
        ...
        self _meth_8522( "damage", var_2, var_2._id_02EA );

        if ( _func_0117( var_2 ) || isdefined( var_2._id_045B ) && var_2._id_045B != var_3 )
            break;

        if ( isdefined( var_2._id_00DE ) && var_2._id_00DE == "script_model" )
        {
            if ( var_2._id_875F )
                break;
        }
...
_id_3461( var_0, var_1, var_2 )
{
    ...
    if ( var_0 > 0 && self._id_0138 != "MOD_MELEE" && self._id_140E != "attack" && self._id_140E != "combat" )
    {
        ...
        if ( distancesquared( var_2, var_3 ) < spawnstruct( level._id_03E1._id_75CA ) )
            self _meth_80B7( self._id_01FF, var_2, var_1, var_1, "MOD_HEAD_SHOT" );
    }
}
...
_id_DA5B( var_0 )
{
    ...
    var_2 = [];
    var_3 = spawnstruct( level._id_03E1._id_4297 );
    var_4 = spawnstruct( level._id_03E1._id_42B8 );
    ...
    foreach ( var_6 in var_1 )
    {
        ...
        var_7 = distancesquared( var_0._id_02EA, var_6._id_02EA );
        ...
        if ( var_7 < var_4 )
        {
            ...
            if ( var_6 _id_0777::_id_B99D( var_0._id_02EA, 0 ) && var_6 _meth_8618( var_0 ) )
                return 0;
...
_id_DA5A( var_0 )
{
    ...
    foreach ( var_6 in var_1 )
    {
        ...
        if ( var_7 < var_4 )
        {
            ...
            if ( var_6 _id_0777::_id_B99D( var_0._id_02EA, 0 ) )
            {
...
_id_7606( var_0 )
{
    if ( var_0 )
    {
        ...
        if ( !isdefined( self._id_03E1._id_97E9 ) )
            self._id_03E1._id_97E9 = level._id_030F;

        _id_06BB::_id_97D7( level._id_030F );
    }
...
_id_567E( var_0 )
{
    ...
    {
        if ( isdefined( var_0._id_0186 ) && isdefined( var_0._id_0186._id_045B ) && var_0._id_0186._id_045B == self._id_045B )
            return 1;
    }
    ...
    {
        if ( _func_0117( var_0._id_0186 ) && distancesquared( var_0._id_0186 geteye(), var_0._id_02EA ) > 1296 )
            return 1;
    }

    if ( var_0._id_F8E1 == "gunshot" || var_0._id_F8E1 == "gunshot_teammate" || var_0._id_F8E1 == "bulletwhizby" )
    {
        if ( _func_0104( var_0._id_0186 ) && var_0._id_0186 _meth_81C6() )
            return 1;
    }
...
_id_DAA8( var_0 )
{
    ...
    if ( isdefined( self._id_03E1._id_31D4 ) )
        var_2 = _id_077B::_id_1B72( var_2, self._id_03E1._id_31D4 );

    if ( _func_0117( var_0._id_0186 ) && _id_077B::_id_30D8( var_0._id_02EA + var_1, self, var_2 ) )
    {
...
_id_567F( var_0 )
{
    ...
    switch ( var_0._id_F8E1 )
    {
        case "sight":
            ...
            break;
        case "grenade danger":
            if ( _id_566B( var_0._id_02EA, 128 ) )
                var_0._id_048F = "combat";

            break;
        case "explode":
            if ( _id_566B( var_0._id_02EA, 192 ) )
                var_0._id_048F = "combat";
            else if ( distancesquared( var_0._id_02EA, self._id_02EA ) <= 1048576 )
                var_0._id_048F = "combat";

            break;
        case "gunshot":
            if ( distancesquared( var_0._id_02EA, self._id_02EA ) < 640000 )
                var_0._id_048F = "combat";

            break;
        case "glass_destroyed":
            if ( self _meth_8618( var_0._id_02EA, 0 ) && distance2dsquared( var_0._id_02EA, self._id_02EA ) < 36864 )
                var_0._id_048F = "combat";
    ...
    if ( isdefined( var_0._id_F8E1 ) )
    {
        ...
        switch ( var_0._id_F8E1 )
        {
            ...
            case "grenade danger":
                ...
                return 1;
            case "seek_backup":
                thread _id_088C::_id_1083( "stealth", "announce4", "seek_backup", _func_01B7( 2, 2.5 ), var_0 );
                return 1;
            case "found_corpse":
            case "saw_corpse":
            ...
            case "bulletwhizby":
                ...
                return 1;
            case "silenced_shot":
                thread _id_088C::_id_1083( "stealth", "announce2", "silenced_shot", _func_01B7( 0.8, 1.3 ), var_0 );
                return 1;
            case "gunshot":
            ...
            case "gunshot_teammate":
                ...
                return 1;
            case "ally_damaged":
                thread _id_088C::_id_1083( "stealth", "announce1", "gunshot", _func_01B7( 0.8, 1.3 ), var_0 );
                return 1;
            case "ally_killed":
...
_id_704D( var_0, var_1 )
{
    ...
    if ( isdefined( self._id_03E1._id_7C8E ) && isdefined( var_1._id_0457 ) )
    {
...
_id_704A( var_0, var_1 )
{
    ...
    if ( ( istrue( var_1._id_036D ) || istrue( var_1._id_CCF0 ) || istrue( var_1._id_CEAA ) || isdefined( var_1._id_CD79 ) || istrue( var_1._id_AF30 ) || !isdefined( var_1._id_0457 ) ) && isdefined( var_1._id_0054 ) )
    {
...
_id_2C3C( var_0 )
{
    ...
    if ( _func_0117( var_0._id_0186 ) && var_0._id_F8E1 == "sight" )
    {
    ...
    if ( isdefined( self._id_017D ) && isdefined( var_0._id_0186 ) && var_0._id_0186 == self._id_017D )
        ...
        var_0._id_84F8 = var_0._id_0186._id_02EA;
    else if ( isdefined( var_1 ) )
        var_0._id_84F8 = var_1._id_02EA;
...
_id_2C3B( var_0 )
{
    ...
    if ( isdefined( var_0._id_0186 ) && isdefined( var_0._id_0186._id_00DE ) && var_0._id_0186._id_00DE == "script_vehicle_blackhornet" )
        return;
    ...
    if ( istrue( level._id_03E1._id_4B18 ) )
    {
        switch ( var_0._id_F8E1 )
        {
            ...
            case "explode":
                _id_088C::_id_D1CF( 0 );
                level _id_077B::_id_46C3( 20, _id_088C::_id_D1CF, 1 );
                break;
        }
    }
    ...
    if ( var_0._id_F8E1 == "light_killed" )
    {
        ...
        var_0._id_84F8 = _id_077B::_id_4FE0( var_0._id_84F8, 24, -256 );
    }
...
_id_2C3A( var_0 )
{
    ...
    _id_077B::_id_5454( "stealth_attack" );
}
