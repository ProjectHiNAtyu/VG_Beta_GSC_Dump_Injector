...
_id_C042( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = _id_077B::_id_F07F( isdefined( var_3 ), var_3, _id_3ED4() );
    var_8 = _id_077B::_id_F07F( isdefined( var_5 ), var_5, 0 );
...
{
    var_6 = _id_077B::_id_F07F( isdefined( var_3 ), var_3, _id_3ED4() );
    var_7 = _id_077B::_id_F07F( isdefined( var_5 ), var_5, 0 );
...
_id_0B4C( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( isdefined( var_5 ) && var_5 )
        return _id_C043( var_0, var_1, var_3, _func_02C4( var_9 ), 1 );
    else
        return _id_C042( var_0, var_1, var_3, _func_02C4( var_9 ), 1 );
}

_id_0B4D( var_0, var_1, var_2, var_3 )
{
    return _id_C047( var_0, var_1, var_3, _id_3ED4( !var_2 ) );
}
...
{
    var_5 = _id_077B::_id_F07F( isdefined( var_3 ), var_3, _id_3ED4() );
...
_id_C047( var_0, var_1, var_2, var_3 )
{
    var_4 = _id_077B::_id_F07F( isdefined( var_3 ), var_3, _id_3ED4() );
...
_id_30CF( var_0, var_1 )
{
    ...
    if ( !_id_0777::_id_B99D( var_0 ) )
        return 0;

    return _id_C047( self geteye(), var_0, self, _id_3EC3( var_1, 1, 0, 1, 0, 1 ) );
}

_id_E406( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = _id_077B::_id_F07F( isdefined( var_4 ), var_4, _id_3ED4() );
...
{
    var_7 = _id_077B::_id_F07F( isdefined( var_4 ), var_4, _id_3ED4() );
    var_8 = _id_077B::_id_F07F( isdefined( var_6 ), var_6, 0 );
...
_id_E407( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        else
        {
            ...
            if ( var_3.size == 2 && isdefined( var_3[0] ) && isdefined( var_3[1] ) && ( _func_0113( var_3[0] ) || isalive( var_3[0] ) && ( _func_0113( var_3[1] ) || isalive( var_3[1] ) ) ) )
            {
                var_14 = var_3[0];
                var_15 = var_3[1];
            }
            else if ( _func_0113( var_3 ) || isalive( var_3 ) )
                var_14 = var_3;

            if ( isdefined( var_14 ) )
            {
                if ( _func_0113( var_14 ) )
                {
                    if ( var_14 == 1 )
                        var_9 = 1;
                }
    ...
    _id_077B::_id_4ED3( var_13, var_2, var_20, var_12, [ var_6, var_6, var_21 ], 0, var_4 );
}
...
{
    var_5 = _id_077B::_id_F07F( isdefined( var_4 ), var_4, _id_3ED4() );
...
_id_31F3( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    var_8 = _id_077B::_id_F07F( isdefined( var_6 ), var_6, _id_3ED4() );
...
_id_31F5( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_7 = _id_077B::_id_F07F( isdefined( var_6 ), var_6, _id_3ED4() );
...
{
    return _id_B47C( self._id_02EA, self._id_0054, var_0, var_1, var_2, var_3 );
}
...
_id_B47C( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isalive( var_3 ) )
        var_3 = _id_077B::_id_1B63( var_3, self );
    else
        var_3 = self;
...
_id_12C9( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_7 = _id_077B::_id_F07F( isdefined( var_4 ), var_4, _id_3F4E() );
...
_id_12CB( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_6 = _id_077B::_id_F07F( isdefined( var_4 ), var_4, _id_3F4E() );
...
_id_3F4E( var_0 )
{
    ...
    if ( !isdefined( var_0 ) || !var_0 )
        var_1 = _id_077B::_id_1B63( var_1, "physicscontents_characterproxy" );

    return _func_02C4( var_1 );
}
...
_id_3F33( var_0, var_1 )
{
    ...
    return _func_02C4( var_2 );
}

_id_3EA7()
{
    var_0 = [ "physicscontents_ainosight" ];
    return _func_02C4( var_0 );
}
