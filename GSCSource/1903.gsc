...
_id_021D()
{
    if ( !isdefined( level._id_B01A ) && !_id_06BB::_id_87BA() )
    ...
    for (;;)
    {
        var_1 = _func_021E( "mp/petWatchTable.csv", var_0, 1 );
        ...
        var_1 = int( var_1 );
        var_2 = _func_020F();
        var_2._id_B023 = int( _func_021E( "mp/petWatchTable.csv", var_0, 2 ) );
        var_2._id_2685 = int( _func_021E( "mp/petWatchTable.csv", var_0, 3 ) );
        var_2._id_269B = int( _func_021E( "mp/petWatchTable.csv", var_0, 4 ) );
        var_2._id_49AE = int( _func_021E( "mp/petWatchTable.csv", var_0, 5 ) );
        var_2._id_F9AD = int( _func_021E( "mp/petWatchTable.csv", var_0, 6 ) );
        var_2._id_7B82 = int( _func_021E( "mp/petWatchTable.csv", var_0, 7 ) );
        var_2._id_2686 = _func_021E( "mp/petWatchTable.csv", var_0, 8 );
        var_2._id_269C = int( _func_021E( "mp/petWatchTable.csv", var_0, 9 ) );
        var_2._id_49AF = int( _func_021E( "mp/petWatchTable.csv", var_0, 10 ) );
        var_2._id_F9AE = int( _func_021E( "mp/petWatchTable.csv", var_0, 11 ) );
        var_2._id_7B83 = int( _func_021E( "mp/petWatchTable.csv", var_0, 12 ) );
...
{
    self _meth_82F6( "ui_pet_watch_action", var_0 * -1 );
...
_id_823E( var_0, var_1 )
{
    ...
    {
        self _meth_82F6( "ui_pet_watch_state", 0 );
        self._id_B01D = _func_020F();
        ...
        if ( var_0 )
        {
            self _meth_82F6( "ui_pet_watch_action", -1 );
            _id_D63C( 0 );
        }
        else
    ...
    else
    {
        ...
        self._id_B01D._id_0134 = self getplayerdata( "common", self._id_B01D._id_B678, "damage" );
...
_id_F0DC( var_0 )
{
    ...
    switch ( var_0 )
    {
        ...
        case 12:
            ...
            break;
        case 13:
            self._id_B01D._id_0134 = 0;
            _id_FD76();
            break;
        case 14:
            self._id_B01D._id_0134 = 900;
            _id_FD76();
            break;
        case 15:
            self._id_B01D._id_0134 = 500;
            _id_FD76();
            break;
        case 16:
            _id_10B2();
...
_id_10D8()
{
    if ( isdefined( self._id_B01D ) )
    {
        ...
        self _meth_82F6( "ui_pet_watch_bonus_earned_4", 10000 + self._id_B01D._id_A718 );
    }
}
...
_id_113F()
{
    if ( isdefined( self._id_B01D ) )
    {
        ...
        self _meth_82F6( "ui_pet_watch_bonus_earned_2", 20000 + self._id_B01D._id_F341 );
    }
}
...
_id_10B2()
{
    if ( isdefined( self._id_B01D ) )
    {
        ...
        self _meth_82F6( "ui_pet_watch_bonus_earned_1", 30000 + self._id_B01D._id_8DAF );
    }
}
...
_id_10E5()
{
    if ( isdefined( self._id_B01D ) )
    {
        ...
        self _meth_82F6( "ui_pet_watch_bonus_earned_0", 40000 + self._id_B01D._id_B1C6 );
    }
}

_id_10D9( var_0, var_1 )
{
    if ( isdefined( self._id_B01D ) && ( !istrue( level._id_B01C[var_0] ) && !_func_0121( var_0, "kill" ) ) )
    {
        self._id_B01D._id_2680 = self._id_B01D._id_2680 + var_1;
        self._id_B01D._id_A8DA = self._id_B01D._id_A8DA + var_1;
        self _meth_82F6( "ui_pet_watch_bonus_earned_3", 50000 + self._id_B01D._id_A8DA );
    }
}
...
_id_111C()
{
    if ( isdefined( self._id_B01D ) )
    {
        ...
        self _meth_82F6( "ui_pet_watch_bonus_earned_0", 60000 + self._id_B01D._id_8D80 );
    }
}
...
_id_1084()
{
    if ( isdefined( self._id_B01D ) )
    {
        ...
        self _meth_82F6( "ui_pet_watch_bonus_earned_1", 70000 + self._id_B01D._id_56E6 );
    }
}
...
_id_115D()
{
    if ( isdefined( self._id_B01D ) )
    {
        ...
        self _meth_82F6( "ui_pet_watch_bonus_earned_0", 80000 + self._id_B01D._id_10E4A );
        _id_59D6();
    }
}
...
_id_115E()
{
    if ( isdefined( self._id_B01D ) )
    {
        ...
        self _meth_82F6( "ui_pet_watch_bonus_earned_1", 90000 + self._id_B01D._id_10E4B );
    }
}
...
{
    self._id_B01D._id_B01F = var_0;
    self._id_0309["petWatchData_phase"] = var_0;
}
...
_id_FD76()
{
    ...
    var_1 = int( self._id_B01D._id_0134 / 100 ) - 1;
    var_1 = int( _func_0147( 0, _func_0148( var_1, 9 ) ) );
    var_0 = var_0 + 100000 * var_1;
    var_2 = var_0 + self._id_B01D._id_B01F;
    self _meth_82F6( "ui_pet_watch_state", var_2 );
}
...
_id_44D8( var_0 )
{
    self _meth_82F6( "ui_pet_watch_action", var_0 );
}
...
_id_59D6()
{
    ...
    var_0 = _func_0147( -240, _func_0148( var_0, 240 ) );
    var_1 = _func_0147( -240, _func_0148( var_1, 240 ) );
    var_2 = _func_0147( -240, _func_0148( var_2, 240 ) );
    var_3 = _func_0147( -240, _func_0148( var_3, 240 ) );
    ...
    if ( var_5 )
    {
        ...
        self _meth_82F6( "ui_pet_watch_health_dirty", var_1 );
    }
    ...
    if ( var_7 )
    {
        ...
        self _meth_82F6( "ui_pet_watch_health_unruly", int( var_2 ) );
    }
    ...
    if ( var_4 )
    {
        ...
        self _meth_82F6( "ui_pet_watch_health_hungry", int( var_3 ) );
    }
    ...
    if ( var_6 )
    {
        ...
        self _meth_82F6( "ui_pet_watch_health_bored", int( var_0 ) );
    }
