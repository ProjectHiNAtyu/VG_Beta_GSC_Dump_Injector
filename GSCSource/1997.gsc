...
_id_0271()
{
    ...
    foreach ( var_3 in var_1 )
        var_0 = _id_077B::_id_1B72( var_0, getentarray( var_3, "classname" ) );

    _id_077B::_id_1BBA( var_0, ::_id_CDC9 );
}
...
_id_CDC9()
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        switch ( var_2._id_0375 )
        {
            case "origin":
                ...
                self._id_AC65 = _func_0205( "script_model", var_2._id_02EA );
                self._id_AC65._id_0054 = var_2._id_0054;
                self._id_AC65 setmode( "tag_origin" );
                self._id_AC65 _meth_820B( self );
                break;
            default:
                break;
        }
    ...
    var_4 = getentarray( self._id_0457, "targetname" );
...
_id_CDD2()
{
    ...
    {
        var_0 = _id_077B::_id_6D7C( self._id_0457, "targetname" );
        var_1 = getentarray( self._id_0457, "targetname" );
    }
    ...
    for ( var_2 = 0; var_2 < var_0.size; var_2++ )
    {
        ...
        switch ( var_3._id_0375 )
        {
            case "ignore":
                ...
                {
                    var_4 = _id_077B::_id_6D7C( var_3._id_0457, "targetname" );
    ...
    foreach ( var_9 in var_1 )
    {
        ...
        var_10 = _func_021A( var_9._id_0375, "_" );
        ...
        {
            case "delete":
                thread _id_CDC0( var_9, ::_meth_809A, var_10[2] );
                break;
            case "hide":
            ...
            case "show":
                var_9 hide();
                thread _id_CDC0( var_9, ::_meth_83C3, var_10[2] );
                break;
            case "triggerhide":
            case "triggerHide":
                thread _id_CDC4( var_9, _id_077B::_id_F5DD, var_10[2] );
                break;
            case "triggershow":
            case "triggerShow":
                var_9 _id_077B::_id_F5DD();
                thread _id_CDC4( var_9, _id_077B::_id_F5DF, var_10[2] );
                break;
            default:
                break;
        }
...
_id_CDCD( var_0 )
{
    ...
    {
        var_1 = _id_077B::_id_BFC7( var_0._id_7070 );
        var_2 = self;
        ...
        var_6 = 0;
        var_7 = 0;
        var_8 = _func_024A( var_1._id_02EA, var_1._id_0054, self._id_AC65._id_02EA, self._id_AC65._id_0054, self._id_02EA, self._id_0054 );

        if ( var_2._id_02EA != var_1._id_02EA )
        {
            if ( isdefined( var_2._id_AE37["move_speed"] ) )
            {
                var_9 = distance( var_2._id_02EA, var_1._id_02EA );
            ...
            var_2 _meth_823B( var_8["origin"], var_3, var_4, var_5 );

            foreach ( var_11 in var_1._id_92EA )
                thread _id_CDD3( var_11._id_02EA, var_11._id_CE0B, self._id_02EA, var_1._id_02EA );

            var_6 = 1;
        }

        if ( _id_176E( var_8["angles"] ) != _id_176E( var_2._id_0054 ) )
        {
            var_2 rotateroll( var_8["angles"], var_3, var_4, var_5 );
            var_7 = 1;
        }
...
_id_CDD3( var_0, var_1, var_2, var_3 )
{
    self endon( "move_end" );
    var_4 = self;
    var_5 = _func_025A( var_3 - var_2 );

    for (;;)
    {
        var_6 = _func_025A( var_0 - var_4._id_02EA );

        if ( _func_0257( var_5, var_6 ) <= 0 )
            break;
...
_id_CDC8()
{
    ...
    self._id_0054 = _id_176E( self._id_0054 );
...
_id_CDD7( var_0, var_1 )
{
    if ( var_1 )
    {
        ...
        var_0 _meth_832B( level._id_CDC7[self._id_AE37["hintstring"]] );
    }
    else
        var_0 _meth_8225();
}
    ...
    if ( self._id_F9A2 >= var_1 )
    {
        if ( isdefined( var_0 ) )
        {
            ...
            else
            {
                ...
                if ( var_2 || var_0 _id_09B4::_id_8ADC() && !_id_09B4::_id_1009C( var_0, self ) )
...
_id_B4D5( var_0 )
{
    ...
    if ( isdefined( var_0._id_EA0B ) && var_0._id_EA0B._id_EA0F == "cruise_predator" )
        var_1 = 1;
...
_id_F9AA( var_0 )
{
    ...
    if ( level._id_EF62 )
    {
        if ( isdefined( var_1._id_02F2._id_045B ) && var_1._id_02F2._id_045B != var_0._id_045B )
            var_2 = 1;
    }
    else if ( var_0 != var_1._id_02F2 )
        var_2 = 1;
    ...
    var_0 _meth_80B7( var_3, var_1._id_02EA, var_1._id_02F2, var_1, "MOD_CRUSH" );
}
...
_id_F9A7( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( _id_0999::_id_88E4() )
        {
            ...
            if ( var_2 _id_09B4::_id_8ADC() )
            {
                var_3 = _id_09BA::_id_10193( var_2, 1 );

                if ( isdefined( var_3 ) )
                {
                    var_4 = _id_09BA::_id_1019C( var_2, var_0, var_3, 1 );

                    if ( isdefined( var_4 ) )
                    {
                        var_0 _meth_835E( var_4[0] );
                        return;
                    }
                }
            }
        ...
        else
        {
            ...
            if ( isdefined( var_5 ) )
                var_5 = _func_01FF( var_5, var_0._id_02EA );
            else
                var_5 = _func_00B5( var_0._id_02EA, 500, 0, 128, "path" );

            var_7 = ( 0, 0, -100 );
            var_0 _meth_8062();
            var_0 _meth_80BE();
            var_8 = _id_659D( var_2 );
            var_9 = _id_077B::_id_1B72( var_8, level._id_33D8 );
            ...
            for ( var_10 = 0; var_10 < var_5.size; var_10++ )
            {
                ...
                var_11 = var_5[var_10];
                var_12 = var_11._id_02EA + ( 0, 0, 10 );
                var_13 = _id_077A::_id_3EC3( 0, 1, 1, 1, 1, 1 );
                var_14 = _id_077A::_id_C042( var_0 gettagorigin( "tag_eye" ), var_12, var_9, var_13 );
                ...
                if ( var_0 getstance() == "prone" )
                    var_0 _meth_8382( "crouch" );

                var_0 _meth_835E( var_12 );
                return;
            }
        }
    }
...
_id_B579( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( _func_0117( var_1 ) || _func_0102( var_1 ) )
        {
...
_id_CDD8( var_0 )
{
    ...
    if ( isdefined( self._id_E733 ) )
    {
        ...
        self._id_E733._id_E734 = self._id_E733._id_02EA;
    }
}
...
_id_CDC6( var_0 )
{
    ...
    return _func_0133( var_0._id_02EA - var_0._id_E734 ) > 0.001;
}
...
_id_BD48( var_0, var_1 )
{
    ...
    if ( isdefined( var_0._id_B372 ) )
        _func_0196( _id_077B::_id_6A40( "airdrop_crate_destroy" ), self._id_02EA );
...
_id_73E7( var_0 )
{
    ...
    if ( isdefined( var_0._id_94F7 ) )
    {
        ...
        if ( !isdefined( var_1 ) || var_1 != var_0._id_94F7 )
            self _meth_820B( var_0._id_94F7 );
    }
