...
_id_27BA()
{
    if ( !isdefined( self._id_ED36 ) )
    {
        if ( self._id_ED71 > 0 )
        {
            var_0 = spawnstruct( 500 + self._id_ED71 * 250 );

            if ( game["teamScores"][self._id_045B] + self._id_ED71 >= level._id_C93B )
                var_0 = spawnstruct( 5000 );
            else if ( !isdefined( self._id_017D ) && !_id_09D1::_id_27D1() )
                var_0 = spawnstruct( 1500 + self._id_ED71 * 250 );

            var_1 = undefined;

            foreach ( var_3 in level._id_A8D5 )
            {
                var_4 = distancesquared( self._id_02EA, var_3._id_047A._id_02EA );
        ...
        if ( self._id_B010 == "camper" && !self._id_3B4C && !self._id_7182 )
        {
            ...
            if ( isdefined( var_1 ) )
            {
                ...
                {
                    if ( _id_09CE::_id_5A91( var_1._id_047A._id_02EA ) )
                    {
                        self._id_3B4D = 1;
                        self notify( "stop_going_to_zone" );
                        self._id_7182 = 0;
...
_id_27B8( var_0, var_1 )
{
    ...
    {
        var_0._id_A3E5 = _func_0080( var_0._id_047A._id_02EA );
        var_0._id_2EBE = 1;
    }

    var_2 = var_0._id_A3E5;
    self _meth_8057( var_2._id_02EA, 32, var_1 );
...
_id_26F2( var_0, var_1 )
{
    ...
    if ( var_2 == "goal" )
    {
        ...
        if ( isdefined( var_3 ) )
        {
            var_4 = _func_0066( self._id_02EA );
            var_4 = _id_077B::_id_1B63( var_4, var_3 );
...
_id_53E3()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( self._id_017D ) && _func_0117( self._id_017D ) && isdefined( self._id_017D._id_ED71 ) && self._id_017D._id_ED71 >= 3 && self _meth_8027( self._id_017D ) && distance( self._id_02EA, self._id_017D._id_02EA ) <= 500 )
        {
