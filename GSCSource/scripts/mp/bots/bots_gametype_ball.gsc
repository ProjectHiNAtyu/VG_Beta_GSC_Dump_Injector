...
_id_26E1()
{
    ...
    for (;;)
    {
        ...
        if ( self._id_C8B8 == "carrier" )
        {
            if ( isdefined( self._id_32C6 ) )
            {
                ...
                if ( isdefined( self._id_017D ) )
                    var_2 = distancesquared( self._id_017D._id_02EA, self._id_02EA );
                ...
                {
                    var_3 = level._id_2106[_id_2796()]._id_02EA;
                    ...
                    var_5 = distance2dsquared( self._id_02EA, var_3 );
                    ...
                    if ( var_5 < 30625 )
                    {
                        ...
                        if ( _id_077A::_id_C047( var_6, var_7, self ) )
                        {
                            if ( var_5 < 256 )
                            {
                                self _meth_8057( self._id_02EA, 16, "critical" );
                                wait 0.25;
                            }
                ...
                else
                {
                    ...
                    if ( !isdefined( var_1 ) )
                        var_1 = gettime() + _func_01B9( 500, 1000 );
                    ...
                    if ( gettime() > var_1 )
                    {
                        ...
                        if ( isdefined( self._id_017D ) )
                        {
                            if ( self _meth_8027( self._id_017D ) )
                            {
                                ...
                                var_9 = self._id_017D._id_02EA - self._id_02EA;
                                var_10 = _func_025A( ( var_9[0], var_9[1], 0 ) );
                                var_11 = _func_0257( var_8, var_10 );
        ...
        if ( self._id_C8B8 == "defender" )
        {
            self _meth_8053( "disable_attack", 0 );
            self _meth_8053( "prefer_melee", 0 );
            var_15 = level._id_2106[self._id_045B];
            var_3 = var_15._id_02EA;
...
_id_81AF()
{
    ...
    var_2 = _id_20E5( self._id_045B );
    var_3 = _id_20E6( self._id_045B );
        ...
        foreach ( var_3 in var_0 )
        {
            ...
            if ( var_6.size > var_4 )
            {
                ...
                if ( !var_9 && var_8.size > 0 )
                    _id_077B::_id_BFC7( var_8 ) _id_212B( "defender" );
            }
            ...
            if ( var_7.size > var_5 )
            {
                ...
                if ( !var_14 && var_13.size > 0 )
                    _id_077B::_id_BFC7( var_13 ) _id_212B( "attacker" );
            }
...
_id_B049( var_0, var_1 )
{
    ...
    foreach ( var_5 in level._id_AE69 )
    {
        ...
        var_6 = distancesquared( var_5._id_02EA, var_1._id_411F );
...
_id_631F( var_0 )
{
    ...
    if ( isdefined( level._id_2106 ) )
    {
        foreach ( var_3 in level._id_B758 )
        {
            ...
            {
                if ( distancesquared( level._id_2106[var_0]._id_02EA, var_3._id_02EA ) > level._id_BDB1 * level._id_BDB1 )
