...
_id_2716()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 && self _meth_8041() )
        {
            ...
            else if ( _id_09D0::_id_27C7( "kill_tag" ) && self._id_ED36 _id_07AD::_id_3166( self._id_045B ) )
            {
...
_id_27EA( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && ( var_4 || var_0._id_AA49 ) )
    {
        ...
        if ( var_5 )
        {
            var_6 = _id_077B::_id_10E74( self._id_02EA, self._id_0054, var_0._id_411F, var_2 );
...
_id_2770( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && isdefined( level._id_4CC7 ) )
    {
        ...
        {
            if ( var_7 _id_07AD::_id_3166( self._id_045B ) )
            {
                var_8 = 0;
                ...
                if ( !var_0 )
                {
                    if ( !isdefined( var_7._id_2EE3 ) )
                    {
                        ...
                        var_8 = distancesquared( self._id_02EA, var_7._id_411F ) < 1000000 && var_7._id_AA49;
                    }
                }
...
_id_2767( var_0, var_1 )
{
    ...
    if ( var_0.size > 0 )
    {
        ...
        foreach ( var_5 in var_0 )
        {
            ...
            if ( !var_1 || var_6 < 2 )
            {
                var_7 = distancesquared( var_5._id_0400._id_411F, self._id_02EA );
...
_id_2881( var_0 )
{
    ...
    {
        if ( var_3._id_0400 _id_07AD::_id_3166( self._id_045B ) && _id_09D1::_id_28F0( var_3._id_0400._id_411F, var_3._id_02EA ) )
        {
