...
_id_2716()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 && self _meth_8041() )
        {
            ...
            else if ( _id_09D0::_id_27C7( "kill_tag" ) && self._id_ED36 _id_26F9( self._id_045B ) )
            {
...
_id_28FE()
{
    for (;;)
    {
        ...
        if ( isdefined( var_0 ) )
        {
            if ( isdefined( var_0._id_103C0 ) && var_0._id_103C0 == self || isdefined( var_0._id_006E ) && var_0._id_006E == self )
            {
...
_id_2715( var_0, var_1 )
{
    ...
    foreach ( var_4 in var_0 )
    {
        ...
        {
            if ( var_4._id_0400 == var_7._id_0400 && _id_09D1::_id_28F0( var_4._id_02EA, var_7._id_02EA ) )
            {
                var_5 = 1;
                break;
            }
...
_id_27EA( var_0, var_1, var_2 )
{
    ...
    {
        var_5 = var_3 == var_1 || newteamhudelem( var_3, var_1, 1 );

        if ( var_5 )
        {
            var_6 = _id_077B::_id_10E74( self._id_02EA, self getplayerangles(), var_0._id_411F, var_2 );
...
_id_2770( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && isdefined( level._id_4CC7 ) )
    {
        ...
        {
            if ( var_7 _id_26F9( self._id_045B ) )
            {
                var_8 = 0;

                if ( !var_0 || isdefined( var_7._id_006E ) && var_7._id_006E == self || isdefined( var_7._id_103C0 ) && var_7._id_103C0 == self )
                {
                ...
                {
                    var_9 = _func_020F();
                    var_9._id_02EA = var_7._id_411F;
                    var_9._id_0400 = var_7;
                    var_5 = _id_077B::_id_1B63( var_5, var_9 );
                }
            }
        }
    }
...
_id_2767( var_0, var_1 )
{
    ...
    if ( var_0.size > 0 )
    {
        ...
        foreach ( var_5 in var_0 )
        {
            ...
            if ( !var_1 || var_6 < 2 )
            {
                var_7 = distancesquared( var_5._id_0400._id_718C, self._id_02EA );
...
_id_2881( var_0 )
{
    ...
    {
        if ( var_3._id_0400 _id_26F9( self._id_045B ) && _id_09D1::_id_28F0( var_3._id_0400._id_411F, var_3._id_02EA ) )
        {
...
_id_65D7( var_0 )
{
    ...
    foreach ( var_3 in level._id_AE69 )
    {
        ...
        if ( var_3._id_045B == self._id_045B && var_3 != self )
        {
            if ( _func_0104( var_3 ) )
            {
            ...
            if ( distancesquared( var_3._id_02EA, var_0._id_411F ) < 160000 )
                var_1++;
        }
    }
...
_id_26F1( var_0, var_1, var_2 )
{
    ...
    if ( var_3 == "goal" )
    {
        ...
        if ( isdefined( var_4 ) )
        {
            var_5 = _func_0066( self._id_02EA );
            var_5 = _id_077B::_id_1B63( var_5, var_4 );
