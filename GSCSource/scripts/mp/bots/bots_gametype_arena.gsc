...
_id_D758()
{
    ...
    var_0 = _id_077B::_id_F07F( level._id_A8FC == 1, 3, 1 );
...
_id_26D9()
{
    ...
    if ( !isdefined( self._id_0309["bot_original_personality"] ) )
        self._id_0309["bot_original_personality"] = self._id_B010;
    ...
    if ( !scripts\mp\gametypes\arena::_id_8936() )
    {
        if ( self _meth_802F( "advancedPersonality" ) && self _meth_802F( "strategyLevel" ) > 0 )
            scripts\mp\bots\bots_gametype_gun::_id_27BF( self getcurrentweapon()._id_0084, self._id_0309["bot_original_personality"] );
    }
    ...
    for (;;)
    {
        if ( isdefined( level._id_1A7E ) && level._id_1A7E._id_10418 == "any" )
        {
            if ( !_id_09D1::_id_27DB() )
                _id_09D0::_id_2704( level._id_1A7E._id_047A._id_02EA, level._id_1A7E._id_A565, level._id_1A7E._id_047A );
        }
        else
            self [[ self._id_B012 ]]();
...
_id_1A39( var_0 )
{
    if ( _id_09D0::_id_27C7( "seek_dropped_weapon", var_0 ) == 0 )
    {
        if ( istrue( level._id_DFBC ) )
        {
            ...
            if ( isdefined( var_1 ) && var_1._id_0084 == "snowball_mp" )
            {
                var_3 = scripts\engine\trace::_id_6985( "primary" );
                var_4 = scripts\engine\trace::_id_69F0( var_3 );

                if ( var_1._id_0084 == "snowball_mp" && var_4 > 3 )
                    return;
            }

            if ( isdefined( var_2 ) && var_2._id_0084 == "pball_mp" )
            {
                var_3 = scripts\engine\trace::_id_6985( "secondary" );
                var_4 = scripts\engine\trace::_id_69F0( var_3 );

                if ( var_2._id_0084 == "pball_mp" )
                    return;
            }
        }
        ...
        if ( var_0._id_045A == "dropped_weapon" )
        {
            ...
            {
                if ( var_0._id_02AE == getweaponmodel( var_9 ) )
                    var_6 = 0;
            }
...
_id_1A76( var_0 )
{
    ...
    if ( var_0._id_A84D._id_045A == "dropped_weapon" )
    {
        ...
        {
            if ( var_5._id_0084 == "s4_me_fists_mp" )
                return 0;
        }
...
_id_1A36()
{
    ...
    if ( var_1.size == 1 && var_1[0]._id_0084 == "s4_me_fists_mp" )
        var_0 = 0;
