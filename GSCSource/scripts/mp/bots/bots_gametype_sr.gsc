...
_id_ED45()
{
    for (;;)
    {
        ...
        if ( var_0.size > 0 )
        {
            ...
            if ( distancesquared( self._id_02EA, var_1._id_0400._id_411F ) < 10000 )
...
_id_E4D5( var_0 )
{
    if ( isdefined( var_0._id_2866 ) && isdefined( var_0._id_2866[self._id_045B] ) && isai( var_0._id_2866[self._id_045B] ) && var_0._id_2866[self._id_045B] != self )
        return;
    ...
    var_0._id_2866[self._id_045B] = self;
    ...
    else if ( var_2 == "bad_path" )
    {
        ...
        if ( var_3.size > 0 )
        {
            var_4 = ( var_0._id_411F[0], var_0._id_411F[1], ( var_3[0]._id_02EA[2] + var_0._id_411F[2] ) * 0.5 );
            self _meth_8057( var_4, 0, "tactical" );
            var_2 = _id_09D1::_id_28F6( undefined, "tag_picked_up", "new_role" );
        }
    }

    if ( var_2 == "goal" && var_0 scripts\mp\bots\bots_gametype_conf::_id_26F9( self._id_045B ) )
        wait 3.0;
    ...
    var_0._id_2866[self._id_045B] = undefined;
    self._id_EBDE = undefined;
}
...
_id_10A80( var_0 )
{
    ...
    for (;;)
    {
        if ( !var_0 scripts\mp\bots\bots_gametype_conf::_id_26F9( self._id_045B ) )
            wait 0.05;
...
_id_E4D0( var_0 )
{
    var_1 = distance( self._id_02EA, var_0._id_411F );
    var_2 = scripts\mp\bots\bots_gametype_common::_id_654B( self._id_045B, 1 );

    foreach ( var_4 in var_2 )
    {
        if ( var_4 != self && isdefined( var_4._id_C8B8 ) && var_4._id_C8B8 != "atk_bomber" && var_4._id_C8B8 != "defuser" )
        {
            var_5 = distance( var_4._id_02EA, var_0._id_411F );
...
_id_A67C( var_0, var_1 )
{
    ...
    while ( var_0 scripts\mp\bots\bots_gametype_conf::_id_26F9( self._id_045B ) && !scripts\mp\bots\bots_gametype_conf::_id_2706( var_0 ) )
        wait 0.05;
...
_id_E4D1( var_0 )
{
    if ( isdefined( var_0._id_26F3 ) && isdefined( var_0._id_26F3[self._id_045B] ) && isai( var_0._id_26F3[self._id_045B] ) && var_0._id_26F3[self._id_045B] != self )
        return;
    ...
    var_0._id_26F3[self._id_045B] = self;
    ...
    while ( var_0 scripts\mp\bots\bots_gametype_conf::_id_26F9( self._id_045B ) && self._id_C8B8 == var_1 )
    {
    ...
    self _meth_802A();
    var_0._id_26F3[self._id_045B] = undefined;
    self._id_EBDE = undefined;
}
