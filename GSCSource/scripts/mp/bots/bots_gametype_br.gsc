...
_id_0271()
{
    if ( _id_0A69::_id_6D80() == "dmz" && scripts\mp\gametypes\br_public::_id_87EA() )
        [[ level._id_4BB1 ]]();
    else
    {
        _id_D78A();
...
_id_D75D()
{
    _func_01D1( "#x35f282ebbc5fa948", 0.25 );
}
...
_id_26E7()
{
    ...
    var_0 = _func_01B6( 1 ) < getdvarfloat( "#x35f282ebbc5fa948", 0.0 );
    thread _id_16AF();
    ...
    for (;;)
    {
        ...
        if ( isdefined( self._id_2A38 ) )
        {
            ...
            {
                var_1 = level._id_29CE._id_02EA;
                var_2 = _func_025A( level._id_7E5E._id_2E14._id_5320 - var_1 );
                ...
                var_14 = var_8 / var_13;
                var_15 = _func_01B7( 0.1, 0.9 ) * var_14;
                wait( var_15 );
        ...
        {
            thread _id_27BE();
            _id_077B::_id_1087E( "death_or_disconnect", "gulag_end" );
            wait 3;
        }
        else
            self _meth_8029();
        ...
        if ( isdefined( level._id_29F5 ) && _func_03D7() )
        {
            ...
            if ( !_id_09D0::_id_27C7() && !_id_09D1::_id_27E9() )
            {
                ...
                if ( var_17 )
                {
                    var_20 = distancesquared( self._id_02EA, var_16 );
...
_id_2853()
{
    ...
    var_0 = gettime() + _func_01B7( 5, 10 ) * 1000;
    var_1 = 0;
...
_id_27A0( var_0 )
{
    if ( !isdefined( level._id_5F28 ) || level._id_5F28.size < 1 )
    {
        ...
        level._id_5F28 = _id_077B::_id_1B94( level._id_5F28 );
    }

    if ( isdefined( level._id_29F5 ) && _func_03D7() )
    {
        var_1 = _id_077B::_id_BFC7( level._id_5F28 );

        if ( isdefined( var_1 ) )
        {
            var_2 = var_1._id_02EA;
            level._id_5F28 = _id_077B::_id_1B96( level._id_5F28, var_1 );
        }
        else
...
_id_6519()
{
    ...
    return _id_077B::_id_634A( var_1, level._id_2807, undefined, undefined, var_0 );
}

_id_2791( var_0, var_1 )
{
    var_2 = _func_025A( var_1 - var_0._id_02EA );
    return _func_025B( var_2 );
}

_id_2795( var_0, var_1 )
{
    return distance( var_0._id_02EA, var_1 );
}
...
_id_27B5()
{
    ...
    var_0 = _id_077B::_id_BFC7( level._id_26D7 );
    ...
    self setweaponammoclip( var_1, visionsetthermal( var_1 ) );
...
_id_27B6()
{
    ...
    {
        var_0 = _func_020F();
        var_0._id_02EA = _id_6CAD();
    }

    var_0._id_37CC = 1;
    var_1 = level._id_285E[self._id_B010] == "stationary";
    self _meth_8057( self _meth_86F5( var_0._id_02EA ), 256, "guard", undefined, undefined, !var_1 );
    _id_077B::_id_1087E( "goal", "last_stand_start" );
...
{
    var_0 = _id_6428();
    var_0 = _func_01FF( var_0, self._id_02EA );
...
_id_6428()
{
    var_0 = scripts\mp\gametypes\br_circle::_id_69A7();
    var_1 = scripts\mp\gametypes\br_circle::_id_69A6();
    var_2 = _id_077B::_id_634A( var_1, level._id_274C, undefined, undefined, var_0 );
    return var_2;
}
...
_id_63B7( var_0 )
{
    return _id_077B::_id_694A( self._id_02EA, var_0 );
}
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_2 ) )
        {
            ...
            else
            {
                ...
                thread _id_AEBF();
                var_4 = _id_077B::_id_1088A( self, "goal", self, "bad path", level, "br_circle_started", self, "last_stand_start", self, "path_timeout" );

                if ( isdefined( var_4 ) && ( var_4 != "bad path" && var_4 != "br_circle_started" && var_4 != "path_timeout" && var_4 != "last_stand_start" ) )
                {
                    var_5 = gettime() + _func_01B9( 3, 8 ) * 1000;
...
_id_27BE()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_3 in var_1._id_1A96 )
        {
            ...
            {
                self _meth_8057( var_1._id_4CED._id_1A7E._id_5C1F._id_02EA, 64, "objective" );
                self _meth_8029();
                continue;
            }

            self _meth_812E( var_3 );
            self _meth_8057( self _meth_86F5( var_3._id_02EA ), 256, "guard" );
            self _meth_8056( var_3 );
        }
...
_id_16AF()
{
    ...
    for (;;)
    {
        ...
        if ( var_0.size == 1 && var_0[0]._id_0084 == "s4_me_fists_mp" )
        {
            wait 1;
            continue;
        }
        ...
        foreach ( var_2 in var_0 )
        {
            if ( self getweaponammostock( var_2 ) < visionsetthermal( var_2 ) )
                self setweaponammoclip( var_2, visionsetthermal( var_2 ) );
        }
...
{
    var_0 = _id_6641();
    var_1 = spawnstruct( 3000 );

    if ( istrue( self._id_82AC ) || scripts\mp\gametypes\br_public::_id_8977() )
        return undefined;

    if ( !isdefined( var_0 ) || istrue( var_0._id_82AC ) || !isai( var_0 ) || var_0 scripts\mp\gametypes\br_public::_id_8977() )
        return undefined;
    ...
    if ( var_2 >= 3 )
    {
        if ( distancesquared( var_0._id_02EA, self._id_02EA ) > var_1 )
            return undefined;
...
_id_FBAA()
{
    ...
    _id_077B::_id_1087F( "death", "death_or_disconnect", "last_stand_start" );
    self._id_B425 = undefined;
...
_id_27E2()
{
    ...
    if ( !isai( self ) || self._id_0392 != "playing" )
        return 0;

    return !_id_077B::_id_89A0( self._id_02EA, var_0, var_1 );
}
...
_id_6CAA( var_0 )
{
    ...
    if ( distance2d( self._id_02EA, var_1 ) > var_0 )
    {
        var_2 = _func_025B( var_1 - self._id_02EA );
        var_3 = anglestoforward( var_2 );
        var_1 = self._id_02EA + var_3 * var_0;
    }
...
_id_6CA9()
{
    ...
    while ( gettime() < var_0 )
    {
        var_1 = scripts\mp\gametypes\br_circle::_id_6CA8( self._id_02EA, 750, 0.6, 1, 1, 1 );
...
_id_899A( var_0 )
{
    ...
    return _id_077B::_id_89A0( var_0, var_1, var_2 );
}
...
_id_6302()
{
    ...
    foreach ( var_2 in level._id_B758 )
    {
        if ( !_func_0107( var_2 ) || !isai( var_2 ) || var_2._id_0392 != "playing" )
            continue;
...
_id_290A( var_0 )
{
    var_1 = level._id_EF67[var_0._id_045B]["alivePlayers"];

    if ( _id_077B::_id_1B78( var_1, self ) )
        return 1;
