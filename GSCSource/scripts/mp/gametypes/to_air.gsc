...
_id_9965()
{
    ...
    {
        _id_0A69::_id_C29C( "to_air", 0, 0, 9 );
        _id_0A69::registersharedfunc( "to_air", 10 );
        _id_0A69::_id_C29F( "to_air", 65 );
        _id_0A69::_id_C29B( "to_air", 1 );
        _id_0A69::_id_C2C2( "to_air", 1 );
        _id_0A69::_id_C270( "to_air", 0 );
        _id_0A69::_id_C24F( "to_air", 0 );
        _id_0A69::_id_C242( "to_air", 0 );
        level._id_9BD4 = 0;
    }
...
_id_6D2C()
{
    ...
    if ( isdefined( self._id_ED15._id_5094 ) )
    {
        ...
        {
            var_7 = _id_077B::_id_B420( self._id_ED15._id_5094._id_02EA, 32, 0, -1500, ( 0, 0, 1 ) );
            self._id_ED15._id_5094._id_E32F = var_7;
        }
        else if ( isdefined( level._id_5608[1] ) && self._id_ED15._id_5094 == level._id_5608[1] )
        {
            self._id_ED15._id_5094._id_E32F = self._id_ED15._id_5094._id_02EA;
            level._id_5608[1]._id_02F2 thread _id_54AD( level._id_5608[1] );
        }
        else if ( isdefined( level._id_5608[2] ) && self._id_ED15._id_5094 == level._id_5608[2] )
        {
            self._id_ED15._id_5094._id_E32F = self._id_ED15._id_5094._id_02EA;
            level._id_5608[2]._id_02F2 thread _id_54AD( level._id_5608[2] );
        }

        var_8 = anglestoforward( self._id_ED15._id_5094._id_0054 );
        var_8 = var_8 * ( 1, 1, 0 );
        var_9 = ( 0, 0, 1 );
...
{
    level._id_5608 = [];
    level._id_5608[0] = _id_E2DA( level._id_138C[0][0][0]._id_02EA );
    level._id_5608[0] thread _id_1FC8();
    level._id_5608[1] = _id_E2DA( level._id_138C[1][0][0]._id_02EA );
    level._id_5608[2] = _id_E2DA( level._id_138C[2][0][0]._id_02EA );
...
_id_D866()
{
    ...
    for ( var_3 = 0; var_3 < var_2.size; var_3++ )
    {
        ...
        if ( var_6 != 0 )
            level._id_A8D5[var_6] _id_077B::_id_46C3( 2.0, ::_id_4D28 );
    }
}
...
_id_D597( var_0 )
{
    var_1 = distance( level._id_1DBE._id_02EA, var_0 );
    var_2 = var_1 / 150;
    var_3 = 0.25;
    var_4 = 0.25;
    level._id_1DBE _meth_823B( var_0, var_2, var_3, var_4 );
    var_5 = anglestoforward( level._id_1DBE._id_0054 );
    var_6 = _func_025A( var_0 - level._id_1DBE._id_02EA );
...
_id_33B8( var_0, var_1, var_2 )
{
    ...
    for ( var_5 = var_4 + var_2; var_3 < var_5; var_3 = gettime() )
    {
        ...
        level._id_1DBE._id_0054 = _id_0A78::_id_FFE1( var_7, ( 0, 0, 1 ) );
        waitframe();
    }
}
