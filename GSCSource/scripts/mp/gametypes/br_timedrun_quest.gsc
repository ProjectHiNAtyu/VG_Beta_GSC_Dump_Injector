...
_id_EDD0( var_0 )
{
    var_1 = scripts\mp\gametypes\br_quest_util::_id_4017( "timedrun", self._id_045B, var_0.health, var_0 );
    ...
    scripts\mp\gametypes\br_quest_util::_id_E729( "timedrun", self, self._id_045B );
    var_6 = _func_020F();
    var_6._id_56BD = [];
    var_6._id_56BD[0] = self;
    var_6._id_B96A = scripts\mp\gametypes\br_quest_util::_id_6C79( "timedrun", scripts\mp\gametypes\br_quest_util::_id_6C84( self._id_045B ) );
    scripts\mp\gametypes\br_quest_util::_id_4B59( self, "br_timedrun_quest_start_tablet_finder", var_6 );
    scripts\mp\gametypes\br_quest_util::_id_4B61( var_1._id_045B, "br_timedrun_quest_start_team_notify", var_6 );
    level thread scripts\mp\gametypes\br_public::_id_2BB8( "mission_timedrun_accept", var_1._id_045B, 1, 1 );
}
...
_id_F3AD( var_0 )
{
    ...
    {
        if ( distance2d( self._id_E6DE, var_2._id_02EA ) < 1500 )
        {
    ...
    foreach ( var_6 in var_4 )
    {
        ...
        else if ( var_6._id_AD9B == self._id_045B )
            break;
    }
    ...
    self._id_1031F = _id_0A72::_id_ACBF( self._id_EF0C, self._id_045B, "outlinefill_nodepth_yellow", "level_script" );
    thread _id_3881();
    thread _id_10B0D();
}
...
_id_10B0D()
{
    ...
    _id_077B::_id_10887( var_0, "vehicle_enter" );

    foreach ( var_2 in var_0 )
    {
        if ( distance2d( var_2._id_02EA, self._id_EF0C._id_02EA ) < 2000 )
        {
            _id_0A72::_id_ACB7( self._id_1031F, self._id_EF0C );
...
_id_F3AA( var_0 )
{
    var_1 = scripts\mp\gametypes\br_quest_util::_id_3FEB( "timedrun_locale", "timedrun", self._id_045B );
...
_id_D87D( var_0 )
{
    ...
    self._id_EEB1 = var_0;
    thread _id_F209( self._id_EEB1._id_02EA );
    _id_FD60();
    return 1;
}
...
{
    var_2 = _func_0207( level._id_0BA3["vfx_marker_base_orange_pulse"], var_0 + ( 0, 0, 10 ) );
    var_2._id_0054 = _func_025B( ( 0, 0, 1 ) );
    var_2 hide();
    wait 0.5;
    _func_024B( var_2 );

    foreach ( var_4 in _id_0A7C::_id_6DAC( self._id_045B, "players" ) )
        var_2 _meth_83CA( var_4 );
...
_id_F3AB()
{
    foreach ( var_1 in _id_0A7C::_id_6DAC( self._id_045B, "players" ) )
    {
        if ( distance( var_1._id_02EA, self._id_411F ) < 150 )
...
_id_3B12( var_0 )
{
    ...
    scripts\mp\gametypes\br_quest_util::_id_4B61( self._id_045B, "br_timedrun_quest_complete", var_1 );
    level thread scripts\mp\gametypes\br_public::_id_2BB8( "mission_misc_success", self._id_045B, 1, 1 );
...
_id_58C1()
{
    scripts\mp\gametypes\br_quest_util::_id_4B61( self._id_045B, "br_timedrun_quest_circle_failure" );
    level thread scripts\mp\gametypes\br_public::_id_2BB8( "mission_obj_circle_fail", self._id_045B, 1, 1 );
    self._id_034B = "fail";
    scripts\mp\gametypes\br_quest_util::_id_C501();
}
...
_id_F3AF()
{
    scripts\mp\gametypes\br_quest_util::_id_4B61( self._id_045B, "br_timedrun_quest_timer_expired" );
    level thread scripts\mp\gametypes\br_public::_id_2BB8( "mission_timedrun_fail", self._id_045B, 1, 1 );
}
...
_id_F3B0( var_0 )
{
    ...
    {
        scripts\mp\gametypes\br_quest_util::_id_6C77( "timedrun_locale", self._id_045B )._id_B6FE = _id_0A7C::_id_6DAC( self._id_045B, "players" );
