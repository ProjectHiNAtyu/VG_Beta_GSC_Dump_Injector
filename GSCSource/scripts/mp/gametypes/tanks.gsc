...
_id_0271()
{
    ...
    _func_01D0( "scr_tanks_teamcount", 2 );
    _func_01D0( "scr_tanks_teamsize", 4 );
    _func_01D0( "scr_tanks_squadsize", 4 );
    _id_07B3::_id_021D();
    _id_07B3::_id_D849();
...
_id_AB9A()
{
    ...
    _id_0A69::_id_D610( "allies", &"OBJECTIVES/TANKS" );
    _id_0A69::_id_D610( "axis", &"OBJECTIVES/TANKS" );

    if ( level._id_E427 )
    {
        _id_0A69::_id_D60E( "allies", &"OBJECTIVES/TANKS" );
        _id_0A69::_id_D60E( "axis", &"OBJECTIVES/TANKS" );
    }
    else
    {
        _id_0A69::_id_D60E( "allies", &"OBJECTIVES/TANKS_SCORE" );
        _id_0A69::_id_D60E( "axis", &"OBJECTIVES/TANKS_SCORE" );
    }

    _id_0A69::_id_D609( "allies", &"OBJECTIVES/TANKS_HINT" );
    _id_0A69::_id_D609( "axis", &"OBJECTIVES/TANKS_HINT" );
    _id_827A();
    var_2[0] = _id_0A69::_id_6A43();
...
_id_E26A( var_0 )
{
    _id_E269( var_0._id_02EA + ( 0, 0, 50 ), var_0._id_0054, var_0._id_045B, var_0 );
}
...
_id_E358( var_0 )
{
    ...
    var_1._id_E39A = "killstreak";
    var_1._id_02EA = var_0._id_02EA;
    var_1._id_31D1 = 0;
    var_1._id_31D2 = 0;

    if ( _id_099C::_id_6C48( var_0 ) == 1 )
        var_1._id_FE20 = 1;
    ...
    if ( !_func_03D5( self ) )
        thread _id_09BA::_id_1017C( var_3, "driver", self, undefined, 1 );
}
