...
_id_AB9A()
{
    ...
    {
        _id_0A69::_id_D610( var_3, &"OBJECTIVES/TDEF" );

        if ( level._id_E427 )
            _id_0A69::_id_D60E( var_3, &"OBJECTIVES/TDEF" );
        else
            _id_0A69::_id_D60E( var_3, &"OBJECTIVES/TDEF_SCORE" );

        _id_0A69::_id_D609( var_3, &"OBJECTIVES/TDEF_ATTACKER_HINT" );
    }
    ...
    _id_827A();
    var_5[0] = _id_0A69::_id_6A43();
    var_5[1] = "tdm";
    var_5[2] = "ball";
    _id_07AD::_id_0271( var_5 );
    _id_EF2F();
...
_id_2ED5( var_0 )
{
    ...
    var_1 = _func_00C4( var_0._id_02EA, level._id_212E[0]._id_718A, 1000 );

    if ( var_1 < 0 )
        var_1 = _id_077B::_id_4B6B( var_0._id_02EA, level._id_212E[0]._id_718A );
    else
        var_1 = var_1 * var_1;
...
_id_6D2C()
{
    ...
    {
        var_3 = [];
        var_3["ballPosition"] = level._id_218A[0]._id_1042E[0]._id_02EA;

        if ( isdefined( level._id_218A[0]._id_32AF ) )
            var_3["activeCarrierPosition"] = level._id_218A[0]._id_32AF._id_02EA;
        else
...
_id_AB5D( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( isdefined( level._id_20E2._id_32AF ) )
    {
        if ( isdefined( var_1 ) && _func_0117( var_1 ) && var_1._id_0309["team"] != var_10._id_0309["team"] )
        {
            ...
            if ( var_1._id_0309["team"] == level._id_20E2._id_AD9B && var_1 != level._id_20E2._id_32AF )
            {
                var_13 = distancesquared( level._id_20E2._id_32AF._id_02EA, var_11 );
...
_id_1F9C( var_0 )
{
    ...
    while ( !level._id_609B )
    {
        ...
        if ( !level._id_609B )
        {
            _id_07AE::_id_6FE4( var_0, var_2, 0 );
            level._id_20E2._id_32AF _id_0A7B::_id_7D93( "objTime", 1 );
            level._id_20E2._id_32AF scripts\mp\gamelogic::_id_E76D( "round", "objTime", level._id_20E2._id_32AF._id_0309["objTime"] );
            level._id_20E2._id_32AF _id_0A7B::_id_D543( level._id_20E2._id_32AF._id_0309["objTime"] );
            level._id_20E2._id_32AF _id_07AE::_id_6FB2( "tdef_hold_obj", 10 );
        }
    }
}
...
_id_10B0B()
{
    ...
    if ( isdefined( self ) )
    {
        if ( isdefined( self._id_EF30 ) )
        {
            ...
            scripts\mp\gamelogic::_id_E76D( "round", "destructions", self._id_0309["destructions"] );
        }
    }
}
...
_id_6D04()
{
    ...
    {
        if ( scripts\mp\tac_ops\hostage_utility::_id_0BF6( "specialty_afterburner" ) )
        {
            self _meth_8485( 0, _id_077B::_id_F07F( _id_0A69::_id_873A(), 600, 2000 ) );
            self _meth_8481( 0, _id_077B::_id_F07F( _id_0A69::_id_873A(), 750, 650 ) );
        }
        else
        {
