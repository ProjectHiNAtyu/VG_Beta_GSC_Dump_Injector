...
_id_0271()
{
    ...
    else
    {
        ...
        _id_0A69::_id_C29F( _id_0A69::_id_6A43(), 85 );
    ...
    _id_FC7A();
    level._id_4CCA = [];
    scripts\mp\gametypes\obj_grindzone::_id_021D();
    level._id_EF62 = 1;
...
_id_AB9A()
{
    ...
    _id_0A69::_id_D610( "allies", &"OBJECTIVES/WAR" );
    _id_0A69::_id_D610( "axis", &"OBJECTIVES/WAR" );

    if ( level._id_E427 )
    {
        _id_0A69::_id_D60E( "allies", &"OBJECTIVES/WAR" );
        _id_0A69::_id_D60E( "axis", &"OBJECTIVES/WAR" );
    }
    else
    {
        _id_0A69::_id_D60E( "allies", &"OBJECTIVES/WAR_SCORE" );
        _id_0A69::_id_D60E( "axis", &"OBJECTIVES/WAR_SCORE" );
    }

    _id_0A69::_id_D609( "allies", &"OBJECTIVES/WAR_HINT" );
    _id_0A69::_id_D609( "axis", &"OBJECTIVES/WAR_HINT" );
    _id_827A();
    _id_4039();
...
_id_FC7A()
{
    ...
    var_0 = _id_0A66::getvehicle( "scorelimit" );
...
_id_AB91()
{
    self _meth_82F6( "ui_match_status_hint_text", 34 );

    if ( isdefined( self._id_ED71 ) )
        self _meth_82F6( "ui_grind_tags", self._id_ED71 );
}

_id_ABA0( var_0 )
{
    self _meth_82F6( "ui_grind_tags", 0 );
...
_id_4039()
{
    ...
    for ( var_0 = 0; var_0 < 50; var_0++ )
    {
        ...
        var_1 setmode( "military_dogtags_iw8" );
        var_1 _meth_82CA( "mp_dogtag_spin" );
        var_1 _meth_8373( "visibility", "hide", 0 );
        var_1 _meth_85A2();
...
_id_E388( var_0 )
{
    ...
    var_7 = ( 0, _func_01B6( 360 ), 0 );
    var_8 = anglestoforward( var_7 );
    var_9 = _func_01B7( 30, 150 );
    var_10 = 0.5;
    var_11 = var_3 + var_9 * var_8;
    var_12 = physicsexplosionsphere( var_3, var_11 );
    var_13 = _id_6D93();
    var_13._id_411F = var_6;
    var_13._id_047A._id_02EA = var_6;
    var_13._id_1042E._id_02EA = var_6;
    var_13._id_045B = var_0._id_045B;
    var_13._id_1042E._id_045B = var_13._id_045B;
    var_13._id_839C = "any";
    var_13._id_047A _meth_83C3();
    var_13._id_047A _meth_820B( var_13._id_1042E, "tag_origin" );
    _func_019D( var_3, "mp_grind_token_drop" );
...
_id_ED69( var_0, var_1, var_2, var_3 )
{
    ...
    self._id_1042E thread _id_DCF4( self, _id_0A69::_id_6BC3( var_0 )[0] );
    self._id_1042E _meth_85A2();
    var_4 = getdvarint( "#x3f7e9b59e29bb9d7e" );
    var_5 = distance( var_1, var_2 );
    var_6 = var_2 - var_1;
    var_7 = 0.5 * var_4 * spawnstruct( var_3 ) * -1;
...
_id_A135( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( var_1 _id_0A74::_id_8AB5() || isdefined( var_1._id_E304 ) )
            continue;

        if ( isdefined( var_1._id_00DE ) && var_1._id_00DE == "script_vehicle" )
            continue;

        if ( _func_0102( var_1 ) && isdefined( var_1._id_02F2 ) )
            var_1 = var_1._id_02F2;

        var_0._id_1042E _meth_8373( "visibility", "hide", 0 );
        var_0._id_047A hide();
        var_0._id_411F = ( 0, 0, 1000 );
        var_0._id_047A._id_02EA = ( 0, 0, 1000 );
        var_0._id_1042E._id_02EA = ( 0, 0, 1000 );
        var_0 _id_07AD::_id_15B7( "none" );
        var_1 _id_B792( var_1._id_ED71 + 1 );
        var_1 thread _id_0A76::_id_6FE6( "tag_collected" );
        var_1 _meth_827B( "mp_grind_token_pickup" );
...
_id_4051()
{
    ...
    if ( level._id_9AA7 == "mp_deadzone" )
    {
        var_5 = _func_020F();
        var_5._id_02EA = ( 1416, 1368, 300 );
...
{
    if ( _id_0A74::_id_89D3( var_0 ) && var_0 _meth_81EF( var_1._id_047A ) && var_1._id_AD9B == var_0._id_045B )
        return 1;
...
_id_BD6E( var_0, var_1 )
{
    while ( var_0._id_ED71 && _id_88BF( var_0, var_1 ) && !var_1._id_E578 && !var_1._id_4A67 )
    {
        ...
        {
            var_0 _meth_827E( "mp_grind_token_banked_large", var_0 );
            _id_CBE7( var_0, level._id_9D21, var_1 );
            var_2 = _id_07E1::_id_6CEE( "tag_score" );
            var_2 = var_2 * level._id_9D21;

            if ( !var_0 scripts\mp\tac_ops\hostage_utility::_id_0BF6( "specialty_killstreak_to_scorestreak" ) )
                var_0 _id_0A28::_id_6FD8( "capture", level._id_9D20 );
        ...
        {
            var_0 _meth_827E( "mp_grind_token_banked", var_0 );
...
_id_CBE7( var_0, var_1, var_2 )
{
    ...
    _id_07AE::_id_6FE4( var_0._id_045B, var_1, 0 );
...
_id_10865()
{
    ...
    wait( level._id_21A8 );
    self._id_4A67 = 0;
    self._id_0383 _meth_8373( "flag", "idle" );
    _id_07AD::_id_15B7( "any" );
...
_id_D8BA()
{
    _id_07AC::_id_D8DA( "waypoint_bank_a", 0, "neutral", "MP_INGAME_ONLY/OBJ_BANK_CAPS", "icon_waypoint_dom_a", 0 );
    _id_07AC::_id_D8DA( "waypoint_bank_b", 0, "neutral", "MP_INGAME_ONLY/OBJ_BANK_CAPS", "icon_waypoint_dom_b", 0 );
    _id_07AC::_id_D8DA( "waypoint_scoring_foe_a", 2, "enemy", "MP_INGAME_ONLY/OBJ_SCORING_CAPS", "icon_waypoint_dom_a", 1 );
    _id_07AC::_id_D8DA( "waypoint_scoring_foe_b", 2, "enemy", "MP_INGAME_ONLY/OBJ_SCORING_CAPS", "icon_waypoint_dom_b", 1 );
    _id_07AC::_id_D8DA( "waypoint_scoring_friend_a", 2, "friendly", "MP_INGAME_ONLY/OBJ_SCORING_CAPS", "icon_waypoint_dom_a", 1 );
    _id_07AC::_id_D8DA( "waypoint_scoring_friend_b", 2, "friendly", "MP_INGAME_ONLY/OBJ_SCORING_CAPS", "icon_waypoint_dom_b", 1 );
    _id_07AC::_id_D8DA( "waypoint_contested_a", 0, "contest", "MP_INGAME_ONLY/OBJ_CONTESTED_CAPS", "icon_waypoint_dom_a", 1 );
    _id_07AC::_id_D8DA( "waypoint_contested_b", 0, "contest", "MP_INGAME_ONLY/OBJ_CONTESTED_CAPS", "icon_waypoint_dom_b", 1 );
}
...
_id_B167()
{
    ...
    for (;;)
    {
        if ( getdvar( "scr_devPlaceDomFlag", "" ) != "" )
        {
            ...
            var_6 = var_1._id_02EA + ( 0, 0, 32 );
            var_7 = var_1._id_02EA + ( 0, 0, -32 );
            var_8 = _id_077A::_id_C042( var_6, var_7, undefined, _id_077A::_id_3ED4( 1 ) );
            var_1._id_02EA = var_8["position"];
            var_1._id_FB2C = _func_025B( var_8["normal"] );
            var_1._id_01C1 = anglestoforward( var_1._id_FB2C );
            var_1._id_034F = anglestoright( var_1._id_FB2C );
            var_9[0] = _func_0205( "script_model", var_1._id_02EA );
            var_9[0]._id_0054 = var_1._id_0054;
            var_10 = _func_0205( "trigger_radius", var_1._id_02EA, 0, 90, 128 );
            ...
            var_6 = var_11._id_1042E[0]._id_02EA + ( 0, 0, 32 );
            var_7 = var_11._id_1042E[0]._id_02EA + ( 0, 0, -32 );
            var_12 = _id_077A::_id_3EC3( 1, 1, 1, 1, 0, 1, 1 );
            var_13 = [];
            var_8 = _id_077A::_id_C042( var_6, var_7, var_13, var_12 );
            var_11._id_228F = var_8["position"];
            var_14 = _func_025B( var_8["normal"] );
            var_14 = -1 * var_14;
