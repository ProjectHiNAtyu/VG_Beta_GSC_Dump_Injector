...
_id_9965()
{
    ...
    {
        _id_0A69::_id_C29C( "to_hstg", 0, 0, 9 );
        _id_0A69::registersharedfunc( "to_hstg", 10 );
        _id_0A69::_id_C29F( "to_hstg", 85 );
        _id_0A69::_id_C29B( "to_hstg", 1 );
        _id_0A69::_id_C2C2( "to_hstg", 1 );
        _id_0A69::_id_C270( "to_hstg", 0 );
        _id_0A69::_id_C24F( "to_hstg", 0 );
        _id_0A69::_id_C242( "to_hstg", 0 );
    }
...
_id_AB9A()
{
    ...
    _id_D5A0();
    _id_0A4A::_id_7A85();
    _func_01D0( "#x379b22518a5fe8a76", 0.75 );
    level._id_110E1 = 120;
    level._id_7A82 = [];
    level._id_7A70 = [];
    level._id_44B4 = 1;
    ...
    level._id_7A71 = [];
    level._id_7A71[0] = _id_077B::_id_6D7C( "hostage_waypoint_1", "targetname" );
    level._id_7A71[1] = _id_077B::_id_6D7C( "hostage_waypoint_2", "targetname" );
    level._id_7A71[2] = _id_077B::_id_6D7C( "hostage_waypoint_3", "targetname" );
    thread _id_3FD5();
    level._id_7A77 = [];
...
_id_4051()
{
    var_0 = _id_077B::_id_6D7C( "hostage_extract_zone_A", "targetname" );
    var_1 = _id_077B::_id_6D7C( "hostage_extract_zone_B", "targetname" );
    level._id_5BCC = _id_077B::_id_1B72( var_0, var_1 );
    level._id_A8D5 = [];
}
...
_id_52E5( var_0 )
{
    ...
    foreach ( var_2 in level._id_7A7B )
    {
        ...
        if ( isdefined( var_2._id_FE8E ) )
            var_2._id_FE8E _meth_809A();

        var_2._id_25A4 _meth_809A();
        var_2._id_75BF _meth_809A();
        var_2 _meth_809A();
    }
...
_id_ABA0( var_0 )
{
    if ( isdefined( var_0._id_7A6E ) )
        _id_0A4A::_id_5012( var_0, var_0._id_7A6E, var_0._id_02EA );
}
...
_id_7A72()
{
    for ( var_0 = 0; var_0 < level._id_0F16.size; var_0++ )
    {
        ...
        if ( distancesquared( self._id_02EA, var_1._id_02EA ) < 14400 )
        {
            iprintlnbold( "OPFOR EXTRACTED A HOSTAGE" );
            _id_0A4A::_id_CBF9( var_1._id_045B, 3 );
            return 1;
        }
    }
...
_id_99E3( var_0, var_1 )
{
    ...
    var_0 scripts\mp\gametypes\obj_grindzone::_id_FC61( var_0._id_045B, 0 );

    if ( isdefined( var_0._id_045B ) )
        _id_FD22( var_0._id_045B, 0 );

    level notify( "zone_moved" );
    _id_0A79::_id_B8DE( "mp_killstreak_radar" );
    var_2 = _func_0207( level._id_0BA3["vfx_smk_signal"], var_1 );
...
_id_E2E0( var_0, var_1 )
{
    ...
    var_3 = ( 0, 0, 0 );
    var_4 = 24000;
    var_5 = _id_099B::_id_6ABC();
    var_6 = var_5._id_02EA[2];
...
_id_386E( var_0 )
{
    ...
    level._id_0F17 = _id_077B::_id_1B9C( level._id_0F17, 0 );
    level._id_0F16 = _id_077B::_id_1B9C( level._id_0F16, 0 );
}
...
_id_34F5()
{
    ...
    level._id_7A7B = _id_077B::_id_1B97( level._id_7A7B, var_0 );
    _id_F746( var_1 );
}
...
_id_D862( var_0 )
{
    ...
    {
        if ( isdefined( var_1 ) )
            var_3 _meth_82F6( "ui_hp_callout_id", var_1 );
    }
}
...
_id_7A73( var_0 )
{
    ...
    if ( var_0._id_045B == "allies" )
    {
        if ( isdefined( var_0._id_7A6E ) )
        {
            var_1 = _id_0A4A::_id_5012( var_0, var_0._id_7A6E, var_0._id_02EA );
            var_1._id_F3FB _id_07AD::_id_4778();
            var_1 _meth_8225();
            var_1._id_FE8E _meth_8415();
            var_1._id_FE8E _meth_8225();
        }

        var_0 thread _id_F739( var_0._id_02EA, undefined, 0 );
        ...
        if ( _id_0A7C::_id_6DAC( "allies", "teamCount" ) )
        {
            level._id_F345 = _id_077B::_id_1BAE( _id_0A7C::_id_6DAC( "allies", "players" ), ::_id_3AD2 );
            var_3 = level._id_F345[0] _id_E2E0( self, 0 );
            var_4 = _id_0A7C::_id_6DAC( "axis", "players" );
            var_5 = var_4.size;
            var_5 = _func_0147( var_5, 1 );
            var_6 = 1666.67;
            var_3._id_01FF = int( var_5 * var_6 );
            var_3._id_027F = var_3._id_01FF;
            level._id_A8D5[0] thread _id_3D29();
            var_3 thread _id_3D2A();
            _func_01E4( "ui_tacops_helo_health_percent", 1.0 );
            thread _id_79B5();
        }
    }
}
...
_id_3D2A()
{
    ...
    for (;;)
    {
        ...
        _func_01E4( "ui_tacops_helo_health_percent", self._id_01FF / self._id_027F );
    }
}
