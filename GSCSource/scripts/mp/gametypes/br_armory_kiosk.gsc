...
_id_0C08()
{
    if ( getdvar( "scr_br_gametype", "" ) == "dmz" )
        _func_01D0( "br_kiosk_ignored_tab_nums", "2,5" );
    else
        _func_01D0( "br_kiosk_ignored_tab_nums", "3,4,5" );
}
...
_id_0C0B()
{
    ...
    level._id_29EA._id_CAFD = _func_021A( var_1, "," );
    var_2 = 20;
    ...
    if ( var_0 != level._id_29EA._id_CAFC )
        _func_01D0( "br_kiosk_sales_discount", level._id_29EA._id_CAFC );
}
...
_id_0C63()
{
    ...
    {
        var_9 = int( _func_021E( var_0, var_8, var_1 ) );
        var_10 = _func_020F();
        var_10._id_048F = _func_021E( var_0, var_8, var_2 );
        var_10._id_C17B = _func_021E( var_0, var_8, var_3 );
        var_10._id_3D6D = int( _func_021E( var_0, var_8, var_4 ) );
        var_10._id_5B6B = int( _func_021E( var_0, var_8, var_5 ) );
        var_10._id_AFB7 = int( _func_021E( var_0, var_8, var_6 ) );
        ...
        {
            var_12 = level._id_29EA._id_CAFD.size == 0 || _id_077B::_id_1B78( level._id_29EA._id_CAFD, var_10._id_C17B );
...
_id_0DA4()
{
    ...
    _func_01D1( "scr_br_disable_kiosk_by_circle", 0 );
    ...
    for (;;)
    {
        ...
        if ( level._id_29F5._id_370B + 1 >= var_0 )
        {
            ...
            foreach ( var_2 in level._id_B758 )
            {
                ...
                var_2 thread _id_07B9::_id_DCE0( "br_kiosks_disabled" );
            }
...
_id_DC96( var_0 )
{
    ...
    if ( level._id_29EA._id_CAFD.size == 0 )
        var_1 thread _id_07B9::_id_DCE0( "br_sales_event_all" );
    else
        var_1 thread _id_07B9::_id_DCE0( "br_sales_event_selective" );
}
...
_id_AB6D()
{
    ...
    {
        var_1 _meth_8373( "br_plunder_box", "visible" );
        var_1._id_10415 = 1;
    }
}
...
_id_431E( var_0, var_1 )
{
    ...
    {
        if ( isdefined( var_4._id_10415 ) && distance2dsquared( var_4._id_02EA, var_0 ) > var_2 )
            _id_4A5D( var_4 );
    }
}
...
_id_4A5D( var_0 )
{
    var_0 _meth_8373( "br_plunder_box", "disabled" );
...
_id_1B5E( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_2 == "visible" )
    {
        var_0 _meth_8373( "br_plunder_box", "opening" );
...
_id_8DEB( var_0, var_1 )
{
    ...
    else if ( !_id_077B::_id_1B78( var_0._id_5B6C, var_1 ) )
        var_0._id_5B6C = _id_077B::_id_1B63( var_0._id_5B6C, var_1 );

    if ( !var_0 scripts\mp\gametypes\br_quest_util::_id_34DA() )
        var_0 scripts\mp\gametypes\br_quest_util::_id_4018( "ui_mp_br_mapmenu_icon_poi_plunder_box_firesale", "active", var_0._id_02EA );
...
_id_88DE( var_0, var_1 )
{
    ...
    return _id_077B::_id_1B78( var_0._id_5B6C, var_1 );
}
...
_id_8DE5( var_0, var_1 )
{
    ...
    var_0._id_5B6C = _id_077B::_id_1B96( var_0._id_5B6C, var_1 );
}

_id_6AD0()
{
    return 180.0 + _func_01B7( -10.0, 10.0 );
}
...
_id_0CA2( var_0 )
{
    ...
    var_3 = var_1 scripts\mp\tac_ops\hostage_utility::_id_0BF6( "specialty_br_cheaper_kiosk" );
    var_1 _meth_82F6( "ui_br_purchase_killstreak_response", 0 );

    if ( var_2 )
        var_1 _meth_82F6( "ui_br_open_purchase_killstreak", 2 );
    else if ( var_3 )
        var_1 _meth_82F6( "ui_br_open_purchase_killstreak", 3 );
    else
        var_1 _meth_82F6( "ui_br_open_purchase_killstreak", 1 );
...
{
    var_1 = self;
    var_1 _meth_82F6( "ui_br_purchase_killstreak_response", var_0 );
    var_1 _meth_82F6( "ui_br_open_purchase_killstreak", 0 );
...
_id_0BD6( var_0 )
{
    ...
    var_2 = var_1 scripts\engine\trace::_id_69F0( var_0 );
    var_3 = var_1 scripts\engine\trace::_id_69F3( var_0 );
    return _func_0147( 0, var_3 - var_2 );
}
...
_id_0C37( var_0 )
{
    ...
    if ( var_2 < var_3 )
        var_1 scripts\engine\trace::_id_D536( var_0, var_3 );
}

_id_0BB8( var_0 )
{
    var_1 = self;
    var_2 = var_1 scripts\engine\trace::_id_69F6( "health" );

    if ( !isdefined( var_2 ) )
        var_2 = 0;

    var_3 = var_1 scripts\engine\trace::_id_69F3( "equip_armorplate" );
    ...
    if ( var_6 > 0 )
    {
        ...
        [var_9, var_10, var_11] = scripts\mp\gametypes\br_pickups::_id_6AAE( 0, var_1._id_02EA, var_1._id_0054, var_1, var_7 );
...
_id_0D8E( var_0, var_1 )
{
    ...
    var_4 = var_2 scripts\mp\tac_ops\hostage_utility::_id_0BF6( "specialty_br_cheaper_kiosk" );
...
{
    var_0 = self;
    _id_077B::_id_10886( var_0, "death", level, "game_ended" );
...
_id_0BF2( var_0, var_1 )
{
    ...
    if ( !var_3 )
    {
        ...
        var_2 thread _id_07B9::_id_DCE0( "br_killstreak_purchased" );
    ...
    else
    {
        if ( _id_0C1C( var_0._id_C17B ) )
        {
            ...
            if ( isdefined( var_5 ) && var_5._id_EA4F == "confirm_location" )
            {
                ...
                {
                    var_2 _id_0C31( var_0._id_3D6D, var_0._id_5B6B, var_0._id_AFB7 );
                    var_2 thread _id_07B9::_id_DCE0( "br_killstreak_purchased_and_activated" );
...
_id_0BF3( var_0, var_1 )
{
    ...
    if ( var_3 )
    {
        ...
        if ( var_4 )
            var_2 thread _id_07B9::_id_DCE0( "br_item_purchased" );
...
_id_0BF4( var_0, var_1 )
{
    ...
    var_9 = _func_02C4( [ "physicscontents_water", "physicscontents_item", "physicscontents_vehicleclip" ] );
    var_10 = 300;
    var_11 = 90;
    var_12 = 300;
    var_13 = 150;
    ...
    {
        var_19 = var_8 + ( _func_01FE( var_15 ) * var_10, cos( var_15 ) * var_10, 0 );
    ...
    var_22 = 150;
    var_23 = _func_020F();
    var_23._id_02EA = var_18 + ( 0, 0, var_22 );
    var_23._id_0054 = ( 0, _func_01B9( 0, 360 ), 0 );
    var_23._id_02F2 = self;
    var_23._id_E39A = "GAME_MODE";
    var_24 = _id_09BB::_id_1028C( var_0._id_C17B, var_23 );

    if ( !isdefined( var_24 ) )
        return 0;

    var_25 = _id_09BA::_id_10193( var_24 );
    thread _id_09BA::_id_1017C( var_24, var_25, self );
    _id_09BB::_id_10286( var_24 );
    return 1;
}
...
_id_AA5E( var_0, var_1 )
{
    ...
    else if ( var_0 == "br_item_purchase" )
    {
        ...
        if ( var_8 )
        {
            ...
            else if ( var_7._id_048F == "fieldupgrade" )
            {
                ...
                var_2 thread _id_07B9::_id_DCE0( "br_field_upgrade_purchased" );
                ...
                if ( level._id_15B0 )
                    var_2 _id_07F2::_id_6FDC( var_2 _id_07F2::_id_6D85() );
            }
    ...
    else if ( var_0 == "br_loadout_purchase" )
    {
        ...
        var_11 = var_2 scripts\mp\tac_ops\hostage_utility::_id_0BF6( "specialty_br_cheaper_kiosk" );
        var_12 = 0;
        var_13 = var_1;
        ...
        var_2._id_0309["class"] = var_18;
        var_2._id_37D9 = var_18;
        var_19 = var_2 scripts\cp_mp\hostmigration::_id_BB8A( var_18 );
        scripts\mp\gametypes\br::_id_2A29( var_2, var_5 );
        var_2 _id_0C31( var_14, var_15, var_16 );
        var_2 thread _id_07B9::_id_DCE0( "br_loadout_purchased" );
    ...
    else if ( var_0 == "br_team_revive" )
    {
        ...
        var_23 = undefined;
        var_24 = _id_0A7C::_id_6DAC( var_2._id_045B, "players" );
        ...
        level thread scripts\mp\gametypes\br_quest_util::_id_FF1F( var_3._id_02EA, "revive" );
        var_2 thread _id_07B9::_id_DCE0( "br_squadmate_revived" );
    }
}
...
_id_0C31( var_0, var_1, var_2 )
{
    ...
    var_5 = var_3 scripts\mp\tac_ops\hostage_utility::_id_0BF6( "specialty_br_cheaper_kiosk" );
