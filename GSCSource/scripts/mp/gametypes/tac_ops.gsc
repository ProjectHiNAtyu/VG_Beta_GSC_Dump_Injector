...
_id_0271()
{
    ...
    {
        _id_0A69::_id_C29C( "tac_ops", 0, 0, 9 );
        _id_0A69::registersharedfunc( "tac_ops", 3 );
        _id_0A69::_id_C29F( "tac_ops", 0 );
        _id_0A69::_id_C29B( "tac_ops", 1 );
        _id_0A69::_id_C2C2( "tac_ops", 1 );
        _id_0A69::_id_C270( "tac_ops", 0 );
        _id_0A69::_id_C24F( "tac_ops", 0 );
        _id_0A69::_id_C242( "tac_ops", 0 );
        _id_0A69::_id_D629( 2 );
    }
...
_id_EF90( var_0, var_1 )
{
    ...
    foreach ( var_3 in _id_0A7C::_id_6DAC( "axis", "players" ) )
...
_id_E361()
{
    var_0 = level._id_CB0D[0][0]._id_02EA;
    _id_0A4D::_id_4038( 5, var_0, "allies", 1 );
    var_0 = level._id_CB0D[1][0]._id_02EA;
    _id_0A4D::_id_4038( 1, var_0, "allies", 1 );
    var_0 = level._id_CB0D[2][0]._id_02EA;
    _id_0A4D::_id_4038( 3, var_0, "allies", 1 );
    var_0 = level._id_CB0D[3][0]._id_02EA;
    _id_0A4D::_id_4038( 6, var_0, "allies", 1 );
    var_0 = level._id_CB0D[4][0]._id_02EA;
    _id_0A4D::_id_4038( 2, var_0, "allies", 1 );
    var_0 = level._id_CB0D[5][0]._id_02EA;
    _id_0A4D::_id_4038( 4, var_0, "allies", 1 );
    var_0 = level._id_CB0D[6][0]._id_02EA;
    _id_0A4D::_id_4038( 1, var_0, "axis", 1 );
    var_0 = level._id_CB0D[7][0]._id_02EA;
    _id_0A4D::_id_4038( 5, var_0, "axis", 1 );
    var_0 = level._id_CB0D[8][0]._id_02EA;
    _id_0A4D::_id_4038( 10, var_0, "axis", 1 );
    var_0 = level._id_CB0D[9][0]._id_02EA;
    _id_0A4D::_id_4038( 9, var_0, "axis", 1 );
    var_0 = level._id_CB0D[10][0]._id_02EA;
    _id_0A4D::_id_4038( 6, var_0, "axis", 1 );
    var_0 = level._id_CB0D[11][0]._id_02EA;
...
_id_CA4F()
{
    ...
    switch ( level._id_ED0A )
    {
        ...
        case "TRANSFER_2A_3AA":
            ...
            wait 6;
            thread _id_07AC::_id_52D7( "none", 0 );
            return;
...
_id_C92D()
{
    foreach ( var_1 in level._id_B758 )
        var_1 thread _id_0A69::_id_D72F( 0.0 );
...
_id_AB9A()
{
    ...
    var_0 = _id_0A66::getvehicle( "winlimit" );
    var_1[0] = "dd";
    var_1[1] = "dd_bombzone";
    var_1[2] = "blocker";
    var_1[3] = "grind";
...
_id_8266()
{
    ...
    level._id_CB0D = [];
    level._id_CB0E = [];
    level._id_CB0D[0] = _id_077B::_id_6D7C( "tac_advantage_a", "targetname" );
    level._id_CB0E[0] = var_0;
    level._id_CB0D[1] = _id_077B::_id_6D7C( "tac_advantage_b", "targetname" );
    level._id_CB0E[1] = var_0;
    level._id_CB0D[2] = _id_077B::_id_6D7C( "tac_advantage_c", "targetname" );
    level._id_CB0E[2] = var_1;
    level._id_CB0D[3] = _id_077B::_id_6D7C( "tac_advantage_d", "targetname" );
    level._id_CB0E[3] = var_1;
    level._id_CB0D[4] = _id_077B::_id_6D7C( "tac_advantage_e", "targetname" );
    level._id_CB0E[4] = var_0;
    level._id_CB0D[5] = _id_077B::_id_6D7C( "tac_advantage_f", "targetname" );
    level._id_CB0E[5] = var_1;
    level._id_CB0D[6] = _id_077B::_id_6D7C( "tac_advantage_h", "targetname" );
    level._id_CB0E[6] = var_1;
    level._id_CB0D[7] = _id_077B::_id_6D7C( "tac_advantage_i", "targetname" );
    level._id_CB0E[7] = var_0;
    level._id_CB0D[8] = _id_077B::_id_6D7C( "tac_advantage_j", "targetname" );
    level._id_CB0E[8] = var_1;
    level._id_CB0D[9] = _id_077B::_id_6D7C( "tac_advantage_k", "targetname" );
    level._id_CB0E[9] = var_1;
    level._id_CB0D[10] = _id_077B::_id_6D7C( "tac_advantage_l", "targetname" );
    level._id_CB0E[10] = var_1;
    level._id_CB0D[11] = _id_077B::_id_6D7C( "tac_advantage_m", "targetname" );
...
_id_AB46( var_0 )
{
    var_0 _meth_82F6( "ui_hp_callout_id", 2 );
    var_0._id_89FD = 0;
    _func_01E4( "ui_tac_ops_submode", level._id_41B1 );
...
_id_6D8F()
{
    if ( !isdefined( level._id_2303 ) )
        level._id_2303 = _id_0A66::getvehicle( "timelimit" ) * 60 * 1000;
...
_id_6D8E()
{
    return level._id_2303 - _id_0A66::getvehicle( "timelimit" ) * 60 * 1000 + level._id_AF64;
}
