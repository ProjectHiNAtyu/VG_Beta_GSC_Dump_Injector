...
_id_021D()
{
    level._id_0BA3["poi_sat_truck_available"] = _func_0139( "vfx/iw8_br/gameplay/vfx_br_poi_satnav_white.vfx" );
    level._id_0BA3["poi_sat_truck_charging"] = _func_0139( "vfx/iw8_br/gameplay/vfx_br_poi_satnav_red.vfx" );
    level._id_2A8B = [];
    ...
    scripts\mp\gametypes\br_functional_poi::_id_C2AD( "satellite_truck", 2, ::_id_0C51, undefined, ::_magicbullet );
...
_id_E362( var_0 )
{
    ...
    var_1 setmode( "veh8_mil_lnd_mkilo23_skud_static2" );
    ...
    if ( !isdefined( var_1._id_CB1F ) )
    {
        ...
        var_3 setmode( "electrical_elevator_access_keypad_01" );
        var_3 _meth_8305( "HINT_NOICON" );
        var_3 setuserange( "duration_medium" );
        var_3 setusefov( 120 );
        var_3 _meth_84D4( 120 );
        var_3 _meth_84CE( 80 );
        var_3 _meth_83A0( -1 );
...
_id_0CAB()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_4 in var_0._id_B7AA )
        {
            if ( isdefined( var_0._id_B7E1 ) && var_4._id_045B == var_0._id_B7E1 && var_0._id_41D5 == 3 )
                continue;
    ...
    for (;;)
    {
        ...
        switch ( var_3 )
        {
            ...
            case 0:
                break;
            case 1:
                var_1 _meth_827B( "truck_sattruck_initialstartup_os" );
                wait 7.5;
                var_1 playlocalsound( "truck_sattruck_idling_lp" );
                break;
            case 2:
                break;
            case 3:
                var_0._id_89FA = 1;
                var_2 _meth_827B( "truck_sattruck_initdeploy_os" );
                wait 4.0;
                var_2 playlocalsound( "truck_sattruck_scanning_lp" );
                break;
            case 4:
                var_1 _meth_827B( "truck_sattruck_engineoff" );

                if ( istrue( var_0._id_89FA ) )
                {
                    var_2 _meth_827B( "truck_sattruck_scanning_off" );
...
_id_0CA9()
{
    var_0 = self;
    var_0 endon( "death" );
    level thread scripts\mp\gametypes\br::_id_EFAA( "br_satellite_truck_active", var_0._id_030F, var_0._id_B7E1 );
    var_1 = 0;
    ...
    {
        _func_02D7( self._id_02EA, var_0._id_B7E1, 5000, var_2 );
        var_1++;
        wait( var_3 );
    }
...
_id_0C54( var_0 )
{
    ...
    var_0._id_CB1F _meth_832B( &"MP/BR_ACTIVATE_SATELLITE_TRUCK" );
    var_0 thread _id_0CAD();
    var_2 = _id_077B::_id_6A40( "poi_sat_truck_available" );
...
_id_0C58( var_0 )
{
    ...
    var_0 _id_0CAA();
    var_0._id_CB1F _meth_8225();
    var_1 = _id_077B::_id_6A40( "poi_sat_truck_available" );
...
_id_0C52( var_0 )
{
    ...
    var_2 = _id_077B::_id_6A40( "poi_sat_truck_charging" );
    _func_0197( var_2, var_0, "tag_origin" );
}

_id_0C57( var_0 )
{
    var_1 = _id_077B::_id_6A40( "poi_sat_truck_charging" );
    _func_0218( var_1, var_0, "tag_origin" );
}
...
_id_0C51( var_0 )
{
    ...
    var_0._id_CB1F _meth_81B0( var_1 );
    var_0._id_CB1F makeunusable();
    var_0._id_CB1F _meth_832B( &"MP/BR_USE_SATELLITE_TRUCK" );
    var_0 thread _id_0CAD();
}
