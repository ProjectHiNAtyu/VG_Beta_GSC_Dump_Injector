...
_id_81CB()
{
    ...
    _id_0A69::_id_C29C( "lava", 0, 0, 9 );
    _func_01D2( "scr_lava_roundlimit", 1 );
    _id_0A69::_id_C29B( "lava", 1 );
    _func_01D2( "scr_lava_winlimit", 1 );
    _id_0A69::_id_C2C2( "lava", 1 );
    _func_01D2( "scr_lava_halftime", 0 );
    _id_0A69::_id_C24F( "lava", 0 );
...
_id_AB9A()
{
    ...
    {
        _id_0A69::_id_D610( var_3, &"OBJECTIVES/LAVA" );

        if ( level._id_E427 )
            _id_0A69::_id_D60E( var_3, &"OBJECTIVES/LAVA" );
        else
            _id_0A69::_id_D60E( var_3, &"OBJECTIVES/LAVA_SCORE" );

        _id_0A69::_id_D609( var_3, &"OBJECTIVES/LAVA_HINT" );
    }
...
_id_ABA0( var_0 )
{
    var_1 = _id_07E1::_id_6CEE( "score_increment" );
    level _id_07AE::_id_6FE4( _id_0A69::_id_6BC3( var_0._id_0309["team"] )[0], var_1, 0 );
}
...
_id_10BE1()
{
    ...
    for (;;)
    {
        ...
        {
            if ( self _meth_81D7() & !self _meth_8497() )
            {
                self _meth_80B7( 8.0, self._id_02EA, self, undefined, "MOD_SUICIDE" );
                wait 1.0;
            }
        }
