...
_id_AB9A()
{
    ...
    {
        _id_0A69::_id_D610( var_3, &"OBJECTIVES/FRONT" );

        if ( level._id_E427 )
            _id_0A69::_id_D60E( var_3, &"OBJECTIVES/FRONT" );
        else
            _id_0A69::_id_D60E( var_3, &"OBJECTIVES/FRONT_SCORE" );

        _id_0A69::_id_D609( var_3, &"OBJECTIVES/FRONT_HINT" );
    }
...
_id_AB2C( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_7 = game["teamScores"][var_1._id_0309["team"]] + var_6;
    var_8 = var_7 >= level._id_C93B;

    if ( var_8 && level._id_C93B != 0 )
        var_6 = level._id_C93B - game["teamScores"][var_1._id_0309["team"]];

    if ( var_6 > 0 )
    {
        _id_07AE::_id_6FE4( var_1._id_0309["team"], var_6, 0 );
...
_id_53E6()
{
    ...
    if ( isdefined( self._id_2299 ) )
        _id_0A72::_id_ACB7( self._id_2299, self );

    self._id_2299 = _id_0A72::_id_ACBF( self, _id_0A69::_id_6BC3( self._id_045B )[0], "outline_nodepth_orange", "perk" );

    if ( !_func_0107( self ) )
        _id_0A72::_id_0C05( "outline_nodepth_orange", 0 );
...
_id_D842()
{
    ...
    if ( game["switchedsides"] )
    {
        ...
        {
            var_3 = _func_0205( "trigger_radius", ( -1410, -2080, 240 ), 0, 1000, 600 );
            level._id_1FC9[level._id_1FC9.size] = var_3;
        }

        foreach ( var_1 in level._id_1FC9 )
        {
            var_1._id_045B = "allies";
            var_1 thread _id_5F83();
            var_1 thread _id_53EA();
            var_1 thread _id_53E7();
        }
...
_id_D8B5( var_0 )
{
    ...
    {
        var_2 = getentarray( var_0._id_0457, "targetname" );

        for ( var_3 = 0; var_3 < var_2.size; var_3++ )
            var_1[var_1.size] = var_2[var_3];
    }

    var_1 = _id_9AA9( var_1, var_0._id_0457 );
    var_0._id_1042E = var_1;
}

_id_9AA9( var_0, var_1 )
{
    if ( level._id_9AA7 == "mp_parkour" && var_1 == "front_vis_axis" )
    {
        var_2 = _func_0205( "script_origin", ( -1088, -1504, 136 ) );
        var_2._id_0054 = ( 0, 180, 0 );
        var_2._id_045A = var_1;
        var_0[var_0.size] = var_2;
        var_3 = _func_0205( "script_origin", ( -1088, -1440, 136 ) );
        var_3._id_0054 = ( 0, 180, 0 );
        var_2._id_045A = var_1;
...
_id_53EA()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0._id_045B ) && var_0._id_045B == self._id_045B )
            continue;

        if ( isai( var_0 ) && isdefined( var_0._id_0392 ) && var_0._id_0392 != "spectator" || _id_B670( var_0 ) )
        {
            var_0._id_7DEB = 1;
...
_id_522C()
{
    ...
    self._id_ACD2 = _id_0A72::_id_ACBF( self, _id_0A69::_id_6BC3( self._id_045B )[0], "outline_nodepth_orange", "perk" );
...
_id_4A8E()
{
    ...
    if ( !_func_0107( self ) && _func_0117( self ) )
        _id_0A72::_id_0C04();
}
...
_id_745E( var_0 )
{
    if ( var_0._id_02F2._id_045B == self._id_045B )
        return;

    if ( var_0 _meth_81EF( self ) )
    {
        if ( !isdefined( var_0._id_ACD2 ) )
            var_0._id_ACD2 = _id_0A72::_id_ACBF( var_0, self._id_045B, "outline_nodepth_orange", "lowest" );
    }
...
_id_DCAB( var_0, var_1 )
{
    for ( var_2 = 0; var_2 < var_0.size; var_2++ )
        var_0[var_2] _meth_83CA( var_1 );
}

_id_78E1( var_0, var_1 )
{
    for ( var_2 = 0; var_2 < var_0.size; var_2++ )
        var_0[var_2] _meth_847B( var_1 );
}
...
_id_E2EE()
{
    ...
    {
        var_1 = anglestoforward( self._id_1042E[var_0]._id_0054 );
        self._id_0B3B[self._id_0B3B.size] = _func_0207( level._id_2292["friendly"], self._id_1042E[var_0]._id_02EA, var_1 );
        self._id_0B3B[self._id_0B3B.size - 1] _meth_8321();
        _func_024B( self._id_0B3B[self._id_0B3B.size - 1] );
    }

    for ( var_0 = 1; var_0 < self._id_1042E.size; var_0++ )
    {
        var_1 = anglestoforward( self._id_1042E[var_0]._id_0054 );
        self._id_0B3A[self._id_0B3A.size] = _func_0207( level._id_2292["enemy"], self._id_1042E[var_0]._id_02EA, var_1 );
        self._id_0B3A[self._id_0B3A.size - 1] _meth_8321();
        _func_024B( self._id_0B3A[self._id_0B3A.size - 1] );
    }
}

_id_227F()
{
    level._id_2292["friendly"] = _func_0139( "vfx/core/mp/core/vfx_front_border_cyan.vfx" );
    level._id_2292["enemy"] = _func_0139( "vfx/core/mp/core/vfx_front_border_orng.vfx" );
}
