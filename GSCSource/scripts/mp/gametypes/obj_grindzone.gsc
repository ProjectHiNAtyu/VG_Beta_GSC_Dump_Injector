...
{
    var_3 = _func_0205( "trigger_radius", var_0._id_02EA, 0, 90, 128 );
    var_3._id_CD8C = var_0._id_CD8C;
    var_0 = var_3;
    var_4[0] = _func_0205( "script_model", var_0._id_02EA );
    var_4[0]._id_0054 = var_0._id_0054;
    ...
    if ( !istrue( var_2 ) )
    {
        ...
        var_8 _id_077B::_id_46C3( 1.0, ::_id_D5FB );
    }
...
_id_D608()
{
    ...
    self._id_0383 = _id_D8A2( self._id_1042E[0]._id_02EA, self );
}
...
_id_D8A2( var_0, var_1 )
{
    var_2 = var_0 + ( 0, 0, 32 );
    var_3 = var_0 + ( 0, 0, -32 );
    var_4 = _id_077A::_id_3EC3( 1, 1, 1, 1, 0, 1, 1 );
    var_5 = [];
    var_6 = _id_077A::_id_C042( var_2, var_3, var_5, var_4 );
    var_1._id_228F = var_6["position"];
    var_7 = _func_025B( var_6["normal"] );
    var_1._id_228E = anglestoforward( var_7 );
    var_1._id_228F = _id_5BDD( var_1 );
    var_8 = _func_0205( "script_model", var_1._id_228F );
    var_8 setmode( "grind_flag_scriptable" );
    var_8._id_0054 = _func_0305( var_1._id_228E, var_8._id_0054 );
    return var_8;
}
...
{
    self._id_0383 _meth_8373( "flag", var_0 );

    if ( !istrue( var_1 ) )
        self._id_0383 _meth_8373( "pulse", "off" );
}

_id_FC60( var_0 )
{
    self._id_0383 _meth_8373( "pulse", var_0 );
}
