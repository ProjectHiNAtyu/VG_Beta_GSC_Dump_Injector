...
_id_021D()
{
    _func_01D1( "scr_br_ai_encounters", 0 );

    if ( !getdvarint( "scr_br_ai_encounters", 0 ) )
        return;

    _func_01D1( "scr_ai_encounters_dom_use_time", 30 );
    var_0 = _func_020F();
    var_0 _id_7F54();
    var_0 _id_7FC5();
...
{
    var_2 = _func_020F();
    var_2._id_02BA = var_0;
    var_2._id_7E83 = self;
    var_2._id_AE47 = var_1;
    var_2.enableoobimmunity = [];
    var_2._id_E68D = [];
    var_2._id_96C7 = [];
    self._id_1468[var_0] = var_2;

    if ( isdefined( var_1 ) )
        var_1.enableoobimmunity[var_1.enableoobimmunity.size] = var_2;
    else
        self.enableoobimmunity[self.enableoobimmunity.size] = var_2;
...
_id_7FC5()
{
    self._id_14F2 = [];
    self._id_0F24 = [];
    var_0 = _id_077B::_id_6D7C( "ai_encounters", "targetname" );
...
_id_7FC4( var_0 )
{
    var_0._id_02BA = var_0._id_0375;
    var_1 = self._id_1468[var_0._id_02BA];
...
_id_5257()
{
    ...
    {
        self._id_FF5F = [];
        _id_FB48( self.enableoobimmunity );

        if ( self._id_FF5F.size )
        {
            var_0 = _id_077B::_id_BFC7( self._id_FF5F );
            _id_525A( var_0 );
        }
...
_id_FB48( var_0 )
{
    foreach ( var_2 in var_0 )
    {
        ...
        _id_FB48( var_2.enableoobimmunity );
...
_id_5255( var_0, var_1 )
{
    ...
    var_2._id_0F24 = _id_077B::_id_1B96( var_2._id_0F24, self );
    var_2._id_8FAE = self;
...
{
    var_1 = var_0 * var_0;
    var_2 = _func_01FF( level._id_B758, self._id_02EA );
...
_id_3B42()
{
    ...
    var_2 = distance2dsquared( self._id_02EA, var_0 );
...
_id_EF02( var_0 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        {
            var_2 = _id_077B::_id_BFC7( var_0._id_706E );
            var_1 _meth_8323( var_2 );
        }

        if ( isdefined( var_0._id_7074 ) )
        {
            var_3 = _id_077B::_id_BFC7( var_0._id_7074 );
...
_id_EF03( var_0 )
{
    var_0._id_045B = scripts\mp\gametypes\br_ai_encounters_util::_id_62F4();
...
_id_EEFF( var_0 )
{
    ...
    _id_07D0::_id_A854( var_1, "current", var_0._id_02EA, "icon_waypoint_objective_general", "icon_regular" );
    _func_0173( var_1, 1 );
    _func_016D( var_1, 1 );
...
_id_EF01( var_0 )
{
    ...
    var_2 = _func_02AA( var_1._id_02EA, ( 30, 15, 10 ), var_1._id_0054 );
...
_id_C806( var_0, var_1 )
{
    ...
    switch ( var_2 )
    {
        case "brloot_killstreak_clusterstrike":
            var_3 = scripts\mp\gametypes\br_pickups::_id_E333( var_2, var_0._id_02EA + ( 0, 0, 0.1 ), var_0._id_0054, 0, 1 );
            break;
        default:
    }
...
_id_C7FF( var_0, var_1, var_2 )
{
    ...
    var_3 = _func_0205( "script_model", var_0._id_02EA + ( 0, 0, 30 ) );
    var_3 setmode( "tag_origin" );
    var_3 makeunusable();
    var_3 _meth_832B( "MP/DOOR_USE_LOCK" );
    var_3 setuserange( "duration_long" );
    var_3 _meth_84D4( 15 );
    var_3 _meth_8305( "HINT_BUTTON" );

    foreach ( var_5 in var_1 )
        var_3 disableoffhandweapons( var_5 );
...
_id_401C( var_0, var_1 )
{
    ...
    if ( var_2 >= 0 )
    {
        _id_07D0::_id_A854( var_2, "current", var_0._id_02EA + ( 0, 0, 50 ), var_1, "icon_regular" );
        _func_0173( var_2, 1 );
...
_id_E0A9( var_0 )
{
    var_1 = _id_07CE::_id_E326( var_0._id_13C9, var_0._id_045B, var_0._id_02EA, var_0._id_0054 );
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        var_1._id_024B = 0;
        var_1._id_0146 = 0;
        var_1._id_0309["cur_kill_streak"] = 0;
        var_1._id_0309["cur_death_streak"] = 0;
        var_1._id_0309["cur_kill_streak_for_nuke"] = 0;
        var_1._id_F339 = [];
        var_1._id_8D65 = [];
        var_1._id_723F = var_1 _id_0A74::_id_6E04();
...
_id_10A23( var_0 )
{
    ...
    self._id_11F2 = _id_077B::_id_1B96( self._id_11F2, var_0 );
    self._id_11F3++;
...
_id_C906()
{
    ...
    for (;;)
    {
        ...
        for ( var_7 = 0; var_7 < level._id_B758.size; var_7++ )
        {
            var_8 = level._id_B758[var_7];
            ...
            var_9 = distance2dsquared( var_8._id_02EA, self._id_02EA );
...
_id_219A()
{
    ...
    level._id_10C5F = [];
    var_2 = _id_077B::_id_6D7C( "enemy_wave_01", "targetname" );
    ...
    foreach ( var_4 in var_2 )
    {
        ...
        level._id_10C5F = _id_077B::_id_1B63( level._id_10C5F, var_5 );
    }
    ...
    var_9 = [];
    var_10 = _id_077B::_id_6D7C( "enemy_wave_02", "targetname" );

    foreach ( var_12 in var_10 )
    {
        var_5 = _id_EF02( var_12 );
        var_5 _meth_8327( var_8 );
        var_9 = _id_077B::_id_1B63( var_9, var_5 );
    }

    foreach ( var_15 in level._id_10C5F )
    {
        if ( isdefined( var_15 ) && isai( var_15 ) )
        {
            var_15 _meth_8327( var_8 );
            var_9 = _id_077B::_id_1B63( var_9, var_15 );
        }
    }
    ...
    var_18 = [];
    var_19 = _id_077B::_id_6D7A( "enemy_wave_03_boss", "targetname" );
    var_20 = _id_EF02( var_19 );
    var_20 thread _id_8BC4();
    var_18 = _id_077B::_id_1B63( var_18, var_20 );
...
_id_FFCE( var_0 )
{
    if ( istrue( var_0._id_021D ) )
    {
        var_0._id_0054 = var_0._id_E5A4;
        return;
    }

    var_1 = getent( "vault_door_clip", "targetname" );
    var_1 _meth_820B( var_0 );
    var_0._id_E5A4 = var_0._id_0054;
    var_0._id_021D = 1;
}
...
_id_8BC4()
{
    var_0 = _func_01FF( level._id_B758, self._id_02EA );
...
_id_13F0()
{
    ...
    foreach ( var_2 in var_0 )
        var_2 playlocalsound( "emt_alarm_bank_bell_lp" );
}
...
_id_13EE()
{
    ...
    foreach ( var_2 in var_0 )
        var_2 stoplookat( "emt_alarm_bank_bell_lp" );
}
...
_id_FFD0()
{
    ...
    foreach ( var_2 in level._id_B758 )
    {
        ...
        {
            if ( distancesquared( var_2._id_02EA, self._id_02EA ) <= var_0 )
                var_2 _meth_827B( "cp_bank_vault_open" );
        }
    }
}
...
_id_138F()
{
    ...
    var_4 = _func_0143( var_3, _id_077B::_id_6D7A( "airport_smoke_toss_pos", "targetname" )._id_02EA, anglestoforward( _id_077B::_id_6D7A( "airport_smoke_toss_pos", "targetname" )._id_0054 ) * 400, 1 );
    wait 0.1;
    var_5 = _func_0143( var_3, _id_077B::_id_6D7A( "airport_smoke_toss_pos_02", "targetname" )._id_02EA, anglestoforward( _id_077B::_id_6D7A( "airport_smoke_toss_pos_02", "targetname" )._id_0054 ) * 400, 1.3 );
    var_6 = _func_0143( var_3, _id_077B::_id_6D7A( "airport_smoke_toss_pos_03", "targetname" )._id_02EA, anglestoforward( _id_077B::_id_6D7A( "airport_smoke_toss_pos_03", "targetname" )._id_0054 ) * 450, 2 );
    var_7 = getent( "airport_vol_01", "targetname" );
    wait 2;
    var_8 = [];
    var_9 = _id_077B::_id_6D7C( "airport_enemy_wave_01", "targetname" );
    ...
    foreach ( var_11 in var_9 )
    {
        ...
        var_8 = _id_077B::_id_1B63( var_8, var_12 );
    }
...
_id_F6B7()
{
    ...
    for (;;)
    {
        ...
        if ( isai( var_9 ) && _func_0117( var_9 ) )
            break;
    }
...
_id_F6E0( var_0 )
{
    ...
    if ( !istrue( var_0._id_021D ) )
    {
        var_0._id_1760 = _id_077B::_id_6D7A( var_0._id_0457, "targetname" );

        if ( !isdefined( var_0._id_1760._id_0054 ) )
            var_0._id_1760._id_0054 = ( 0, 0, 0 );

        var_0._id_E61E = var_0._id_02EA;
        var_0._id_E5A4 = var_0._id_0054;
        var_0._id_021D = 1;
    }
    else
    {
        var_0._id_02EA = var_0._id_E61E;
        var_0._id_0054 = var_0._id_E5A4;
    }
}
...
_id_F6E2( var_0 )
{
    ...
    foreach ( var_3 in level._id_B758 )
    {
        ...
        {
            if ( distancesquared( var_3._id_02EA, var_0._id_02EA ) <= var_1 )
                var_3 _meth_827B( "cp_bank_gate_fall" );
        }
    }
}
...
_id_3E6B()
{
    ...
    for (;;)
    {
        ...
        if ( isai( var_8 ) && _func_0117( var_8 ) )
            break;
    }
...
_id_3E6A( var_0, var_1 )
{
    ...
    _id_077B::_id_10887( var_2, "death", "damage", "enemy" );
...
_id_DE59( var_0 )
{
    ...
    {
        self._id_7CA4 _meth_8415();
        self._id_7CA4 _meth_8254( self._id_7CA4._id_02EA, ( 0, 0, -10 ) );
...
_id_1292( var_0 )
{
    ...
    {
        case "attach":
            _func_0197( level._id_6082["cigarette_unlit"], self, "tag_accessory_right" );
            break;
        case "light":
            _func_0197( level._id_6082["cigarette_lit"], self, "tag_accessory_right" );
            _func_0218( level._id_6082["cigarette_unlit"], self, "tag_accessory_right" );
            _func_0196( level._id_6082["lighter_glow"], self gettagorigin( "tag_accessory_right" ) );
            thread _id_12BD();
            break;
        case "detach":
            _func_0218( level._id_6082["cigarette_lit"], self, "tag_accessory_right" );
            _func_0218( level._id_6082["cigarette_unlit"], self, "tag_accessory_right" );
            _func_0196( level._id_6082["cigarette_lit_toss"], self gettagorigin( "tag_accessory_right" ), anglestoforward( self gettagangles( "tag_accessory_right" ) ) );
            break;
    }
}
...
_id_12BD()
{
    ...
    for (;;)
    {
        _func_0196( level._id_6082["cigarette_smoke"], self geteye() - ( 0, 0, 2 ), anglestoforward( self gettagangles( "tag_eye" ) ) );
        var_0 = _func_01B9( 5, 8 );
        wait( var_0 );
    }
}
...
_id_12BE()
{
    ...
    if ( _id_077B::_id_759F( self._id_02AE, "tag_accessory_right" ) )
    {
...
_id_C5B1( var_0 )
{
    var_0 allowcrouch( "prone", "stand", "crouch" );
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        switch ( var_4 )
        {
            case "trigger_radius":
                var_5 = 315;
                var_6 = 120;
                var_0 = _func_0205( "trigger_radius", var_3._id_02EA, 0, int( var_5 ), int( var_6 ) );
                break;
            default:
                break;
        }
...
_id_525C( var_0 )
{
    ...
    if ( isdefined( var_0._id_5C1F ) )
        var_0._id_5C1F _meth_809A();

    if ( isdefined( var_0._id_0383 ) )
        var_0._id_0383 _meth_809A();

    if ( isdefined( var_0._id_047A ) )
    {
        var_0._id_047A _meth_809A();
...
_id_4CFA( var_0 )
{
    self._id_525E _id_5255( 1, var_0._id_045B );
}
...
_id_4CFC( var_0, var_1, var_2 )
{
    switch ( var_1 )
    {
        ...
        default:
            ...
            self._id_0383 _meth_8373( var_0, var_1 );

            if ( var_0 == "pulse" )
                self._id_0383 _meth_8373( "flag", var_1 );
...
_id_EEFE( var_0 )
{
    ...
    var_1 = _func_0205( "script_model", var_0._id_02EA + ( 0, 0, 20 ) );
    var_1 setmode( "ctf_game_flag_east" );
    self._id_01E1 = var_1;
    var_1._id_5254 = self;
}
...
{
    var_1 = _func_0205( "script_model", var_0._id_02EA + ( 0, 0, 20 ) );
    var_1 setmode( "fullbody_usmc_ar" );
...
_id_5806()
{
    ...
    for (;;)
    {
        ...
        if ( !self._id_C09F )
        {
            var_0 _id_580D( self, var_0._id_045B );
            continue;
        }
...
_id_5801( var_0 )
{
    if ( distance2d( self._id_02EA, self._id_5254._id_01E1._id_02EA ) < 100 )
        return 1;
    else
        return 0;
}
...
_id_5800()
{
    ...
    self _meth_857F( 1 );
    self _meth_832B( &"MP_BR_USE_PLUNDER_CACHE" );
    self._id_C09F = 1;
}
...
_id_57FD( var_0 )
{
    ...
    self._id_5254._id_01E1 _meth_809A();
    self _meth_809A();
}
