...
_id_403A( var_0 )
{
    ...
    for ( var_1 = 0; var_1 < var_0._id_9C96; var_1++ )
    {
        ...
        var_2 setmode( var_0._id_ED68 );
        var_2 _meth_82CA( "mp_dogtag_spin" );
        var_2 hide();
        var_2 _meth_85A2();
        var_3 = _func_0205( "trigger_radius", ( 0, 0, 0 ), 0, 32, 32 );
        var_3._id_045A = "trigger_dogtag";
        var_3 hide();
        var_4 = _func_020F();
        var_4._id_048F = "useObject";
        var_4._id_411F = var_3._id_02EA;
...
_id_E388( var_0, var_1, var_2, var_3 )
{
    ...
    var_8._id_047A._id_02EA = var_4;
    var_8._id_1042E._id_02EA = var_4;
    var_8._id_ED75 = var_0;
    var_8._id_047A _meth_83C3();
...
_id_5030( var_0, var_1 )
{
    ...
    if ( _id_0A69::_id_6A43() == "pill" )
        var_0 _id_5047( var_0._id_ED71, var_1 );
    else
    {
        var_2 = _id_077B::_id_1B78( level._id_5BB5, var_0 );
        var_3 = 1;

        if ( !var_2 )
        {
            var_3 = 5;
            level._id_5BB5 = _id_077B::_id_1B63( level._id_5BB5, var_0 );
        }
...
{
    self _meth_82F6( "ui_hvt_value", 0 );
    var_2 = int( var_0 / 80 );
    var_3 = int( var_0 % 80 );
    _id_5049( 5, int( _func_0147( 0, var_2 ) ), self, var_1 );
    var_4 = int( var_3 / 40 );
    var_3 = int( var_3 % 40 );
    _id_5049( 4, int( _func_0147( 0, var_4 ) ), self, var_1 );
    var_5 = int( var_3 / 20 );
    var_3 = int( var_3 % 20 );
    _id_5049( 3, int( _func_0147( 0, var_5 ) ), self, var_1 );
    var_6 = int( var_3 / 10 );
    var_3 = int( var_3 % 10 );
    _id_5049( 2, int( _func_0147( 0, var_6 ) ), self, var_1 );
    var_7 = int( var_3 / 5 );
    var_3 = int( var_3 % 5 );
    _id_5049( 1, int( _func_0147( 0, var_7 ) ), self, var_1 );
    var_8 = int( var_3 / 1 );
    var_3 = int( var_3 % 1 );
    _id_5049( 0, int( _func_0147( 0, var_8 ) ), self, var_1 );
}
...
_id_5049( var_0, var_1, var_2, var_3 )
{
    ...
    {
        var_5 = _id_E388( var_0, var_2._id_02EA, var_2._id_045B, 1 );
        var_5._id_045B = var_2._id_045B;
        level notify( "new_tag_spawned", var_5 );
        var_5._id_103C0 = var_2;
        var_5._id_006E = var_3;
...
_id_B792( var_0 )
{
    ...
    if ( _id_0A69::_id_6A43() != "br" && _id_0A69::_id_6A43() != "pill" )
    {
        ...
        if ( var_3 < 20 )
            _func_01E4( "ui_droploot_inv_" + self getentitynumber(), var_2 );
    }
}
...
_id_A135( var_0 )
{
    ...
    for (;;)
    {
        ...
        _func_019D( var_0._id_411F, "mp_killconfirm_tags_pickup" );
...
_id_8201()
{
    var_0 = _id_077B::_id_6D7C( "loot_cache", "targetname" );
    ...
    if ( 1 )
    {
        for ( var_2 = 0; var_2 < var_1; var_2++ )
            level._id_984F[level._id_984F.size] = _id_3FEE( var_0[var_2]._id_02EA, var_0[var_2]._id_0054, -1 );
    }
    else
    {
        var_3 = var_1 * 0.4;
        ...
        {
            level._id_984F[level._id_984F.size] = _id_3FEE( var_0[var_2]._id_02EA, var_0[var_2]._id_0054, 3 );
            var_5 = var_2;
        }

        for ( var_2 = var_5 + 1; var_2 < var_1; var_2++ )
            level._id_984F[level._id_984F.size] = _id_3FEE( var_0[var_2]._id_02EA, var_0[var_2]._id_0054, 0 );
    }
}

_id_3FEE( var_0, var_1, var_2 )
{
    var_3 = _id_0980::_id_B166( var_2, var_0, var_1 );
    return var_3;
}
...
_id_3209( var_0 )
{
    ...
    var_0 _meth_8275( "ammo_crate_use" );
}

_id_6D95( var_0 )
{
    return var_0 * _func_01B7( 0.8, 1.2 );
}

_id_6A69()
{
    var_0 = _func_01B8( level._id_2A6F._id_2A9A.size );
    return level._id_2A6F._id_2A9A[var_0];
}

_id_6AAF()
{
    var_0 = _func_01B8( level._id_2A6F._id_2A9B.size );
...
_id_6897()
{
    if ( !1 )
    {
        var_0 = _func_01B8( level._id_558A._id_16A4.size );
