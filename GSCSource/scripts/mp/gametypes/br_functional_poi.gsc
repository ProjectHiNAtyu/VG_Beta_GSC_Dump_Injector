...
_id_021D()
{
    scripts\mp\gametypes\br_plunder::_id_021D();
    scripts\mp\gametypes\br_mobile_armory::_id_021D();
    scripts\mp\gametypes\br_satellite_truck::_id_021D();
    scripts\mp\gametypes\br_armory_kiosk::_id_021D();
    scripts\mp\gametypes\br_bank::_id_021D();
...
_id_0D56()
{
    ...
    if ( level._id_9F1D < level._id_9C82 )
        level._id_9C82 = _func_01B9( level._id_9F1D, level._id_9C82 + 1 );
    ...
    var_9 = _id_077B::_id_6D7C( "br_respawn_station", "targetname" );
    ...
    var_12 = _id_077B::_id_6D7C( "br_mobile_armory_location", "targetname" );
    ...
    var_15 = _id_077B::_id_6D7C( "br_satellite_truck_location", "targetname" );
...
_id_0BD9( var_0, var_1, var_2 )
{
    ...
    var_4 = int( _func_0147( 1, var_3 * getdvarfloat( "br_poi_noise", 1.0 ) ) );

    for ( var_5 = 0; var_5 < var_0.size; var_5++ )
    {
        var_6 = var_0[var_5];
        var_7 = _func_01B9( -1 * var_4, var_4 + 1 );
        var_6._id_0369 = scripts\mp\gametypes\br_circle::_id_693B( var_6._id_02EA ) + var_7;
    }

    var_8 = _id_077B::_id_1BAE( var_0, ::_id_3AD9 );
    var_9 = [];

    for ( var_5 = 0; var_5 < var_1; var_5++ )
        var_9[var_5] = var_8[var_5];

    return _id_077B::_id_1BAC( var_8, 0, var_1 );
}
...
_id_0BE0( var_0, var_1 )
{
    ...
    if ( var_0.size > 0 )
    {
        ...
        var_3 = int( _func_0148( var_1, var_0.size ) );
...
_id_DCC4( var_0, var_1, var_2, var_3 )
{
    if ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_8 ) && var_8 >= 0 )
            var_7 = int( _func_021E( var_4, var_8, var_6 ) );
        ...
        var_12 = _id_0A7C::_id_6DAC( var_0, "players" );
...
{
    level._id_B9B7[var_0][var_1] = _func_020F();
...
_id_D87E()
{
    ...
    var_0 = level._id_9A9A[0]._id_02EA[0];
    var_1 = level._id_9A9A[1]._id_02EA[0];
    var_2 = ( level._id_9A9A[0]._id_02EA[0], level._id_9A9A[0]._id_02EA[1], level._id_9A9A[0]._id_02EA[2] );
    var_3 = ( level._id_9A9A[1]._id_02EA[0], level._id_9A9A[0]._id_02EA[1], level._id_9A9A[1]._id_02EA[2] );

    if ( var_1 < var_0 )
    {
        var_2 = ( level._id_9A9A[1]._id_02EA[0], level._id_9A9A[0]._id_02EA[1], level._id_9A9A[1]._id_02EA[2] );
        var_3 = ( level._id_9A9A[0]._id_02EA[0], level._id_9A9A[0]._id_02EA[1], level._id_9A9A[0]._id_02EA[2] );
    }

    var_4 = level._id_9A9A[0]._id_02EA[1];
    var_5 = level._id_9A9A[1]._id_02EA[1];
    var_6 = ( level._id_9A9A[0]._id_02EA[0], level._id_9A9A[1]._id_02EA[1], level._id_9A9A[0]._id_02EA[2] );
    var_7 = ( level._id_9A9A[1]._id_02EA[0], level._id_9A9A[1]._id_02EA[1], level._id_9A9A[1]._id_02EA[2] );

    if ( var_5 < var_4 )
    {
        var_6 = ( level._id_9A9A[1]._id_02EA[0], level._id_9A9A[1]._id_02EA[1], level._id_9A9A[1]._id_02EA[2] );
        var_7 = ( level._id_9A9A[0]._id_02EA[0], level._id_9A9A[1]._id_02EA[1], level._id_9A9A[0]._id_02EA[2] );
    }

    var_8 = [];

    if ( level._id_9AA7 == "mp_donetsk" )
    {
    ...
    else if ( level._id_9AA7 == "mp_br_money" )
    {
    ...
    level._id_BE87 = _id_077B::_id_1B94( level._id_BE87 );
    var_15 = 33704;
    level._id_BE88 = abs( var_15 * var_15 );

    if ( level._id_1178 > 0 && level._id_9AA7 == "mp_donetsk" )
    {
        level._id_BFE9 = _func_01B9( 0, 5 );
        var_9 = level._id_3D47 / 10;
        ...
        if ( level._id_BE42 == 2 )
            level._id_ADBF = _id_077B::_id_1B94( var_21 );
        else
        {
            switch ( level._id_BFE9 )
            {
