...
_id_E46D( var_0 )
{
    if ( var_0._id_045B == self._id_045B )
    {
        ...
        scripts\mp\gametypes\br_quest_util::_id_6C77( "scavenger_locale", self._id_045B )._id_B6FE = var_1;

        if ( isdefined( self._id_EABC ) && isdefined( self._id_EABC._id_2E80 ) && var_1.size )
            self._id_EABC._id_2E80 setorigin( var_1[0] );

        if ( !scripts\mp\gametypes\br_quest_util::_id_8A81( var_0._id_045B ) )
        {
            self._id_034B = "fail";
...
_id_34DF( var_0 )
{
    if ( var_0._id_045B == self._id_EABB[0]._id_045B )
        return 1;
    else
        return 0;
}
...
_id_E464( var_0 )
{
    var_1 = scripts\mp\gametypes\br_quest_util::_id_3FEB( "scavenger_locale", "scavenger", self._id_045B );
    ...
    var_1._id_B6FE = _id_0A7C::_id_6DAC( self._id_045B, "players" );
    var_1._id_B020 = 0;
...
_id_E46B( var_0 )
{
    ...
    if ( var_1 )
    {
        self._id_EABB[0]._id_41EC = var_0._id_02EA;
        scripts\mp\gametypes\br_quest_util::_id_4B61( self._id_EABB[0]._id_045B, "br_scavenger_quest_next_location" );
        level thread scripts\mp\gametypes\br_public::_id_2BB8( "mission_obj_next_nptarget", self._id_EABB[0]._id_045B, 1 );
...
_id_D87D( var_0 )
{
    ...
    _func_03F5( var_0.health );
    _id_E363( var_0._id_02EA, var_0._id_0054, self );
    self._id_411F = var_0._id_02EA + ( 0, 0, 50 );
...
_id_EDD0( var_0 )
{
    var_1 = scripts\mp\gametypes\br_quest_util::_id_4017( "scavenger", self._id_045B, var_0.health, var_0 );
    ...
    var_1._id_E6DE = self._id_02EA;
    var_1._id_41EC = self._id_02EA;
    ...
    if ( !var_3._id_521F )
    {
        ...
        var_1._id_034B = "no_locale";
        var_1 scripts\mp\gametypes\br_quest_util::_id_C2F7( self._id_045B );
        var_4 = _func_020F();
    ...
    scripts\mp\gametypes\br_quest_util::_id_F91F( "scavenger", self._id_045B );
    var_1._id_F37C = 0;
    ...
    scripts\mp\gametypes\br_quest_util::_id_E729( "scavenger", self, self._id_045B );
    var_6 = _func_020F();
    var_6._id_56BD = [];
    var_6._id_56BD[0] = self;
    var_6._id_B96A = scripts\mp\gametypes\br_quest_util::_id_6C79( "scavenger", scripts\mp\gametypes\br_quest_util::_id_6C84( self._id_045B ) );
    scripts\mp\gametypes\br_quest_util::_id_4B61( self._id_045B, "br_scavenger_quest_start_team", var_6 );
    ...
    scripts\mp\gametypes\br_quest_util::_id_4B60( var_1._id_045B, self, 6, scripts\mp\gametypes\br_quest_util::_id_6C76( "scavenger" ) );
    level thread scripts\mp\gametypes\br_public::_id_2BB8( "mission_scav_accept", var_1._id_045B, 1 );
}
...
{
    var_1 = _func_020F();
    var_2 = scripts\mp\gametypes\br_quest_util::_id_6C84( self._id_045B );
    ...
    if ( !scripts\mp\gametypes\br_public::_id_8A9F() )
    {
        scripts\mp\gametypes\br_quest_util::_id_4B61( self._id_045B, "br_scavenger_quest_complete", var_1 );
        level thread scripts\mp\gametypes\br_public::_id_2BB8( "mission_scav_success", self._id_045B, 1, 1 );
    }
...
_id_58C0()
{
    scripts\mp\gametypes\br_quest_util::_id_4B61( self._id_045B, "br_scavenger_quest_circle_failure" );
    level thread scripts\mp\gametypes\br_public::_id_2BB8( "mission_obj_circle_fail", self._id_045B, 1 );
    self._id_034B = "fail";
    scripts\mp\gametypes\br_quest_util::_id_C501();
}
...
_id_E46C()
{
    scripts\mp\gametypes\br_quest_util::_id_4B61( self._id_045B, "br_scavenger_quest_timer_expired" );
    level thread scripts\mp\gametypes\br_public::_id_2BB8( "mission_gen_fail", self._id_045B, 1 );
}
...
_id_E363( var_0, var_1, var_2 )
{
    ...
    var_3 setmode( "military_loot_crate_01_br_scavenger_01" );
    var_3 _meth_8373( "body", "scavenger_closed" );
    var_3._id_BEA5 = var_2;
    var_2._id_2E80 = var_3;

    foreach ( var_6 in level._id_B758 )
    {
        if ( var_6 != var_4 && ( var_4._id_045B == "none" || var_6._id_045B != var_4._id_045B ) )
...
_id_CB9E( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( var_2 == "scavenger_closed" && isdefined( var_0._id_0186 ) )
    {
        ...
        if ( var_3._id_045B != var_6._id_045B )
        {
            var_3 iprintlnbold( "Chest Requires a Scavenger Mission" );
            return;
        }

        var_0 _meth_8373( "body", "scavenger_opening" );
        var_7 = getdvarint( "scr_br_scavenger_cacheDeleteDelay", 30 );
        var_0._id_0186 _id_077B::_id_4687( var_7, ::_meth_809A );
        var_6 scripts\mp\gametypes\br_quest_util::_id_C23C( var_3 );

        switch ( var_0._id_0186._id_BEA5._id_B020 )
        {
            case 0:
                scripts\mp\gametypes\br_quest_util::_id_6FBB( "scavenger_1", var_3._id_045B, var_0._id_02EA, var_0._id_0054, var_6._id_C805 );
                break;
            case 1:
                scripts\mp\gametypes\br_quest_util::_id_6FBB( "scavenger_2", var_3._id_045B, var_0._id_02EA, var_0._id_0054, var_6._id_C805 );
                break;
            case 3:
                break;
        }
        ...
        {
            var_6._id_C803 = var_0._id_02EA;
            var_6._id_C7F8 = var_0._id_0054;
            scripts\mp\gametypes\br_quest_util::_id_4B60( var_6._id_045B, var_3, 8, scripts\mp\gametypes\br_quest_util::_id_6C76( "scavenger" ) );
            var_6 _id_3B11( var_0._id_0186 );
        }
        else
        {
            scripts\mp\gametypes\br_quest_util::_id_4B60( var_6._id_045B, var_3, 7, scripts\mp\gametypes\br_quest_util::_id_6C76( "scavenger" ) );
            var_8 = _id_9850( var_0._id_02EA, var_6._id_C58C[var_0._id_0186._id_BEA5._id_B020 + 1] );
        ...
        var_9 = [[ _id_099D::_id_6D05( "game", "getFriendlyPlayers" ) ]]( var_3._id_045B, 0 );
...
_id_E474()
{
    ...
    for ( var_1 = 0; var_1 < 3; var_1++ )
    {
        ...
        _func_03F5( var_3.health );
        var_0 = var_3._id_02EA;
