...
_id_0271()
{
    ...
    else
    {
        ...
        _id_0A69::_id_C29F( level._id_60D1, 75 );
    ...
    if ( _id_0999::_id_6B0E() != "mp_arena_evo" )
        return;
    ...
    _id_077B::_id_0FB3( "flare_fanfare_lrg_1", "vfx/s4/flare/flare_fanfare_blue_lrg" );
    _id_077B::_id_0FB3( "flare_fanfare_lrg_2", "vfx/s4/flare/flare_fanfare_green_lrg" );
    _id_077B::_id_0FB3( "flare_fanfare_lrg_3", "vfx/s4/flare/flare_fanfare_yellow_lrg" );
    _id_077B::_id_0FB3( "flare_fanfare_lrg_4", "vfx/s4/flare/flare_fanfare_lrg" );
    level thread scripts\mp\gametypes\arena_evo_tourney::_id_021D();
    level._id_E2E7 = 0;
    level._id_ABAF = 0.0;
    level._id_41E2 = 0.0;
    level._id_318F = 0;
...
givearenaevobonusxp( var_0, var_1, var_2 )
{
    ...
    if ( _id_077B::_id_85A4( self.arenaevobonusxpallowed, 0 ) )
        return;
    ...
    _id_07E1::_id_6FC0( "arena_evo_timeXPBonus", var_0, var_1, var_3, var_4 );
...
arena_evo_set_random_loadout_active()
{
    ...
    var_2 = int( _id_077B::_id_BFC7( var_1 ) );
    _func_01E4( "ui_arena_evo_loadout_select", var_2 );
}
...
_id_81CB()
{
    ...
    var_0 = getdvarint( "scr_" + _id_0A69::_id_6A43() + "_override_teamsize", -1 );

    if ( var_0 > 0 )
    {
        _func_01D2( "scr_" + _id_0A69::_id_6A43() + "_teamsize", var_0 );
        _func_01D2( "scr_" + _id_0A69::_id_6A43() + "_squadsize", var_0 );
    }

    _func_01D2( "scr_" + _id_0A69::_id_6A43() + "_roundswitch", 0 );
    _id_0A69::_id_C29C( _id_0A69::_id_6A43(), 0, 0, 9 );
    _func_01D2( "scr_" + _id_0A69::_id_6A43() + "_roundlimit", 1 );
    _id_0A69::_id_C29B( _id_0A69::_id_6A43(), 1 );
    _func_01D2( "scr_" + _id_0A69::_id_6A43() + "_winlimit", 1 );
    _id_0A69::_id_C2C2( _id_0A69::_id_6A43(), 1 );
    _func_01D2( "scr_" + _id_0A69::_id_6A43() + "_halftime", 0 );
...
_id_AB46( var_0 )
{
    ...
    if ( !istrue( level._id_1A5C ) && var_0 _meth_876B( "ui_arena_ui_state" ) != 4 )
        var_0 _meth_82F6( "ui_arena_ui_state", 4 );
}
...
_id_1A47( var_0 )
{
    ...
    if ( isdefined( var_0 ) && var_0 != "tie" )
    {
        ...
        _func_01E4( "ui_arena_elim_order" + var_4, scripts\mp\gametypes\arena_evo_tourney_util::_id_67A0( var_0 ) + 1 );
    }
    ...
    if ( var_0 == "tie" )
    {
        ...
        {
            if ( !_id_077B::_id_85A4( var_9, var_0 ) )
    ...
    thread _id_07AC::_id_52D7( var_0, game["end_reason"][_func_0243( game[game["defenders"]] ) + "_eliminated"] );
}
