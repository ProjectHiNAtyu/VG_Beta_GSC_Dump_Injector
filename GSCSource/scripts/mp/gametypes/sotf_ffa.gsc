...
_id_81CB()
{
    ...
    _id_0A69::_id_C29B( "sotf_ffa", 1 );
    _func_01D2( "scr_sotf_ffa_winlimit", 1 );
    _id_0A69::_id_C2C2( "sotf_ffa", 1 );
    _func_01D2( "scr_sotf_ffa_halftime", 0 );
    _id_0A69::_id_C24F( "sotf_ffa", 0 );
    _func_01D2( "scr_sotf_ffa_promode", 0 );
}

_id_AB6C()
{
    level._id_0BA3["signal_chest_drop"] = _func_0139( "vfx/iw7/_requests/mp/vfx_debug_warning.vfx" );
    level._id_0BA3["signal_chest_drop_mover"] = _func_0139( "vfx/iw7/_requests/mp/vfx_debug_warning.vfx" );
}
...
_id_AB9A()
{
    ...
    {
        _id_0A69::_id_D610( var_4, var_0 );

        if ( level._id_E427 )
            _id_0A69::_id_D60E( var_4, var_0 );
        else
            _id_0A69::_id_D60E( var_4, var_1 );

        _id_0A69::_id_D609( var_4, var_2 );
    }
...
_id_D65B()
{
    ...
    var_1 = _id_0A7F::_id_6E6C( var_0["name"] );
    var_2 = stopfxontag( "mp/sotfWeapons.csv", 2, var_1, 0 );
    _func_01E4( "ui_sotf_pistol", int( var_2 ) );
...
_id_6D2C()
{
    var_0 = _id_07EE::_id_6DBF( self._id_045B );
...
_id_AB91()
{
    ...
    self._id_0309["gamemodeLoadout"] = level._id_E043[self._id_0309["team"]];
    level notify( "sotf_player_spawned", self );

    if ( !isdefined( self._id_56AA ) )
    {
        self._id_56AA = _id_07E1::_id_6CEE( "kill" );
...
_id_E280( var_0 )
{
    var_1 = _id_077B::_id_6D7C( "sotf_chest_spawnpoint", "targetname" );
...
_id_B82D( var_0 )
{
    ...
    if ( isdefined( var_5 ) )
    {
        var_7 = _func_0205( "script_model", var_4 );
        var_7 setmode( "tag_origin" );
        var_7._id_0054 = ( 90, _func_01B9( -180, 179 ), 0 );
        var_7 _meth_820B( var_5 );
        thread _id_B863( _id_077B::_id_6A40( "signal_chest_drop_mover" ), var_7 );
    }
    else
        _func_0196( _id_077B::_id_6A40( "signal_chest_drop" ), var_4 );
}
...
_id_B863( var_0, var_1 )
{
    level endon( "game_ended" );
    wait 0.05;
    _func_0197( var_0, var_1, "tag_origin" );
    wait 6;
    _func_0218( var_0, var_1, "tag_origin" );
    wait 0.05;
    var_1 _meth_809A();
}
...
_id_6932( var_0 )
{
    ...
    {
        var_5 = distance2dsquared( level._id_9A95, var_4._id_02EA );
    ...
    level._id_FE4D[level._id_FE4D.size] = var_1._id_02EA;
...
_id_6CA6( var_0 )
{
    ...
    for ( var_2 = 0; var_2 < var_0.size; var_2++ )
    {
        ...
        if ( isdefined( level._id_FE4D ) && level._id_FE4D.size > 0 )
        {
            ...
            var_1[var_1.size] = var_0[var_2]._id_02EA;
            continue;
        }
...
_id_4613()
{
    ...
    for ( var_2 = 0; _func_021E( "mp/sotfWeapons.csv", var_2, 0 ) != ""; var_2++ )
    {
        var_3 = _func_021E( "mp/sotfWeapons.csv", var_2, 2 );
        var_4 = _func_021E( "mp/sotfWeapons.csv", var_2, 1 );
...
_id_E045( var_0 )
{
    ...
    var_2 = "icon_hunted";
    _id_0980::_id_3E7B( var_1, var_2 );
    thread _id_0980::_id_3E5E();
    ...
    for (;;)
    {
        ...
        var_5 _meth_8275( "ammo_crate_use" );
        var_6 = _id_6CB2( level._id_10D5B );
        var_6 = _id_6C9E( var_6 );

        if ( _func_0120( var_6 ) )
            var_6 = _func_0378( var_6 );
        ...
        if ( var_6 == var_7 )
        {
            ...
            var_5 setweaponammoclip( var_6, var_8 );
        }
        else
        {
            if ( isdefined( var_7 ) && !_func_036F( var_7 ) )
            {
                var_9 = var_5 _meth_80C2( var_7 );
            ...
            var_5 setweaponammoclip( var_6, 0 );
            var_5 _id_099A::_id_0D67( var_6 );

            if ( var_5 getweaponammoclip( var_6 ) == 1 )
                var_5 setweaponammoclip( var_6, 1 );
        ...
        if ( var_4 > 0 )
        {
            ...
            var_10 = thread _id_0766::_id_D58E( level._id_B758, "blitz_time_0" + var_4 + "_blue", 24 );
...
_id_3E71( var_0 )
{
    for ( var_1 = 0; var_1 < level._id_FE4D.size; var_1++ )
    {
        ...
        level._id_FE4D = _id_077B::_id_1B96( level._id_FE4D, var_0 );
    }
...
_id_8A08( var_0 )
{
    var_1 = stopfxontag( "mp/sotfWeapons.csv", 2, var_0, 3 );
    var_2 = stopfxontag( "mp/sotfWeapons.csv", 2, var_0, 4 );
...
_id_6CB2( var_0 )
{
    ...
    var_2 = _func_01B8( level._id_10DB0["sum"] );
    var_3 = undefined;
...
_id_6C9E( var_0 )
{
    ...
    var_2 = [];
    var_3 = [];
    var_4 = _id_0A7F::_id_6E6C( var_0["name"] );
    var_5 = _id_0A7F::_id_688D( var_4 );
    ...
    if ( var_5.size > 0 )
    {
        ...
        for ( var_7 = 0; var_7 < var_6; var_7++ )
        {
            ...
            var_8 = _func_01B8( var_1.size );
            var_2[var_2.size] = var_1[var_8];
            var_9 = _id_0A7F::_id_1D81( var_1[var_8], var_4 );
            var_3[var_3.size] = var_9;
        }

        var_10 = _id_0A7F::_id_6E59( var_0["name"] );
        ...
        if ( var_10 == "weapon_dmr" || var_10 == "weapon_sniper" || var_4 == "iw6_dlcweap02" )
        {
            ...
            {
                if ( _id_0A7F::_id_68C6( var_13 ) == "rail" )
                {
                    var_11 = 1;
                    break;
                }
...
_id_1D68( var_0, var_1 )
{
    ...
    {
        if ( var_0 == var_1[var_2] || !_id_0A7F::_id_1D89( var_0, var_1[var_2] ) )
            return 0;
    }
...
_id_9787()
{
    self._id_0309["killChains"]++;
    scripts\mp\gamelogic::_id_E76D( "round", "killChains", self._id_0309["killChains"] );
}
    ...
    if ( level._id_159F )
    {
        switch ( self._id_EA10 )
        {
            case 2:
                ...
                thread _id_07B9::_id_DCE0( "specialty_fastsprintrecovery_sotf", self._id_EA10 );
                thread _id_9787();
                break;
            case 3:
                scripts\mp\tac_ops\hostage_utility::_id_6FA5( "specialty_lightweight" );
                thread _id_07B9::_id_DCE0( "specialty_lightweight_sotf", self._id_EA10 );
                thread _id_9787();
                break;
            case 4:
                scripts\mp\tac_ops\hostage_utility::_id_6FA5( "specialty_stalker" );
                thread _id_07B9::_id_DCE0( "specialty_stalker_sotf", self._id_EA10 );
                thread _id_9787();
                break;
            case 5:
                scripts\mp\tac_ops\hostage_utility::_id_6FA5( "specialty_regenfaster" );
                thread _id_07B9::_id_DCE0( "specialty_regenfaster_sotf", self._id_EA10 );
                thread _id_9787();
                break;
            case 6:
                scripts\mp\tac_ops\hostage_utility::_id_6FA5( "specialty_deadeye" );
                thread _id_07B9::_id_DCE0( "specialty_deadeye_sotf", self._id_EA10 );
                thread _id_9787();
                break;
        }
    }
...
{
    var_2 = var_0 thread _id_0766::_id_D58E( level._id_B758, var_1, 24, 1 );
    self._id_3E6D = var_1;
    self._id_3E6E = var_2;
}
