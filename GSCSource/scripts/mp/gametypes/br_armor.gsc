...
_id_8120()
{
    ...
    self._id_752C = 0;
    self._id_2A57 = 150;
    self _meth_82F6( "ui_br_armor_damage", 0 );
...
_id_6F65( var_0 )
{
    ...
    self _meth_82F6( "ui_br_armor_damage", var_1 );
...
_id_EDC2( var_0, var_1 )
{
    ...
    self _meth_82F6( "ui_br_helmet_class", var_2 );

    if ( self._id_2A34 == 3 )
        scripts\mp\tac_ops\hostage_utility::_id_6FA5( "specialty_stun_resistance" );

    self _meth_82F6( "ui_br_helmet_damage", 1 );
}
...
_id_B9D6( var_0, var_1, var_2 )
{
    ...
    var_4 = _func_0205( "script_model", self gettagorigin( "j_helmet" ) );
    var_4 setmode( "loot_helmet" );
    var_4._id_0054 = var_1;
    var_5 = anglestoup( var_1 );
    var_6 = var_0;
    var_7 = _func_025A( var_6 + var_5 ) * 2500;
    var_4 _meth_8254( var_4._id_02EA, var_7 );
    var_8 = "brloot_armor_helmet_" + self._id_2A34;
    var_9 = 15;
    var_10 = 0.1;
    var_9 = var_9 * ( 1 / var_10 );
    var_11 = var_4._id_02EA;

    for ( var_12 = 0; var_12 < var_9; var_12++ )
    {
        wait( var_10 );
        var_13 = var_11 - var_4._id_02EA;

        if ( var_13[0] < 2 && var_13[1] < 2 && var_13[2] < 2 && var_13[0] > -2 && var_13[1] > -2 && var_13[2] > -2 )
        {
            var_14 = var_4._id_02EA;
            var_15 = var_4._id_0054;
            var_4 _meth_809A();
...
{
    if ( isdefined( var_0 ) )
        var_0 thread _id_B9D6( var_1, var_0._id_0054, var_0._id_02EA );
}
