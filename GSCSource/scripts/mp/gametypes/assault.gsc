...
_id_0271()
{
    ...
    else
    {
        ...
        _id_0A69::registersharedfunc( _id_0A69::_id_6A43(), 3.0 );
    ...
    var_1 = _id_0A66::getvehicle( "timelimit" );
...
_id_81CB()
{
    ...
    _id_0A69::_id_C29B( "assault", 0 );
    _func_01D2( "scr_assault_scorelimit", 1 );
    _id_0A69::_id_C29F( "assault", 1 );
    _func_01D2( "scr_assault_halftime", 0 );
    _id_0A69::_id_C24F( "assault", 0 );
}
...
_id_AB9A()
{
    ...
    level._id_0BA3["bomb_explosion"] = _func_0139( "vfx/iw7/_requests/mp/vfx_debug_warning.vfx" );
...
_id_CF91( var_0, var_1 )
{
    ...
    {
        if ( !_func_0104( var_3 ) )
            var_3 _meth_82F6( "ui_objective_state", 0 );
    }
...
_id_AB2F( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_3 == game["attackers"] )
    {
        ...
        {
            var_5 = _id_0A66::getvehicle( "addObjectiveTime" );
            _id_0A66::_id_D627( "timelimit", _id_0A69::_id_6DC7() + var_5 );
            _id_C6D6();
            level._id_411C = _id_D889( level._id_411D );
        }
        else
...
_id_AAA5( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_3 == "neutral" )
    {
        var_5 = _id_0A69::_id_6BC3( var_4 )[0];
...
_id_D894()
{
    ...
    self _meth_824A( "playerPing", "+breath_sprint" );
    thread _id_1081A();
}
...
_id_4E44()
{
    ...
    var_2 = _id_077A::_id_C042( var_0, var_1, self );
    var_3 = var_2["entity"];
    var_4 = "WAYPOINT";
    var_5 = ( 1, 1, 1 );
    ...
    if ( isdefined( var_3 ) )
    {
        if ( isdefined( var_3._id_045B ) && var_3._id_045B != self._id_045B )
        {
            var_5 = ( 1, 0, 0 );
