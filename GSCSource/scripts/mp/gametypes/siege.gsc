...
_id_34B9()
{
    ...
    if ( !_id_0A7C::_id_6DAC( level._id_CA77, "aliveCount" ) )
    {
...
_id_4D0B()
{
    ...
    var_3 = _id_0999::_id_6B0E();
    var_4 = 1;

    for ( var_5 = 2; var_5 < 11; var_5++ )
    {
        var_6 = stopfxontag( var_2, var_4, var_3, var_5 );
    ...
    level._id_33BC = 3;
    _func_01E4( "ui_num_dom_flags", level._id_33BC );
    ...
    for ( var_8 = 0; var_8 < var_7.size; var_8++ )
    {
        ...
        var_10._id_02EA = _id_6A24( var_10._id_CD8C, var_10._id_02EA );

        if ( isdefined( var_10._id_0457 ) )
            var_12[0] = getent( var_10._id_0457, "targetname" );
        else
        {
            var_12[0] = _func_0205( "script_model", var_10._id_02EA );
            var_12[0]._id_0054 = var_10._id_0054;
        }
        ...
        var_14 = var_12[0]._id_02EA + ( 0, 0, 32 );
        var_15 = var_12[0]._id_02EA + ( 0, 0, -32 );
        var_16 = _id_077A::_id_C042( var_14, var_15, undefined, _id_077A::_id_3ED4( 1 ) );
        var_17 = scripts\mp\gametypes\obj_dom::_id_3504( var_13 );
        var_13._id_228F = var_16["position"] + var_17;
        var_18 = _func_025B( var_16["normal"] );
        var_19 = scripts\mp\gametypes\obj_dom::_id_3503( var_13, var_18 );
        var_13._id_228E = anglestoforward( var_19 );
        var_13._id_A5C2 = 1;
        var_13._id_5C1F = _func_0205( "script_model", var_13._id_228F );
        var_13._id_5C1F setmode( "military_dom_flag_neutral" );
    ...
    level._id_03DE["allies"] = var_21[0]._id_02EA;
    level._id_03DE["axis"] = var_20[0]._id_02EA;
    level._id_24AD = [];
...
_id_10AE8()
{
    ...
    for (;;)
    {
        ...
        if ( level._id_CA75 )
        {
            ...
            {
                var_1 = _id_0A69::_id_6BC3( var_0._id_BC58 )[0];
                ...
                if ( isdefined( level._id_DD2C ) && level._id_DD2C != "pause" && !_id_8AFB( var_1 ) )
                {
                    ...
                    if ( !_id_5C22( var_0._id_BC58 ) )
                        _id_D8E6( var_1, _func_0243( game[var_0._id_BC58] ) + "_eliminated" );
                }
            }
        }
    }
...
_id_5C22( var_0 )
{
    ...
    {
        if ( isdefined( var_3 ) && var_3._id_045B == var_0 && ( _id_0A74::_id_89D3( var_3 ) || var_3._id_0309["lives"] > 0 ) )
        {
            var_1 = 1;
            break;
        }
...
_id_10AE7( var_0 )
{
    ...
    if ( var_1 == 2 || var_2 == 2 )
    {
        level._id_CA77 = _id_077B::_id_F07F( var_1 > var_2, "allies", "axis" );
        ...
        if ( var_3 != level._id_CA77 )
        {
            if ( level._id_CA75 )
            {
                ...
                if ( !isdefined( level._id_DD2C ) || level._id_DD2C != "start" )
                {
                    ...
                    level._id_F217 = 1;
                    _id_07AC::_id_AF63( var_5 );
                    setclientnamemode( var_5 );
                    _id_07AC::_id_C725( var_5 );
...
_id_10B66( var_0 )
{
    ...
    while ( var_1 > 0 )
    {
        ...
        {
            if ( var_1 != 0 )
                var_2 _meth_827B( "ui_mp_timer_countdown" );
        }
...
_id_D8E6( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) )
        thread _id_07AC::_id_52D7( var_0, game["end_reason"][var_1], game["end_reason"][var_2] );
    else
        thread _id_07AC::_id_52D7( var_0, game["end_reason"][var_1] );
}

_id_AA66( var_0 )
{
    if ( !_id_077B::_id_1B78( level._id_DD28, self._id_A8CE ) )
    {
...
_id_ABB8( var_0 )
{
    ...
    if ( _id_0A7C::_id_885E( var_1 ) )
    {
        if ( level._id_EF67[var_1]["aliveCount"] < level._id_EF67[var_1]["players"].size )
        {
            foreach ( var_7 in level._id_EF67[var_1]["players"] )
                var_7 _meth_8275( "mp_bodycount_tick_positive" );

            var_9 = _id_0A7C::_id_69DE( var_1 );

            foreach ( var_7 in var_9 )
                var_7 _meth_8275( "mp_bodycount_tick_negative" );
        }
    }
}
...
_id_ABC1( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_1 > 0.05 && var_2 && !self._id_4959 )
    {
        if ( var_4 == "neutral" )
        {
            ...
            self._id_BC44 = _id_0A69::_id_6BC3( var_0 )[0];
        }
        else
        {
...
_id_AAAF( var_0, var_1, var_2 )
{
    ...
    level._id_DD28 = _id_077B::_id_1B96( level._id_DD28, self._id_A8CE );
    thread _id_10864();
}
...
_id_ABB4( var_0 )
{
    ...
    if ( var_1 == "neutral" )
    {
        ...
        _id_07D0::_id_A8A3( self._id_A8F5, _id_0A69::_id_6BC3( var_1 )[0] );
...
_id_AA90( var_0 )
{
    if ( _id_0A69::_id_60A6() )
    {
        ...
        else if ( var_0 == game["attackers"] )
        {
            ...
            _id_D8E6( game["defenders"], _func_0243( game[game["attackers"]] ) + "_eliminated" );
        }
        else if ( var_0 == game["defenders"] )
        {
            ...
            _id_D8E6( game["attackers"], _func_0243( game[game["defenders"]] ) + "_eliminated" );
        }
    }
}
...
_id_AB5D( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( !_id_5C22( self._id_045B ) && scripts\mp\gametypes\obj_dom::_id_6DB0( self._id_045B ) == 2 )
        _id_0A64::_id_E772( "objs_capture", var_1._id_045B, 1 );

    var_10 = 0;
    var_11 = 0;
    var_12 = 0;
    var_13 = self;
    var_14 = var_13._id_045B;
    var_15 = var_13._id_02EA;
    var_16 = var_1._id_045B;
    var_17 = var_1._id_02EA;
    var_18 = 0;

    if ( isdefined( var_0 ) )
    {
        var_17 = var_0._id_02EA;
        var_18 = var_0 == var_1;
    }
...
{
    var_2 = _id_0A7C::_id_6DAC( var_1._id_045B, "teamCount" );
    ...
    {
        if ( isdefined( var_4 ) && var_4._id_045B == var_0 && !_id_0A74::_id_89D3( var_4 ) && !_id_077B::_id_1B78( _id_0A7C::_id_6A3A( var_4._id_045B, 1 ), var_4 ) && ( !isdefined( var_4._id_10846 ) || !var_4._id_10846 ) )
        {
            if ( isdefined( var_4._id_DD2A ) && var_4._id_DD2A )
                var_4._id_DD2A = 0;

            if ( !istrue( var_4._id_0309["teamKillPunish"] ) )
            {
                if ( istrue( var_4._id_10A10 ) )
                    continue;

                var_4._id_10A10 = 1;
                var_4 thread _id_07D9::_id_1094A( 0 );
                var_4 thread _id_07E1::_id_CBF3( "revived" );
...
_id_A698( var_0 )
{
    foreach ( var_2 in level._id_B758 )
        var_2 thread _id_07B9::_id_DCE0( var_0 );
...
_id_6F7D( var_0, var_1, var_2 )
{
    ...
    if ( _func_0117( var_3 ) )
    {
        level thread _id_07BA::_id_EF8A( "callout_securedposition" + self._id_A8CE, var_3 );
        var_3 thread _id_06BB::_id_F737( level._id_9B9C, "capture", var_3._id_02EA );
    }
    ...
    {
        var_6 = var_0[var_4[var_5]]._id_030F;

        if ( isdefined( var_6._id_02F2 ) )
            var_6 = var_6._id_02F2;
        ...
        var_6 thread _id_07E1::_id_CBF3( "capture" );
        var_6 thread _id_0788::_id_6F9C( "mode_siege_secure", var_8, var_7 );
        var_6 _id_0A7B::_id_7D93( "captures", 1 );
        var_6 scripts\mp\gamelogic::_id_E76D( "round", "captures", var_6._id_0309["captures"] );
        var_6 _id_0A7B::_id_D543( var_6._id_0309["captures"] );
        var_6 _id_0A7B::_id_7D93( "rescues", self._id_B7C5 );
        var_6 scripts\mp\gamelogic::_id_E76D( "round", "rescues", var_6._id_0309["rescues"] );
        var_6 _id_0A7B::_id_D544( var_6._id_0309["rescues"] );
        wait 0.05;
    }
...
_id_FC3E()
{
    ...
    self._id_3E04 = self._id_A762 / _id_0A69::_id_6B40();
}
