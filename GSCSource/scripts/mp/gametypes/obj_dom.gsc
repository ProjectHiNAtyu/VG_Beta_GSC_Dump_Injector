...
_id_D88B( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_0._id_0457 ) )
    {
        if ( !isdefined( var_0._id_1042E ) )
            var_5[0] = getent( var_0._id_0457, "targetname" );
        else
            var_5 = var_0._id_1042E;
    }
    else
    {
        var_5[0] = _func_0205( "script_model", var_0._id_02EA );
        var_5[0]._id_0054 = var_0._id_0054;
    }
    ...
    var_10 = var_5[0]._id_02EA + ( 0, 0, 32 );
    var_11 = var_5[0]._id_02EA + ( 0, 0, -32 );
    var_12 = _id_077A::_id_3EC3( 1, 1, 1, 1, 0, 1, 1 );
    var_13 = [];
    var_14 = _id_077A::_id_C042( var_10, var_11, var_13, var_12 );
    var_15 = _id_3504( var_9 );
    var_9._id_228F = var_14["position"] + var_15;
    var_16 = _func_025B( var_14["normal"] );
    var_17 = _id_3503( var_9, var_16 );
    var_9._id_228E = anglestoforward( var_17 );
    var_18 = _func_0205( "script_model", var_9._id_228F );
    var_18 setmode( "dom_flag_scriptable" );
    var_18._id_0054 = _func_0305( var_9._id_228E, var_18._id_0054 );
    ...
    var_9._id_5C1F = _func_0205( "script_model", var_9._id_228F );
    var_9._id_5C1F setmode( "gen_flag_dom" );
    var_9._id_5C1F hide();
    var_9.friendlyflagmodel = _func_0205( "script_model", var_9._id_228F );
    var_9.friendlyflagmodel setmode( "gen_flag_dom" );
    var_9 thread flagmodelcoreloop( var_9.friendlyflagmodel, "allies" );
    var_9.enemyflagmodel = _func_0205( "script_model", var_9._id_228F );
    var_9.enemyflagmodel setmode( "gen_flag_dom" );
...
flagmodelcoreloop( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        _id_077B::_id_108F3( "updateFlagState", 0.5 );
    }
}
...
flagupdatecolor( var_0, var_1 )
{
    ...
    if ( var_2 == var_1 )
        var_0 setmode( "gen_flag_dom_blue" );
    else if ( var_2 != "neutral" )
        var_0 setmode( "gen_flag_dom_red" );
    else
        var_0 setmode( "gen_flag_dom" );

    foreach ( var_4 in level._id_B758 )
    {
        if ( var_4._id_045B == var_1 )
            var_0 _meth_83CA( var_4 );
    }
...
_id_C4E4( var_0 )
{
    ...
    if ( isdefined( var_0.enemyflagmodel ) )
        var_0.enemyflagmodel _meth_809A();

    if ( isdefined( var_0.friendlyflagmodel ) )
        var_0.friendlyflagmodel _meth_809A();
...
_id_4D07( var_0 )
{
    ...
    if ( isdefined( level._id_9BC3 ) && isdefined( self._id_9785 ) && isdefined( self._id_977A ) )
        [[ level._id_9BC3 ]]( self._id_9785, undefined, self._id_977A, self._id_1042E[0]._id_02EA[0], self._id_1042E[0]._id_02EA[1], gettime(), 0 );

    _id_0780::_id_9753( self._id_1742, self._id_1741, self._id_1042E[0]._id_02EA, -1, "neutral" );
}
...
_id_4D33( var_0, var_1 )
{
    ...
    if ( _id_0A69::_id_6A43() == "btm" )
        level thread _id_07B9::_id_FCBD( self._id_AD9B, 15, 14 );

    if ( _id_0A69::_id_6A43() == "base" )
    {
        var_3 = _func_00CA( "build_scriptable", "script_noteworthy", self._id_02EA, 3000 );

        foreach ( var_5 in var_3 )
        {
            var_5._id_045B = var_0;

            if ( var_5._id_00DE == scripts\mp\gametypes\base::_id_2293() )
    ...
    if ( isdefined( self._id_1D06[var_0] ) )
    {
        ...
        {
            var_13 = self._id_1D06[var_0][var_12]._id_030F;

            if ( isdefined( var_13._id_02F2 ) )
                var_13 = var_13._id_02F2;
...
_id_4D2F( var_0 )
{
    ...
    if ( !self._id_A422 )
    {
        ...
        _id_0A69::_id_D5EE( 21, var_1, var_0 getentitynumber(), var_4 );
...
_id_4D30( var_0 )
{
    ...
    if ( self._id_A423 )
    {
        if ( var_1 != var_0._id_045B )
            var_2 = _id_69CE();
        else
            var_2 = 0;
    }
    else if ( var_1 != var_0._id_045B )
        var_2 = 1;
    else
        var_2 = 0;

    if ( _id_0A69::_id_6A43() == "control" && var_1 != var_0._id_045B )
    {
        self._id_5C1E = 1;
        _id_07AC::_id_AF63();
    }

    var_0 _meth_82F6( "ui_objective_state", var_2 );
    ...
    var_3 = _id_077B::_id_F07F( istrue( level._id_5C21 ) && !self._id_5BA6, level._id_5C1B * 0.5, level._id_5C1B );
    _id_07AD::_id_D8C7( var_3 );

    if ( var_3 > 0 )
    {
        self._id_BC44 = _id_0A69::_id_6BC3( var_0._id_045B )[0];
        _id_FC60( var_0._id_045B );
...
_id_4D32( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_1 < 1.0 && !level._id_609B && !_id_0A69::_id_873A() )
    ...
    if ( isdefined( level._id_320A ) )
    {
        ...
        if ( var_5 )
        {
            foreach ( var_9 in self._id_F393[var_0] )
                var_9._id_030F thread _id_07E1::_id_CBF3( "segment_captured" );
        }
    }
    ...
    if ( var_1 > 0.05 && var_2 && !self._id_4959 )
    {
        if ( var_4 == "neutral" )
        {
            if ( level._id_5C1B > 0.05 )
            {
                ...
                {
                    var_11 = _id_0A69::_id_6BC3( var_0 )[0];
...
_id_FC60( var_0 )
{
    ...
    if ( _id_0A69::_id_6A43() != "arm" && _id_0A69::_id_6A43() != "defcon" )
    {
        if ( isdefined( self._id_0383 ) )
...
_id_6F7B( var_0 )
{
    ...
    {
        var_3 = var_0[var_1[var_2]]._id_030F;
        ...
        if ( istrue( level._id_5C21 ) )
            var_3 thread _id_07E1::_id_CBF3( "neutralized" );
        else
            var_3 thread _id_07E1::_id_CBF3( "capture" );
...
_id_6F7D( var_0, var_1, var_2 )
{
    ...
    if ( _func_0117( var_3 ) )
    {
        if ( _id_0A69::_id_6A43() == "cmd" || _id_0A69::_id_6A43() == "rush" )
            level thread _id_07BA::_id_EF8A( "callout_securedposition", var_3 );
        else
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        {
            var_7 = var_0[var_5[var_6]]._id_030F;
...
_id_6F7C( var_0, var_1 )
{
    ...
    if ( var_2.size > 0 )
    {
        ...
        {
            var_4 = self._id_1D06[var_0][var_2[var_3]]._id_030F;

            if ( isdefined( var_4._id_02F2 ) )
                var_4 = var_4._id_02F2;
...
_id_6F6D( var_0, var_1, var_2 )
{
    ...
    if ( var_2 )
    {
        var_0 thread _id_07E1::_id_CBF3( "capture_assist" );
        var_4 = "mode_dom_secure_assist";
    }
    else if ( var_1 )
    {
        var_5 = _id_0A69::_id_6A43() == "arm";
        ...
        if ( var_6 )
        {
            if ( var_5 )
            {
                var_0 thread _id_07E1::_id_CBF3( "neutral_capture" );
                var_4 = "mode_arm_secure_mid";
            }
            else
            {
                var_0 thread _id_07E1::_id_CBF3( "neutral_b_capture" );
    ...
    {
        var_0 thread _id_07E1::_id_CBF3( "capture" );
    ...
    if ( var_3 )
        var_0 _id_0A28::_id_6FD8( "capture", 1, 0 );
}
...
_id_D4A6()
{
    ...
    {
        scripts\mp\gamelogic::_id_E76D( "round", "captures", self._id_0309["captures"] );
...
_id_6E08( var_0, var_1 )
{
    ...
    foreach ( var_6 in level._id_A8D5 )
    {
        ...
        var_7 = distancesquared( var_6._id_047A._id_02EA, level._id_03DE[var_0] );
...
_id_1F9E( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( !isdefined( var_1._id_045B ) || !isdefined( var_13._id_045B ) )
        return;
    ...
    foreach ( var_18 in level._id_A8D5 )
    {
        ...
        if ( var_20 && var_1._id_045B != var_19 )
        {
        ...
        if ( var_19 == "neutral" )
        {
            if ( var_20 || var_21 )
            {
                if ( var_18._id_37D2 == var_13._id_045B )
                {
                    if ( !var_11 )
                    {
                        var_11 = 1;
                ...
                else if ( var_18._id_37D2 == var_1._id_045B )
                {
                    if ( !var_12 )
                    {
                        var_12 = 1;
