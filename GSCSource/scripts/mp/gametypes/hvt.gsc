...
_id_C60B()
{
    if ( _id_077B::_id_1B78( level._id_0F1D, self ) )
        level._id_0F1D = _id_077B::_id_1B96( level._id_0F1D, self );
}
...
_id_479D()
{
    _id_C788();
    level._id_0F1D = _id_077B::_id_1B96( level._id_0F1D, self );
    self _meth_82F6( "ui_hvt_status", 0 );
    thread _id_DCF9( "hvt_rank_demoted" );
    _id_07E1::_id_CBF3( "hvt_demoted" );
}
...
_id_E02A( var_0, var_1 )
{
    ...
    {
        var_2 = _id_077B::_id_1B78( level._id_0F1D, var_0 );
        return var_2;
    }
    else
...
_id_ED73()
{
    self _meth_82F6( "ui_hvt_value", self._id_ED71 );
    var_0 = 0;
    var_1 = 0;
    ...
    _id_07AE::_id_0CC9( "allies", var_0 );
    _id_07AE::_id_0CC9( "axis", var_1 );
}
...
_id_DCF9( var_0, var_1 )
{
    ...
    thread _id_07B9::_id_DCE0( var_0, var_1 );
}
...
_id_8896()
{
    ...
    return _id_077B::_id_1B78( level._id_0F1D, self );
}
...
_id_2450()
{
    ...
    _id_07E1::_id_CBF3( "hvt_status" );
    self _meth_82F6( "ui_hvt_status", 1 );
    _id_0A72::_id_0C05( "outlinefill_nodepth_orange", 0 );
...
{
    if ( _id_8896() )
        var_1 _id_07E1::_id_CBF3( "hvt_kill" );
    ...
    if ( self._id_045B == "allies" || self._id_045B == "axis" )
        _id_07AE::_id_6FE4( self._id_045B, self._id_ED71 * -1 );
}
...
_id_10B83()
{
    ...
    for (;;)
    {
        var_0 = _id_077B::_id_1BAE( level._id_B758, ::_id_E02A );
        var_1 = int( _func_0148( var_0.size, level._id_7C0A ) );
        var_2 = 0;
        ...
        for ( var_3 = 0; var_3 < var_0.size; var_3++ )
        {
            ...
            if ( !var_4 _id_8896() && var_4._id_045B != "spectator" && var_4._id_ED71 >= 10 )
            {
                var_4 _id_2450();
                var_4._id_8C90 = 1;
            }
        ...
        foreach ( var_6 in level._id_B758 )
        {
            ...
            if ( isai( var_6 ) && istrue( var_6 _id_8896() ) )
            {
                if ( !isdefined( level._id_ACBA[var_7] ) )
                {
                    level._id_ACBA[var_7] = var_6;
                    var_6._id_ACD5 = _id_0A72::_id_ACBF( var_6, var_8, "outline_nodepth_green", "level_script" );
                    var_6._id_ACD4 = _id_0A72::_id_ACBF( var_6, var_9, "outline_nodepth_red", "level_script" );
                }
            ...
            if ( isdefined( level._id_ACBA[var_7] ) )
            {
                _id_0A72::_id_ACB7( var_6._id_ACD5, var_6 );
                _id_0A72::_id_ACB7( var_6._id_ACD4, var_6 );
