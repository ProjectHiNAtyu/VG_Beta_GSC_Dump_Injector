...
_id_AB9A()
{
    ...
    _id_0A69::_id_D610( game["attackers"], &"OBJECTIVES/CTF" );
    _id_0A69::_id_D610( game["defenders"], &"OBJECTIVES/CTF" );
...
_id_1CFE()
{
    ...
    if ( level._id_EF6F.size == 2 )
    {
        ...
        foreach ( var_9 in var_0 )
        {
            ...
            if ( var_13 < 0.33 )
            {
                var_9._id_EF61 = _id_0A69::_id_6BC3( var_2._id_AD9B )[0];
            ...
            if ( var_13 > 0.67 )
            {
                var_9._id_EF61 = _id_0A69::_id_6BC3( var_3._id_AD9B )[0];
                level._id_EFA8[var_9._id_EF61][level._id_EFA8[var_9._id_EF61].size] = var_9;
                continue;
            }
...
_id_5BE8()
{
    ...
    foreach ( var_1 in level._id_01AF )
    {
        ...
        {
            case "_a":
                level._id_4549[game["attackers"]] = var_1._id_02EA;
                break;
            case "_c":
                level._id_4549[game["defenders"]] = var_1._id_02EA;
                break;
        }
    }
}
...
_id_C493( var_0 )
{
    ...
    {
        if ( isdefined( self._id_0BC2[self._id_045B] ) )
            self._id_0BC2[self._id_045B] _meth_809A();
    }
    else if ( isdefined( self._id_0BC2[_id_0A69::_id_6BC3( self._id_045B )[0]] ) )
        self._id_0BC2[_id_0A69::_id_6BC3( self._id_045B )[0]] _meth_809A();
}
...
_id_B3F4( var_0 )
{
    if ( var_0 == self._id_045B )
    {
        if ( isdefined( self._id_0BC1[self._id_045B] ) )
            self._id_0BC1[self._id_045B] _meth_809A();
    }
    else if ( isdefined( self._id_0BC1[_id_0A69::_id_6BC3( self._id_045B )[0]] ) )
        self._id_0BC1[_id_0A69::_id_6BC3( self._id_045B )[0]] _meth_809A();
}
...
_id_403C( var_0, var_1 )
{
    ...
    if ( !isdefined( var_3 ) )
    {
        ...
        var_3 = _func_0205( "trigger_radius", var_4._id_02EA - ( 0, 0, var_4._id_0333 / 2 ), 0, var_4._id_0333, 80 );
        var_3._id_A509 = 1;
        var_3._id_94FD = 1;
        var_3._id_22FB = var_3._id_02EA;
        var_2 = 1;
        var_5[0] = _func_0205( "script_model", var_4._id_02EA );
        var_5[0] _meth_85A2();
    ...
    if ( !var_2 )
    {
        ...
        var_7 = _func_0205( "trigger_radius", var_3._id_02EA, 0, var_6, var_3._id_0201 );
        var_3 = var_7;
    }
    ...
    {
        var_3 _id_5BED();
        var_3._id_02EA = var_3._id_718A;
        var_5[0]._id_02EA = var_3._id_718A - ( 0, 0, 0.5 );
    }

    var_5[0] setmode( level._id_5C1F[var_0] );
    var_5[0] _meth_85A2();
    var_5[0] _id_D708( var_1 );
    var_8 = _id_0A69::_id_6BC3( var_0 )[0];
    ...
    if ( isdefined( level._id_DC9D ) )
    {
        ...
        _id_07D0::_id_A854( var_10, "done", var_9._id_02EA );
    ...
    var_11 = var_3._id_02EA + ( 0, 0, 32 );
    var_12 = var_3._id_02EA + ( 0, 0, -32 );
    var_13 = _id_077A::_id_3EC3( 1, 1, 1, 1, 0, 1, 1 );
    var_14 = [];
    var_15 = _id_077A::_id_C042( var_11, var_12, var_14, var_13 );
    var_9._id_228F = var_9._id_1042E[0]._id_02EA;
    var_16 = anglestoup( var_9._id_1042E[0]._id_0054 );
...
_id_5C23( var_0 )
{
    return !var_0 _id_099C::_id_88BC();
}
...
_id_AB3A( var_0, var_1, var_2 )
{
    ...
    {
        if ( self._id_502B == var_0._id_045B )
        {
        ...
        {
            _id_07AD::_id_D62D( _id_0A69::_id_6BC3( var_0._id_045B )[0] );
            var_3 = self._id_502B;
        }
    ...
    if ( var_4 != var_3 )
    {
        ...
        _id_0A77::_id_BCFE( var_4, _id_0A69::_id_6BC3( var_4 )[0], undefined, undefined, "mp_obj_returned", "mp_obj_returned", var_0 );
        _id_0A64::_id_911F( "enemy_flag_returned", var_5, "status" );
        _id_0A64::_id_911F( "flag_returned", var_4, "status" );
        _id_0A69::_id_D5EE( 18, var_0._id_045B, var_0 getentitynumber() );
...
_id_AAA6( var_0 )
{
    if ( isdefined( var_0._id_9157 ) )
    {
        ...
        self._id_502B = var_0._id_045B;

    var_0 _id_FCBF();
    _id_07AD::_id_D62D( _id_0A69::_id_6BC3( self._id_502B )[0] );
    var_1 = self._id_502B;
    var_2 = _id_0A69::_id_6BC3( self._id_502B )[0];
    ...
    _id_0A64::_id_911F( "flag_dropped", _id_0A69::_id_6BC3( self._id_AC7D )[0], "status" );
...
_id_ABB8( var_0 )
{
    if ( !level._id_609B )
    {
        ...
        _id_0A69::_id_D5EE( 17, var_0._id_045B, var_0 getentitynumber() );
        _func_0166( level._id_EF6F[var_2]._id_B0CE, "done" );
        var_0 _id_FCBF();
        thread _id_07BA::_id_EF8A( "callout_flagcapture", var_0 );
        var_0 thread _id_07E1::_id_CBF3( "flag_capture" );
...
_id_AB5D( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( isdefined( var_1 ) && _func_0117( var_1 ) && var_1._id_0309["team"] != self._id_0309["team"] )
    {
        ...
        {
            var_1 thread _id_07E1::_id_CBF3( "carrier_kill" );
        ...
        if ( isdefined( self._id_32C0 ) )
        {
            ...
            _id_0A69::_id_D5EE( 20, var_1._id_045B, var_1 getentitynumber() );
            var_10 = 1;
        }
...
_id_C490()
{
    ...
    for (;;)
    {
        if ( getdvar( "scr_devRemoveDomFlag", "" ) != "" )
        {
            ...
            level._id_EF6F[var_1]._id_1042E[0] _meth_809A();
            level._id_EF6E[var_1] _meth_809A();
...
_id_B154()
{
    ...
    for (;;)
    {
        if ( getdvar( "scr_devPlaceDomFlag", "" ) != "" )
        {
            ...
            var_2 = _func_020F();
            var_2 _id_48B7();
            var_2._id_02EA = var_2._id_718A;
            var_2._id_0333 = 30;
            var_2._id_045B = var_1;
            var_3 = _func_0205( "trigger_radius", var_2._id_02EA, 0, 30, 80 );
            var_4[0] = _func_0205( "script_model", var_2._id_02EA );
            var_4[0] setmode( level._id_5C1F[var_1] );
            ...
            var_5._id_02EA = var_2._id_02EA;
            var_5._id_024D = var_1;
            var_5._id_BC28 = undefined;
            var_6 = var_3._id_02EA + ( 0, 0, 32 );
            var_7 = var_3._id_02EA + ( 0, 0, -32 );
            var_8 = _id_077A::_id_3EC3( 1, 1, 1, 1, 0, 1, 1 );
            var_9 = [];
            var_10 = _id_077A::_id_C042( var_6, var_7, var_9, var_8 );
            var_5._id_228F = var_10["position"];
            var_11 = _func_025B( var_10["normal"] );
            ...
            var_12 _id_07AD::_id_D5B8( level._id_EF6F[_id_0A69::_id_6BC3( var_1 )[0]] );
            level._id_3214[_id_0A69::_id_6BC3( var_1 )[0]] _id_07AD::_id_D5B8( var_5 );
...
_id_48B7()
{
    var_0 = level._id_B758[0]._id_02EA + ( 0, 0, 32 );
    var_1 = level._id_B758[0]._id_02EA + ( 0, 0, -1000 );
    var_2 = _id_077A::_id_3EC3( 1, 1, 1, 1, 0, 1, 1 );
    var_3 = [];
    var_4 = _id_077A::_id_C042( var_0, var_1, var_3, var_2 );
...
_id_D8BA()
{
    _id_07AC::_id_D8DA( "waypoint_ctf_kill", 2, "enemy", "MP_INGAME_ONLY/OBJ_KILL_CAPS", "icon_waypoint_kill", 0 );
    _id_07AC::_id_D8DA( "waypoint_recover_flag", 2, "friendly", "MP_INGAME_ONLY/OBJ_RECOVER_CAPS", "icon_waypoint_flag", 0 );
    _id_07AC::_id_D8DA( "waypoint_escort_flag", 2, "friendly", "MP_INGAME_ONLY/OBJ_ESCORT_CAPS", "icon_waypoint_flag", 0 );
    _id_07AC::_id_D8DA( "waypoint_take_flag", 2, "enemy", "MP_INGAME_ONLY/OBJ_TAKE_CAPS", "icon_waypoint_flag", 0 );
    _id_07AC::_id_D8DA( "waypoint_defend_flag", 2, "friendly", "MP_INGAME_ONLY/OBJ_DEFEND_CAPS", "icon_waypoint_flag", 0 );
    _id_07AC::_id_D8DA( "waypoint_mlg_empty_flag", 0, "friendly", "MP_INGAME_ONLY/OBJ_DEFEND_CAPS", "codcaster_icon_waypoint_ctf_empty", 0 );
    _id_07AC::_id_D8DA( "waypoint_mlg_full_flag", 0, "friendly", "MP_INGAME_ONLY/OBJ_DEFEND_CAPS", "codcaster_icon_waypoint_ctf_full", 0 );
}

_id_FCBF()
{
    self _meth_82F6( "ui_match_status_hint_text", 37 );
}

_id_FCBE()
{
    self _meth_82F6( "ui_match_status_hint_text", 38 );
}
