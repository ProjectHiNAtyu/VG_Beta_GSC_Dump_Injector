...
_id_9965()
{
    ...
    {
        _id_0A69::_id_C29C( "to_dd", 0, 0, 9 );
        _id_0A69::registersharedfunc( "to_dd", 3 );
        _id_0A69::_id_C29F( "to_dd", 0 );
        _id_0A69::_id_C29B( "to_dd", 1 );
        _id_0A69::_id_C2C2( "to_dd", 1 );
        _id_0A69::_id_C270( "to_dd", 0 );
        _id_0A69::_id_C24F( "to_dd", 0 );
        _id_0A69::_id_C242( "to_dd", 0 );
        _id_0A69::_id_D629( 2 );
        level._id_9BD4 = 0;
        level._id_9BD9 = 0;
    }
...
_id_AB9A( var_0 )
{
    ...
    var_1 = _id_0A66::getvehicle( "winlimit" );
    var_2[0] = "dd";
    var_2[1] = "dd_bombzone";
    var_2[2] = "blocker";
    var_2[3] = "grind";
    var_2[4] = "dom";
    var_2[5] = "conf";
    _id_07AD::_id_0271( var_2 );
    level._id_ED20 = 1;
    var_3 = _func_01B6( 1.0 );
...
_id_3F7B()
{
    ...
    _id_077B::_id_46C3( 3.0, ::_id_46B9 );
...
_id_E67F()
{
    ...
    level._id_A8D5[level._id_2BAA]._id_0383 _meth_8373( "flag", "off" );
    level._id_F2A8 = 0;
...
_id_10807()
{
    ...
    if ( level._id_7C07 == "_a" )
        level._id_5819 = _id_077B::_id_6D7C( "hostage_extraction_a", "targetname" )[0]._id_02EA;
    else
        level._id_5819 = _id_077B::_id_6D7C( "hostage_extraction_b", "targetname" )[0]._id_02EA;

    level._id_434B = _func_0205( "trigger_radius", level._id_5819, 0, 90, 128 );
    level._id_434B._id_0054 = ( 0, 0, 0 );
    ...
    level._id_434B._id_045B = "allies";
    ...
    if ( _id_0A7C::_id_6DAC( "axis", "teamCount" ) )
    {
        level._id_F345 = _id_077B::_id_1BAE( _id_0A7C::_id_6DAC( "axis", "players" ), ::_id_3AD2 );
...
_id_AB2C( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( !_func_0102( var_0 ) )
    {
        if ( !isdefined( var_0._id_EC30 ) )
            var_0 _id_07D9::_id_4533( var_0._id_045B );
    }
}
...
_id_2638( var_0, var_1, var_2 )
{
    ...
    if ( var_1 == "explode" )
    {
        ...
        if ( level._id_434C > 0 )
            level thread _id_07BA::_id_EF8A( "callout_time_added", var_0 );
