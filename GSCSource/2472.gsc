...
_id_3D14()
{
    var_0 = _id_09B4::_id_100BF( "cop_car", 1 );
    ...
    if ( _id_099D::_id_8A10( "cop_car", "init" ) )
        [[ _id_099D::_id_6D05( "cop_car", "init" ) ]]();
...
_id_3D18()
{
    if ( _id_099D::_id_8A10( "cop_car", "initLate" ) )
        [[ _id_099D::_id_6D05( "cop_car", "initLate" ) ]]();
}

_id_3D19()
{
    var_0 = _id_09BA::_id_101A1( "cop_car", 1 );
    ...
    var_3 = "driver";
    var_4 = _id_09BA::_id_101A0( "cop_car", var_3, 1 );
...
_id_3D16()
{
    level._id_0BA3["cop_car_explode"] = _func_0139( "vfx/iw8/veh/scriptables/vfx_veh_explosion_sedan.vfx" );
}
...
_id_3D0B( var_0, var_1 )
{
    ...
    _id_09B4::_id_10024( var_2, "cop_car", var_0 );
    var_2._id_A90B = _func_034C( "cop_car_mp" );
    _id_09B5::_id_10016( var_2 );
    _id_09B4::vehicle_create( var_2, var_0 );
    thread _id_09B4::_id_102E0( var_2, undefined, _id_09B4::_id_100A8 );

    if ( _id_099D::_id_8A10( "cop_car", "create" ) )
        [[ _id_099D::_id_6D05( "cop_car", "create" ) ]]( var_2 );
...
_id_3D12( var_0, var_1 )
{
    ...
    if ( !istrue( level._id_EBC0 ) )
    {
        ...
        self _meth_8287( var_2, 256, 140, 70, var_3, "MOD_EXPLOSIVE", "cop_car_mp" );
        _func_0196( _id_077B::_id_6A40( "cop_car_explode" ), var_2, anglestoforward( self._id_0054 ), anglestoup( self._id_0054 ) );
...
_id_3D0D()
{
    ...
    if ( _id_099D::_id_8A10( "cop_car", "delete" ) )
        [[ _id_099D::_id_6D05( "cop_car", "delete" ) ]]( self );
...
_id_3D1B()
{
    ...
    var_0._id_E271 = _id_099D::_id_6D05( "cop_car", "spawnCallback" );
    var_0._id_38FF = 100;
    var_0._id_38FB = 60;
    var_0._id_38FD = 100;
}
...
_id_3D13()
{
    var_0 = _id_077B::_id_6D7C( "copcar_spawn", "targetname" );
