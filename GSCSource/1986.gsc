...
_id_101B( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        var_7 = _id_077B::_id_1BA9( self._id_9446 );
        self._id_9446 = var_7;
        self._id_9446[self._id_9446.size] = _func_020F();
    }
...
_id_9A0A()
{
    ...
    for (;;)
    {
        ...
        if ( self._id_9446.size > 1 )
        {
            ...
            var_1 = _id_077B::_id_1BAE( var_0, ::_id_85D8 );
        }
        else
            var_1 = self._id_9446;
...
_id_381C()
{
    var_0 = _id_077B::_id_1BA9( self._id_9446 );
    self._id_9446 = var_0;
}
...
_id_5302( var_0, var_1 )
{
    ...
    if ( isalive( var_0 ) )
        var_2 = _id_077B::_id_10890( var_0 );
    else
        self waittill( var_0 );
...
_id_D266( var_0 )
{
    self _meth_82F6( "lb_color", var_0 );
}

_id_D26B()
{
    self _meth_82F6( "lb_gsc_controlled", 1 );
}

_id_D26A()
{
    self _meth_82F6( "lb_gsc_controlled", 0 );
}

_id_D26E( var_0 )
{
    self _meth_82F6( "lb_pulse_time", var_0 );
}
