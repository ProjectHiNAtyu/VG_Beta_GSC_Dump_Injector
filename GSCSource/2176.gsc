...
_id_5ADC( var_0, var_1, var_2, var_3 )
{
    ...
    var_4 = var_2;
    var_5 = var_0;
    var_6 = _func_0148( var_1._id_24BF, 3 );
    var_7 = 48 * ( 1 + var_6 );
    var_8 = 84 * ( 1 + var_6 );

    while ( var_3 && var_4 < var_1._id_C942.size || !var_3 && var_4 >= 0 )
    {
        var_9 = var_1._id_C942[var_4]._id_02EA;
        ...
        if ( isdefined( var_10 ) )
        {
            ...
            if ( var_3 && var_4 - 1 >= 0 )
                var_11 = var_1._id_C942[var_4 - 1]._id_02EA;
            ...
            if ( var_14 || _func_0257( var_12, var_10._id_02EA - var_11 ) > var_13 - 24 )
            {
                if ( var_3 )
        ...
        var_7 = _func_0147( var_7 - var_15, 0 );
        var_8 = _func_0147( var_8 - var_15, 0 );
        var_5 = var_9;
...
_id_5AC8( var_0, var_1 )
{
    ...
    {
        var_6 = ( var_5 + 1 ) % var_2;
        var_7 = var_1[var_6]._id_02EA - var_1[var_5]._id_02EA;
        var_8 = _func_0130( var_7 );
        var_7 = var_7 / var_8;
        var_9 = var_0 - var_1[var_5]._id_02EA;
        var_10 = _func_0257( var_7, var_9 );

        if ( var_3 > 0 && ( var_10 < 0 || var_10 > var_8 ) )
            continue;

        var_11 = ( var_7[1], -1 * var_7[0], 0 );
        var_11 = _func_025A( var_11 );
        var_12 = abs( _func_0257( var_11, var_9 ) );
...
_id_6CC9( var_0 )
{
    ...
    foreach ( var_5 in var_3._id_7BA3 )
    {
        ...
        var_6 = _func_0133( var_5._id_19D5 - self._id_02EA );
...
_id_6A8F( var_0 )
{
    ...
    {
        var_4 = _func_021A( var_3._id_CE60, " " );

        foreach ( var_6 in var_4 )
            var_1[var_1.size] = var_6;
    }

    return _id_077B::_id_1B99( var_1 );
}
...
_id_6A90( var_0, var_1 )
{
    ...
    foreach ( var_4 in var_0 )
    {
        ...
        {
            if ( _func_0121( var_6._id_CE60, var_4 ) )
            {
    ...
    foreach ( var_20, var_1 in level._id_7BA2._id_7BAA )
    {
        foreach ( var_3 in var_1._id_7BA3 )
        {
                ...
                foreach ( var_10 in var_8 )
                {
                    foreach ( var_12 in var_10._id_3BB2 )
                    {
                        if ( var_12._id_E7AB == var_7 )
                        {
                            ...
                            if ( !_id_077B::_id_1B78( var_10._id_F49A, var_6 ) )
                            {
                                var_13 = var_10._id_F49A.size;
                                var_10._id_F49A[var_13] = var_6;
                            }

                            if ( !_id_077B::_id_1B78( var_12._id_F48B, var_10 ) )
                            {
            ...
            foreach ( var_16 in var_4 )
                _id_077B::_id_1B9C( var_3._id_F48B, var_16, 0 );
        }
    }
}
...
_id_2CD8()
{
    foreach ( var_23, var_1 in level._id_7BA2._id_7BAA )
    {
        ...
        foreach ( var_3 in var_1._id_7BA3 )
        {
            ...
            {
                var_3._id_19D5 = var_3._id_C942[0]._id_02EA;
                continue;
            }
            ...
            {
                var_19 = _func_0130( var_3._id_C942[var_20]._id_02EA - var_3._id_C942[var_20 - 1]._id_02EA );
            ...
            var_3._id_19D5 = _func_0259( var_3._id_C942[var_20]._id_02EA, var_3._id_C942[var_20 + 1]._id_02EA, var_21 );
        }
    }
}
...
_id_8195()
{
    ...
    {
        level._id_7BA2._id_7BAA[var_36] = _func_020F();
        ...
        foreach ( var_19, var_8 in var_6 )
        {
            ...
            {
                if ( _func_0119( var_12._id_02EA, var_8 ) )
                {
                    ...
                    var_14 = var_12 _id_077B::_id_653D();
            ...
            {
                if ( _func_0119( var_17._id_02EA, var_8 ) )
                {
        ...
        foreach ( var_9 in level._id_7BA2._id_7BAA[var_36]._id_7BA3 )
        {
            ...
            for ( var_22 = 0; var_22 < var_9._id_C942.size; var_22++ )
            {
                ...
                {
                    if ( isdefined( var_27._id_0457 ) && var_27._id_0457 == var_23 )
                        var_25 = var_27;
                }
...
_id_7BB2( var_0, var_1 )
{
    ...
    {
        if ( !var_6 _id_077B::_id_5452( "stealth_enabled" ) || !var_6 _id_077B::_id_544E( "stealth_enabled" ) )
            continue;
        ...
        for ( var_3 = 0; var_3 < var_2; var_3++ )
        {
            ...
            if ( _func_0119( var_6._id_02EA, var_4._id_1069F ) )
            {
                var_7 = var_4;
                break;
            }

            var_9 = _func_0133( var_4._id_19D5 - var_6._id_02EA );
    ...
    {
        var_4 = var_1._id_7BA3[var_3];
        var_18 = _func_0147( var_4._id_24C0, var_18 );
    }
...
_id_7BC4( var_0 )
{
    if ( !self._id_03E1._id_3912._id_88B3 && _func_0119( self._id_02EA, var_0._id_1069F ) )
    {
