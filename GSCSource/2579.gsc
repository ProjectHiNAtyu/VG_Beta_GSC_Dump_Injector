...
_id_10AC2( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    var_3 _meth_827E( level._id_2968[var_1]._id_47C8, self );
...
_id_9B3A( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isdefined( var_10._id_94F7 ) && isdefined( var_10._id_94F7._id_02AE ) && var_10._id_94F7._id_02AE != "" )
    {
        var_9._id_02EA = var_10._id_94F7._id_02EA;
    ...
    var_9 thread _id_07CD::_id_73E7( var_10 );
    var_9._id_A270 = var_10._id_94F7;
    var_9 setorigin( var_7 );
    waitframe();
...
_id_47C4( var_0 )
{
    if ( var_0 == "mp_satcom" )
        return 1;
    else if ( _func_0121( var_0, "paris_catacombs_iron" ) )
        return 1;
    else if ( _func_0121( var_0, "mp_warhawk_iron_gate" ) )
        return 1;
...
_id_888B()
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        {
            if ( _func_034D( var_0 ) == var_2._id_04D5 )
                return 1;
        }
    }
...
_id_3F7A( var_0, var_1, var_2 )
{
    ...
    var_4 = _func_0205( "script_model", var_1 - ( 0, 0, 1 ) );
    var_4 setmode( var_3._id_9FBD );
    var_4._id_01FF = 999999;
    var_4._id_027F = var_3._id_027F;
    var_4._id_0054 = var_2._id_0054;
    var_4._id_296B = var_0;
    var_4._id_02F2 = var_2;
    var_4._id_045B = var_2._id_045B;
...
_id_2957( var_0, var_1, var_2 )
{
    ...
    self _meth_832B( var_3._id_020A );
    ...
    if ( !isdefined( self _meth_8151() ) )
        _id_07D0::_id_FB94( var_4, self._id_02EA );
    else
    ...
    {
        if ( var_4 != -1 )
            _id_07D0::_id_A8B7( var_4, self._id_045B );

        _id_2958( self._id_045B, var_3._id_EA0F, var_3._id_75DA );

        foreach ( var_6 in level._id_B758 )
        {
            if ( self._id_045B != var_6._id_045B )
                continue;
    ...
    {
        if ( var_4 != -1 )
            _id_07D0::_id_A892( var_4, self._id_02F2 );

        if ( !isdefined( var_3._id_31DB ) || self._id_02F2 [[ var_3._id_31DB ]]( self ) )
            _id_2958( self._id_02F2, var_3._id_EA0F, var_3._id_75DA );
    }
    ...
    _id_07E9::_id_C2A4( "Tactical_Ground", self._id_02F2 );

    if ( isdefined( self._id_02F2 ) )
        self._id_02F2 notify( "new_deployable_box", self );
    ...
    if ( level._id_EF62 )
    {
        foreach ( var_6 in level._id_AE69 )
        {
            if ( istrue( var_3._id_8A7A ) )
                ...
                _id_0B3F( var_6, self._id_045B == var_6._id_045B, var_3._id_31DB );
    ...
    {
        foreach ( var_6 in level._id_AE69 )
            _id_0B3F( var_6, isdefined( self._id_02F2 ) && self._id_02F2 == var_6, var_3._id_31DB );
    }
...
_id_2944( var_0 )
{
    if ( self._id_045B == var_0._id_045B || istrue( level._id_2968[self._id_296B]._id_8A7A ) )
    {
        _id_294C( var_0 );
        thread _id_2969( var_0 );
    }
...
_id_294D()
{
    ...
    _id_079A::_id_A0EC( var_0._id_027F, var_0._id_42DC, ::_id_294F, ::_id_2954, 1 );
}
...
_id_294E()
{
    ...
    {
        _func_0196( var_0._id_4400, self._id_02EA );
        self _meth_827B( "mp_killstreak_disappear" );
    }
    else
    {
        var_1 = self._id_02EA + ( 0, 0, var_0._id_75DA );
        ...
        if ( isdefined( var_0._id_43BE ) )
        {
            ...
            {
                _func_0196( var_0._id_57AD, self._id_02EA );
                self _meth_827B( "c4_expl_trans" );
            }

            _func_01B5( var_1, var_0._id_43C0, var_0._id_43BE, var_0._id_43BF, var_2, "MOD_EXPLOSIVE", "support_box_mp" );
            thread _id_07EB::_id_7127( self._id_02EA, 1.0 );
        }
    }
...
_id_2969( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( var_2 == var_0 )
        {
            var_0 _meth_8275( var_1._id_ABC0 );

            if ( isdefined( var_1._id_ABBA ) )
                var_0 [[ var_1._id_ABBA ]]( self );

            if ( isdefined( self._id_02F2 ) && var_0 != self._id_02F2 && !_id_099C::_id_B779( self._id_02F2, var_0 ) )
                self._id_02F2 thread _id_0A76::_id_6FE6( "support", undefined, var_1._id_FEF5 );
...
_id_4E7C( var_0 )
{
    ...
    if ( level._id_EF62 )
    {
        if ( self._id_045B == var_0._id_045B )
        {
            if ( isdefined( self._id_2965 ) )
    ...
    else if ( isdefined( self._id_02F2 ) && self._id_02F2 == var_0 )
    {
        if ( isdefined( self._id_2965 ) )
            _id_0766::_id_D583( self._id_2965, var_0 );
...
_id_2963( var_0 )
{
    ...
    while ( isdefined( self ) )
    {
        ...
        if ( isdefined( level._id_2968[self._id_296B]._id_A6B2 ) && level._id_2968[self._id_296B]._id_A6B2 && _id_0A7F::_id_88DC( var_0 getcurrentweapon() ) )
            continue;
...
_id_8856( var_0 )
{
    return level._id_EF62 && self._id_045B == var_0._id_045B;
}
...
_id_295A()
{
    ...
    if ( isdefined( var_0._id_1068E ) )
        self._id_02F2 thread _id_0A64::_id_9120( var_0._id_1068E );
...
{
    wait 0.25;
    self _meth_820B( var_0, "tag_origin", ( 0, 0, 0 ), ( 0, 0, 0 ) );
    var_0 waittill( "death" );
    _id_2952();
}
