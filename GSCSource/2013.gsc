...
_id_021D()
{
    ...
    level._id_BA7E._id_5695 = _func_020F();
...
_id_AB4E( var_0, var_1, var_2 )
{
    ...
    if ( _id_06BB::_id_69A5( var_2 ) == "splash" && !var_1 _id_0A69::_id_8A2E() )
...
_id_AB5D( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_12 = _id_077A::_id_3EC3( 0, 1, 1, 1, 1, 1, 1, 1 );
    ...
    var_15 = _id_077B::_id_10E74( var_0 geteye(), var_0 getplayerangles(), var_2._id_02EA, cos( 80 ) );
    ...
    if ( _id_06BB::_id_69A5( var_3 ) == "splash" )
    {
        if ( _id_0A69::_id_6DC8() <= 12000 && _func_01B9( 0, 2 ) == 0 )
    ...
    if ( isdefined( var_9._id_9086 ) && var_7 - var_9._id_9086 < 1000 && _func_01B9( 0, 2 ) == 0 )
    ...
    if ( level._id_EF62 )
    {
        var_6._id_9087[var_0._id_045B] = var_0;
        var_6._id_9088[var_0._id_045B] = var_7;
    }
...
_id_7426( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        var_6 = _id_0A7F::_id_8A86( var_4 );

        if ( isdefined( var_1._id_E34F ) )
        {
            var_7 = distancesquared( var_1._id_E34F, var_1._id_02EA );
...
{
    var_5 = _id_06BB::_id_B7B4( var_0, 1000 );
...
_id_10314( var_0 )
{
    ...
    var_0._id_006E _id_07DC::_id_BD5E( "vehicle_destroyed" );
}
...
_id_B7C8( var_0 )
{
    ...
    if ( var_0 == "crouch" )
    {
        ...
        {
            if ( distancesquared( self._id_8FEA, self._id_02EA ) < 40000 )
            {
...
_id_FD27( var_0 )
{
    ...
    var_1 = _id_69EC();
    var_2 = _id_077B::_id_F07F( var_0, 1.0, 0.0 );
