...
_id_0271()
{
    ...
    self._id_2570 = 1;
    var_3 = var_1._id_02EA - var_0._id_02EA;
    ...
    if ( var_3[2] > 0 )
    {
        if ( var_8[2] > 0 )
        {
            ...
            if ( var_10.size > 0 )
            {
                ...
                if ( length( var_4 ) < 0.64 * length( var_8 ) )
                    var_11 = 0.4;
                ...
                var_11 = 1;
                var_12 = 1;
                var_16 = var_1._id_02EA - self._id_02EA;
                var_17 = var_8 - var_14;

                if ( length( var_16 ) < 0.5625 * length( var_17 ) )
                    var_11 = 0.75;
                ...
                var_20 = _func_01C2( var_19, var_5 );
                var_21 = var_1._id_02EA - var_20;
                var_22 = var_15 - var_14;
                var_23 = _func_01C2( var_22, var_5 );
                var_24 = var_21 - self._id_02EA;
        ...
        else
        {
            ...
            if ( var_25.size > 0 )
            {
                ...
                if ( isdefined( var_26 ) )
                {
                    var_27 = var_26 - self._id_02EA;
                    var_28 = var_1._id_02EA - var_26;
            ...
            self _meth_82B2( var_0._id_02EA, var_1._id_02EA, var_31 );
            _id_0017::_id_B343( var_2, 0, "traverse" );
        }
    }
    else
    {
        ...
        if ( var_25.size > 0 )
        {
            ...
            if ( abs( var_33 ) > 0 )
            {
                var_34 = self._id_02EA[2] - var_1._id_02EA[2];
