...
_id_C329()
{
    ...
    level._id_2805["isUsing"]["odin_assault"] = _id_0A74::_id_8AB5;
    level._id_2805["isUsing"]["odin_support"] = _id_0A74::_id_8AB5;
    level._id_2805["isUsing"]["heli_pilot"] = _id_0A74::_id_8AB5;
    level._id_2805["isUsing"]["switchblade_cluster"] = _id_0A74::_id_8AB5;
    ...
    level._id_2805["control_aiming"]["heli_sniper"] = _id_077B::_id_51A7;
    ...
    var_0 = _id_077B::_id_6D7C( "so_chopper_boss_path_struct", "script_noteworthy" );
    level._id_27CA = [];

    foreach ( var_2 in var_0 )
    {
        if ( isdefined( var_2._id_0372 ) )
            level._id_27CA = _id_077B::_id_1B63( level._id_27CA, var_2 );
    }
    ...
    {
        var_5._id_FFBA = var_5._id_02EA;
        var_6 = var_5._id_02EA + ( 0, 0, 50 );
        var_5._id_FF2E = 1;

        if ( var_6[2] <= var_5._id_02EA[2] - 1000 )
            var_5._id_FF2E = 0;
    ...
    foreach ( var_5 in level._id_27CA )
        var_8 = _func_0147( var_8, var_5._id_02EA[2] );
    ...
    foreach ( var_14 in var_11 )
    {
        if ( _func_002A( var_14 ) < 0.25 )
            level._id_AD06 = _id_077B::_id_1B63( level._id_AD06, var_14 );
    }
...
_id_27FB( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( self._id_A53A ) )
    {
        ...
        var_9 = distancesquared( self._id_02EA, self._id_A53A._id_02EA );

        if ( var_9 < spawnstruct( var_8 ) )
        {
            var_5 = 0;
            var_6 = 0;
        }
        else if ( var_9 < spawnstruct( 200 ) )
            var_5 = 0;
    }
    ...
    if ( var_10 || var_5 )
    {
        var_11 = _func_00B4( self._id_02EA, 500, 0, 512 );
        ...
        if ( isdefined( var_11 ) && var_11.size > 0 )
        {
            if ( isdefined( var_4 ) && var_4 )
            {
                ...
                foreach ( var_14 in var_12 )
                {
                    if ( newhudelem( var_14 ) )
                    {
                        ...
                        {
                            if ( newhudelem( var_18 ) )
                                var_16++;
                        }

                        if ( var_16 / var_15.size > 0.5 )
                            var_11 = _id_077B::_id_1B63( var_11, var_14 );
                    }
                }
            }
            ...
            if ( var_10 )
            {
                ...
                {
                    if ( _id_077A::_id_0B4D( var_14._id_02EA + ( 0, 0, 30 ), var_14._id_02EA + ( 0, 0, 400 ), 0, self ) )
                    {
                        var_7 = var_14;
                        break;
                    }
                ...
                var_7 = self _meth_8048( var_11, _func_0148( 3, var_11.size ), "node_hide" );
    ...
    scripts\cp_mp\utility\weapon_utility::_id_28CA( var_0, var_1, var_0._id_04CE );
...
_id_2720()
{
    ...
    while ( self [[ level._id_2805["isUsing"]["switchblade_cluster"] ]]() && isdefined( var_1 ) )
    {
        ...
        {
            if ( isdefined( var_14 ) && var_14._id_02F2 == self && var_14._id_10D06 == "switch_blade_child_mp" )
            {
                var_15 = 1;
                ...
                if ( var_15 )
                {
                    ...
                    var_19._id_0457 = var_6;
                    var_6 = undefined;
                    var_5 = _id_077B::_id_1B63( var_5, var_19 );
                }
            }
        }
        ...
        for ( var_21 = 0; var_21 < var_5.size; var_21++ )
        {
            ...
            if ( isdefined( var_17 ) && isdefined( var_17._id_0354 ) && !_id_077B::_id_1B78( level._id_C8AB, var_17._id_0354 ) )
            {
        ...
        if ( isdefined( var_10 ) )
        {
            ...
            if ( !isai( var_10 ) || !self _meth_8027( var_22 ) )
            {
                if ( !isai( var_10 ) )
                    var_11 = 1;
        ...
        if ( !isdefined( var_22 ) )
        {
            ...
            foreach ( var_17 in var_5 )
            {
                if ( isdefined( var_17._id_0457 ) )
                    var_25 = _id_077B::_id_1B63( var_25, var_17._id_0457 );
            }

            var_24 = _id_077B::_id_1B97( var_24, var_25 );

            foreach ( var_29 in var_24 )
            {
                if ( var_29 scripts\mp\tac_ops\hostage_utility::_id_0BF6( "specialty_noplayertarget" ) )
                    continue;

                if ( self _meth_8027( var_29 ) || var_12 && _id_077B::_id_10E74( self geteye(), var_1._id_0054, var_29._id_02EA, self _meth_8031() ) )
                {
                    if ( !_id_26E4() && distancesquared( var_29._id_02EA, self._id_02EA ) < 40000 )
                        continue;

                    var_23 = _id_077B::_id_1B63( var_23, var_29 );
                    ...
                    var_30 = _func_025A( var_22._id_02EA - var_1._id_02EA );
                    var_31 = _func_025A( var_29._id_02EA - var_1._id_02EA );
                    var_32 = anglestoforward( var_1._id_0054 );
                    var_33 = _func_0257( var_30, var_32 );
                    var_34 = _func_0257( var_31, var_32 );
        ...
        {
            var_2 = undefined;
            var_36 = var_1._id_02EA[2] - var_22._id_02EA[2];
            var_37 = self _meth_802E();

            if ( var_37 == "recruit" )
                var_9 = var_22._id_02EA;
            else if ( var_36 < 5000 )
                var_9 = var_22._id_02EA;
            else if ( _func_0130( var_22 _meth_8131() ) < 25 )
                var_9 = var_22._id_02EA;
            ...
            if ( var_7 )
                var_41 = _func_0148( var_41 * 3, 1.0 );
        ...
        {
            if ( !isdefined( var_2 ) )
                var_2 = _id_077B::_id_BFC7( level._id_AD06 );

            var_43 = _func_00F6( var_2 )._id_02EA;
...
_id_9F49( var_0, var_1 )
{
    ...
    var_3 = _func_025A( var_1 - var_2 );
    return _func_025B( var_3 );
}
...
_id_9F48( var_0, var_1 )
{
    ...
    var_3 = ( var_1 - var_0._id_02EA[2] ) / var_2[2];
    var_4 = var_0._id_02EA + var_2 * var_3;
    return var_4;
}
...
_id_5A9D( var_0 )
{
    for (;;)
    {
        ...
        {
            if ( isdefined( var_2 ) && var_2._id_02F2 == var_0 )
                return var_2;
        }
...
_id_FFB4()
{
    if ( !scripts\cp_mp\utility\weapon_utility::_id_11B6() )
        return 0;

    if ( scripts\cp_mp\utility\weapon_utility::_id_88D2( "vanguard" ) )
        return 0;
...
_id_8ABF()
{
    return _id_0A74::_id_8AB5() && self._id_FF16 == "vanguard" && isdefined( self._id_C336 );
}
...
_id_2721()
{
    ...
    while ( var_2 && !var_5 )
    {
        var_6 = _func_00B5( self._id_1001E._id_02EA, 1024, 64, 512, "path" );

        if ( isdefined( var_3 ) )
            var_6 = _id_077B::_id_1B96( var_6, var_3 );
        ...
        var_10 = _id_09D1::_id_2875( "GetNodesOnPathVanguard", _id_09D1::_id_5FFF, self._id_1001E._id_02EA, var_3._id_02EA );
        ...
        for ( var_11 = 0; var_11 < var_10.size; var_11++ )
        {
            ...
            if ( var_11 == 0 && distancesquared( self._id_02EA, var_12._id_02EA ) < 1600 )
                continue;
            ...
            var_14 = self._id_1001E._id_02EA;
            var_15 = gettime() + 2500;

            while ( distance2dsquared( var_12._id_02EA, self._id_1001E._id_02EA ) > var_13 * var_13 )
            {
                ...
                {
                    var_15 = gettime() + 2500;
                    var_16 = distancesquared( self._id_1001E._id_02EA, var_14 );
                ...
                var_17 = _func_025A( var_12._id_02EA - self._id_1001E._id_02EA );
                self _meth_8059( _func_025B( var_17 )[1], 0.2 );
                self _meth_8044( var_12._id_02EA, 0.2, "script_forced" );
                var_18 = var_12._id_02EA[2] + 64;
                var_19 = var_18 - self._id_1001E._id_02EA[2];
    ...
    var_21 = self._id_1001E._id_02EA[2];
    var_22 = undefined;
    var_23 = gettime() + 2000;
    var_24 = [];
    var_24[0] = ( 1, 0, 0 );
    ...
    var_24[6] = ( -1, 1, 0 );
    var_24[7] = ( -1, -1, 0 );
    var_25 = _id_5A9B( self._id_1001E._id_02EA, "vanguard" );

    while ( var_25._id_FFBA[2] - self._id_1001E._id_02EA[2] > 20 )
    {
        if ( gettime() > var_23 )
        {
            var_23 = gettime() + 2000;
            ...
            {
                var_19 = self._id_1001E._id_02EA[2] - var_21;

                if ( var_19 < 20 && !var_5 )
                {
                    var_26 = _id_077B::_id_1B94( var_24 );

                    foreach ( var_28 in var_26 )
                    {
                        if ( _id_B9F3( self._id_1001E._id_02EA + var_28 * 64 ) )
                        {
                            if ( !_id_077A::_id_0B4D( self._id_1001E._id_02EA, self._id_1001E._id_02EA + var_28 * 64, 0, self._id_1001E ) )
                            {
                                wait 0.05;
                                continue;
                            }
        ...
        if ( isdefined( var_22 ) )
        {
            self _meth_8059( _func_025B( var_22 )[1], 0.05 );
...
{
    if ( newhudelem( var_0 ) )
        return _id_B9F3( var_0._id_02EA );
...
_id_B9F3( var_0 )
{
    ...
    var_3 = _id_077A::_id_0B4D( var_1, var_2, 0, undefined );
    return var_3;
}

_id_FFB7()
{
    var_0 = _func_0080( self._id_02EA );

    if ( isdefined( var_0 ) && !newhudelem( var_0 ) )
        return 0;

    wait 0.05;

    if ( !_id_B9F3( self._id_02EA + ( 18, 0, 25 ) ) )
        return 0;
    ...
    if ( !_id_B9F3( self._id_02EA + ( 0, 18, 25 ) ) )
        return 0;
...
_id_FFB5()
{
    ...
    while ( self [[ level._id_2805["isUsing"]["vanguard"] ]]() )
    {
        ...
        if ( isai( self._id_017D ) && self _meth_8027( self._id_017D ) )
        {
            var_10 = 1;
            var_6 = self._id_017D;
            var_5 = 0;
        ...
        {
            foreach ( var_12 in level._id_33D8 )
            {
                if ( var_12 == self || !isai( var_12 ) )
                    continue;

                if ( var_12 scripts\mp\tac_ops\hostage_utility::_id_0BF6( "specialty_noplayertarget" ) )
                    continue;

                if ( !isdefined( var_12._id_045B ) )
                    continue;

                if ( !level._id_EF62 || self._id_045B != var_12._id_045B )
                {
                    if ( _id_077B::_id_10E74( var_7, var_8, var_12._id_02EA, var_9 ) )
                    {
                        var_5 = var_5 + 0.05;

                        if ( isdefined( var_6 ) )
                        {
                            var_13 = distancesquared( self._id_1001E._id_02EA, var_6._id_02EA );
                            var_14 = distancesquared( self._id_1001E._id_02EA, var_12._id_02EA );
        ...
        if ( isdefined( var_6 ) )
        {
            if ( ( _func_0104( var_6 ) || _func_0117( var_6 ) ) && _func_0130( var_6 _meth_8131() ) < 25 )
                var_0 = var_6._id_02EA;
            ...
            if ( distancesquared( self._id_1001E._id_1DA3._id_02EA, var_0 ) < level._id_FFB8 * level._id_FFB8 )
            {
                if ( _id_26E4() || distancesquared( self._id_1001E._id_1DA3._id_02EA, self._id_02EA ) > level._id_FFB8 * level._id_FFB8 )
                {
                    var_2 = gettime();
                    self _meth_804D( "attack" );
                }
        ...
        {
            var_1 = gettime() + _func_01B9( 1000, 2000 );
            var_0 = _id_66BC();
...
_id_FFBB( var_0 )
{
    ...
    foreach ( var_5 in var_3 )
    {
        if ( var_5._id_FF2E )
        {
            if ( var_0._id_02EA[2] != var_0._id_FFBA[2] || var_5._id_02EA[2] != var_5._id_FFBA[2] )
            {
                ...
                if ( distancesquared( var_7, var_6 ) < 1 )
                    var_2 = _id_077B::_id_1B63( var_2, var_5 );
...
_id_76E5()
{
    ...
    if ( _id_0A20::_id_56AE( self._id_045B ) )
        return 0;
...
_id_76E9()
{
    ...
    while ( self [[ level._id_2805["isUsing"]["heli_pilot"] ]]() )
    {
        ...
        {
            if ( isdefined( var_4 ) && !_id_077B::_id_1B78( var_0, var_4 ) )
                var_2 = 0;
        }
...
_id_76E6()
{
    ...
    while ( self [[ level._id_2805["isUsing"]["heli_pilot"] ]]() )
    {
        ...
        if ( var_8 )
        {
            ...
            if ( var_9 && ( _id_26E4() || distancesquared( var_2, self._id_02EA ) > level._id_76E8 * level._id_76E8 ) )
                self _meth_804D( "attack" );

            if ( gettime() > var_4 + 500 )
            {
                var_11 = _func_01B7( -1 * var_6 / 2, var_6 / 2 );
            ...
            var_15 = _func_025A( var_2 - var_14 );
            var_16 = anglestoforward( self getplayerangles() );
            var_17 = _func_0257( var_15, var_16 );
        ...
        var_18 = var_2 - self._id_1001E._id_02EA;
        var_19 = _func_0130( var_18 );
        var_20 = _func_025B( var_18 );
        var_21 = _func_000A( self._id_1001E._id_0054[0] );
        ...
        var_2 = self._id_1001E._id_02EA + var_18 * var_19;

        if ( _func_0130( var_2 ) == 0 )
            var_2 = ( 0, 0, 10 );
...
_id_284A()
{
    var_0 = gettime() >= self._id_A917.objweapon;
    ...
    if ( var_0 || var_1 )
    {
        ...
        var_3 = [];
        var_4 = distancesquared( self._id_02EA, self._id_A917._id_EEAA._id_02EA );

        for ( var_5 = 0; var_5 < var_2.size; var_5++ )
        {
            var_6 = _id_2845( var_2[var_5] );
            var_3[var_5] = distancesquared( self._id_A917._id_EEAA._id_02EA, var_6 );
        }
        ...
        if ( var_0 )
        {
            ...
            for ( var_5 = 0; var_5 < var_2.size; var_5++ )
            {
                if ( var_3[var_5] < spawnstruct( level._id_A91D ) )
                {
        ...
        if ( var_1 )
        {
            ...
            for ( var_5 = 0; var_5 < var_2.size; var_5++ )
            {
                if ( var_3[var_5] < spawnstruct( level._id_A925 ) )
                {
...
_id_2849()
{
    ...
    for ( var_2 = 0; var_2 < var_0.size; var_2++ )
    {
        ...
        var_1[var_2] = distancesquared( self._id_A917._id_EEAA._id_02EA, var_3 );

        if ( var_1[var_2] < spawnstruct( level._id_A91B / 2 ) )
            return 1;
    }
...
_id_2848()
{
    ...
    foreach ( var_2 in var_0 )
    {
        if ( distancesquared( var_2, self._id_A917._id_EEAA._id_02EA ) < 2500 )
            return 1;
    }
...
_id_2843()
{
    ...
    foreach ( var_2 in level._id_3248 )
    {
        ...
        {
            var_3[0] = self;
            var_4 = _id_077B::_id_634A( var_2._id_02EA, level._id_B758, var_3 );

            if ( var_4.size > 0 && var_4[0]._id_045B == self._id_045B )
                var_0 = _id_077B::_id_1B63( var_0, var_2._id_02EA );
        }
    }
    ...
    foreach ( var_8 in var_6 )
    {
        if ( _func_0104( var_8 ) && var_8 _id_09D1::_id_27DB() )
            var_0 = _id_077B::_id_1B63( var_0, var_8._id_02EA );
    }
...
_id_A0C6()
{
    for (;;)
    {
        self._id_A917._id_EEAA._id_A3E5 = _func_0080( self._id_A917._id_EEAA._id_02EA );

        if ( _id_09D1::_id_286B( self._id_A917._id_EEAA._id_02EA, 200 ) )
            self._id_A917._id_EEAA._id_A3E8 = self._id_A917._id_EEAA._id_02EA;
        else
...
_id_271D( var_0 )
{
    ...
    var_5 = self._id_A917._id_EEAA._id_02EA;
    var_6 = gettime();
    ...
    while ( self [[ level._id_2805["isUsing"][var_0] ]]() )
    {
        ...
        {
            var_6 = gettime();
            var_8 = distance( var_5, self._id_A917._id_EEAA._id_02EA );
            var_5 = self._id_A917._id_EEAA._id_02EA;
        ...
        if ( gettime() > var_3 || !isdefined( var_4 ) )
        {
            ...
            else
            {
                ...
                var_11 = _func_00F6( var_2 )._id_02EA;

                if ( distance2dsquared( self._id_A917._id_EEAA._id_02EA, var_11 ) < 10000 )
                {
                    var_2 = _id_077B::_id_BFC7( level._id_AD06 );
                    var_11 = _func_00F6( var_2 )._id_02EA;
                    var_6 = gettime();
        ...
        var_12 = var_4 - self._id_A917._id_EEAA._id_02EA;
...
_id_2845( var_0 )
{
    ...
    {
        if ( _func_0130( var_0 _meth_8131() ) < 25 )
            return var_0._id_02EA;
        ...
        if ( var_3 <= 400 )
        {
            var_4 = _func_025A( var_0 _meth_8131() );
            var_5 = _func_025A( self._id_A923[var_1] - var_0._id_02EA );

            if ( _func_0257( var_4, var_5 ) < -0.5 )
                return var_0._id_02EA;
        }
...
_id_2842( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) )
        var_3 = _id_077B::_id_1B96( var_3, var_2 );

    if ( var_3.size > 0 )
    {
        var_4 = _id_077B::_id_634A( self._id_A917._id_EEAA._id_02EA, var_3 );
        return var_4[0];
    }
...
_id_2847()
{
    ...
    if ( var_4 == 0 )
    {
        ...
        foreach ( var_8 in var_6 )
        {
            if ( distancesquared( var_8._id_02EA, self._id_A917._id_EEAA._id_02EA ) < 14400 )
                var_5 = 1;
        }
    ...
    if ( var_2 - var_4 >= 2 )
    {
        var_10 = _id_077B::_id_634A( self._id_A917._id_EEAA._id_02EA, var_1[var_0] );
        var_11 = _id_077B::_id_634A( self._id_A917._id_EEAA._id_02EA, var_3[var_0] );
        var_12 = distance( self._id_A917._id_EEAA._id_02EA, var_10[0]._id_02EA );
        var_13 = distance( self._id_A917._id_EEAA._id_02EA, var_11[0]._id_02EA );
...
{
    var_3 = _id_27F5( self._id_045B, var_0, var_1 );
    ...
    foreach ( var_7 in var_3 )
    {
        ...
        if ( _id_077B::_id_10E74( self._id_1001E._id_02EA, self getplayerangles(), var_7._id_02EA, var_9 ) )
        {
            if ( !var_8 || self _meth_8027( var_7 ) )
                var_5 = _id_077B::_id_1B63( var_5, var_7 );
        }
    }
...
_id_76E3( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
        ...
        return _id_077B::_id_BFC7( var_0 );
}
...
_id_27F6( var_0 )
{
    ...
    foreach ( var_5 in var_1 )
    {
        ...
        if ( isdefined( var_7 ) )
            var_2[var_7] = _id_077B::_id_1B63( var_2[var_7], var_5 );
    }
...
_id_27F4( var_0 )
{
    return _id_27F5( self._id_045B, "enemy", var_0 );
}

_id_27F3( var_0 )
{
    return _id_27F5( self._id_045B, "ally", var_0 );
}
...
_id_27F5( var_0, var_1, var_2 )
{
    ...
    {
        if ( var_6 == self || !isai( var_6 ) )
            continue;

        var_7 = 0;

        if ( var_1 == "ally" )
            var_7 = level._id_EF62 && var_0 == var_6._id_045B;
        else if ( var_1 == "enemy" )
            var_7 = !level._id_EF62 || var_0 != var_6._id_045B;
        ...
        if ( var_7 )
        {
            ...
            if ( isdefined( var_8 ) && newhudelem( var_8 ) )
                var_3 = _id_077B::_id_1B63( var_3, var_6 );
        }
    }

    var_3 = _id_077B::_id_1B96( var_3, self );
    return var_3;
}
...
{
    if ( var_0 )
        return spawnstruct( 100 );
    else
        return spawnstruct( 30 );
}

_id_279B( var_0 )
{
    if ( var_0 )
        return spawnstruct( 300 );
    else
        return spawnstruct( 90 );
}
...
_id_271A( var_0, var_1 )
{
    ...
    var_5 = _id_5A9B( self._id_1001E._id_02EA, var_0 );
    var_6 = undefined;
    self._id_A45A = 0;
    var_7 = "needs_new_goal";
    var_8 = undefined;
    var_9 = self._id_1001E._id_02EA;
    var_10 = 3.0;
    var_11 = 0.05;
    ...
    while ( self [[ level._id_2805["isUsing"][var_0] ]]() )
    {
        if ( gettime() > self._id_A45A && var_7 == "needs_new_goal" )
        {
            ...
            if ( isdefined( var_5 ) )
            {
                ...
                if ( var_1 )
                {
                    var_14 = var_5._id_02EA + ( _id_0A6F::_id_6A79() + level._id_27CB );
                    var_15 = var_5._id_02EA + ( _id_0A6F::_id_6A79() - level._id_27CB );
                    var_16 = _id_077A::_id_0B4C( var_14, var_15, 0, undefined, 0, 0, 1 );
        ...
        else if ( var_7 == "waiting_till_goal" )
        {
            if ( !var_1 )
            {
                var_17 = var_6[2] - self._id_1001E._id_02EA[2];
            ...
            var_18 = var_6 - self._id_1001E._id_02EA;
            ...
            if ( var_8 < _id_279A( var_1 ) )
            {
                ...
                if ( self _meth_802E() == "recruit" )
                    self._id_A45A = gettime() + _func_01B9( 5000, 7000 );
                else
                    self._id_A45A = gettime() + _func_01B9( 3000, 5000 );
            ...
            {
                var_18 = var_6 - self._id_1001E._id_02EA;
                var_19 = _func_025B( var_18 );
                var_20 = _id_077B::_id_F07F( var_8 < _id_279B( var_1 ), 0.5, 1.0 );
                self _meth_8059( var_19[1], var_11, var_20 );
                var_10 = var_10 - var_11;

                if ( var_10 <= 0.0 )
                {
                    if ( distancesquared( self._id_1001E._id_02EA, var_9 ) < 225 )
                    {
                        var_5._id_28F3[self._id_54E1]++;
                        var_7 = "needs_new_goal";
                    }
...
_id_66BC()
{
    ...
    {
        var_3 = _func_0029( var_2, self._id_045B, "enemy_predict" );

        if ( var_3 > 0 )
            var_0 = _id_077B::_id_1B63( var_0, var_2 );
    }
    ...
    if ( var_0.size > 0 )
    {
        var_6 = _id_077B::_id_BFC7( var_0 );
        var_7 = _id_077B::_id_BFC7( _func_00F7( var_6 ) );
    ...
    else
    {
        ...
        while ( var_10 < 10 )
        {
            ...
            if ( isdefined( var_8 ) )
                var_11 = _id_077B::_id_BFC7( var_8 );
            else
                var_11 = _func_03DB( _func_01B8( var_9 ) );

            if ( isdefined( var_11 ) )
            {
                var_5 = var_11._id_02EA;

                if ( newhudelem( var_11 ) && distance2dsquared( var_11._id_02EA, self._id_1001E._id_02EA ) > 62500 )
                    break;
            }
        }
    }
