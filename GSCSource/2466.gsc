...
_id_0C2D( var_0, var_1, var_2, var_3, var_4 )
{
...
_id_10C12( var_0, var_1 )
{
    ...
    _id_10BC( var_0 );
    _id_1095( var_0 );
    var_1 _id_077B::_id_1087E( "death", "clearTargetLockedOntoByProjectile" );
...
_id_5056( var_0, var_1, var_2 )
{
    ...
    var_3 = _func_01B7( 150, 350 );
    var_4 = _func_01B7( 150, 250 );
    ...
    var_5 = _id_0777::_id_A5B2( 0, 200, var_1 );
    var_6 = _id_0777::_id_5878( 950, 1300, var_5 );
    ...
    var_10 = _id_0777::_id_5878( -7.0, -5.0, var_5 );
    var_11 = _id_0777::_id_5878( 0.75, 1.1, var_5 );
    ...
    var_0 physicslaunchserver( var_12, var_8 );
}
