...
_id_CF5B()
{
    ...
    if ( !isdefined( var_0 ) && isdefined( level._id_60D1 ) )
    {
        var_1 = "scripted_widgets_" + level._id_60D1;

        if ( _func_0225( "scripted_widget_list_assets.csv", 0, var_1 ) != -1 )
            var_0 = _func_038E( "scriptedwidgetslist:scripted_widgets_" + level._id_60D1 );
    }
    ...
    if ( !isdefined( level._id_7B23 ) )
        level._id_7B23 = _func_020F();

    if ( !isdefined( level._id_7B23._id_CF5A ) )
        level._id_7B23._id_CF5A = _func_020F();
    ...
    var_3.anchor_types = [];
    var_3._id_1A15 = [];
    var_3.list_widget_data = _func_020F();
    ...
    if ( isdefined( var_0.anchors ) )
    {
        foreach ( var_21, var_18 in var_0.anchors )
        {
            ...
            if ( isdefined( var_19 ) )
            {
                var_20 = _func_0243( var_18._id_174A );
    ...
    foreach ( var_32, var_23 in var_0._id_CF5A )
    {
        ...
        if ( isdefined( var_24 ) )
        {
            var_25 = _func_0243( var_23.scripted_widget );
            var_3._id_10E18[var_25] = _func_020F();
            var_3._id_10E18[var_25].health = var_32 + 1;

            if ( isdefined( var_24._id_1A0D ) )
            {
                var_5 = _func_038E( "scriptedwidgetarchetype:" + var_24._id_1A0D );
                var_7 = _func_0243( var_24._id_1A0D );
            ...
            if ( isdefined( var_24.parameters ) )
            {
                ...
                {
                    if ( var_27._id_02BA != "" )
                        var_3._id_10E18[var_25].parameters[_func_0243( var_27._id_02BA )] = var_28;
                }
            }
            ...
            if ( isdefined( var_24._id_E75B ) )
            {
                ...
                {
                    if ( var_30._id_02BA != "" )
                        var_3._id_10E18[var_25]._id_E75B[_func_0243( var_30._id_02BA )] = var_31;
                }
            }
        }
    }
...
_id_789E( var_0, var_1 )
{
    ...
    if ( !isdefined( level._id_7B23._id_78C6 ) )
        level._id_7B23._id_78C6 = _func_020F();
    ...
    if ( isdefined( var_1 ) && _func_021C( var_1 ) )
    {
        ...
        {
            var_5 = _func_021E( var_1, var_4, 0 );

            if ( var_5 != "" )
                var_2._id_10E19[_func_0243( var_5 )] = var_4;
        }
    }
}
...
_id_789D( var_0, var_1 )
{
    ...
    foreach ( var_4 in var_0 )
    {
        ...
        self setclientomnvar( var_2._id_AA2B, var_2._id_10E19[var_4], var_1 );
    }
}
...
_id_CF55( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_4 ) )
    {
        ...
        self _meth_82F6( "ui_scripted_widget_type_" + var_4, var_3._id_10E18[var_1].health );
...
scripted_widget_set_param( var_0, var_1 )
{
    ...
    var_4 = "ui_scripted_widget_param_" + var_3.health;
...
_id_CF58( var_0, var_1 )
{
    ...
    var_2 = level._id_7B23._id_CF5A;
    var_3 = self._id_0F02[var_0];
    var_4 = "ui_scripted_widget_data_" + var_3.health;
...
_id_CF59( var_0, var_1 )
{
    ...
    var_2 = level._id_7B23._id_CF5A;
    var_3 = self._id_0F02[var_0];
    var_4 = "ui_scripted_widget_state_" + var_3.health;
...
scripted_widget_anchor_to_ent( var_0, var_1, var_2 )
{
    ...
    var_5.ent_num = var_4;
    self.scripted_widget_anchors[var_4][var_0] = var_5.health;
    var_6 = "ui_scripted_widget_ent_" + var_5.health;
    self _meth_82F6( var_6, var_1 );
    _widget_set_omnvar( var_3.anchor_types[var_2], "ui_scripted_widget_position_" + var_5.health );
...
scripted_widget_set_position( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_11 = "ui_scripted_widget_position_" + var_10.health;
    self _meth_82F6( var_11, var_8 );
}
...
scripted_widget_set_priority( var_0, var_1 )
{
    ...
    var_2 = level._id_7B23._id_CF5A;
    var_3 = self._id_0F02[var_0];
    var_4 = "ui_scripted_widget_priority_" + var_3.health;
    self _meth_82F6( var_4, var_1 );
}
...
scripted_widget_archetype_set_field_values( var_0, var_1, var_2 )
{
    ...
    var_5 = "ui_scripted_widget_data_" + var_4.health;
    var_6 = undefined;

    if ( !istrue( var_2 ) )
        var_6 = "ui_scripted_widget_time_" + var_4.health;
...
scripted_widget_archetype_set_progress( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = self._id_0F02[var_0];
    var_6 = "ui_scripted_widget_data_" + var_5.health;
    var_7 = "ui_scripted_widget_time_" + var_5.health;
...
scripted_widget_set_timestamp( var_0, var_1 )
{
    ...
    var_2 = level._id_7B23._id_CF5A;
    var_3 = self._id_0F02[var_0];
    var_4 = "ui_scripted_widget_time_" + var_3.health;
    self _meth_82F6( var_4, var_1 );
}
...
_id_950F( var_0, var_1, var_2 )
{
    ...
    foreach ( var_8, var_6 in var_1 )
    {
        ...
        var_7 = _id_0C27( var_0, _func_0243( var_8 ), var_6 );
...
list_widget_shift_items( var_0, var_1 )
{
    ...
    var_4 = _id_077B::_id_1BAC( self._id_0F02[var_0]._id_9505, 0, var_3 );
    var_5 = _id_077B::_id_1BAC( self._id_0F02[var_0]._id_9505, var_3, var_2 );
    self._id_0F02[var_0]._id_9505 = _id_077B::_id_1B72( var_5, var_4 );
    _list_widget_update_list( var_0 );
}
...
{
    var_0 = _func_0243( var_0 );
    self._id_0F02[var_0]._id_9505 = _id_077B::_id_1BAA( self._id_0F02[var_0]._id_9505 );
    _list_widget_update_list( var_0 );
}
...
{
    var_1 = _func_0243( var_1 ) + var_0 getentitynumber();
...
_id_0B36( var_0 )
{
    ...
    var_0 _id_077B::_id_1087D( "death", "disconnected", "deleted" );
...
_widget_archetype_set_field_values( var_0, var_1, var_2, var_3 )
{
    ...
    self _meth_82F6( var_1, var_7 );

    if ( isdefined( var_3 ) )
        self _meth_82F6( var_3, gettime() );
}
...
_widget_archetype_set_progress( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    self _meth_82F6( var_1, var_9 );
    self _meth_82F6( var_5, gettime() );
}
...
_widget_archetype_set_progress_bool( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    self _meth_82F6( var_1, var_8 );
    self _meth_82F6( var_4, gettime() );
}
...
_id_0CB3( var_0, var_1 )
{
    ...
    if ( self._id_1F65.size > 0 )
    {
        ...
        self._id_1F65 = _id_077B::_id_1B9C( self._id_1F65, 0 );
        self._id_0F02[var_0] = _func_020F();
        self._id_0F02[var_0].health = var_3;
...
_id_0CB2( var_0 )
{
    ...
    if ( isdefined( self._id_0F02[var_0] ) )
        var_2 = self._id_0F02[var_0].health;
...
_scripted_widget_reset_omnvars( var_0 )
{
    ...
    self _meth_82F6( var_2, 0 );
    self _meth_82F6( var_3, 0 );
    self _meth_82F6( var_4, 0 );
    self _meth_82F6( var_5, 0 );
    self _meth_82F6( var_6, 0 );
    self _meth_82F6( var_7, 0 );
    self _meth_82F6( var_8, 0 );
    self _meth_82F6( var_9, undefined );
}
...
_id_0C27( var_0, var_1, var_2 )
{
    ...
    if ( var_12 >= 0 )
    {
        ...
        self._id_0EF8[var_0][var_1] = _func_020F();
...
_list_widget_group_reserve( var_0, var_1 )
{
    ...
    {
        var_4 = "ui_scripted_widget_data_" + self._id_0F02[var_0].health;
...
{
    if ( istrue( var_3 ) )
        self._id_0F02[var_0]._id_9505 = _id_077B::_id_1B72( var_2, self._id_0F02[var_0]._id_9505 );
    else
        self._id_0F02[var_0]._id_9505 = _id_077B::_id_1B72( self._id_0F02[var_0]._id_9505, var_2 );
    ...
    foreach ( var_8, var_6 in var_1 )
    {
        ...
        self _meth_82F6( var_7, var_4._id_10E18[var_6].health );
    }
...
{
    self._id_0F02[var_0]._id_9505 = _id_077B::_id_1B97( self._id_0F02[var_0]._id_9505, var_1 );
    _list_widget_update_list( var_0 );
}
