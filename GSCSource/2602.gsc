...
_id_021D()
{
    _id_0A28::_id_C25C( "manual_turret", _id_0991::_id_F78F );
    _id_7FD0();
    _id_7FD1();
    _id_099D::_id_C2A5( "manual_turret", "monitorDamage", ::_id_9A4A );
    _id_099D::_id_C2A5( "manual_turret", "createHintObject", ::_id_9A45 );
    _id_099D::_id_C2A5( "manual_turret", "getTargetMarker", ::_id_9A48 );
    _id_099D::_id_C2A5( "manual_turret", "getEnemyPlayers", ::_id_9A47 );
    _id_099D::_id_C2A5( "manual_turret", "watchForPlayerEnteringLastStand", ::_id_9A49 );
}

_id_7FD0()
{
    level._id_D0ED["manual_turret"] = _func_020F();
    level._id_D0ED["manual_turret"]._id_01FF = 999999;
    level._id_D0ED["manual_turret"]._id_027F = 650;
    ...
    level._id_D0ED["manual_turret"]._id_04D5 = "manual_turret_mp";
...
{
    scripts\engine\trace::_id_EDBA( var_1 );
    var_3 = _id_0991::_id_F78E( "manual_turret" );

    if ( !var_3 )
        scripts\engine\trace::_id_6F76( "equip_shieldturret", var_1 );
    else
    {
        _id_7FD0();
        _id_7FD1();
...
_id_9A47( var_0 )
{
    return _id_0A7C::_id_69DE( var_0 );
}
